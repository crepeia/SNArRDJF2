---
title: "SNA Centralities 32.CENTRALIDADE_ACESSO E CONFIANÇA"
...
# 32.CENTRALIDADE_ACESSO E CONFIANÇA
...
```
#1. Descriptive Analysis for 32.CENTRALIDADE_ACESSO E CONFIANÇA
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acessoeconfianca, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acessoeconfianca)/10, main="Histogram of Indegree Nodes - 32.CENTRALIDADE_ACESSO E CONFIANÇA")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acessoeconfianca, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acessoeconfianca)/10, main="Histogram of Outdegree Nodes - 32.CENTRALIDADE_ACESSO E CONFIANÇA")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acessoeconfianca, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acessoeconfianca)/10, main="Histogram of All Degree Nodes - 32.CENTRALIDADE_ACESSO E CONFIANÇA")
```  
...
#Histogram acessoeconfianca degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(acessoeconfianca, weights=E(acessoeconfianca)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(acessoeconfianca)/10, main="Histogram of Strength Degree Nodes - 32.CENTRALIDADE_ACESSO E CONFIANÇA")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acessoeconfianca, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acessoeconfianca)/10, main="Histogram of Normalized Indegree Nodes - 32.CENTRALIDADE_ACESSO E CONFIANÇA")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acessoeconfianca, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acessoeconfianca)/10, main="Histogram of Normalized Outdegree Nodes - 32.CENTRALIDADE_ACESSO E CONFIANÇA")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acessoeconfianca, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acessoeconfianca)/10, main="Histogram of Normalized All Degree Nodes - 32.CENTRALIDADE_ACESSO E CONFIANÇA")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(acessoeconfianca), breaks=vcount(acessoeconfianca)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 32.CENTRALIDADE_ACESSO E CONFIANÇA")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 32.CENTRALIDADE_ACESSO E CONFIANÇA ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 32.CENTRALIDADE_ACESSO E CONFIANÇA"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 32.CENTRALIDADE_ACESSO E CONFIANÇA)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acessoeconfianca)$acessoeconfianca_a.nn.deg <- graph.knn(acessoeconfianca,V(acessoeconfianca))$knn
```
...
plot(degree(acessoeconfianca), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 32.CENTRALIDADE_ACESSO E CONFIANÇA"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 32.CENTRALIDADE_ACESSO E CONFIANÇA)
...
sd(acessoeconfianca_a.nn.deg_w)
```
...
plot(degree(acessoeconfianca), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 32.CENTRALIDADE_ACESSO E CONFIANÇA"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(acessoeconfianca)$size <- degree(acessoeconfianca)
V(acessoeconfianca)$label <- V(acessoeconfianca)$V5_LABEL_TIPO_NOME
V(acessoeconfianca)$label.cex <- degree(acessoeconfianca)/100
V(acessoeconfianca)$label.color <- "black"

## Just in case if we wanna change colors
#V(acessoeconfianca)$color <- V(acessoeconfianca)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(acessoeconfianca)$weight <- E(acessoeconfianca)$weight
E(acessoeconfianca)$width <- E(acessoeconfianca)$weight
E(acessoeconfianca)$color <- "gray"

## Here we can change other edge parameter
#E(acessoeconfianca)[ weight < 0.5 ]$width <- 4
#E(acessoeconfianca)[ weight < 0.5 ]$color <- "green"
#E(acessoeconfianca)$label <- LETTERS[1:10]
#E(acessoeconfianca)$label.cex = seq(1, 2,length.out = 10)
#E(acessoeconfianca)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(acessoeconfianca, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(acessoeconfianca, 
     ...
     edge.width=(edge.betweenness(acessoeconfianca, weights=V(acessoeconfianca)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ", cex = .5)
...
plot(acessoeconfianca, 
     ...
     edge.width=(edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
...
plot(small_acessoeconfianca, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_acessoeconfianca)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_acessoeconfianca, 
     ...
     vertex.label.cex=log(degree(small_acessoeconfianca)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_acessoeconfianca, mode="in")), 
     median(degree(small_acessoeconfianca, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #acessoeconfianca_a.nn.deg_w 
plot(acessoeconfianca, 
     layout=layout.kamada.kawai(acessoeconfianca), 
     vertex.label=get.vertex.attribute(acessoeconfianca,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(acessoeconfianca,V(acessoeconfianca))$knn+1)/30,
     edge.width=(edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(acessoeconfianca, 
     layout=layout.kamada.kawai(acessoeconfianca), 
     vertex.label=get.vertex.attribute(acessoeconfianca,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(acessoeconfianca,V(acessoeconfianca), weights= E(acessoeconfianca)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(acessoeconfianca,V(acessoeconfianca), weights= E(acessoeconfianca)$weight)$knn+1)/10,
     edge.width=edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(acessoeconfianca,V(acessoeconfianca), weights= E(acessoeconfianca)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acessoeconfianca)$incloseness_w <- closeness(acessoeconfianca, mode = "in", normalized = T, weights=E(acessoeconfianca)$weight) %>% round(6)
V(acessoeconfianca)$outcloseness_w <- closeness(acessoeconfianca, mode = "out", normalized = T,weights=E(acessoeconfianca)$weight) %>% round(6)
V(acessoeconfianca)$totalcloseness_w <- closeness(acessoeconfianca, mode = "total", normalized = T, weights=E(acessoeconfianca)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
acessoeconfianca_incloseness_w<- closeness(acessoeconfianca, mode = "in", normalized = T, weights=E(acessoeconfianca)$weight) %>% round(6)
acessoeconfianca_outcloseness_w<- closeness(acessoeconfianca, mode = "out", normalized = T, weights=E(acessoeconfianca)$weight) %>% round(6)
acessoeconfianca_totalcloseness_w<- closeness(acessoeconfianca, mode = "total", normalized = T, weights=E(acessoeconfianca)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acessoeconfianca)$acessoeconfianca_closeness_stats_w <- closeness(acessoeconfianca, vids = V(acessoeconfianca), mode = "all", weights =E(acessoeconfianca)$weight, normalized = FALSE)
acessoeconfianca_closeness_stats_w <- closeness(acessoeconfianca, vids = V(acessoeconfianca), mode = "all", weights =E(acessoeconfianca)$weight, normalized = FALSE)
```
...
acessoeconfianca_outcloseness_w<- closeness(acessoeconfianca, mode = "out", normalized = T, weights=E(acessoeconfianca)$weight) %>% round(6)
acessoeconfianca_totalcloseness_w<- closeness(acessoeconfianca, mode = "total", normalized = T, weights=E(acessoeconfianca)$weight) %>% round(6)
acessoeconfianca_closeness_stats_w <- closeness(acessoeconfianca, vids = V(acessoeconfianca), mode = "all", weights=E(acessoeconfianca)$weight, normalized = FALSE) %>% round(6)
...
acessoeconfianca_incloseness_w,
acessoeconfianca_outcloseness_w,
acessoeconfianca_totalcloseness_w,
acessoeconfianca_closeness_stats_w,
...
#Adding names
names(acessoeconfianca_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
acessoeconfianca_df_closseness<-acessoeconfianca_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(acessoeconfianca)$acessoeconfianca_color_degree<-round(V(acessoeconfianca)$acessoeconfianca_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(acessoeconfianca, mode="in")), 
     median(closeness(acessoeconfianca, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acessoeconfianca)$acessoeconfianca_betweenness_w <- betweenness(acessoeconfianca, weights=E(acessoeconfianca)$weight) %>% round(1)
acessoeconfianca_betweenness_w <- betweenness(acessoeconfianca, weights=E(acessoeconfianca)$weight) %>% round(1)
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(acessoeconfianca)$acessoeconfianca_centr_betweenness<-(centralization.betweenness(acessoeconfianca)$res)/10000
...
#Adding Title
  title("Network Centralization Betweenness - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(acessoeconfianca)$eigenvector <- eigen_centrality(acessoeconfianca, directed = TRUE, weights =E(acessoeconfianca)$weight) %$% vector %>% round(3)
acessoeconfianca_eigenvector <- eigen_centrality(acessoeconfianca, directed = TRUE, weights = E(acessoeconfianca)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
acessoeconfianca_eigenvector_value <- eigen_centrality(acessoeconfianca, directed = TRUE, weights = E(acessoeconfianca)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
plot(acessoeconfianca, 
     layout=layout.kamada.kawai(acessoeconfianca), 
     vertex.label=get.vertex.attribute(acessoeconfianca,"LABEL_COR"),
     vertex.size=(eigen_centrality(acessoeconfianca, directed =TRUE, weights = E(acessoeconfianca)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(acessoeconfianca)$vector)+1)/10,
     edge.width=edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(acessoeconfianca, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(acessoeconfianca, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(acessoeconfianca, directed = T)$vector), 
     sd(centr_eigen(acessoeconfianca, directed = T)$vector)
   ))
```
...
acessoeconfianca_power_centrality_stats <- power_centrality(acessoeconfianca, nodes = V(acessoeconfianca), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(acessoeconfianca)$acessoeconfianca_power_centrality_stats <-power_centrality(acessoeconfianca, nodes = V(acessoeconfianca), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(acessoeconfianca)$LABEL_COR, acessoeconfianca_power_centrality_stats))
...
V(acessoeconfianca)$acessoeconfianca_power_centrality_stats_r<-round(V(acessoeconfianca)$acessoeconfianca_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(acessoeconfianca)$acessoeconfianca_power_centrality_stats_r)), "Blues"))(length(unique(V(acessoeconfianca)$acessoeconfianca_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(acessoeconfianca)$color_spower <- vertex_col_spower[factor(V(acessoeconfianca)$acessoeconfianca_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(acessoeconfianca)$acessoeconfianca_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(acessoeconfianca_power_centrality_stats),sd(acessoeconfianca_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
acessoeconfianca_alpha_centrality_stats <- alpha_centrality(acessoeconfianca, loops = FALSE, alpha = 1, exo = 1, weights=E(acessoeconfianca)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(acessoeconfianca)$acessoeconfianca_alpha_centrality_stats<-alpha_centrality(acessoeconfianca, loops = FALSE, alpha = 1, exo = 1, weights=E(acessoeconfianca)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(acessoeconfianca)$LABEL_COR, round(acessoeconfianca_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(acessoeconfianca)$acessoeconfianca_alpha_centrality_stats_r<-round(V(acessoeconfianca)$acessoeconfianca_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(acessoeconfianca)$acessoeconfianca_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(acessoeconfianca)$acessoeconfianca_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(acessoeconfianca)$color_s <- vertex_col_s[factor(V(acessoeconfianca)$acessoeconfianca_alpha_centrality_stats_r)]  
```
...
plot(acessoeconfianca, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(acessoeconfianca, loops = FALSE, alpha = 1, exo = 1, weights=E(acessoeconfianca)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(acessoeconfianca)$acessoeconfianca_alpha_centrality_stats_r
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(acessoeconfianca_alpha_centrality_stats),sd(acessoeconfianca_alpha_centrality_stats)
     ))
```
...
plot(acessoeconfianca, 
     layout=layout.kamada.kawai(acessoeconfianca), 
     vertex.label=get.vertex.attribute(acessoeconfianca,"LABEL_COR"),
     vertex.size=10*hub.score(acessoeconfianca)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(acessoeconfianca, 
     layout=layout.kamada.kawai(acessoeconfianca), 
     vertex.label=get.vertex.attribute(acessoeconfianca,"LABEL_COR"),
     vertex.size=10*authority.score(acessoeconfianca)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(acessoeconfianca)+1)/20,
     edge.width=log(edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(acessoeconfianca, 
     layout=layout.kamada.kawai(acessoeconfianca), 
     vertex.label=get.vertex.attribute(acessoeconfianca,"LABEL_COR"),
     vertex.size=200*page.rank(acessoeconfianca)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(acessoeconfianca)+1)/15,
     edge.width=log(edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 32.CENTRALIDADE_ACESSO E CONFIANÇA", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_acessoeconfianca, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_acessoeconfianca)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_acessoeconfianca, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_acessoeconfianca)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_acessoeconfianca)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_acessoeconfianca, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_acessoeconfianca)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_acessoeconfianca_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_acessoeconfianca_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_acessoeconfianca_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_acessoeconfianca_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_acessoeconfianca_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_acessoeconfianca_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_acessoeconfianca_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_acessoeconfianca, 
     ...
     vertex.size=degree(msp_acessoeconfianca)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_acessoeconfianca)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_acessoeconfianca, 
     layout=layout.auto(msp_acessoeconfianca), 
     vertex.label=get.vertex.attribute(msp_acessoeconfianca,"LABEL_COR"),
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_acessoeconfianca, mode="in")), 
     median(degree(msp_acessoeconfianca, mode="out"))
...
msp_acessoeconfianca_w<-minimum.spanning.tree(acessoeconfianca, weights=1/edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_acessoeconfianca_w, 
     layout=layout.auto(msp_acessoeconfianca_w), 
     ...
     edge.width=1/edge.betweenness(msp_acessoeconfianca_w, weights =E(msp_acessoeconfianca_w)$msp_acessoeconfianca_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
acessoeconfianca_sp_in <- shortest.paths(acessoeconfianca, mode='in', weights=E(acessoeconfianca)$weight) # sames as bellow
acessoeconfianca_sp_out <- shortest.paths(acessoeconfianca, mode='out', weights=E(acessoeconfianca)$weight) #same as above
acessoeconfianca_sp_all <- shortest.paths(acessoeconfianca, mode='all', weights=E(acessoeconfianca)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_acessoeconfianca<-distances(acessoeconfianca, mode="all", weights=E(acessoeconfianca)$weight)
#distances_sp_all_acessoeconfianca

#In shortest paths 
distances_sp_in_acessoeconfianca<-distances(acessoeconfianca, mode="in",weights=E(acessoeconfianca)$weight)
#distances_sp_in_acessoeconfianca

#Out shortest paths 
distances_sp_out_acessoeconfianca<-distances(acessoeconfianca, mode="out", weights=E(acessoeconfianca)$weight)
...
acessoeconfianca_dist.from.CAPSAD <- distances(acessoeconfianca, v=V(acessoeconfianca)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(acessoeconfianca), weights=E(acessoeconfianca)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(acessoeconfianca, weights=E(acessoeconfianca)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(acessoeconfianca, weights=E(acessoeconfianca)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(acessoeconfianca, weights=E(acessoeconfianca)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_acessoeconfianca_u_size<-sapply(cliques(acessoeconfianca_u), length) # too intesive calculation
```
...
V(as.undirected_acessoeconfianca_u)$vcollabel[V(as.undirected_acessoeconfianca_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_acessoeconfianca_u)$vcollabel [V(as.undirected_acessoeconfianca_u)$vcol=="grey80"]<-"Others"
```
...
plot(as.undirected(acessoeconfianca_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(acessoeconfianca_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(acessoeconfianca_u), weights =E(as.undirected(acessoeconfianca_u))$acessoeconfianca))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Coreness Colored Graph - 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(acessoeconfianca)$edge.btweenness<-edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight)
acessoeconfianca_edge.betweenness <-edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight)
```
...
plot(acessoeconfianca, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(acessoeconfianca)+1)/10,
     edge.width=log(edge.betweenness(acessoeconfianca, weights =E(acessoeconfianca)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_acessoeconfianca1, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_acessoeconfianca1)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(acessoeconfianca, weights=E(acessoeconfianca)$weight)
acessoeconfianca_dim<-get.diameter(acessoeconfianca, weights=E(acessoeconfianca)$weight)
acessoeconfianca_dim
```
...
#Adding Title
  title("Diameter of 32.CENTRALIDADE_ACESSO E CONFIANÇA", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
