---
title: "SNA Centralities 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12)."
...
# 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).
...
```
#1. Descriptive Analysis for 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var12, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var12)/10, main="Histogram of Indegree Nodes - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var12, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var12)/10, main="Histogram of Outdegree Nodes - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var12, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var12)/10, main="Histogram of All Degree Nodes - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```  
...
#Histogram var12 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var12, weights=E(var12)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var12)/10, main="Histogram of Strength Degree Nodes - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var12, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var12)/10, main="Histogram of Normalized Indegree Nodes - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var12, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var12)/10, main="Histogram of Normalized Outdegree Nodes - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var12, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var12)/10, main="Histogram of Normalized All Degree Nodes - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var12), breaks=vcount(var12)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12). ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12)."
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).)
...
plot(degree(var12), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12)."
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).)
...
plot(degree(var12), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12)."
     )
```
...
#Adding Title
  title("Network Vertex Degree Sized - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ", cex = .5)
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
...
#Adding Title
  title("Network Higher Than Median Degree - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Network Lower than Median Degree - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var12, mode="in")), 
     median(degree(small_var12, mode="out"))
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Centralization Closeness - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var12, mode="in")), 
     median(closeness(var12, mode="out"))
...
#Adding Title
  title("Network Vertex Betweenness Sized - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Centralization Betweenness - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Eigenvector Centrality Measure - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network EigenVector - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Hub Sized - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Authorities Scores  Sized - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Google Page Rank Sized - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var12, mode="in")), 
     median(degree(msp_var12, mode="out"))
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Distance from CAPS AD - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Coreness Colored Graph - 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
#Adding Title
  title("Diameter of 14.CENTRALIDADE_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
