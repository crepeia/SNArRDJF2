---
title: "SNA Centralities 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)"
...
# 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)
...
```
#1. Descriptive Analysis for 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var7, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var7)/10, main="Histogram of Indegree Nodes - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var7, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var7)/10, main="Histogram of Outdegree Nodes - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var7, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var7)/10, main="Histogram of All Degree Nodes - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)")
```  
...
#Histogram var7 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var7, weights=E(var7)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var7)/10, main="Histogram of Strength Degree Nodes - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var7, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var7)/10, main="Histogram of Normalized Indegree Nodes - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var7, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var7)/10, main="Histogram of Normalized Outdegree Nodes - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var7, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var7)/10, main="Histogram of Normalized All Degree Nodes - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var7), breaks=vcount(var7)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$var7_a.nn.deg <- graph.knn(var7,V(var7))$knn
```
...
plot(degree(var7), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var7)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var7), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var7)$size <- degree(var7)
V(var7)$label <- V(var7)$V5_LABEL_TIPO_NOME
V(var7)$label.cex <- degree(var7)/100
V(var7)$label.color <- "black"

## Just in case if we wanna change colors
#V(var7)$color <- V(var7)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var7)$weight <- E(var7)$weight
E(var7)$width <- E(var7)$weight
E(var7)$color <- "gray"

## Here we can change other edge parameter
#E(var7)[ weight < 0.5 ]$width <- 4
#E(var7)[ weight < 0.5 ]$color <- "green"
#E(var7)$label <- LETTERS[1:10]
#E(var7)$label.cex = seq(1, 2,length.out = 10)
#E(var7)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var7, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=degree(var7)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var7)/10000,
     vertex.label.cex=degree(var7)/500,
     edge.width=(edge.betweenness(var7, weights=V(var7)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ", cex = .5)
...
plot(var7, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var7))/800,
     edge.width=(edge.betweenness(var7, weights =E(var7)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var7, 
     layout=layout.kamada.kawai(small_var7), 
     vertex.label=get.vertex.attribute(small_var7,"LABEL_COR"),
     vertex.size=degree(small_var7)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var7)+1)/10,
     edge.width=(edge.betweenness(small_var7))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var7, mode="in")), 
     median(degree(small_var7, mode="out"))
   )
  )
```
...
plot(small_var7, 
     layout=layout.kamada.kawai(small_var7), 
     vertex.label=get.vertex.attribute(small_var7,"LABEL_COR"),
     vertex.size=degree(small_var7)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var7)+2)/5,
     edge.width=(edge.betweenness(small_var7)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var7, mode="in")), 
     median(degree(small_var7, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var7_a.nn.deg_w 
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=(graph.knn(var7,V(var7))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var7,V(var7))$knn+1)/30,
     edge.width=(edge.betweenness(var7, weights =E(var7)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var7,V(var7))$knn)
   ))
```
...
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var7,V(var7), weights= E(var7)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var7,V(var7), weights= E(var7)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var7, weights =E(var7)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var7,V(var7), weights= E(var7)$weight)$knn)
   ))
```
...
V(var7)$totalcloseness <- closeness(var7, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$incloseness_n <- closeness(var7, mode = "in", normalized = T) %>% round(6)
V(var7)$outcloseness_n <- closeness(var7, mode = "out", normalized = T) %>% round(6)
V(var7)$totalcloseness_n <- closeness(var7, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var7_incloseness_n<- closeness(var7, mode = "in", normalized = T) %>% round(6)
var7_outcloseness_n<- closeness(var7, mode = "out", normalized = T) %>% round(6)
var7_totalcloseness_n<- closeness(var7, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$incloseness_w <- closeness(var7, mode = "in", normalized = T, weights=E(var7)$weight) %>% round(6)
V(var7)$outcloseness_w <- closeness(var7, mode = "out", normalized = T,weights=E(var7)$weight) %>% round(6)
V(var7)$totalcloseness_w <- closeness(var7, mode = "total", normalized = T, weights=E(var7)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var7_incloseness_w<- closeness(var7, mode = "in", normalized = T, weights=E(var7)$weight) %>% round(6)
var7_outcloseness_w<- closeness(var7, mode = "out", normalized = T, weights=E(var7)$weight) %>% round(6)
var7_totalcloseness_w<- closeness(var7, mode = "total", normalized = T, weights=E(var7)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var7_incloseness_w)
sd(var7_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var7_outcloseness_w)
sd(var7_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var7_totalcloseness_w)
sd(var7_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$var7_closeness_stats_w <- closeness(var7, vids = V(var7), mode = "all", weights =E(var7)$weight, normalized = FALSE)
var7_closeness_stats_w <- closeness(var7, vids = V(var7), mode = "all", weights =E(var7)$weight, normalized = FALSE)
```
...
var7_outcloseness_w<- closeness(var7, mode = "out", normalized = T, weights=E(var7)$weight) %>% round(6)
var7_totalcloseness_w<- closeness(var7, mode = "total", normalized = T, weights=E(var7)$weight) %>% round(6)
var7_closeness_stats_w <- closeness(var7, vids = V(var7), mode = "all", weights=E(var7)$weight, normalized = FALSE) %>% round(6)
...
var7_incloseness_w,
var7_outcloseness_w,
var7_totalcloseness_w,
var7_closeness_stats_w,
...
#Adding names
names(var7_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var7_df_closseness<-var7_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var7)$var7_color_degree<-round(V(var7)$totalcloseness,4)
...
plot(var7, 
     ...
     vertex.color=V(var7)$vertex_var7_color_degree,
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=closeness(var7)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var7))/80,
     edge.width=(edge.betweenness(var7, weights =E(var7)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var7, mode="in")), 
     median(closeness(var7, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var7)$var7_color_degree<-round(V(var7)$var7_centr_closeness,2)
...
plot(var7, 
     ...
     vertex.color=V(var7)$vertex_var7_color_degree,
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=centralization.closeness(var7)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var7, mode="in")), 
     median(closeness(var7, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$var7_betweenness_w <- betweenness(var7, weights=E(var7)$weight) %>% round(1)
var7_betweenness_w <- betweenness(var7, weights=E(var7)$weight) %>% round(1)
```
##Betweenness Centrality Weighted - (Vertex) - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var7_betweenness_w)
sd(var7_betweenness_w)
```
#2.8.3 Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$var7_centr_betweenness <- centralization.betweenness(var7)$res
var7_centr_betweenness <- centralization.betweenness(var7)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var7_centr_betweenness$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var7_centr_betweenness$theoretical_max
```
...
var7_betweenness <- betweenness(var7) %>% round(1)
var7_betweenness_w <- betweenness(var7, weights=E(var7)$weight) %>% round(1)
var7_centr_betweenness <- centralization.betweenness(var7)$res %>% round(1)

#Creating a dataframe of measures
var7_df_betweenness <- data.frame(var7_betweenness,
var7_betweenness_w,
var7_centr_betweenness) %>% round(1)

#Adding type
var7_df_betweenness <-cbind(var7_df_betweenness, V(var7)$LABEL_COR)

#Adding names
names(var7_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var7_df_betweenness<-var7_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=betweenness(var7)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var7)+1)/10000,
     edge.width=edge.betweenness(var7, weights =E(var7)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var7)), 
     sd(betweenness(var7))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var7)$var7_centr_betweenness<-(centralization.betweenness(var7)$res)/10000
V(var7)$var7_color_degree<-round(V(var7)$var7_centr_betweenness,1)
...
plot(var7, 
     ...
     vertex.color=V(var7)$vertex_var7_color_degree,
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var7)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centralization.betweenness(var7)$res + 1)/10000,
     edge.width=(edge.betweenness(var7, weights =E(var7)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Betweenness - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var7)$eigenvector <- eigen_centrality(var7, directed = TRUE, weights =E(var7)$weight) %$% vector %>% round(3)
var7_eigenvector <- eigen_centrality(var7, directed = TRUE, weights = E(var7)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var7_eigenvector_value <- eigen_centrality(var7, directed = TRUE, weights = E(var7)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var7_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$var7_centr_eigen <- centr_eigen(var7, directed = T)$vector
var7_centr_eigen <-centr_eigen(var7, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var7, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var7, directed = T)$theoretical_max
```
...
var7_eigenvector_w <- eigen_centrality(var7, directed = TRUE, weights = E(var7)$weight) %$% vector %>% round(3) 
var7_centr_eigen <-centr_eigen(var7, directed = T)$vector

#Creating a datagrame of measures
var7_df_eigenvector <- data.frame(var7_eigenvector,
var7_eigenvector_w,
var7_centr_eigen) %>% round(3)

#Adding type
var7_df_eigenvector <-cbind(var7_df_eigenvector, V(var7)$LABEL_COR)

#Adding names
names(var7_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var7_df_eigenvector<-var7_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var7_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var7_df_eigenvector, by=list(var7_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var7_df_eigenvector, by=list(var7_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=(eigen_centrality(var7, directed =TRUE, weights = E(var7)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var7)$vector)+1)/10,
     edge.width=edge.betweenness(var7, weights =E(var7)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var7)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var7)$var7_color_degree<-round(centr_eigen(var7, directed = T)$vector,2)
...
plot(var7, 
     ...
     vertex.color=V(var7)$vertex_var7_color_degree,
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=centr_eigen(var7, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var7, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var7, weights =E(var7)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var7, directed = T)$vector), 
     sd(centr_eigen(var7, directed = T)$vector)
   ))
```
...
var7_power_centrality_stats <- power_centrality(var7, nodes = V(var7), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var7)$var7_power_centrality_stats <-power_centrality(var7, nodes = V(var7), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var7)$LABEL_COR, var7_power_centrality_stats))
...
V(var7)$var7_power_centrality_stats_r<-round(V(var7)$var7_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var7)$var7_power_centrality_stats_r)), "Blues"))(length(unique(V(var7)$var7_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var7)$color_spower <- vertex_col_spower[factor(V(var7)$var7_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.color=V(var7)$color_spower, 
     vertex.label=V(var7)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var7)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var7)+1)^2)/10,
     edge.width=edge.betweenness(var7, weights =E(var7)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var7)$var7_power_centrality_stats_r
b<-V(var7)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var7_power_centrality_stats),sd(var7_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var7_alpha_centrality_stats <- alpha_centrality(var7, loops = FALSE, alpha = 1, exo = 1, weights=E(var7)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var7)$var7_alpha_centrality_stats<-alpha_centrality(var7, loops = FALSE, alpha = 1, exo = 1, weights=E(var7)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var7)$LABEL_COR, round(var7_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var7)$var7_alpha_centrality_stats_r<-round(V(var7)$var7_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var7)$var7_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var7)$var7_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var7)$color_s <- vertex_col_s[factor(V(var7)$var7_alpha_centrality_stats_r)]  
```
...
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.color=V(var7)$color_s, 
     vertex.label=V(var7)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var7, loops = FALSE, alpha = 1, exo = 1, weights=E(var7)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var7))^2)/50,
     edge.width=edge.betweenness(var7, weights =E(var7)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var7)$var7_alpha_centrality_stats_r
b<-V(var7)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var7_alpha_centrality_stats),sd(var7_alpha_centrality_stats)
     ))
```
...
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=10*hub.score(var7)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var7)+1)/10,
     edge.width=edge.betweenness(var7, weights =E(var7)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=10*authority.score(var7)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var7)+1)/20,
     edge.width=log(edge.betweenness(var7, weights =E(var7)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var7, 
     layout=layout.kamada.kawai(var7), 
     vertex.label=get.vertex.attribute(var7,"LABEL_COR"),
     vertex.size=200*page.rank(var7)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var7)+1)/15,
     edge.width=log(edge.betweenness(var7, weights =E(var7)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var7<-make_ego_graph(var7, order=1, V(var7)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var7, 
     layout=layout.kamada.kawai(make_ego_graph_all_var7), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var7,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var7)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var7)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var7))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var7)$LABEL_COR
b<-V(make_ego_graph_all_var7)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var7)$vector),
     sd(page.rank(make_ego_graph_all_var7)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var7<-make_ego_graph(var7, order=1, V(var7)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var7, 
     layout=layout.kamada.kawai(make_ego_graph_out_var7), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var7,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var7)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var7)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var7))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var7)$LABEL_COR
b<-V(make_ego_graph_out_var7)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var7)$vector),
     sd(page.rank(make_ego_graph_out_var7)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var7<-make_ego_graph(var7, order=1, V(var7)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var7, 
     layout=layout.kamada.kawai(make_ego_graph_in_var7), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var7,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var7)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var7))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var7))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var7)$LABEL_COR
b<-V(make_ego_graph_in_var7)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var7)$vector),
     sd(page.rank(make_ego_graph_in_var7)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var7_without_CAPSAD<-delete_vertices(make_ego_graph_all_var7,V(make_ego_graph_all_var7)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var7_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var7_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var7_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var7_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var7_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var7_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var7_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var7_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var7_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var7_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var7_without_complex<-
  delete_vertices(make_ego_graph_all_var7,
                  c(V(make_ego_graph_all_var7)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var7)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var7_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var7_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var7_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var7_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var7_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var7_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var7_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var7_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var7_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var7_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var7, 
     layout=layout.kamada.kawai(msp_var7), 
     vertex.label=get.vertex.attribute(msp_var7,"LABEL_COR"),
     vertex.size=degree(msp_var7)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var7)/50,
     edge.width=log(edge.betweenness(msp_var7, weights =E(msp_var7)$msp_var7))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var7, 
     layout=layout.auto(msp_var7), 
     vertex.label=get.vertex.attribute(msp_var7,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var7)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var7))/50,
     edge.width=log(edge.betweenness(msp_var7, weights=E(msp_var7)$msp_var7))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var7, mode="in")), 
     median(degree(msp_var7, mode="out"))
...
msp_var7_w<-minimum.spanning.tree(var7, weights=1/edge.betweenness(var7, weights =E(var7)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var7_w, 
     layout=layout.auto(msp_var7_w), 
     vertex.label=get.vertex.attribute(msp_var7_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var7_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var7_w))/20,
     edge.width=1/edge.betweenness(msp_var7_w, weights =E(msp_var7_w)$msp_var7_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var7)$mut/ecount(var7) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var7_sp_in <- shortest.paths(var7, mode='in', weights=E(var7)$weight) # sames as bellow
var7_sp_out <- shortest.paths(var7, mode='out', weights=E(var7)$weight) #same as above
var7_sp_all <- shortest.paths(var7, mode='all', weights=E(var7)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var7<-distances(var7, mode="all", weights=E(var7)$weight)
#distances_sp_all_var7

#In shortest paths 
distances_sp_in_var7<-distances(var7, mode="in",weights=E(var7)$weight)
#distances_sp_in_var7

#Out shortest paths 
distances_sp_out_var7<-distances(var7, mode="out", weights=E(var7)$weight)
#distances_sp_out_var7
```
...
var7_dist.from.CAPSAD <- distances(var7, v=V(var7)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var7), weights=E(var7)$weight)
...
plot(var7, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var7)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var7))/10,
     edge.width=edge.betweenness(var7, weights=E(var7)$var7)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var7, weights=E(var7)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var7, weights=E(var7)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var7, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$transitivity_local_w<-transitivity(var7, type="barrat") 
transitivity_local_w<-transitivity(var7, weights=E(var7)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var7_u <- as.undirected(var7, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var7_u_size<-sapply(cliques(var7_u), length) # too intesive calculation
```
...
as.undirected_var7_u<-as.undirected(var7_u)
...
V(as.undirected_var7_u)$vcol<-vcol

#Saving labels to display as legend
V(as.undirected_var7_u)$vcollabel[V(as.undirected_var7_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var7_u)$vcollabel [V(as.undirected_var7_u)$vcol=="grey80"]<-"Others"
```

#Plotting based only on degree measures 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(as.undirected(var7_u), 
     layout=layout.kamada.kawai(as.undirected(var7_u)), 
     vertex.label=get.vertex.attribute(as.undirected(var7_u),"LABEL_COR"),
     vertex.color=vcol,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(as.undirected(var7_u))),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var7_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var7_u), weights =E(as.undirected(var7_u))$var7))/50,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(as.undirected_var7_u)$vcollabel
b<-V(as.undirected_var7_u)$vcol
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Coreness Colored Graph - 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(var7)), 
     max(graph.coreness(var7))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var7)$edge.btweenness<-edge.betweenness(var7, weights =E(var7)$weight)
var7_edge.betweenness <-edge.betweenness(var7, weights =E(var7)$weight)
```
...
plot(var7, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var7_edge.betweenness.community),
                      var7_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var7)+1)/10,
     edge.width=log(edge.betweenness(var7, weights =E(var7)$weight))/5,
     edge.curved = TRUE
     )
...
var7_walktrap.community <- walktrap.community(var7)
```

#3.11.1 Network Dendograma
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var7 <- as.dendrogram(var7_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var7, main = "Dendrograma var7", nodePar=list(pch=c(NA, 20)))
```

#3.11.2 Saving Random walk community
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var7)$walktrap.community <- membership(var7_walktrap.community)
var7_walktrap.community <- membership(var7_walktrap.community)
```
...
plot(var7, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var7)),
     mark.groups = by(seq_along(var7_walktrap.community),
                      var7_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var7)+1)/10,
     edge.width=log(edge.betweenness(var7, weights =E(var7)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var7 <- decompose.graph(var7)
sapply(comps_var7, diameter)
table(sapply(comps_var7, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var71<-comps_var7[[1]]
#comps_var72<-comps_var7[[2]]
#comps_var73<-comps_var7[[3]]
#comps_var74<-comps_var7[[4]]
#comps_var75<-comps_var7[[5]]
#comps_var76<-comps_var7[[6]]
#comps_var77<-comps_var7[[7]]
#comps_var78<-comps_var7[[8]]
#...
```
...
plot(comps_var71, 
     layout=layout.kamada.kawai(comps_var71), 
     vertex.label=get.vertex.attribute(comps_var71,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var71)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var71)+1)/10,
     edge.width=log(edge.betweenness(comps_var71, weights=E(comps_var71)$comps_var71))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var71)$LABEL_COR
b<-V(comps_var71)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var71, mode="in")), 
     median(degree(comps_var71, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var7)$optimal_comm_var7 <- #membership(optimal.community(var7))
#optimal_comm_var7 <- membership(optimal.community(var7))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var7)
var7_dim<-get.diameter(var7)
var7_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var7, weights=E(var7)$weight)
var7_dim<-get.diameter(var7, weights=E(var7)$weight)
var7_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var7)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 9.CENTRALIDADE_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
