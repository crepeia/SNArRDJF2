---
title: "SNA Centralities 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)"
...
# 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)
...
```
#1. Descriptive Analysis for 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var5)/10, main="Histogram of Indegree Nodes - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var5)/10, main="Histogram of Outdegree Nodes - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var5)/10, main="Histogram of All Degree Nodes - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)")
```  
...
#Histogram var5 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var5, weights=E(var5)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var5)/10, main="Histogram of Strength Degree Nodes - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var5)/10, main="Histogram of Normalized Indegree Nodes - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var5)/10, main="Histogram of Normalized Outdegree Nodes - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var5, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var5)/10, main="Histogram of Normalized All Degree Nodes - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var5), breaks=vcount(var5)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var5)$var5_a.nn.deg <- graph.knn(var5,V(var5))$knn
```
...
plot(degree(var5), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5))
...
plot(degree(var5), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var5)$size <- degree(var5)
V(var5)$label <- V(var5)$V5_LABEL_TIPO_NOME
V(var5)$label.cex <- degree(var5)/100
V(var5)$label.color <- "black"

## Just in case if we wanna change colors
#V(var5)$color <- V(var5)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var5)$weight <- E(var5)$weight
E(var5)$width <- E(var5)$weight
E(var5)$color <- "gray"

## Here we can change other edge parameter
#E(var5)[ weight < 0.5 ]$width <- 4
#E(var5)[ weight < 0.5 ]$color <- "green"
#E(var5)$label <- LETTERS[1:10]
#E(var5)$label.cex = seq(1, 2,length.out = 10)
#E(var5)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var5, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var5, 
     ...
     edge.width=(edge.betweenness(var5, weights=V(var5)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ", cex = .5)
...
plot(var5, 
     ...
     edge.width=(edge.betweenness(var5, weights =E(var5)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
...
plot(small_var5, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var5)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var5, 
     ...
     vertex.label.cex=log(degree(small_var5)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var5, mode="in")), 
     median(degree(small_var5, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var5_a.nn.deg_w 
plot(var5, 
     layout=layout.kamada.kawai(var5), 
     vertex.label=get.vertex.attribute(var5,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var5,V(var5))$knn+1)/30,
     edge.width=(edge.betweenness(var5, weights =E(var5)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var5, 
     layout=layout.kamada.kawai(var5), 
     vertex.label=get.vertex.attribute(var5,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var5,V(var5), weights= E(var5)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var5,V(var5), weights= E(var5)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var5, weights =E(var5)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var5,V(var5), weights= E(var5)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var5)$incloseness_w <- closeness(var5, mode = "in", normalized = T, weights=E(var5)$weight) %>% round(6)
V(var5)$outcloseness_w <- closeness(var5, mode = "out", normalized = T,weights=E(var5)$weight) %>% round(6)
V(var5)$totalcloseness_w <- closeness(var5, mode = "total", normalized = T, weights=E(var5)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var5_incloseness_w<- closeness(var5, mode = "in", normalized = T, weights=E(var5)$weight) %>% round(6)
var5_outcloseness_w<- closeness(var5, mode = "out", normalized = T, weights=E(var5)$weight) %>% round(6)
var5_totalcloseness_w<- closeness(var5, mode = "total", normalized = T, weights=E(var5)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var5)$var5_closeness_stats_w <- closeness(var5, vids = V(var5), mode = "all", weights =E(var5)$weight, normalized = FALSE)
var5_closeness_stats_w <- closeness(var5, vids = V(var5), mode = "all", weights =E(var5)$weight, normalized = FALSE)
```
...
var5_outcloseness_w<- closeness(var5, mode = "out", normalized = T, weights=E(var5)$weight) %>% round(6)
var5_totalcloseness_w<- closeness(var5, mode = "total", normalized = T, weights=E(var5)$weight) %>% round(6)
var5_closeness_stats_w <- closeness(var5, vids = V(var5), mode = "all", weights=E(var5)$weight, normalized = FALSE) %>% round(6)
...
var5_incloseness_w,
var5_outcloseness_w,
var5_totalcloseness_w,
var5_closeness_stats_w,
...
#Adding names
names(var5_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var5_df_closseness<-var5_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var5)$var5_color_degree<-round(V(var5)$var5_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var5, mode="in")), 
     median(closeness(var5, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var5)$var5_betweenness_w <- betweenness(var5, weights=E(var5)$weight) %>% round(1)
var5_betweenness_w <- betweenness(var5, weights=E(var5)$weight) %>% round(1)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var5)$var5_centr_betweenness <- centralization.betweenness(var5)$res
var5_centr_betweenness <- centralization.betweenness(var5)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var5_betweenness <- betweenness(var5) %>% round(1)
var5_betweenness_w <- betweenness(var5, weights=E(var5)$weight) %>% round(1)
var5_centr_betweenness <- centralization.betweenness(var5)$res %>% round(1)

#Creating a dataframe of measures
var5_df_betweenness <- data.frame(var5_betweenness,
var5_betweenness_w,
var5_centr_betweenness) %>% round(1)

#Adding type
var5_df_betweenness <-cbind(var5_df_betweenness, V(var5)$LABEL_COR)

#Adding names
names(var5_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var5_df_betweenness<-var5_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var5)$var5_centr_betweenness<-(centralization.betweenness(var5)$res)/10000
V(var5)$var5_color_degree<-round(V(var5)$var5_centr_betweenness,1)
...
#Adding Title
  title("Network Centralization Betweenness - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var5)$eigenvector <- eigen_centrality(var5, directed = TRUE, weights =E(var5)$weight) %$% vector %>% round(3)
var5_eigenvector <- eigen_centrality(var5, directed = TRUE, weights = E(var5)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var5_eigenvector_value <- eigen_centrality(var5, directed = TRUE, weights = E(var5)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var5)$var5_centr_eigen <- centr_eigen(var5, directed = T)$vector
var5_centr_eigen <-centr_eigen(var5, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var5_eigenvector_w <- eigen_centrality(var5, directed = TRUE, weights = E(var5)$weight) %$% vector %>% round(3) 
var5_centr_eigen <-centr_eigen(var5, directed = T)$vector

#Creating a datagrame of measures
var5_df_eigenvector <- data.frame(var5_eigenvector,
var5_eigenvector_w,
var5_centr_eigen) %>% round(3)

#Adding type
var5_df_eigenvector <-cbind(var5_df_eigenvector, V(var5)$LABEL_COR)

#Adding names
names(var5_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var5_df_eigenvector<-var5_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var5_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var5_df_eigenvector, by=list(var5_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var5_df_eigenvector, by=list(var5_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var5, 
     layout=layout.kamada.kawai(var5), 
     vertex.label=get.vertex.attribute(var5,"LABEL_COR"),
     vertex.size=(eigen_centrality(var5, directed =TRUE, weights = E(var5)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var5)$vector)+1)/10,
     edge.width=edge.betweenness(var5, weights =E(var5)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var5, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var5, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var5, weights =E(var5)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var5, directed = T)$vector), 
     sd(centr_eigen(var5, directed = T)$vector)
   ))
```
...
var5_power_centrality_stats <- power_centrality(var5, nodes = V(var5), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var5)$var5_power_centrality_stats <-power_centrality(var5, nodes = V(var5), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var5)$LABEL_COR, var5_power_centrality_stats))
...
V(var5)$var5_power_centrality_stats_r<-round(V(var5)$var5_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var5)$var5_power_centrality_stats_r)), "Blues"))(length(unique(V(var5)$var5_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var5)$color_spower <- vertex_col_spower[factor(V(var5)$var5_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var5)$var5_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var5_power_centrality_stats),sd(var5_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var5_alpha_centrality_stats <- alpha_centrality(var5, loops = FALSE, alpha = 1, exo = 1, weights=E(var5)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var5)$var5_alpha_centrality_stats<-alpha_centrality(var5, loops = FALSE, alpha = 1, exo = 1, weights=E(var5)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var5)$LABEL_COR, round(var5_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var5)$var5_alpha_centrality_stats_r<-round(V(var5)$var5_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var5)$var5_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var5)$var5_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var5)$color_s <- vertex_col_s[factor(V(var5)$var5_alpha_centrality_stats_r)]  
```
...
plot(var5, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var5, loops = FALSE, alpha = 1, exo = 1, weights=E(var5)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(var5)$var5_alpha_centrality_stats_r
b<-V(var5)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var5_alpha_centrality_stats),sd(var5_alpha_centrality_stats)
     ))
```
...
var5_hub<- hub.score(var5)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var5)$LABEL_COR, var5_hub))
...
plot(var5, 
     layout=layout.kamada.kawai(var5), 
     vertex.label=get.vertex.attribute(var5,"LABEL_COR"),
     vertex.size=10*hub.score(var5)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var5_auth <- authority.score(var5)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var5)$LABEL_COR, var5_auth))
...
plot(var5, 
     layout=layout.kamada.kawai(var5), 
     vertex.label=get.vertex.attribute(var5,"LABEL_COR"),
     vertex.size=10*authority.score(var5)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var5)+1)/20,
     edge.width=log(edge.betweenness(var5, weights =E(var5)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var5_pr<-page.rank(var5)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var5)$LABEL_COR, var5_pr))
...
plot(var5, 
     layout=layout.kamada.kawai(var5), 
     vertex.label=get.vertex.attribute(var5,"LABEL_COR"),
     vertex.size=200*page.rank(var5)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var5)+1)/15,
     edge.width=log(edge.betweenness(var5, weights =E(var5)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_var5, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var5)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var5, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_var5)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var5)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var5, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_var5)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var5_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_var5_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var5_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var5_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var5_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var5_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var5_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_var5, 
     ...
     vertex.size=degree(msp_var5)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var5)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var5, mode="in")), 
     median(degree(msp_var5, mode="out"))
...
msp_var5_w<-minimum.spanning.tree(var5, weights=1/edge.betweenness(var5, weights =E(var5)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var5_w, 
     layout=layout.auto(msp_var5_w), 
     ...
     edge.width=1/edge.betweenness(msp_var5_w, weights =E(msp_var5_w)$msp_var5_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var5_sp_in <- shortest.paths(var5, mode='in', weights=E(var5)$weight) # sames as bellow
var5_sp_out <- shortest.paths(var5, mode='out', weights=E(var5)$weight) #same as above
var5_sp_all <- shortest.paths(var5, mode='all', weights=E(var5)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var5<-distances(var5, mode="all", weights=E(var5)$weight)
#distances_sp_all_var5

#In shortest paths 
distances_sp_in_var5<-distances(var5, mode="in",weights=E(var5)$weight)
#distances_sp_in_var5

#Out shortest paths 
distances_sp_out_var5<-distances(var5, mode="out", weights=E(var5)$weight)
...
var5_dist.from.CAPSAD <- distances(var5, v=V(var5)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var5), weights=E(var5)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var5, weights=E(var5)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var5, weights=E(var5)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(var5, weights=E(var5)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var5_u_size<-sapply(cliques(var5_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(var5)), 
     max(graph.coreness(var5))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var5)$edge.btweenness<-edge.betweenness(var5, weights =E(var5)$weight)
var5_edge.betweenness <-edge.betweenness(var5, weights =E(var5)$weight)
```
...
plot(var5, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var5)+1)/10,
     edge.width=log(edge.betweenness(var5, weights =E(var5)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_var51, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var51)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var5, weights=E(var5)$weight)
var5_dim<-get.diameter(var5, weights=E(var5)$weight)
var5_dim
```
...
#Adding Title
  title("Diameter of 7.CENTRALIDADE_OFERTA DE TREINAMENTOS CAPACITAÇÕES (var5)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
