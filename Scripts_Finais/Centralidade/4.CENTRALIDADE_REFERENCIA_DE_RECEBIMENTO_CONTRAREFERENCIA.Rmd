...
#1. Descriptive Analysis for var2* - Complete Graph - All networks were generated using from this one
...
hist(degree(var2, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var2)/10, main="Histogram of Indegree Nodes - var2*")
hist(degree(var2, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var2)/10, main="Histogram of Outdegree Nodes - var2*")
hist(degree(var2, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var2)/10, main="Histogram of All Degree Nodes - var2*")
```  
...
```{r}
V(var2)$strength_var2<- strength(var2, weights=E(var2)$var2)
strength_var2<- strength(var2, weights=E(var2)$var2)

##Stats
summary(strength_var2)
sd(strength_var2)
```
...
#Histogram var2 degree
hist(degree(var2, mode = "in", normalized = F), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var2)/10, main="Histogram of Normalized Indegree Nodes - var2*")
hist(degree(var2, mode = "out", normalized = F), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var2)/10, main="Histogram of Normalized Indegree Nodes - var2*")
hist(degree(var2, mode = "all", normalized = F), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var2)/10, main="Histogram of Normalized All Degree Nodes - var2*")
```

#2.2.1 Centralization Degree
```{r}
V(var2)$centr_degree_var2 <- centralization.degree(var2)$res
centr_degree_var2 <- centralization.degree(var2)

#Centralization
centr_degree_var2$centralization
#Theoretical Max
centr_degree_var2$theoretical_max
```
...
hist(degree.distribution(var2), breaks=vcount(var2)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - var2*")

#Degree Probability Distribution
dd <- degree.distribution(var2, cumulative=T, mode="all")
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of var2* ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For var2*"
     )
```

#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for var2*)
```{r}
#Average Neighbor Degree versus vertex degree (log-log scale for var2)
a.nn.deg.var2 <- graph.knn(var2,V(var2))$knn

#Saving to igraph object
V(var2)$a.nn.deg.var2 <- a.nn.deg.var2 <- graph.knn(var2,V(var2))$knn
...
plot(degree(var2), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for var2*"
     )
```

#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted var2*)
```{r}
#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var2)
a.nn.deg.var2_w <- graph.knn(var2,V(var2), weights=E(var2)$var2)$knn

#Saving to igraph object
V(var2)$a.nn.deg.var2_w <-a.nn.deg.var2 <- graph.knn(var2,V(var2), weights=E(var2)$var2)$knn

#Average Weighted Neighbor Descriptive
summary(a.nn.deg.var2_w)
sd(a.nn.deg.var2_w)
...
plot(degree(var2), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted var2*"
     )
```
...
#Adding Title
  title("Network Vertex Degree Sized - var2*", sub = "Source: from authors ")
...
```{r}
#Get Variable
V(var2)$var2_color_degree<-V(var2)$totaldegree
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(var2, mode="in")), 
     median(degree(var2, mode="out"))
...
```{r}
#Get Variable
V(var2)$var2_color_degree<-V(var2)$centr_degree_var2
...
plot(small_var2, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var2))/10,
...
#Adding Title
  title("Network Higher Than Median Degree - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var2, 
     ...
     vertex.label.cex=log(degree(small_var2)+2)/2,
...
#Adding Title
  title("Network Lower than Median Degree - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var2, mode="in")), 
     median(degree(small_var2, mode="out"))
...
```{r}
#Plotting based only on degree measures  #a.nn.deg.var2_w 
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var2,V(var2))$knn)/20,
     edge.width=(edge.betweenness(var2, weights =E(var2)$var2))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var2,V(var2), weights= E(var2)$var2)$knn),
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var2,V(var2), weights= E(var2)$var2)$knn)/10,
     edge.width=edge.betweenness(var2, weights =E(var2)$var2)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var2,V(var2), weights= E(var2)$var2)$knn)
   ))
```
...
#Saving to Igraph object
V(var2)$incloseness_w <- closeness(var2, mode = "in", normalized = T, weights=E(var2)$var2) #%>% round(6)
V(var2)$outcloseness_w <- closeness(var2, mode = "out", normalized = T,weights=E(var2)$var2) #%>% round(6)
V(var2)$totalcloseness_w <- closeness(var2, mode = "total", normalized = T, weights=E(var2)$var2) #%>% round(6)

#Saving to Environment
var2_incloseness_w<- closeness(var2, mode = "in", normalized = T, weights=E(var2)$var2) #%>% round(6)
var2_outcloseness_w<- closeness(var2, mode = "out", normalized = T, weights=E(var2)$var2) #%>% round(6)
var2_totalcloseness_w<- closeness(var2, mode = "total", normalized = T, weights=E(var2)$var2) #%>% round(6)
...
```{r}
V(var2)$closeness_stats_var2_w <- closeness(var2, vids = V(var2), mode = "all", weights =V(var2)$var2, normalized = FALSE)

closeness_stats_var2_w <- closeness(var2, vids = V(var2), mode = "all", weights =V(var2)$var2, normalized = FALSE)
```

#2.7.5 Centralization Closseness
```{r}
V(var2)$centr_closeness_var2 <- centralization.closeness(var2)$res
centr_closeness_var2 <- centralization.closeness(var2)

#Centralization
centr_closeness_var2$centralization
#Theoretical Max
centr_closeness_var2$theoretical_max
```
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r}
#Get Variable
V(var2)$var2_color_degree<-round(V(var2)$centr_closeness_var2,3)
...
#Adding Title
  title("Network Centralization Closeness - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var2, mode="in")), 
     median(closeness(var2, mode="out"))
...
```{r}
V(var2)$betweenness_var2_w <- betweenness(var2, weights=E(var2)$var2) %>% round(1)

betweenness_var2_w <- betweenness(var2, weights=E(var2)$var2) %>% round(1)

##all
summary(betweenness_var2_w)
sd(betweenness_var2_w)
```

#2.8.3 Centralization Betweenness
```{r}
V(var2)$centr_betweenness_var2 <- centralization.betweenness(var2)$res
centr_betweenness_var2 <- centralization.betweenness(var2)

#Centralization
centr_betweenness_var2$centralization
#Theoretical Max
centr_betweenness_var2$theoretical_max
```
...
plot(var2, 
     ...
     edge.width=log(edge.betweenness(var2, weights =E(var2)$var2))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r}
#Get Variable
V(var2)$var2_color_degree<-round(V(var2)$centr_betweenness_var2,3)
...
#Adding Title
  title("Network Centralization Betweenness - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r}
#Eigen_Centrality 
V(var2)$eigenvector <- eigen_centrality(var2, directed = TRUE, weights = V(var2)$var2) %$% vector %>% round(3)

var2_eigenvector <- eigen_centrality(var2, directed = TRUE, weights = V(var2)$var2) %$% vector %>% round(3)

#Eigenvalue Calculated Eigenvector
var2_eigenvector_value <- eigen_centrality(var2, directed = TRUE, weights = V(var2)$var2) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r}
V(var2)$centr_eigen_var2 <- centr_eigen(var2, directed = T)$vector
centr_eigen_var2 <-centr_eigen(var2, directed = T)$vector
#Centralization
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=(eigen_centrality(var2)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(eigen_centrality(var2)$vector)/2,
     edge.width=edge.betweenness(var2, weights =E(var2)$var2)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var2, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var2, directed = T)$vector + 1)/10,
     edge.width=(edge.betweenness(var2, weights =E(var2)$var2))/500,
     edge.curved = TRUE
     )
...
power_centrality_stats_var2 <- power_centrality(var2, nodes = V(var2), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var2)$power_centrality_stats_var2 <-power_centrality(var2, nodes = V(var2), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 

#Or are you more powerful if you're connected to weak, dependent people? (negative attenuation factor)
i=sort(power_centrality_stats_var2) %>% round(3)
table_i<-cbind(V(var2)$V5_LABEL_LABEL,i)
...
d=sort(power_centrality_stats_var2, decreasing = T) %>% round(3)
table_d<-cbind(V(var2)$V5_LABEL_LABEL,d)
...
V(var2)$power_centrality_stats_var2_r<-round(V(var2)$power_centrality_stats_var2,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var2)$power_centrality_stats_var2_r)), "Blues"))(length(unique(V(var2)$power_centrality_stats_var2_r))) 

#Saving as Vertex properties                                   
V(var2)$color_spower <- vertex_col_spower[factor(V(var2)$power_centrality_stats_var2_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var2)$power_centrality_stats_var2_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(power_centrality_stats_var2),sd(power_centrality_stats_var2)
     ))
```
...
```{r, results="asis"}
#Saving power as an object
alpha_centrality_stats_var2 <- alpha_centrality(var2, loops = FALSE, alpha = 1, exo = 1, weights = V(var2)$var2, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var2)$alpha_centrality_stats_var2<-alpha_centrality(var2, loops = FALSE, alpha = 1, exo = 1, weights = V(var2)$var2, tol = 1e-07, sparse = TRUE)

#Descriptive 
summary(alpha_centrality_stats_var2)
sd(alpha_centrality_stats_var2)

#Or are you more powerful if you're connected to weak, dependent people? (negative attenuation factor)
i=sort(alpha_centrality_stats_var2) %>% round(3)
table_i<-cbind(V(var2)$V5_LABEL_LABEL,i)
...
#Are you more powerful if you're connected to powerful people? (positive attenuation factor)
d=sort(alpha_centrality_stats_var2, decreasing = T) %>% round(3)
table_d<-cbind(V(var2)$V5_LABEL_LABEL,d)
colnames(table_d) <- c("ID", "Power")
table_d10<-table_d[1:10,]
...
```{r}
# Set colors to plot distances:
V(var2)$alpha_centrality_stats_var2_r<-round(V(var2)$alpha_centrality_stats_var2,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var2)$alpha_centrality_stats_var2_r)), "YlOrRd"))(length(unique(V(var2)$alpha_centrality_stats_var2_r))) 

#Saving as Vertex properties                                                                  
V(var2)$color_s <- vertex_col_s[factor(V(var2)$alpha_centrality_stats_var2_r)]  
```
...
plot(var2, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var2, weights = V(var2)$var2)^2)),
     edge.arrow.size=0.1,
...
#Solving Problems with legend rendering 
a<-V(var2)$alpha_centrality_stats_var2_r
b<-V(var2)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(alpha_centrality_stats_var2),sd(alpha_centrality_stats_var2)
     ))
```
...
var2_hub<- hub.score(var2)$vector
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=10*sqrt(hub.score(var2)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var2))/10,
     edge.width=log(edge.betweenness(var2, weights =E(var2)$var2))/5,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var2_auth <- authority.score(var2)$vector
#stats
summary(var2_auth)
sd(var2_auth)
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=10*sqrt(authority.score(var2)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var2))/10,
     edge.width=log(edge.betweenness(var2, weights =E(var2)$var2))/5,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(var2)$vecto),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var2))/10,
     edge.width=log(edge.betweenness(var2, weights =E(var2)$var2))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r}
#For in-degrees:
indegnamesPB=which(indegPB>sort(indegPB)[vcount(var2)-5]) #For out- degrees:
outdegnamesPB=which(outdegPB>sort(outdegPB)[vcount(var2)-5]) #For PageRank:
prnamesPB=which(prPB>sort(prPB)[vcount(var2)-5]) #For Hubs:
hnamesPB=which(hPB>sort(hPB)[vcount(var2)-5]) #For Authorities:
authnamesPB=which(authPB>sort(authPB)[vcount(var2)-5])
...
plot(make_ego_graph_all_var2, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(make_ego_graph_all_var2))/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var2, 
     ...
     vertex.size=30*sqrt(page.rank(make_ego_graph_out_var2)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(make_ego_graph_out_var2))/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var2, 
     ...
     vertex.size=30*sqrt(page.rank(make_ego_graph_in_var2)$vector),
     edge.arrow.size=0.1,
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var2_without_CAPSAD, 
     ...
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var2_without_CAPSAD)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(make_ego_graph_all_var2_without_CAPSAD))/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var2_without_CAPSAD))/10,
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var2_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(make_ego_graph_all_var2_without_complex))/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var2_without_complex))/10,
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
msp_var2_w<-minimum.spanning.tree(var2, weights=1/edge.betweenness(var2, weights =E(var2)$var2), algorithm='prim')
...
#Plotting based only on degree measures 
plot(msp_var2_w, 
     layout=layout.kamada.kawai(msp_var2_w), 
     ...
     edge.width=1/edge.betweenness(msp_var2_w, weights =E(msp_var2_w)$msp_var2_w),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
is.connected(var2) #trick information - let's check this out further
```

#3.3.1 Strong Connected Components
```{r}
#Strong Connected
components_strong_var2<-components(var2, mode="strong")
V(var2)$components_strong_var2_membership<-components_strong_var2$membership # adding to igraph object

#Number of clusters
count_components(var2)

#Display components structure
components_strong_var2
```
...
plot(var2, 
     ...
     mark.groups = by(seq_along(components_strong_var2$membership),
                      components_strong_var2$membership, 
...
#Adding Title
  title("Network Vertex Degree Sized - Classfied by Components Structure - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(var2, mode="in")), 
     median(degree(var2, mode="out"))
...
```{r}
#Shortest Paths
var2_sp_in <- shortest.paths(var2, mode='in', weights=V(var2)$var2) # sames as bellow
var2_sp_out <- shortest.paths(var2, mode='out', weights=V(var2)$var2) #same as above
var2_sp_all <- shortest.paths(var2, mode='all', weights=V(var2)$var2) # all
...
```{r}
#All shortest paths 
distances_sp_all_var2<-distances(var2, mode="all", weights=E(var2)$var2)
#distances_sp_all_var2

#In shortest paths 
distances_sp_in_var2<-distances(var2, mode="in",weights=E(var2)$var2)
#distances_sp_in_var2

#Out shortest paths 
distances_sp_out_var2<-distances(var2, mode="out", weights=E(var2)$var2)
#distances_sp_out_var2
```

#3.7.4 Histogram from shortest path length between each pair of vertices. 
```{r}
distance_table(var2, directed = TRUE)
```
...
var2_dist.from.CAPSAD <- distances(var2, v=V(var2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var2), weights=V(var2)$var2)
...
#Adding Title
  title("Distance from CAPS AD - var2*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
cliques_var2_u_size<-sapply(cliques(var2_u), length) # clique sizes
largest_cliques(var2_u) # cliques with max number of nodes
```
...
V(as.undirected_var2_u)$vcollabel <- recode(V(as.undirected_var2_u)$vcol, "'gold' = 'Largest Clique'; else= 'Others'")
...
plot(as.undirected(var2_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var2_u)))/10,
     edge.width=log(edge.betweenness(as.undirected(var2_u), weights =E(as.undirected(var2_u))$var2))/5,
     edge.curved = TRUE
     )
...
```{r}
#Edge Betweenness
E(var2)$edge.btweenness<-edge.betweenness(var2, weights =E(var2)$var2)
...
E(var2)[order(var2_edge.betweenness, decreasing=T)[1:10]]
```

#3.10.1 Community detection (using edge betweenness)
```{r}
## Community structure detection based on edge betweenness
communityEdgeBetwn_var2 <- edge.betweenness.community(var2)
...
plot(comps_var21, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var21))/10,
...
#Non-weighted 
transitivity(var2, weights=E(var2)$var2, type="global")

#Weighted
transitivity(var2, weights=E(var2)$var2,type="weighted")
transitivity(var2, weights=E(var2)$var2,type="global")
...
transitivity_local_w<-transitivity(var2, weights=E(var2)$var2, type="barrat")
...
#Diameter Weigthed 
diameter(var2, weights=E(var2)$var2)
var2_dim<-get.diameter(var2, weights=E(var2)$var2)
var2_dim
```
...
#Adding Title
  title("Diameter of var2*", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
...
node_list <- get.data.frame(var2, what = "vertices")

#Writing Node CSV 
write.csv2(node_list, "~/SNArRDJF/Banco Redes R/Networks/node_var2.csv", fileEncoding = "macintosh")

# Edge List
edge_list <- get.data.frame(var2, what = "edges") %>%
...
write.csv2(edge_list, "~/SNArRDJF/Banco Redes R/Networks/edge_var2.csv", fileEncoding = "macintosh")
