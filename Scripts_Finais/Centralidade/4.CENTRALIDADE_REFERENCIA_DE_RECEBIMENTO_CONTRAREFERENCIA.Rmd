---
title: "SNA Centralities 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)"
...
```
#1. Descriptive Analysis for 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var2, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var2)/10, main="Histogram of Indegree Nodes - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var2, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var2)/10, main="Histogram of Outdegree Nodes - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var2, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var2)/10, main="Histogram of All Degree Nodes - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)")
```  
...
#Histogram var2 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var2, weights=E(var2)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var2)/10, main="Histogram of Strength Degree Nodes - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var2, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var2)/10, main="Histogram of Normalized Indegree Nodes - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var2, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var2)/10, main="Histogram of Normalized Outdegree Nodes - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var2, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var2)/10, main="Histogram of Normalized All Degree Nodes - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var2), breaks=vcount(var2)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var2)$var2_a.nn.deg <- graph.knn(var2,V(var2))$knn
```
...
plot(degree(var2), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var2)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var2), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var2, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=degree(var2)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var2)/10000,
     vertex.label.cex=degree(var2)/500,
     edge.width=(edge.betweenness(var2, weights=V(var2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ", cex = .5)
...
plot(var2, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var2))/800,
     edge.width=(edge.betweenness(var2, weights =E(var2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var2, 
     layout=layout.kamada.kawai(small_var2), 
     vertex.label=get.vertex.attribute(small_var2,"LABEL_COR"),
     vertex.size=degree(small_var2)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var2)+1)/10,
     edge.width=(edge.betweenness(small_var2))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var2, mode="in")), 
     median(degree(small_var2, mode="out"))
   )
  )
```
...
plot(small_var2, 
     layout=layout.kamada.kawai(small_var2), 
     vertex.label=get.vertex.attribute(small_var2,"LABEL_COR"),
     vertex.size=degree(small_var2)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var2)+2)/5,
     edge.width=(edge.betweenness(small_var2)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var2, mode="in")), 
     median(degree(small_var2, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var2_a.nn.deg_w 
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=(graph.knn(var2,V(var2))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var2,V(var2))$knn+1)/30,
     edge.width=(edge.betweenness(var2, weights =E(var2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var2,V(var2))$knn)
   ))
```
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var2,V(var2), weights= E(var2)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var2,V(var2), weights= E(var2)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var2, weights =E(var2)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var2,V(var2), weights= E(var2)$weight)$knn)
   ))
```
...
V(var2)$totalcloseness <- closeness(var2, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var2)$incloseness_n <- closeness(var2, mode = "in", normalized = T) %>% round(6)
V(var2)$outcloseness_n <- closeness(var2, mode = "out", normalized = T) %>% round(6)
V(var2)$totalcloseness_n <- closeness(var2, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var2_incloseness_n<- closeness(var2, mode = "in", normalized = T) %>% round(6)
var2_outcloseness_n<- closeness(var2, mode = "out", normalized = T) %>% round(6)
var2_totalcloseness_n<- closeness(var2, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var2)$incloseness_w <- closeness(var2, mode = "in", normalized = T, weights=E(var2)$weight) %>% round(6)
V(var2)$outcloseness_w <- closeness(var2, mode = "out", normalized = T,weights=E(var2)$weight) %>% round(6)
V(var2)$totalcloseness_w <- closeness(var2, mode = "total", normalized = T, weights=E(var2)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var2_incloseness_w<- closeness(var2, mode = "in", normalized = T, weights=E(var2)$weight) %>% round(6)
var2_outcloseness_w<- closeness(var2, mode = "out", normalized = T, weights=E(var2)$weight) %>% round(6)
var2_totalcloseness_w<- closeness(var2, mode = "total", normalized = T, weights=E(var2)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var2_incloseness_w)
sd(var2_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var2_outcloseness_w)
sd(var2_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var2_totalcloseness_w)
sd(var2_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var2)$var2_closeness_stats_w <- closeness(var2, vids = V(var2), mode = "all", weights =E(var2)$weight, normalized = FALSE)
var2_closeness_stats_w <- closeness(var2, vids = V(var2), mode = "all", weights =E(var2)$weight, normalized = FALSE)
```
...
var2_outcloseness_w<- closeness(var2, mode = "out", normalized = T, weights=E(var2)$weight) %>% round(6)
var2_totalcloseness_w<- closeness(var2, mode = "total", normalized = T, weights=E(var2)$weight) %>% round(6)
var2_closeness_stats_w <- closeness(var2, vids = V(var2), mode = "all", weights=E(var2)$weight, normalized = FALSE) %>% round(6)
...
var2_incloseness_w,
var2_outcloseness_w,
var2_totalcloseness_w,
var2_closeness_stats_w,
...
#Adding names
names(var2_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var2_df_closseness<-var2_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var2)$var2_color_degree<-round(V(var2)$totalcloseness,4)
...
plot(var2, 
     ...
     vertex.color=V(var2)$vertex_var2_color_degree,
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=closeness(var2)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var2))/80,
     edge.width=(edge.betweenness(var2, weights =E(var2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var2, mode="in")), 
     median(closeness(var2, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var2)$var2_color_degree<-round(V(var2)$var2_centr_closeness,2)
...
plot(var2, 
     ...
     vertex.color=V(var2)$vertex_var2_color_degree,
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=centralization.closeness(var2)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var2, mode="in")), 
     median(closeness(var2, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var2)$var2_betweenness_w <- betweenness(var2, weights=E(var2)$weight) %>% round(1)
var2_betweenness_w <- betweenness(var2, weights=E(var2)$weight) %>% round(1)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var2)$var2_centr_betweenness <- centralization.betweenness(var2)$res
var2_centr_betweenness <- centralization.betweenness(var2)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var2_betweenness <- betweenness(var2) %>% round(1)
var2_betweenness_w <- betweenness(var2, weights=E(var2)$weight) %>% round(1)
var2_centr_betweenness <- centralization.betweenness(var2)$res %>% round(1)

#Creating a dataframe of measures
var2_df_betweenness <- data.frame(var2_betweenness,
var2_betweenness_w,
var2_centr_betweenness) %>% round(1)

#Adding type
var2_df_betweenness <-cbind(var2_df_betweenness, V(var2)$LABEL_COR)

#Adding names
names(var2_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var2_df_betweenness<-var2_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=betweenness(var2)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var2)+1)/10000,
     edge.width=edge.betweenness(var2, weights =E(var2)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var2)), 
     sd(betweenness(var2))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var2)$var2_centr_betweenness<-(centralization.betweenness(var2)$res)/10000
V(var2)$var2_color_degree<-round(V(var2)$var2_centr_betweenness,1)
...
plot(var2, 
     ...
     vertex.color=V(var2)$vertex_var2_color_degree,
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var2)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centralization.betweenness(var2)$res + 1)/10000,
     edge.width=(edge.betweenness(var2, weights =E(var2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Betweenness - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var2)$eigenvector <- eigen_centrality(var2, directed = TRUE, weights =E(var2)$weight) %$% vector %>% round(3)
var2_eigenvector <- eigen_centrality(var2, directed = TRUE, weights = E(var2)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var2_eigenvector_value <- eigen_centrality(var2, directed = TRUE, weights = E(var2)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var2_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var2)$var2_centr_eigen <- centr_eigen(var2, directed = T)$vector
var2_centr_eigen <-centr_eigen(var2, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var2, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var2, directed = T)$theoretical_max
```
...
var2_eigenvector_w <- eigen_centrality(var2, directed = TRUE, weights = E(var2)$weight) %$% vector %>% round(3) 
var2_centr_eigen <-centr_eigen(var2, directed = T)$vector

#Creating a datagrame of measures
var2_df_eigenvector <- data.frame(var2_eigenvector,
var2_eigenvector_w,
var2_centr_eigen) %>% round(3)

#Adding type
var2_df_eigenvector <-cbind(var2_df_eigenvector, V(var2)$LABEL_COR)

#Adding names
names(var2_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var2_df_eigenvector<-var2_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var2_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var2_df_eigenvector, by=list(var2_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var2_df_eigenvector, by=list(var2_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=(eigen_centrality(var2, directed =TRUE, weights = E(var2)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var2)$vector)+1)/10,
     edge.width=edge.betweenness(var2, weights =E(var2)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var2)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var2)$var2_color_degree<-round(centr_eigen(var2, directed = T)$vector,2)
...
plot(var2, 
     ...
     vertex.color=V(var2)$vertex_var2_color_degree,
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=centr_eigen(var2, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var2, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var2, weights =E(var2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var2, directed = T)$vector), 
     sd(centr_eigen(var2, directed = T)$vector)
   ))
```
...
var2_power_centrality_stats <- power_centrality(var2, nodes = V(var2), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var2)$var2_power_centrality_stats <-power_centrality(var2, nodes = V(var2), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var2)$LABEL_COR, var2_power_centrality_stats))
...
plot(var2, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var2)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var2)+1)^2)/10,
     edge.width=edge.betweenness(var2, weights =E(var2)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, results="asis"}
#Saving power as an object
var2_alpha_centrality_stats <- alpha_centrality(var2, loops = FALSE, alpha = 1, exo = 1, weights=E(var2)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var2)$var2_alpha_centrality_stats<-alpha_centrality(var2, loops = FALSE, alpha = 1, exo = 1, weights=E(var2)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var2)$LABEL_COR, round(var2_alpha_centrality_stats,1)))
...
plot(var2, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var2, loops = FALSE, alpha = 1, exo = 1, weights=E(var2)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var2))^2)/50,
     edge.width=edge.betweenness(var2, weights =E(var2)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
V(var2)$hub <- hub.score(var2)$vector
var2_hub<- hub.score(var2)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var2)$LABEL_COR, var2_hub))
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=10*hub.score(var2)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var2)+1)/10,
     edge.width=edge.betweenness(var2, weights =E(var2)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
V(var2)$authority.score<- authority.score(var2)$vector
var2_auth <- authority.score(var2)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var2)$LABEL_COR, var2_auth))
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=10*authority.score(var2)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var2)+1)/20,
     edge.width=log(edge.betweenness(var2, weights =E(var2)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var2_pr<-page.rank(var2)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var2)$LABEL_COR, var2_pr))
...
plot(var2, 
     layout=layout.kamada.kawai(var2), 
     vertex.label=get.vertex.attribute(var2,"LABEL_COR"),
     vertex.size=200*page.rank(var2)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var2)+1)/15,
     edge.width=log(edge.betweenness(var2, weights =E(var2)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
prPB<-page_rank(var2)$vector
hPB<-hub.score(var2)$vector
authPB<-authority.score(var2)$vector
indegPB<-degree(var2, mode="in")
outdegPB<-degree(var2, mode="out")
```
...
title("Hits by in and out degree - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var2<-make_ego_graph(var2, order=1, V(var2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var2, 
     layout=layout.kamada.kawai(make_ego_graph_all_var2), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var2,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var2)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var2)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var2))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var2)$LABEL_COR
b<-V(make_ego_graph_all_var2)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var2)$vector),
     sd(page.rank(make_ego_graph_all_var2)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var2<-make_ego_graph(var2, order=1, V(var2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var2, 
     layout=layout.kamada.kawai(make_ego_graph_out_var2), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var2,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var2)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var2)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var2))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var2)$LABEL_COR
b<-V(make_ego_graph_out_var2)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var2)$vector),
     sd(page.rank(make_ego_graph_out_var2)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var2<-make_ego_graph(var2, order=1, V(var2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var2, 
     layout=layout.kamada.kawai(make_ego_graph_in_var2), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var2,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var2)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var2))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var2))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var2)$LABEL_COR
b<-V(make_ego_graph_in_var2)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var2)$vector),
     sd(page.rank(make_ego_graph_in_var2)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var2_without_CAPSAD<-delete_vertices(make_ego_graph_all_var2,V(make_ego_graph_all_var2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var2_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var2_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var2_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var2_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var2_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var2_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var2_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var2_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var2_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var2_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var2_without_complex<-
  delete_vertices(make_ego_graph_all_var2,
                  c(V(make_ego_graph_all_var2)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var2)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var2_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var2_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var2_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var2_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var2_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var2_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var2_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var2_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var2_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var2_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var2, 
     layout=layout.kamada.kawai(msp_var2), 
     vertex.label=get.vertex.attribute(msp_var2,"LABEL_COR"),
     vertex.size=degree(msp_var2)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var2)/50,
     edge.width=log(edge.betweenness(msp_var2, weights =E(msp_var2)$msp_var2))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var2, 
     layout=layout.auto(msp_var2), 
     vertex.label=get.vertex.attribute(msp_var2,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var2)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var2))/50,
     edge.width=log(edge.betweenness(msp_var2, weights=E(msp_var2)$msp_var2))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var2, mode="in")), 
     median(degree(msp_var2, mode="out"))
...
msp_var2_w<-minimum.spanning.tree(var2, weights=1/edge.betweenness(var2, weights =E(var2)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var2_w, 
     layout=layout.auto(msp_var2_w), 
     vertex.label=get.vertex.attribute(msp_var2_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var2_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var2_w))/20,
     edge.width=1/edge.betweenness(msp_var2_w, weights =E(msp_var2_w)$msp_var2_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var2)$mut/ecount(var2) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var2_sp_in <- shortest.paths(var2, mode='in', weights=E(var2)$weight) # sames as bellow
var2_sp_out <- shortest.paths(var2, mode='out', weights=E(var2)$weight) #same as above
var2_sp_all <- shortest.paths(var2, mode='all', weights=E(var2)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var2<-distances(var2, mode="all", weights=E(var2)$weight)
#distances_sp_all_var2

#In shortest paths 
distances_sp_in_var2<-distances(var2, mode="in",weights=E(var2)$weight)
#distances_sp_in_var2

#Out shortest paths 
distances_sp_out_var2<-distances(var2, mode="out", weights=E(var2)$weight)
#distances_sp_out_var2
```
...
var2_dist.from.CAPSAD <- distances(var2, v=V(var2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var2), weights=E(var2)$weight)
...
plot(var2, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var2)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var2))/10,
     edge.width=edge.betweenness(var2, weights=E(var2)$var2)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var2, weights=E(var2)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var2, weights=E(var2)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var2, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var2)$transitivity_local_w<-transitivity(var2, type="barrat") 
transitivity_local_w<-transitivity(var2, weights=E(var2)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var2_u <- as.undirected(var2, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var2_u_size<-sapply(cliques(var2_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var2)$edge.btweenness<-edge.betweenness(var2, weights =E(var2)$weight)
var2_edge.betweenness <-edge.betweenness(var2, weights =E(var2)$weight)
```
...
plot(var2, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var2_edge.betweenness.community),
                      var2_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var2)+1)/10,
     edge.width=log(edge.betweenness(var2, weights =E(var2)$weight))/5,
     edge.curved = TRUE
     )
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var2 <- as.dendrogram(var2_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var2, main = "Dendrograma var2", nodePar=list(pch=c(NA, 20)))
```
...
plot(var2, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var2)),
     mark.groups = by(seq_along(var2_walktrap.community),
                      var2_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var2)+1)/10,
     edge.width=log(edge.betweenness(var2, weights =E(var2)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var2 <- decompose.graph(var2)
sapply(comps_var2, diameter)
table(sapply(comps_var2, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var21<-comps_var2[[1]]
#comps_var22<-comps_var2[[2]]
#comps_var23<-comps_var2[[3]]
#comps_var24<-comps_var2[[4]]
#comps_var25<-comps_var2[[5]]
#comps_var26<-comps_var2[[6]]
#comps_var27<-comps_var2[[7]]
#comps_var28<-comps_var2[[8]]
#...
```
...
plot(comps_var21, 
     layout=layout.kamada.kawai(comps_var21), 
     vertex.label=get.vertex.attribute(comps_var21,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var21)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var21)+1)/10,
     edge.width=log(edge.betweenness(comps_var21, weights=E(comps_var21)$comps_var21))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var21)$LABEL_COR
b<-V(comps_var21)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var21, mode="in")), 
     median(degree(comps_var21, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var2)$optimal_comm_var2 <- #membership(optimal.community(var2))
#optimal_comm_var2 <- membership(optimal.community(var2))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var2)
var2_dim<-get.diameter(var2)
var2_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var2, weights=E(var2)$weight)
var2_dim<-get.diameter(var2, weights=E(var2)$weight)
var2_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var2)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 4.CENTRALIDADE_REFERENCIA DE RECEBIMENTO CONTRAREFERENCIA (var2)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
