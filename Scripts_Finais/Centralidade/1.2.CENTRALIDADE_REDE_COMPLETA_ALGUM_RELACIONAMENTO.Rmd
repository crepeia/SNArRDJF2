---
title: "SNA Centralities 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)"
...
# 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)
...
```
#1. Descriptive Analysis for 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
edge_density_x2<-edge_density(x2) #The proportion of present edges from all possible edges in the network.
edge_density_x2
```
#1.4.2 Edge connectivity - Adhesion
The edge connectivity of a graph or two vertices, this is recently also called group adhesion.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
edge_connectivity(x2, source =NULL, target =NULL, checks = T) #source and target can be replaced - their are here just as default
```
# Adhesion example
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
edge_connectivity(x2, source =150, target =3, checks = T) 
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
vertex_connectivity(x2, source = NULL, target = NULL, checks = TRUE)
```
# Cohesion example
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
vertex_connectivity(x2, source =6, target =185, checks = T) 
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(x2)/10, main="Histogram of Indegree Nodes - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(x2)/10, main="Histogram of Outdegree Nodes - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(x2)/10, main="Histogram of All Degree Nodes - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)")
```  
...
#Histogram x2 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(x2, weights=E(x2)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(x2)/10, main="Histogram of Strength Degree Nodes - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(x2)/10, main="Histogram of Normalized Indegree Nodes - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(x2)/10, main="Histogram of Normalized Outdegree Nodes - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(x2)/10, main="Histogram of Normalized All Degree Nodes - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(x2), breaks=vcount(x2)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$x2_a.nn.deg <- graph.knn(x2,V(x2))$knn
```
...
plot(degree(x2), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for x2)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(x2), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)"
     )
```
...
## Vertex 
V(x2)$size <- degree(x2)
V(x2)$label <- V(x2)$V5_LABEL_TIPO_NOME
V(x2)$label.cex <- degree(x2)/100
V(x2)$label.color <- "black"

## Just in case if we wanna change colors
#V(x2)$color <- V(x2)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(x2)$weight <- E(x2)$weight
E(x2)$width <- E(x2)$weight
E(x2)$color <- "gray"

## Here we can change other edge parameter
#E(x2)[ weight < 0.5 ]$width <- 4
#E(x2)[ weight < 0.5 ]$color <- "green"
#E(x2)$label <- LETTERS[1:10]
#E(x2)$label.cex = seq(1, 2,length.out = 10)
#E(x2)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(x2, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=degree(x2)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(x2)/10000,
     vertex.label.cex=degree(x2)/500,
     edge.width=(edge.betweenness(x2, weights=V(x2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ", cex = .5)
...
plot(x2, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(x2))/800,
     edge.width=(edge.betweenness(x2, weights =E(x2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
...
#Plotting 
plot(small_x2, 
     layout=layout.kamada.kawai(small_x2), 
     vertex.label=get.vertex.attribute(small_x2,"LABEL_COR"),
     vertex.size=degree(small_x2)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_x2)+1)/10,
     edge.width=(edge.betweenness(small_x2))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_x2, mode="in")), 
     median(degree(small_x2, mode="out"))
   )
  )
```
...
plot(small_x2, 
     layout=layout.kamada.kawai(small_x2), 
     vertex.label=get.vertex.attribute(small_x2,"LABEL_COR"),
     vertex.size=degree(small_x2)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_x2)+2)/5,
     edge.width=(edge.betweenness(small_x2)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_x2, mode="in")), 
     median(degree(small_x2, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #x2_a.nn.deg_w 
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=(graph.knn(x2,V(x2))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(x2,V(x2))$knn+1)/30,
     edge.width=(edge.betweenness(x2, weights =E(x2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(x2,V(x2))$knn)
   ))
```
...
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(x2,V(x2), weights= E(x2)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(x2,V(x2), weights= E(x2)$weight)$knn+1)/10,
     edge.width=edge.betweenness(x2, weights =E(x2)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(x2,V(x2), weights= E(x2)$weight)$knn)
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$incloseness <- closeness(x2, mode = "in") %>% round(6)
V(x2)$outcloseness <- closeness(x2, mode = "out") %>% round(6)
V(x2)$totalcloseness <- closeness(x2, mode = "total") %>% round(4)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
x2_incloseness<- closeness(x2, mode = "in") %>% round(6)
x2_outcloseness<- closeness(x2, mode = "out") %>% round(6)
x2_totalcloseness<- closeness(x2, mode = "total") %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$incloseness_n <- closeness(x2, mode = "in", normalized = T) %>% round(6)
V(x2)$outcloseness_n <- closeness(x2, mode = "out", normalized = T) %>% round(6)
V(x2)$totalcloseness_n <- closeness(x2, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
x2_incloseness_n<- closeness(x2, mode = "in", normalized = T) %>% round(6)
x2_outcloseness_n<- closeness(x2, mode = "out", normalized = T) %>% round(6)
x2_totalcloseness_n<- closeness(x2, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$incloseness_w <- closeness(x2, mode = "in", normalized = T, weights=E(x2)$weight) %>% round(6)
V(x2)$outcloseness_w <- closeness(x2, mode = "out", normalized = T,weights=E(x2)$weight) %>% round(6)
V(x2)$totalcloseness_w <- closeness(x2, mode = "total", normalized = T, weights=E(x2)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
x2_incloseness_w<- closeness(x2, mode = "in", normalized = T, weights=E(x2)$weight) %>% round(6)
x2_outcloseness_w<- closeness(x2, mode = "out", normalized = T, weights=E(x2)$weight) %>% round(6)
x2_totalcloseness_w<- closeness(x2, mode = "total", normalized = T, weights=E(x2)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(x2_incloseness_w)
sd(x2_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(x2_outcloseness_w)
sd(x2_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(x2_totalcloseness_w)
sd(x2_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$x2_closeness_stats_w <- closeness(x2, vids = V(x2), mode = "all", weights =E(x2)$weight, normalized = FALSE)
x2_closeness_stats_w <- closeness(x2, vids = V(x2), mode = "all", weights =E(x2)$weight, normalized = FALSE)
```
...
x2_outcloseness_w<- closeness(x2, mode = "out", normalized = T, weights=E(x2)$weight) %>% round(6)
x2_totalcloseness_w<- closeness(x2, mode = "total", normalized = T, weights=E(x2)$weight) %>% round(6)
x2_closeness_stats_w <- closeness(x2, vids = V(x2), mode = "all", weights=E(x2)$weight, normalized = FALSE) %>% round(6)
...
#Adding names
names(x2_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
x2_df_closseness<-x2_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(x2)$x2_color_degree<-round(V(x2)$totalcloseness,4)
...
plot(x2, 
     ...
     vertex.color=V(x2)$vertex_x2_color_degree,
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=closeness(x2)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(x2))/80,
     edge.width=(edge.betweenness(x2, weights =E(x2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(x2, mode="in")), 
     median(closeness(x2, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(x2)$x2_color_degree<-round(V(x2)$x2_centr_closeness,2)
...
plot(x2, 
     ...
     vertex.color=V(x2)$vertex_x2_color_degree,
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=centralization.closeness(x2)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(x2, mode="in")), 
     median(closeness(x2, mode="out"))
...
#Saving objects
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$betweenness <- betweenness(x2) %>% round(1)
x2_betweenness <- betweenness(x2) %>% round(1)
```
##Betweenness Centrality - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(x2_betweenness)
sd(x2_betweenness)
```
#2.8.2 Betweenness Centrality Weighted - (Vertex)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$x2_betweenness_w <- betweenness(x2, weights=E(x2)$weight) %>% round(1)
x2_betweenness_w <- betweenness(x2, weights=E(x2)$weight) %>% round(1)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$x2_centr_betweenness <- centralization.betweenness(x2)$res
x2_centr_betweenness <- centralization.betweenness(x2)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
x2_betweenness <- betweenness(x2) %>% round(1)
x2_betweenness_w <- betweenness(x2, weights=E(x2)$weight) %>% round(1)
x2_centr_betweenness <- centralization.betweenness(x2)$res %>% round(1)

#Creating a dataframe of measures
x2_df_betweenness <- data.frame(x2_betweenness,
x2_betweenness_w,
x2_centr_betweenness) %>% round(1)

#Adding type
x2_df_betweenness <-cbind(x2_df_betweenness, V(x2)$LABEL_COR)

#Adding names
names(x2_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
x2_df_betweenness<-x2_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
# General tabel for Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(x2_df_betweenness, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(x2_df_betweenness, by=list(x2_df_betweenness$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(x2_df_betweenness, by=list(x2_df_betweenness$Type), FUN=sd, na.rm=TRUE) 
...
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=betweenness(x2)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(x2)+1)/10000,
     edge.width=edge.betweenness(x2, weights =E(x2)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(x2)), 
     sd(betweenness(x2))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(x2)$x2_centr_betweenness<-(centralization.betweenness(x2)$res)/10000
V(x2)$x2_color_degree<-round(V(x2)$x2_centr_betweenness,1)
...
plot(x2, 
     ...
     vertex.color=V(x2)$vertex_x2_color_degree,
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=(centralization.betweenness(x2)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centralization.betweenness(x2)$res + 1)/10000,
     edge.width=(edge.betweenness(x2, weights =E(x2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Betweenness - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(x2)$eigenvector <- eigen_centrality(x2, directed = TRUE, weights =E(x2)$weight) %$% vector %>% round(3)
x2_eigenvector <- eigen_centrality(x2, directed = TRUE, weights = E(x2)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
x2_eigenvector_value <- eigen_centrality(x2, directed = TRUE, weights = E(x2)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
#2.9.2 Eigen Centrality Descriptive
#all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(x2_eigenvector)
sd(x2_eigenvector)
```
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
x2_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$x2_centr_eigen <- centr_eigen(x2, directed = T)$vector
x2_centr_eigen <-centr_eigen(x2, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(x2, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(x2, directed = T)$theoretical_max
```
#2.9.4 Eigenvector Centrality Measures Dinamic Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Getting  Measures
#Eigen_Centrality 
x2_eigenvector <- eigen_centrality(x2, directed = TRUE) %$% vector %>% round(3)
x2_eigenvector_w <- eigen_centrality(x2, directed = TRUE, weights = E(x2)$weight) %$% vector %>% round(3) 
x2_centr_eigen <-centr_eigen(x2, directed = T)$vector

#Creating a datagrame of measures
x2_df_eigenvector <- data.frame(x2_eigenvector,
x2_eigenvector_w,
x2_centr_eigen) %>% round(3)

#Adding type
x2_df_eigenvector <-cbind(x2_df_eigenvector, V(x2)$LABEL_COR)

#Adding names
names(x2_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
x2_df_eigenvector<-x2_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(x2_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(x2_df_eigenvector, by=list(x2_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(x2_df_eigenvector, by=list(x2_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=(eigen_centrality(x2, directed =TRUE, weights = E(x2)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(x2)$vector)+1)/10,
     edge.width=edge.betweenness(x2, weights =E(x2)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(x2)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(x2)$x2_color_degree<-round(centr_eigen(x2, directed = T)$vector,2)
...
plot(x2, 
     ...
     vertex.color=V(x2)$vertex_x2_color_degree,
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=centr_eigen(x2, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(x2, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(x2, weights =E(x2)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(x2, directed = T)$vector), 
     sd(centr_eigen(x2, directed = T)$vector)
   ))
```
...
x2_power_centrality_stats <- power_centrality(x2, nodes = V(x2), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(x2)$x2_power_centrality_stats <-power_centrality(x2, nodes = V(x2), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(x2)$LABEL_COR, x2_power_centrality_stats))
...
V(x2)$x2_power_centrality_stats_r<-round(V(x2)$x2_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(x2)$x2_power_centrality_stats_r)), "Blues"))(length(unique(V(x2)$x2_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(x2)$color_spower <- vertex_col_spower[factor(V(x2)$x2_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.color=V(x2)$color_spower, 
     vertex.label=V(x2)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(x2)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(x2)+1)^2)/10,
     edge.width=edge.betweenness(x2, weights =E(x2)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(x2)$x2_power_centrality_stats_r
b<-V(x2)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(x2_power_centrality_stats),sd(x2_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
x2_alpha_centrality_stats <- alpha_centrality(x2, loops = FALSE, alpha = 1, exo = 1, weights=E(x2)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(x2)$x2_alpha_centrality_stats<-alpha_centrality(x2, loops = FALSE, alpha = 1, exo = 1, weights=E(x2)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(x2)$LABEL_COR, round(x2_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(x2)$x2_alpha_centrality_stats_r<-round(V(x2)$x2_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(x2)$x2_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(x2)$x2_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(x2)$color_s <- vertex_col_s[factor(V(x2)$x2_alpha_centrality_stats_r)]  
```
...
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.color=V(x2)$color_s, 
     vertex.label=V(x2)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(x2, loops = FALSE, alpha = 1, exo = 1, weights=E(x2)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(x2))^2)/50,
     edge.width=edge.betweenness(x2, weights =E(x2)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(x2)$x2_alpha_centrality_stats_r
b<-V(x2)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(x2_alpha_centrality_stats),sd(x2_alpha_centrality_stats)
     ))
```
...
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=10*hub.score(x2)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(x2)+1)/10,
     edge.width=edge.betweenness(x2, weights =E(x2)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=10*authority.score(x2)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(x2)+1)/20,
     edge.width=log(edge.betweenness(x2, weights =E(x2)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(x2, 
     layout=layout.kamada.kawai(x2), 
     vertex.label=get.vertex.attribute(x2,"LABEL_COR"),
     vertex.size=200*page.rank(x2)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(x2)+1)/15,
     edge.width=log(edge.betweenness(x2, weights =E(x2)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_x2<-make_ego_graph(x2, order=1, V(x2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_x2, 
     layout=layout.kamada.kawai(make_ego_graph_all_x2), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_x2,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_x2)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_x2)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_x2))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_x2)$LABEL_COR
b<-V(make_ego_graph_all_x2)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_x2)$vector),
     sd(page.rank(make_ego_graph_all_x2)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_x2<-make_ego_graph(x2, order=1, V(x2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_x2, 
     layout=layout.kamada.kawai(make_ego_graph_out_x2), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_x2,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_x2)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_x2)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_x2))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_x2)$LABEL_COR
b<-V(make_ego_graph_out_x2)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_x2)$vector),
     sd(page.rank(make_ego_graph_out_x2)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_x2<-make_ego_graph(x2, order=1, V(x2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_x2, 
     layout=layout.kamada.kawai(make_ego_graph_in_x2), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_x2,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_x2)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_x2))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_x2))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_x2)$LABEL_COR
b<-V(make_ego_graph_in_x2)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_x2)$vector),
     sd(page.rank(make_ego_graph_in_x2)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_x2_without_CAPSAD<-delete_vertices(make_ego_graph_all_x2,V(make_ego_graph_all_x2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_x2_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_x2_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_x2_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_x2_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_x2_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_x2_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_x2_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_x2_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_x2_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_x2_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_x2_without_complex<-
  delete_vertices(make_ego_graph_all_x2,
                  c(V(make_ego_graph_all_x2)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_x2)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_x2_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_x2_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_x2_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_x2_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_x2_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_x2_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_x2_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_x2_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_x2_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_x2_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_x2, 
     layout=layout.kamada.kawai(msp_x2), 
     vertex.label=get.vertex.attribute(msp_x2,"LABEL_COR"),
     vertex.size=degree(msp_x2)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_x2)/50,
     edge.width=log(edge.betweenness(msp_x2, weights =E(msp_x2)$msp_x2))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_x2, 
     layout=layout.auto(msp_x2), 
     vertex.label=get.vertex.attribute(msp_x2,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_x2)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_x2))/50,
     edge.width=log(edge.betweenness(msp_x2, weights=E(msp_x2)$msp_x2))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_x2, mode="in")), 
     median(degree(msp_x2, mode="out"))
...
msp_x2_w<-minimum.spanning.tree(x2, weights=1/edge.betweenness(x2, weights =E(x2)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_x2_w, 
     layout=layout.auto(msp_x2_w), 
     vertex.label=get.vertex.attribute(msp_x2_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_x2_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_x2_w))/20,
     edge.width=1/edge.betweenness(msp_x2_w, weights =E(msp_x2_w)$msp_x2_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(x2)$mut/ecount(x2) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
x2_sp_in <- shortest.paths(x2, mode='in', weights=E(x2)$weight) # sames as bellow
x2_sp_out <- shortest.paths(x2, mode='out', weights=E(x2)$weight) #same as above
x2_sp_all <- shortest.paths(x2, mode='all', weights=E(x2)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_x2<-distances(x2, mode="all", weights=E(x2)$weight)
#distances_sp_all_x2

#In shortest paths 
distances_sp_in_x2<-distances(x2, mode="in",weights=E(x2)$weight)
#distances_sp_in_x2

#Out shortest paths 
distances_sp_out_x2<-distances(x2, mode="out", weights=E(x2)$weight)
#distances_sp_out_x2
```
...
x2_dist.from.CAPSAD <- distances(x2, v=V(x2)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(x2), weights=E(x2)$weight)
...
plot(x2, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(x2)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(x2))/10,
     edge.width=edge.betweenness(x2, weights=E(x2)$x2)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(x2, weights=E(x2)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(x2, weights=E(x2)$weight,type="weighted")
```
...
transitivity_local<-transitivity(x2, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$transitivity_local_w<-transitivity(x2, type="barrat") 
transitivity_local_w<-transitivity(x2, weights=E(x2)$weight, type="barrat")
```
...
#Reachability
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
x2_reach_in <- reachability(x2, 'in')
x2_reach_out <- reachability(x2, 'out')
```
#Descriptive - Reachability - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
mean(x2_reach_in[which(x2_reach_in != Inf)])
sd(x2_reach_in[which(x2_reach_in != Inf)])
```
##Descriptive - Reachability  - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
mean(x2_reach_out[which(x2_reach_out != Inf)])
sd(x2_reach_out[which(x2_reach_out != Inf)])
```

#3.9 Subgroups and communities
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
x2_u <- as.undirected(x2, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_x2_u_size<-sapply(cliques(x2_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(x2)), 
     max(graph.coreness(x2))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(x2)$edge.btweenness<-edge.betweenness(x2, weights =E(x2)$weight)
x2_edge.betweenness <-edge.betweenness(x2, weights =E(x2)$weight)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(x2_edge.betweenness)
sd(x2_edge.betweenness)
```
#Edge Betweenness Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
labels<-attr(E(x2), "vnames")
edgebt<-cbind(round(x2_edge.betweenness,2),labels)
datatable(edgebt)
```
...
plot(x2, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(x2_edge.betweenness.community),
                      x2_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(x2)+1)/10,
     edge.width=log(edge.betweenness(x2, weights =E(x2)$weight))/5,
     edge.curved = TRUE
     )
...
x2_walktrap.community <- walktrap.community(x2)
```

#3.11.1 Network Dendograma
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_x2 <- as.dendrogram(x2_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_x2, main = "Dendrograma x2", nodePar=list(pch=c(NA, 20)))
```

#3.11.2 Saving Random walk community
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(x2)$walktrap.community <- membership(x2_walktrap.community)
x2_walktrap.community <- membership(x2_walktrap.community)
```
...
plot(x2, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(x2)),
     mark.groups = by(seq_along(x2_walktrap.community),
                      x2_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(x2)+1)/10,
     edge.width=log(edge.betweenness(x2, weights =E(x2)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_x2 <- decompose.graph(x2)
sapply(comps_x2, diameter)
table(sapply(comps_x2, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_x21<-comps_x2[[1]]
#comps_x22<-comps_x2[[2]]
#comps_x23<-comps_x2[[3]]
#comps_x24<-comps_x2[[4]]
#comps_x25<-comps_x2[[5]]
#comps_x26<-comps_x2[[6]]
#comps_x27<-comps_x2[[7]]
#comps_x28<-comps_x2[[8]]
#...
```
...
plot(comps_x21, 
     layout=layout.kamada.kawai(comps_x21), 
     vertex.label=get.vertex.attribute(comps_x21,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_x21)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_x21)+1)/10,
     edge.width=log(edge.betweenness(comps_x21, weights=E(comps_x21)$comps_x21))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_x21)$LABEL_COR
b<-V(comps_x21)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_x21, mode="in")), 
     median(degree(comps_x21, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(x2)$optimal_comm_x2 <- #membership(optimal.community(x2))
#optimal_comm_x2 <- membership(optimal.community(x2))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(x2)
x2_dim<-get.diameter(x2)
x2_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(x2, weights=E(x2)$weight)
x2_dim<-get.diameter(x2, weights=E(x2)$weight)
x2_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$x2)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 1.2.CENTRALIDADE - ALGUM RELACIONAMENTO (x2)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
