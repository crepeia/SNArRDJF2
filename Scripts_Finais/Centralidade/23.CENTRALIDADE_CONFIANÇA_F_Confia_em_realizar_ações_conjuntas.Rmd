---
title: "SNA Centralities 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21)."
...
# 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).
...
```
#1. Descriptive Analysis for 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var21, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var21)/10, main="Histogram of Indegree Nodes - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var21, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var21)/10, main="Histogram of Outdegree Nodes - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var21, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var21)/10, main="Histogram of All Degree Nodes - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).")
```  
...
#Histogram var21 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var21, weights=E(var21)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var21)/10, main="Histogram of Strength Degree Nodes - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var21, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var21)/10, main="Histogram of Normalized Indegree Nodes - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var21, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var21)/10, main="Histogram of Normalized Outdegree Nodes - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var21, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var21)/10, main="Histogram of Normalized All Degree Nodes - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var21), breaks=vcount(var21)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21). ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21)."
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var21)$var21_a.nn.deg <- graph.knn(var21,V(var21))$knn
```
...
plot(degree(var21), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21)."
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).)

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var21)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var21), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21)."
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var21)$size <- degree(var21)
V(var21)$label <- V(var21)$V5_LABEL_TIPO_NOME
V(var21)$label.cex <- degree(var21)/100
V(var21)$label.color <- "black"

## Just in case if we wanna change colors
#V(var21)$color <- V(var21)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var21)$weight <- E(var21)$weight
E(var21)$width <- E(var21)$weight
E(var21)$color <- "gray"

## Here we can change other edge parameter
#E(var21)[ weight < 0.5 ]$width <- 4
#E(var21)[ weight < 0.5 ]$color <- "green"
#E(var21)$label <- LETTERS[1:10]
#E(var21)$label.cex = seq(1, 2,length.out = 10)
#E(var21)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var21, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=degree(var21)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var21)/10000,
     vertex.label.cex=degree(var21)/500,
     edge.width=(edge.betweenness(var21, weights=V(var21)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ", cex = .5)
...
plot(var21, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var21))/800,
     edge.width=(edge.betweenness(var21, weights =E(var21)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
...
#Plotting 
plot(small_var21, 
     layout=layout.kamada.kawai(small_var21), 
     vertex.label=get.vertex.attribute(small_var21,"LABEL_COR"),
     vertex.size=degree(small_var21)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var21)+1)/10,
     edge.width=(edge.betweenness(small_var21))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var21, mode="in")), 
     median(degree(small_var21, mode="out"))
   )
  )
```
...
plot(small_var21, 
     layout=layout.kamada.kawai(small_var21), 
     vertex.label=get.vertex.attribute(small_var21,"LABEL_COR"),
     vertex.size=degree(small_var21)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var21)+2)/5,
     edge.width=(edge.betweenness(small_var21)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var21, mode="in")), 
     median(degree(small_var21, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var21_a.nn.deg_w 
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=(graph.knn(var21,V(var21))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var21,V(var21))$knn+1)/30,
     edge.width=(edge.betweenness(var21, weights =E(var21)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var21,V(var21))$knn)
   ))
```
...
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var21,V(var21), weights= E(var21)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var21,V(var21), weights= E(var21)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var21, weights =E(var21)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var21,V(var21), weights= E(var21)$weight)$knn)
   ))
```
...
V(var21)$totalcloseness <- closeness(var21, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var21)$incloseness_n <- closeness(var21, mode = "in", normalized = T) %>% round(6)
V(var21)$outcloseness_n <- closeness(var21, mode = "out", normalized = T) %>% round(6)
V(var21)$totalcloseness_n <- closeness(var21, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var21_incloseness_n<- closeness(var21, mode = "in", normalized = T) %>% round(6)
var21_outcloseness_n<- closeness(var21, mode = "out", normalized = T) %>% round(6)
var21_totalcloseness_n<- closeness(var21, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var21)$incloseness_w <- closeness(var21, mode = "in", normalized = T, weights=E(var21)$weight) %>% round(6)
V(var21)$outcloseness_w <- closeness(var21, mode = "out", normalized = T,weights=E(var21)$weight) %>% round(6)
V(var21)$totalcloseness_w <- closeness(var21, mode = "total", normalized = T, weights=E(var21)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var21_incloseness_w<- closeness(var21, mode = "in", normalized = T, weights=E(var21)$weight) %>% round(6)
var21_outcloseness_w<- closeness(var21, mode = "out", normalized = T, weights=E(var21)$weight) %>% round(6)
var21_totalcloseness_w<- closeness(var21, mode = "total", normalized = T, weights=E(var21)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var21_incloseness_w)
sd(var21_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var21_outcloseness_w)
sd(var21_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var21_totalcloseness_w)
sd(var21_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var21)$var21_closeness_stats_w <- closeness(var21, vids = V(var21), mode = "all", weights =E(var21)$weight, normalized = FALSE)
var21_closeness_stats_w <- closeness(var21, vids = V(var21), mode = "all", weights =E(var21)$weight, normalized = FALSE)
```
...
var21_outcloseness_w<- closeness(var21, mode = "out", normalized = T, weights=E(var21)$weight) %>% round(6)
var21_totalcloseness_w<- closeness(var21, mode = "total", normalized = T, weights=E(var21)$weight) %>% round(6)
var21_closeness_stats_w <- closeness(var21, vids = V(var21), mode = "all", weights=E(var21)$weight, normalized = FALSE) %>% round(6)
...
var21_incloseness_w,
var21_outcloseness_w,
var21_totalcloseness_w,
var21_closeness_stats_w,
...
#Adding names
names(var21_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var21_df_closseness<-var21_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var21)$var21_color_degree<-round(V(var21)$totalcloseness,4)
...
plot(var21, 
     ...
     vertex.color=V(var21)$vertex_var21_color_degree,
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=closeness(var21)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var21))/80,
     edge.width=(edge.betweenness(var21, weights =E(var21)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var21, mode="in")), 
     median(closeness(var21, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var21)$var21_color_degree<-round(V(var21)$var21_centr_closeness,2)
...
plot(var21, 
     ...
     vertex.color=V(var21)$vertex_var21_color_degree,
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=centralization.closeness(var21)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var21, mode="in")), 
     median(closeness(var21, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var21)$var21_betweenness_w <- betweenness(var21, weights=E(var21)$weight) %>% round(1)
var21_betweenness_w <- betweenness(var21, weights=E(var21)$weight) %>% round(1)
```
##Betweenness Centrality Weighted - (Vertex) - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var21_betweenness_w)
sd(var21_betweenness_w)
```
#2.8.3 Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var21)$var21_centr_betweenness <- centralization.betweenness(var21)$res
var21_centr_betweenness <- centralization.betweenness(var21)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var21_centr_betweenness$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var21_centr_betweenness$theoretical_max
```
...
var21_betweenness <- betweenness(var21) %>% round(1)
var21_betweenness_w <- betweenness(var21, weights=E(var21)$weight) %>% round(1)
var21_centr_betweenness <- centralization.betweenness(var21)$res %>% round(1)

#Creating a dataframe of measures
var21_df_betweenness <- data.frame(var21_betweenness,
var21_betweenness_w,
var21_centr_betweenness) %>% round(1)

#Adding type
var21_df_betweenness <-cbind(var21_df_betweenness, V(var21)$LABEL_COR)

#Adding names
names(var21_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var21_df_betweenness<-var21_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=betweenness(var21)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var21)+1)/10000,
     edge.width=edge.betweenness(var21, weights =E(var21)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var21)), 
     sd(betweenness(var21))
   ))
```
#2.8.2 Network Plotting Based On Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var21)$var21_centr_betweenness<-(centralization.betweenness(var21)$res)/10000
V(var21)$var21_color_degree<-round(V(var21)$var21_centr_betweenness,1)
...
plot(var21, 
     ...
     vertex.color=V(var21)$vertex_var21_color_degree,
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var21)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centralization.betweenness(var21)$res + 1)/10000,
     edge.width=(edge.betweenness(var21, weights =E(var21)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Betweenness - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var21)$eigenvector <- eigen_centrality(var21, directed = TRUE, weights =E(var21)$weight) %$% vector %>% round(3)
var21_eigenvector <- eigen_centrality(var21, directed = TRUE, weights = E(var21)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var21_eigenvector_value <- eigen_centrality(var21, directed = TRUE, weights = E(var21)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=(eigen_centrality(var21, directed =TRUE, weights = E(var21)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var21)$vector)+1)/10,
     edge.width=edge.betweenness(var21, weights =E(var21)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var21)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var21)$var21_color_degree<-round(centr_eigen(var21, directed = T)$vector,2)
...
plot(var21, 
     ...
     vertex.color=V(var21)$vertex_var21_color_degree,
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=centr_eigen(var21, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var21, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var21, weights =E(var21)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var21, directed = T)$vector), 
     sd(centr_eigen(var21, directed = T)$vector)
   ))
```
...
var21_power_centrality_stats <- power_centrality(var21, nodes = V(var21), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var21)$var21_power_centrality_stats <-power_centrality(var21, nodes = V(var21), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var21)$LABEL_COR, var21_power_centrality_stats))
...
V(var21)$var21_power_centrality_stats_r<-round(V(var21)$var21_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var21)$var21_power_centrality_stats_r)), "Blues"))(length(unique(V(var21)$var21_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var21)$color_spower <- vertex_col_spower[factor(V(var21)$var21_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.color=V(var21)$color_spower, 
     vertex.label=V(var21)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var21)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var21)+1)^2)/10,
     edge.width=edge.betweenness(var21, weights =E(var21)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var21)$var21_power_centrality_stats_r
b<-V(var21)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var21_power_centrality_stats),sd(var21_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var21_alpha_centrality_stats <- alpha_centrality(var21, loops = FALSE, alpha = 1, exo = 1, weights=E(var21)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var21)$var21_alpha_centrality_stats<-alpha_centrality(var21, loops = FALSE, alpha = 1, exo = 1, weights=E(var21)$weight, tol = 1e-07, sparse = TRUE)

#Descriptive 
summary(var21_alpha_centrality_stats)
sd(var21_alpha_centrality_stats)
```
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var21)$LABEL_COR, round(var21_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var21)$var21_alpha_centrality_stats_r<-round(V(var21)$var21_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var21)$var21_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var21)$var21_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var21)$color_s <- vertex_col_s[factor(V(var21)$var21_alpha_centrality_stats_r)]  
```
...
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.color=V(var21)$color_s, 
     vertex.label=V(var21)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var21, loops = FALSE, alpha = 1, exo = 1, weights=E(var21)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var21))^2)/50,
     edge.width=edge.betweenness(var21, weights =E(var21)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var21)$var21_alpha_centrality_stats_r
b<-V(var21)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var21_alpha_centrality_stats),sd(var21_alpha_centrality_stats)
     ))
```
...
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=10*hub.score(var21)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var21)+1)/10,
     edge.width=edge.betweenness(var21, weights =E(var21)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=10*authority.score(var21)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var21)+1)/20,
     edge.width=log(edge.betweenness(var21, weights =E(var21)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var21, 
     layout=layout.kamada.kawai(var21), 
     vertex.label=get.vertex.attribute(var21,"LABEL_COR"),
     vertex.size=200*page.rank(var21)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var21)+1)/15,
     edge.width=log(edge.betweenness(var21, weights =E(var21)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var21<-make_ego_graph(var21, order=1, V(var21)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var21, 
     layout=layout.kamada.kawai(make_ego_graph_all_var21), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var21,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var21)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var21)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var21))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var21)$LABEL_COR
b<-V(make_ego_graph_all_var21)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var21)$vector),
     sd(page.rank(make_ego_graph_all_var21)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var21<-make_ego_graph(var21, order=1, V(var21)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var21, 
     layout=layout.kamada.kawai(make_ego_graph_out_var21), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var21,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var21)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var21)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var21))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var21)$LABEL_COR
b<-V(make_ego_graph_out_var21)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var21)$vector),
     sd(page.rank(make_ego_graph_out_var21)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var21<-make_ego_graph(var21, order=1, V(var21)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var21, 
     layout=layout.kamada.kawai(make_ego_graph_in_var21), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var21,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var21)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var21))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var21))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var21)$LABEL_COR
b<-V(make_ego_graph_in_var21)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var21)$vector),
     sd(page.rank(make_ego_graph_in_var21)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var21_without_CAPSAD<-delete_vertices(make_ego_graph_all_var21,V(make_ego_graph_all_var21)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var21_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var21_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var21_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var21_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var21_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var21_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var21_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var21_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var21_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var21_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var21_without_complex<-
  delete_vertices(make_ego_graph_all_var21,
                  c(V(make_ego_graph_all_var21)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var21)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var21_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var21_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var21_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var21_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var21_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var21_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var21_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var21_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var21_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var21_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var21, 
     layout=layout.kamada.kawai(msp_var21), 
     vertex.label=get.vertex.attribute(msp_var21,"LABEL_COR"),
     vertex.size=degree(msp_var21)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var21)/50,
     edge.width=log(edge.betweenness(msp_var21, weights =E(msp_var21)$msp_var21))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var21, 
     layout=layout.auto(msp_var21), 
     vertex.label=get.vertex.attribute(msp_var21,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var21)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var21))/50,
     edge.width=log(edge.betweenness(msp_var21, weights=E(msp_var21)$msp_var21))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var21, mode="in")), 
     median(degree(msp_var21, mode="out"))
...
msp_var21_w<-minimum.spanning.tree(var21, weights=1/edge.betweenness(var21, weights =E(var21)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var21_w, 
     layout=layout.auto(msp_var21_w), 
     vertex.label=get.vertex.attribute(msp_var21_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var21_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var21_w))/20,
     edge.width=1/edge.betweenness(msp_var21_w, weights =E(msp_var21_w)$msp_var21_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var21)$mut/ecount(var21) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var21_sp_in <- shortest.paths(var21, mode='in', weights=E(var21)$weight) # sames as bellow
var21_sp_out <- shortest.paths(var21, mode='out', weights=E(var21)$weight) #same as above
var21_sp_all <- shortest.paths(var21, mode='all', weights=E(var21)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var21<-distances(var21, mode="all", weights=E(var21)$weight)
#distances_sp_all_var21

#In shortest paths 
distances_sp_in_var21<-distances(var21, mode="in",weights=E(var21)$weight)
#distances_sp_in_var21

#Out shortest paths 
distances_sp_out_var21<-distances(var21, mode="out", weights=E(var21)$weight)
#distances_sp_out_var21
```
...
var21_dist.from.CAPSAD <- distances(var21, v=V(var21)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var21), weights=E(var21)$weight)
...
plot(var21, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var21)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var21))/10,
     edge.width=edge.betweenness(var21, weights=E(var21)$var21)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var21, weights=E(var21)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var21, weights=E(var21)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var21, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var21)$transitivity_local_w<-transitivity(var21, type="barrat") 
transitivity_local_w<-transitivity(var21, weights=E(var21)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var21_u <- as.undirected(var21, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var21_u_size<-sapply(cliques(var21_u), length) # too intesive calculation
```
...
as.undirected_var21_u<-as.undirected(var21_u)
...
V(as.undirected_var21_u)$vcol<-vcol

#Saving labels to display as legend
V(as.undirected_var21_u)$vcollabel[V(as.undirected_var21_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var21_u)$vcollabel [V(as.undirected_var21_u)$vcol=="grey80"]<-"Others"
```

#Plotting based only on degree measures 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(as.undirected(var21_u), 
     layout=layout.kamada.kawai(as.undirected(var21_u)), 
     vertex.label=get.vertex.attribute(as.undirected(var21_u),"LABEL_COR"),
     vertex.color=vcol,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(as.undirected(var21_u))),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var21_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var21_u), weights =E(as.undirected(var21_u))$var21))/50,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(as.undirected_var21_u)$vcollabel
b<-V(as.undirected_var21_u)$vcol
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Coreness Colored Graph - 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(var21)), 
     max(graph.coreness(var21))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var21)$edge.btweenness<-edge.betweenness(var21, weights =E(var21)$weight)
var21_edge.betweenness <-edge.betweenness(var21, weights =E(var21)$weight)
```
...
plot(var21, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var21_edge.betweenness.community),
                      var21_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var21)+1)/10,
     edge.width=log(edge.betweenness(var21, weights =E(var21)$weight))/5,
     edge.curved = TRUE
     )
...
var21_walktrap.community <- walktrap.community(var21)
```

#3.11.1 Network Dendograma
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var21 <- as.dendrogram(var21_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var21, main = "Dendrograma var21", nodePar=list(pch=c(NA, 20)))
```

#3.11.2 Saving Random walk community
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var21)$walktrap.community <- membership(var21_walktrap.community)
var21_walktrap.community <- membership(var21_walktrap.community)
```
...
plot(var21, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var21)),
     mark.groups = by(seq_along(var21_walktrap.community),
                      var21_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var21)+1)/10,
     edge.width=log(edge.betweenness(var21, weights =E(var21)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var21 <- decompose.graph(var21)
sapply(comps_var21, diameter)
table(sapply(comps_var21, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var211<-comps_var21[[1]]
#comps_var212<-comps_var21[[2]]
#comps_var213<-comps_var21[[3]]
#comps_var214<-comps_var21[[4]]
#comps_var215<-comps_var21[[5]]
#comps_var216<-comps_var21[[6]]
#comps_var217<-comps_var21[[7]]
#comps_var218<-comps_var21[[8]]
#...
```
...
plot(comps_var211, 
     layout=layout.kamada.kawai(comps_var211), 
     vertex.label=get.vertex.attribute(comps_var211,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var211)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var211)+1)/10,
     edge.width=log(edge.betweenness(comps_var211, weights=E(comps_var211)$comps_var211))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var211)$LABEL_COR
b<-V(comps_var211)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var211, mode="in")), 
     median(degree(comps_var211, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var21)$optimal_comm_var21 <- #membership(optimal.community(var21))
#optimal_comm_var21 <- membership(optimal.community(var21))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var21)
var21_dim<-get.diameter(var21)
var21_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var21, weights=E(var21)$weight)
var21_dim<-get.diameter(var21, weights=E(var21)$weight)
var21_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var21)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 23.CENTRALIDADE_CONFIANÇA F) Confia em realizar ações conjuntas com este serviço (var21).", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
