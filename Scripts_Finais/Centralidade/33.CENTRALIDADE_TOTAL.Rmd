---
title: "SNA Centralities 33.CENTRALIDADE_TOTAL"
...
```
#1. Descriptive Analysis for 33.CENTRALIDADE_TOTAL
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(total, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(total)/10, main="Histogram of Indegree Nodes - 33.CENTRALIDADE_TOTAL")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(total, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(total)/10, main="Histogram of Outdegree Nodes - 33.CENTRALIDADE_TOTAL")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(total, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(total)/10, main="Histogram of All Degree Nodes - 33.CENTRALIDADE_TOTAL")
```  
...
#Histogram total degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(total, weights=E(total)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(total)/10, main="Histogram of Strength Degree Nodes - 33.CENTRALIDADE_TOTAL")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(total, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(total)/10, main="Histogram of Normalized Indegree Nodes - 33.CENTRALIDADE_TOTAL")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(total, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(total)/10, main="Histogram of Normalized Outdegree Nodes - 33.CENTRALIDADE_TOTAL")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(total, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(total)/10, main="Histogram of Normalized All Degree Nodes - 33.CENTRALIDADE_TOTAL")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(total), breaks=vcount(total)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 33.CENTRALIDADE_TOTAL")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 33.CENTRALIDADE_TOTAL ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 33.CENTRALIDADE_TOTAL"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 33.CENTRALIDADE_TOTAL)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(total)$total_a.nn.deg <- graph.knn(total,V(total))$knn
```
...
plot(degree(total), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 33.CENTRALIDADE_TOTAL"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 33.CENTRALIDADE_TOTAL)
...
plot(degree(total), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 33.CENTRALIDADE_TOTAL"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(total)$size <- degree(total)
V(total)$label <- V(total)$V5_LABEL_TIPO_NOME
V(total)$label.cex <- degree(total)/100
V(total)$label.color <- "black"

## Just in case if we wanna change colors
#V(total)$color <- V(total)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(total)$weight <- E(total)$weight
E(total)$width <- E(total)$weight
E(total)$color <- "gray"

## Here we can change other edge parameter
#E(total)[ weight < 0.5 ]$width <- 4
#E(total)[ weight < 0.5 ]$color <- "green"
#E(total)$label <- LETTERS[1:10]
#E(total)$label.cex = seq(1, 2,length.out = 10)
#E(total)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(total, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(total, 
     ...
     edge.width=(edge.betweenness(total, weights=V(total)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ", cex = .5)
...
plot(total, 
     ...
     edge.width=(edge.betweenness(total, weights =E(total)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
...
plot(small_total, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_total)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_total, 
     ...
     vertex.label.cex=log(degree(small_total)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_total, mode="in")), 
     median(degree(small_total, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #total_a.nn.deg_w 
plot(total, 
     layout=layout.kamada.kawai(total), 
     vertex.label=get.vertex.attribute(total,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(total,V(total))$knn+1)/30,
     edge.width=(edge.betweenness(total, weights =E(total)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(total, 
     layout=layout.kamada.kawai(total), 
     vertex.label=get.vertex.attribute(total,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(total,V(total), weights= E(total)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(total,V(total), weights= E(total)$weight)$knn+1)/10,
     edge.width=edge.betweenness(total, weights =E(total)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(total,V(total), weights= E(total)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(total)$incloseness_w <- closeness(total, mode = "in", normalized = T, weights=E(total)$weight) %>% round(6)
V(total)$outcloseness_w <- closeness(total, mode = "out", normalized = T,weights=E(total)$weight) %>% round(6)
V(total)$totalcloseness_w <- closeness(total, mode = "total", normalized = T, weights=E(total)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
total_incloseness_w<- closeness(total, mode = "in", normalized = T, weights=E(total)$weight) %>% round(6)
total_outcloseness_w<- closeness(total, mode = "out", normalized = T, weights=E(total)$weight) %>% round(6)
total_totalcloseness_w<- closeness(total, mode = "total", normalized = T, weights=E(total)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(total)$total_closeness_stats_w <- closeness(total, vids = V(total), mode = "all", weights =E(total)$weight, normalized = FALSE)
total_closeness_stats_w <- closeness(total, vids = V(total), mode = "all", weights =E(total)$weight, normalized = FALSE)
```
...
total_outcloseness_w<- closeness(total, mode = "out", normalized = T, weights=E(total)$weight) %>% round(6)
total_totalcloseness_w<- closeness(total, mode = "total", normalized = T, weights=E(total)$weight) %>% round(6)
total_closeness_stats_w <- closeness(total, vids = V(total), mode = "all", weights=E(total)$weight, normalized = FALSE) %>% round(6)
...
total_incloseness_w,
total_outcloseness_w,
total_totalcloseness_w,
total_closeness_stats_w,
...
#Adding names
names(total_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
total_df_closseness<-total_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(total)$total_color_degree<-round(V(total)$total_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(total, mode="in")), 
     median(closeness(total, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(total)$total_betweenness_w <- betweenness(total, weights=E(total)$weight) %>% round(1)
total_betweenness_w <- betweenness(total, weights=E(total)$weight) %>% round(1)
```
##Betweenness Centrality Weighted - (Vertex) - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(total_betweenness_w)
sd(total_betweenness_w)
```
#2.8.3 Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(total)$total_centr_betweenness <- centralization.betweenness(total)$res
total_centr_betweenness <- centralization.betweenness(total)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
total_centr_betweenness$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
total_centr_betweenness$theoretical_max
```
...
total_betweenness <- betweenness(total) %>% round(1)
total_betweenness_w <- betweenness(total, weights=E(total)$weight) %>% round(1)
total_centr_betweenness <- centralization.betweenness(total)$res %>% round(1)

#Creating a dataframe of measures
total_df_betweenness <- data.frame(total_betweenness,
total_betweenness_w,
total_centr_betweenness) %>% round(1)

#Adding type
total_df_betweenness <-cbind(total_df_betweenness, V(total)$LABEL_COR)

#Adding names
names(total_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
total_df_betweenness<-total_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(total)$total_centr_betweenness<-(centralization.betweenness(total)$res)/10000
V(total)$total_color_degree<-round(V(total)$total_centr_betweenness,1)
...
#Adding Title
  title("Network Centralization Betweenness - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(total)$eigenvector <- eigen_centrality(total, directed = TRUE, weights =E(total)$weight) %$% vector %>% round(3)
total_eigenvector <- eigen_centrality(total, directed = TRUE, weights = E(total)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
total_eigenvector_value <- eigen_centrality(total, directed = TRUE, weights = E(total)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(total)$total_centr_eigen <- centr_eigen(total, directed = T)$vector
total_centr_eigen <-centr_eigen(total, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
total_eigenvector_w <- eigen_centrality(total, directed = TRUE, weights = E(total)$weight) %$% vector %>% round(3) 
total_centr_eigen <-centr_eigen(total, directed = T)$vector

#Creating a datagrame of measures
total_df_eigenvector <- data.frame(total_eigenvector,
total_eigenvector_w,
total_centr_eigen) %>% round(3)

#Adding type
total_df_eigenvector <-cbind(total_df_eigenvector, V(total)$LABEL_COR)

#Adding names
names(total_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
total_df_eigenvector<-total_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(total_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(total_df_eigenvector, by=list(total_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(total_df_eigenvector, by=list(total_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(total, 
     layout=layout.kamada.kawai(total), 
     vertex.label=get.vertex.attribute(total,"LABEL_COR"),
     vertex.size=(eigen_centrality(total, directed =TRUE, weights = E(total)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(total)$vector)+1)/10,
     edge.width=edge.betweenness(total, weights =E(total)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(total, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(total, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(total, weights =E(total)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(total, directed = T)$vector), 
     sd(centr_eigen(total, directed = T)$vector)
   ))
```
...
total_power_centrality_stats <- power_centrality(total, nodes = V(total), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(total)$total_power_centrality_stats <-power_centrality(total, nodes = V(total), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(total)$LABEL_COR, total_power_centrality_stats))
...
V(total)$total_power_centrality_stats_r<-round(V(total)$total_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(total)$total_power_centrality_stats_r)), "Blues"))(length(unique(V(total)$total_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(total)$color_spower <- vertex_col_spower[factor(V(total)$total_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(total)$total_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(total_power_centrality_stats),sd(total_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
total_alpha_centrality_stats <- alpha_centrality(total, loops = FALSE, alpha = 1, exo = 1, weights=E(total)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(total)$total_alpha_centrality_stats<-alpha_centrality(total, loops = FALSE, alpha = 1, exo = 1, weights=E(total)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(total)$LABEL_COR, round(total_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(total)$total_alpha_centrality_stats_r<-round(V(total)$total_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(total)$total_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(total)$total_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(total)$color_s <- vertex_col_s[factor(V(total)$total_alpha_centrality_stats_r)]  
```
...
plot(total, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(total, loops = FALSE, alpha = 1, exo = 1, weights=E(total)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(total)$total_alpha_centrality_stats_r
b<-V(total)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(total_alpha_centrality_stats),sd(total_alpha_centrality_stats)
     ))
```
...
plot(total, 
     layout=layout.kamada.kawai(total), 
     vertex.label=get.vertex.attribute(total,"LABEL_COR"),
     vertex.size=10*hub.score(total)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(total, 
     layout=layout.kamada.kawai(total), 
     vertex.label=get.vertex.attribute(total,"LABEL_COR"),
     vertex.size=10*authority.score(total)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(total)+1)/20,
     edge.width=log(edge.betweenness(total, weights =E(total)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(total, 
     layout=layout.kamada.kawai(total), 
     vertex.label=get.vertex.attribute(total,"LABEL_COR"),
     vertex.size=200*page.rank(total)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(total)+1)/15,
     edge.width=log(edge.betweenness(total, weights =E(total)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 33.CENTRALIDADE_TOTAL", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_total, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_total)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_total, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_total)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_total)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_total, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_total)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_total_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_total_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_total_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_total_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_total_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_total_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_total_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_total, 
     ...
     vertex.size=degree(msp_total)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_total)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_total, mode="in")), 
     median(degree(msp_total, mode="out"))
...
msp_total_w<-minimum.spanning.tree(total, weights=1/edge.betweenness(total, weights =E(total)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_total_w, 
     layout=layout.auto(msp_total_w), 
     ...
     edge.width=1/edge.betweenness(msp_total_w, weights =E(msp_total_w)$msp_total_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
total_sp_in <- shortest.paths(total, mode='in', weights=E(total)$weight) # sames as bellow
total_sp_out <- shortest.paths(total, mode='out', weights=E(total)$weight) #same as above
total_sp_all <- shortest.paths(total, mode='all', weights=E(total)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_total<-distances(total, mode="all", weights=E(total)$weight)
#distances_sp_all_total

#In shortest paths 
distances_sp_in_total<-distances(total, mode="in",weights=E(total)$weight)
#distances_sp_in_total

#Out shortest paths 
distances_sp_out_total<-distances(total, mode="out", weights=E(total)$weight)
...
total_dist.from.CAPSAD <- distances(total, v=V(total)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(total), weights=E(total)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(total, weights=E(total)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(total, weights=E(total)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(total, weights=E(total)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_total_u_size<-sapply(cliques(total_u), length) # too intesive calculation
```
...
V(as.undirected_total_u)$vcollabel[V(as.undirected_total_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_total_u)$vcollabel [V(as.undirected_total_u)$vcol=="grey80"]<-"Others"
```
...
plot(as.undirected(total_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(total_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(total_u), weights =E(as.undirected(total_u))$total))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Coreness Colored Graph - 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(total)$edge.btweenness<-edge.betweenness(total, weights =E(total)$weight)
total_edge.betweenness <-edge.betweenness(total, weights =E(total)$weight)
```
...
plot(total, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(total)+1)/10,
     edge.width=log(edge.betweenness(total, weights =E(total)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_total1, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_total1)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(total, weights=E(total)$weight)
total_dim<-get.diameter(total, weights=E(total)$weight)
total_dim
```
...
#Adding Title
  title("Diameter of 33.CENTRALIDADE_TOTAL", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
