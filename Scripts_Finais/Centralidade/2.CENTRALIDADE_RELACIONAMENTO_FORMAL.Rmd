---
title: "SNA Centralities 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)"
...
```
#1. Descriptive Analysis for 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var0, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var0)/10, main="Histogram of Indegree Nodes - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var0, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var0)/10, main="Histogram of Outdegree Nodes - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var0, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var0)/10, main="Histogram of All Degree Nodes - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)")
```  
...
#Histogram var0 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var0, weights=E(var0)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var0)/10, main="Histogram of Strength Degree Nodes - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var0, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var0)/10, main="Histogram of Normalized Indegree Nodes - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var0, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var0)/10, main="Histogram of Normalized Outdegree Nodes - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var0, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var0)/10, main="Histogram of Normalized All Degree Nodes - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var0), breaks=vcount(var0)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var0)$var0_a.nn.deg <- graph.knn(var0,V(var0))$knn
```
...
plot(degree(var0), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var0)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var0), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var0, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=degree(var0)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var0)/10000,
     vertex.label.cex=degree(var0)/500,
     edge.width=(edge.betweenness(var0, weights=V(var0)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ", cex = .5)
...
plot(var0, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var0))/800,
     edge.width=(edge.betweenness(var0, weights =E(var0)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var0, 
     layout=layout.kamada.kawai(small_var0), 
     vertex.label=get.vertex.attribute(small_var0,"LABEL_COR"),
     vertex.size=degree(small_var0)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var0)+1)/10,
     edge.width=(edge.betweenness(small_var0))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var0, mode="in")), 
     median(degree(small_var0, mode="out"))
   )
  )
```
...
plot(small_var0, 
     layout=layout.kamada.kawai(small_var0), 
     vertex.label=get.vertex.attribute(small_var0,"LABEL_COR"),
     vertex.size=degree(small_var0)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var0)+2)/5,
     edge.width=(edge.betweenness(small_var0)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var0, mode="in")), 
     median(degree(small_var0, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var0_a.nn.deg_w 
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=(graph.knn(var0,V(var0))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var0,V(var0))$knn+1)/30,
     edge.width=(edge.betweenness(var0, weights =E(var0)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var0,V(var0))$knn)
   ))
```
...
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var0,V(var0), weights= E(var0)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var0,V(var0), weights= E(var0)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var0, weights =E(var0)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var0,V(var0), weights= E(var0)$weight)$knn)
   ))
```
...
V(var0)$totalcloseness <- closeness(var0, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var0)$incloseness_n <- closeness(var0, mode = "in", normalized = T) %>% round(6)
V(var0)$outcloseness_n <- closeness(var0, mode = "out", normalized = T) %>% round(6)
V(var0)$totalcloseness_n <- closeness(var0, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var0_incloseness_n<- closeness(var0, mode = "in", normalized = T) %>% round(6)
var0_outcloseness_n<- closeness(var0, mode = "out", normalized = T) %>% round(6)
var0_totalcloseness_n<- closeness(var0, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var0)$incloseness_w <- closeness(var0, mode = "in", normalized = T, weights=E(var0)$weight) %>% round(6)
V(var0)$outcloseness_w <- closeness(var0, mode = "out", normalized = T,weights=E(var0)$weight) %>% round(6)
V(var0)$totalcloseness_w <- closeness(var0, mode = "total", normalized = T, weights=E(var0)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var0_incloseness_w<- closeness(var0, mode = "in", normalized = T, weights=E(var0)$weight) %>% round(6)
var0_outcloseness_w<- closeness(var0, mode = "out", normalized = T, weights=E(var0)$weight) %>% round(6)
var0_totalcloseness_w<- closeness(var0, mode = "total", normalized = T, weights=E(var0)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var0_incloseness_w)
sd(var0_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var0_outcloseness_w)
sd(var0_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var0_totalcloseness_w)
sd(var0_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var0)$var0_closeness_stats_w <- closeness(var0, vids = V(var0), mode = "all", weights =E(var0)$weight, normalized = FALSE)
var0_closeness_stats_w <- closeness(var0, vids = V(var0), mode = "all", weights =E(var0)$weight, normalized = FALSE)
```
...
var0_outcloseness_w<- closeness(var0, mode = "out", normalized = T, weights=E(var0)$weight) %>% round(6)
var0_totalcloseness_w<- closeness(var0, mode = "total", normalized = T, weights=E(var0)$weight) %>% round(6)
var0_closeness_stats_w <- closeness(var0, vids = V(var0), mode = "all", weights=E(var0)$weight, normalized = FALSE) %>% round(6)
...
var0_incloseness_w,
var0_outcloseness_w,
var0_totalcloseness_w,
var0_closeness_stats_w,
...
#Adding names
names(var0_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var0_df_closseness<-var0_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var0)$var0_color_degree<-round(V(var0)$totalcloseness,4)
...
plot(var0, 
     ...
     vertex.color=V(var0)$vertex_var0_color_degree,
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=closeness(var0)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var0))/80,
     edge.width=(edge.betweenness(var0, weights =E(var0)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var0, mode="in")), 
     median(closeness(var0, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var0)$var0_color_degree<-round(V(var0)$var0_centr_closeness,2)
...
plot(var0, 
     ...
     vertex.color=V(var0)$vertex_var0_color_degree,
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=centralization.closeness(var0)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var0, mode="in")), 
     median(closeness(var0, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var0)$var0_betweenness_w <- betweenness(var0, weights=E(var0)$weight) %>% round(1)
var0_betweenness_w <- betweenness(var0, weights=E(var0)$weight) %>% round(1)
```
...
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=betweenness(var0)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var0)+1)/10000,
     edge.width=edge.betweenness(var0, weights =E(var0)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var0)), 
     sd(betweenness(var0))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var0)$var0_centr_betweenness<-(centralization.betweenness(var0)$res)/10000
...
plot(var0, 
     ...
     vertex.color=V(var0)$vertex_var0_color_degree,
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var0)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Betweenness - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var0)$eigenvector <- eigen_centrality(var0, directed = TRUE, weights =E(var0)$weight) %$% vector %>% round(3)
var0_eigenvector <- eigen_centrality(var0, directed = TRUE, weights = E(var0)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var0_eigenvector_value <- eigen_centrality(var0, directed = TRUE, weights = E(var0)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var0_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var0)$var0_centr_eigen <- centr_eigen(var0, directed = T)$vector
var0_centr_eigen <-centr_eigen(var0, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var0, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var0, directed = T)$theoretical_max
```
...
var0_eigenvector_w <- eigen_centrality(var0, directed = TRUE, weights = E(var0)$weight) %$% vector %>% round(3) 
var0_centr_eigen <-centr_eigen(var0, directed = T)$vector

#Creating a datagrame of measures
var0_df_eigenvector <- data.frame(var0_eigenvector,
var0_eigenvector_w,
var0_centr_eigen) %>% round(3)

#Adding type
var0_df_eigenvector <-cbind(var0_df_eigenvector, V(var0)$LABEL_COR)

#Adding names
names(var0_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var0_df_eigenvector<-var0_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var0_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var0_df_eigenvector, by=list(var0_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var0_df_eigenvector, by=list(var0_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=(eigen_centrality(var0, directed =TRUE, weights = E(var0)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var0)$vector)+1)/10,
     edge.width=edge.betweenness(var0, weights =E(var0)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var0)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var0)$var0_color_degree<-round(centr_eigen(var0, directed = T)$vector,2)
...
plot(var0, 
     ...
     vertex.color=V(var0)$vertex_var0_color_degree,
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=centr_eigen(var0, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var0, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var0, weights =E(var0)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var0, directed = T)$vector), 
     sd(centr_eigen(var0, directed = T)$vector)
   ))
```
...
var0_power_centrality_stats <- power_centrality(var0, nodes = V(var0), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var0)$var0_power_centrality_stats <-power_centrality(var0, nodes = V(var0), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var0)$LABEL_COR, var0_power_centrality_stats))
...
V(var0)$var0_power_centrality_stats_r<-round(V(var0)$var0_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var0)$var0_power_centrality_stats_r)), "Blues"))(length(unique(V(var0)$var0_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var0)$color_spower <- vertex_col_spower[factor(V(var0)$var0_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.color=V(var0)$color_spower, 
     vertex.label=V(var0)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var0)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var0)+1)^2)/10,
     edge.width=edge.betweenness(var0, weights =E(var0)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var0)$var0_power_centrality_stats_r
b<-V(var0)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var0_power_centrality_stats),sd(var0_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var0_alpha_centrality_stats <- alpha_centrality(var0, loops = FALSE, alpha = 1, exo = 1, weights=E(var0)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var0)$var0_alpha_centrality_stats<-alpha_centrality(var0, loops = FALSE, alpha = 1, exo = 1, weights=E(var0)$weight, tol = 1e-07, sparse = TRUE)

#Descriptive 
summary(var0_alpha_centrality_stats)
sd(var0_alpha_centrality_stats)
```
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var0)$LABEL_COR, round(var0_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var0)$var0_alpha_centrality_stats_r<-round(V(var0)$var0_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var0)$var0_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var0)$var0_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var0)$color_s <- vertex_col_s[factor(V(var0)$var0_alpha_centrality_stats_r)]  
```
...
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.color=V(var0)$color_s, 
     vertex.label=V(var0)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var0, loops = FALSE, alpha = 1, exo = 1, weights=E(var0)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var0))^2)/50,
     edge.width=edge.betweenness(var0, weights =E(var0)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var0)$var0_alpha_centrality_stats_r
b<-V(var0)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var0_alpha_centrality_stats),sd(var0_alpha_centrality_stats)
     ))
```
...
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=10*hub.score(var0)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var0)+1)/10,
     edge.width=edge.betweenness(var0, weights =E(var0)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=10*authority.score(var0)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var0)+1)/20,
     edge.width=log(edge.betweenness(var0, weights =E(var0)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var0, 
     layout=layout.kamada.kawai(var0), 
     vertex.label=get.vertex.attribute(var0,"LABEL_COR"),
     vertex.size=200*page.rank(var0)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var0)+1)/15,
     edge.width=log(edge.betweenness(var0, weights =E(var0)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var0<-make_ego_graph(var0, order=1, V(var0)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var0, 
     layout=layout.kamada.kawai(make_ego_graph_all_var0), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var0,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var0)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var0)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var0))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var0)$LABEL_COR
b<-V(make_ego_graph_all_var0)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var0)$vector),
     sd(page.rank(make_ego_graph_all_var0)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var0<-make_ego_graph(var0, order=1, V(var0)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var0, 
     layout=layout.kamada.kawai(make_ego_graph_out_var0), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var0,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var0)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var0)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var0))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var0)$LABEL_COR
b<-V(make_ego_graph_out_var0)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var0)$vector),
     sd(page.rank(make_ego_graph_out_var0)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var0<-make_ego_graph(var0, order=1, V(var0)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var0, 
     layout=layout.kamada.kawai(make_ego_graph_in_var0), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var0,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var0)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var0))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var0))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var0)$LABEL_COR
b<-V(make_ego_graph_in_var0)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var0)$vector),
     sd(page.rank(make_ego_graph_in_var0)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var0_without_CAPSAD<-delete_vertices(make_ego_graph_all_var0,V(make_ego_graph_all_var0)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var0_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var0_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var0_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var0_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var0_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var0_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var0_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var0_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var0_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var0_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var0_without_complex<-
  delete_vertices(make_ego_graph_all_var0,
                  c(V(make_ego_graph_all_var0)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var0)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var0_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var0_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var0_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var0_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var0_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var0_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var0_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var0_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var0_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var0_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var0, 
     layout=layout.kamada.kawai(msp_var0), 
     vertex.label=get.vertex.attribute(msp_var0,"LABEL_COR"),
     vertex.size=degree(msp_var0)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var0)/50,
     edge.width=log(edge.betweenness(msp_var0, weights =E(msp_var0)$msp_var0))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var0, mode="in")), 
     median(degree(msp_var0, mode="out"))
   ))
```
...
#Plotting based only on degree measures 
plot(msp_var0, 
     layout=layout.auto(msp_var0), 
     vertex.label=get.vertex.attribute(msp_var0,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var0)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var0))/50,
     edge.width=log(edge.betweenness(msp_var0, weights=E(msp_var0)$msp_var0))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var0, mode="in")), 
     median(degree(msp_var0, mode="out"))
...
msp_var0_w<-minimum.spanning.tree(var0, weights=1/edge.betweenness(var0, weights =E(var0)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var0_w, 
     layout=layout.auto(msp_var0_w), 
     vertex.label=get.vertex.attribute(msp_var0_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var0_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var0_w))/20,
     edge.width=1/edge.betweenness(msp_var0_w, weights =E(msp_var0_w)$msp_var0_w)*2,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(msp_var0_w)$LABEL_COR
b<-V(msp_var0_w)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var0_w, mode="in")), 
     median(degree(msp_var0_w, mode="out"))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var0)$mut/ecount(var0) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var0_sp_in <- shortest.paths(var0, mode='in', weights=E(var0)$weight) # sames as bellow
var0_sp_out <- shortest.paths(var0, mode='out', weights=E(var0)$weight) #same as above
var0_sp_all <- shortest.paths(var0, mode='all', weights=E(var0)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var0<-distances(var0, mode="all", weights=E(var0)$weight)
#distances_sp_all_var0

#In shortest paths 
distances_sp_in_var0<-distances(var0, mode="in",weights=E(var0)$weight)
#distances_sp_in_var0

#Out shortest paths 
distances_sp_out_var0<-distances(var0, mode="out", weights=E(var0)$weight)
#distances_sp_out_var0
```
...
var0_dist.from.CAPSAD <- distances(var0, v=V(var0)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var0), weights=E(var0)$weight)
...
plot(var0, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var0)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var0))/10,
     edge.width=edge.betweenness(var0, weights=E(var0)$var0)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var0, weights=E(var0)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var0, weights=E(var0)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var0, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var0)$transitivity_local_w<-transitivity(var0, type="barrat") 
transitivity_local_w<-transitivity(var0, weights=E(var0)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var0_u <- as.undirected(var0, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var0_u_size<-sapply(cliques(var0_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(var0)), 
     max(graph.coreness(var0))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var0)$edge.btweenness<-edge.betweenness(var0, weights =E(var0)$weight)
var0_edge.betweenness <-edge.betweenness(var0, weights =E(var0)$weight)
```
...
plot(var0, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var0_edge.betweenness.community),
                      var0_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var0)+1)/10,
     edge.width=log(edge.betweenness(var0, weights =E(var0)$weight))/5,
     edge.curved = TRUE
     )
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var0 <- as.dendrogram(var0_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var0, main = "Dendrograma var0", nodePar=list(pch=c(NA, 20)))
```
...
plot(var0, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var0)),
     mark.groups = by(seq_along(var0_walktrap.community),
                      var0_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var0)+1)/10,
     edge.width=log(edge.betweenness(var0, weights =E(var0)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var0 <- decompose.graph(var0)
sapply(comps_var0, diameter)
table(sapply(comps_var0, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var01<-comps_var0[[1]]
#comps_var02<-comps_var0[[2]]
#comps_var03<-comps_var0[[3]]
#comps_var04<-comps_var0[[4]]
#comps_var05<-comps_var0[[5]]
#comps_var06<-comps_var0[[6]]
#comps_var07<-comps_var0[[7]]
#comps_var08<-comps_var0[[8]]
#...
```
...
plot(comps_var01, 
     layout=layout.kamada.kawai(comps_var01), 
     vertex.label=get.vertex.attribute(comps_var01,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var01)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var01)+1)/10,
     edge.width=log(edge.betweenness(comps_var01, weights=E(comps_var01)$comps_var01))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var01)$LABEL_COR
b<-V(comps_var01)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var01, mode="in")), 
     median(degree(comps_var01, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var0)$optimal_comm_var0 <- #membership(optimal.community(var0))
#optimal_comm_var0 <- membership(optimal.community(var0))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var0)
var0_dim<-get.diameter(var0)
var0_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var0, weights=E(var0)$weight)
var0_dim<-get.diameter(var0, weights=E(var0)$weight)
var0_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var0)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 2.CENTRALIDADE_RELACIONAMENTO FORMAL (var0)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
