---
title: "SNA Centralities 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)"
...
```
#1. Descriptive Analysis for 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var1, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var1)/10, main="Histogram of Indegree Nodes - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var1, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var1)/10, main="Histogram of Outdegree Nodes - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var1, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var1)/10, main="Histogram of All Degree Nodes - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)")
```  
...
#Histogram var1 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var1, weights=E(var1)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var1)/10, main="Histogram of Strength Degree Nodes - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var1, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var1)/10, main="Histogram of Normalized Indegree Nodes - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var1, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var1)/10, main="Histogram of Normalized Outdegree Nodes - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var1, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var1)/10, main="Histogram of Normalized All Degree Nodes - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var1), breaks=vcount(var1)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var1)$var1_a.nn.deg <- graph.knn(var1,V(var1))$knn
```
...
plot(degree(var1), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var1)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var1), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)"
     )
```
...
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=degree(var1)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var1)/10000,
     vertex.label.cex=degree(var1)/500,
     edge.width=(edge.betweenness(var1, weights=V(var1)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ", cex = .5)
...
plot(var1, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var1))/800,
     edge.width=(edge.betweenness(var1, weights =E(var1)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var1, 
     layout=layout.kamada.kawai(small_var1), 
     vertex.label=get.vertex.attribute(small_var1,"LABEL_COR"),
     vertex.size=degree(small_var1)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var1)+1)/10,
     edge.width=(edge.betweenness(small_var1))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var1, mode="in")), 
     median(degree(small_var1, mode="out"))
   )
  )
```
...
plot(small_var1, 
     layout=layout.kamada.kawai(small_var1), 
     vertex.label=get.vertex.attribute(small_var1,"LABEL_COR"),
     vertex.size=degree(small_var1)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var1)+2)/5,
     edge.width=(edge.betweenness(small_var1)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var1, mode="in")), 
     median(degree(small_var1, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var1_a.nn.deg_w 
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=(graph.knn(var1,V(var1))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var1,V(var1))$knn+1)/30,
     edge.width=(edge.betweenness(var1, weights =E(var1)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var1,V(var1))$knn)
   ))
```
...
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var1,V(var1), weights= E(var1)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var1,V(var1), weights= E(var1)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var1, weights =E(var1)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var1,V(var1), weights= E(var1)$weight)$knn)
   ))
```
...
V(var1)$totalcloseness <- closeness(var1, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var1)$incloseness_n <- closeness(var1, mode = "in", normalized = T) %>% round(6)
V(var1)$outcloseness_n <- closeness(var1, mode = "out", normalized = T) %>% round(6)
V(var1)$totalcloseness_n <- closeness(var1, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var1_incloseness_n<- closeness(var1, mode = "in", normalized = T) %>% round(6)
var1_outcloseness_n<- closeness(var1, mode = "out", normalized = T) %>% round(6)
var1_totalcloseness_n<- closeness(var1, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var1)$incloseness_w <- closeness(var1, mode = "in", normalized = T, weights=E(var1)$weight) %>% round(6)
V(var1)$outcloseness_w <- closeness(var1, mode = "out", normalized = T,weights=E(var1)$weight) %>% round(6)
V(var1)$totalcloseness_w <- closeness(var1, mode = "total", normalized = T, weights=E(var1)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var1_incloseness_w<- closeness(var1, mode = "in", normalized = T, weights=E(var1)$weight) %>% round(6)
var1_outcloseness_w<- closeness(var1, mode = "out", normalized = T, weights=E(var1)$weight) %>% round(6)
var1_totalcloseness_w<- closeness(var1, mode = "total", normalized = T, weights=E(var1)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var1_incloseness_w)
sd(var1_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var1_outcloseness_w)
sd(var1_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var1_totalcloseness_w)
sd(var1_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var1)$var1_closeness_stats_w <- closeness(var1, vids = V(var1), mode = "all", weights =E(var1)$weight, normalized = FALSE)
var1_closeness_stats_w <- closeness(var1, vids = V(var1), mode = "all", weights =E(var1)$weight, normalized = FALSE)
```
...
var1_outcloseness_w<- closeness(var1, mode = "out", normalized = T, weights=E(var1)$weight) %>% round(6)
var1_totalcloseness_w<- closeness(var1, mode = "total", normalized = T, weights=E(var1)$weight) %>% round(6)
var1_closeness_stats_w <- closeness(var1, vids = V(var1), mode = "all", weights=E(var1)$weight, normalized = FALSE) %>% round(6)
...
var1_incloseness_w,
var1_outcloseness_w,
var1_totalcloseness_w,
var1_closeness_stats_w,
...
#Adding names
names(var1_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var1_df_closseness<-var1_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var1)$var1_color_degree<-round(V(var1)$totalcloseness,4)
...
plot(var1, 
     ...
     vertex.color=V(var1)$vertex_var1_color_degree,
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=closeness(var1)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var1))/80,
     edge.width=(edge.betweenness(var1, weights =E(var1)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var1, mode="in")), 
     median(closeness(var1, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var1)$var1_color_degree<-round(V(var1)$var1_centr_closeness,2)
...
plot(var1, 
     ...
     vertex.color=V(var1)$vertex_var1_color_degree,
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=centralization.closeness(var1)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var1, mode="in")), 
     median(closeness(var1, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var1)$var1_betweenness_w <- betweenness(var1, weights=E(var1)$weight) %>% round(1)
var1_betweenness_w <- betweenness(var1, weights=E(var1)$weight) %>% round(1)
```
...
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=betweenness(var1)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var1)+1)/10000,
     edge.width=edge.betweenness(var1, weights =E(var1)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var1)), 
     sd(betweenness(var1))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var1)$var1_centr_betweenness<-(centralization.betweenness(var1)$res)/10000
...
plot(var1, 
     ...
     vertex.color=V(var1)$vertex_var1_color_degree,
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var1)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Betweenness - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var1)$eigenvector <- eigen_centrality(var1, directed = TRUE, weights =E(var1)$weight) %$% vector %>% round(3)
var1_eigenvector <- eigen_centrality(var1, directed = TRUE, weights = E(var1)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var1_eigenvector_value <- eigen_centrality(var1, directed = TRUE, weights = E(var1)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var1_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var1)$var1_centr_eigen <- centr_eigen(var1, directed = T)$vector
var1_centr_eigen <-centr_eigen(var1, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var1, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var1, directed = T)$theoretical_max
```
...
var1_eigenvector_w <- eigen_centrality(var1, directed = TRUE, weights = E(var1)$weight) %$% vector %>% round(3) 
var1_centr_eigen <-centr_eigen(var1, directed = T)$vector

#Creating a datagrame of measures
var1_df_eigenvector <- data.frame(var1_eigenvector,
var1_eigenvector_w,
var1_centr_eigen) %>% round(3)

#Adding type
var1_df_eigenvector <-cbind(var1_df_eigenvector, V(var1)$LABEL_COR)

#Adding names
names(var1_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var1_df_eigenvector<-var1_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var1_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var1_df_eigenvector, by=list(var1_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var1_df_eigenvector, by=list(var1_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=(eigen_centrality(var1, directed =TRUE, weights = E(var1)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var1)$vector)+1)/10,
     edge.width=edge.betweenness(var1, weights =E(var1)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var1)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var1)$var1_color_degree<-round(centr_eigen(var1, directed = T)$vector,2)
...
plot(var1, 
     ...
     vertex.color=V(var1)$vertex_var1_color_degree,
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=centr_eigen(var1, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var1, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var1, weights =E(var1)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var1, directed = T)$vector), 
     sd(centr_eigen(var1, directed = T)$vector)
   ))
```
...
var1_power_centrality_stats <- power_centrality(var1, nodes = V(var1), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var1)$var1_power_centrality_stats <-power_centrality(var1, nodes = V(var1), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var1)$LABEL_COR, var1_power_centrality_stats))
...
V(var1)$var1_power_centrality_stats_r<-round(V(var1)$var1_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var1)$var1_power_centrality_stats_r)), "Blues"))(length(unique(V(var1)$var1_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var1)$color_spower <- vertex_col_spower[factor(V(var1)$var1_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.color=V(var1)$color_spower, 
     vertex.label=V(var1)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var1)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var1)+1)^2)/10,
     edge.width=edge.betweenness(var1, weights =E(var1)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var1)$var1_power_centrality_stats_r
b<-V(var1)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var1_power_centrality_stats),sd(var1_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var1_alpha_centrality_stats <- alpha_centrality(var1, loops = FALSE, alpha = 1, exo = 1, weights=E(var1)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var1)$var1_alpha_centrality_stats<-alpha_centrality(var1, loops = FALSE, alpha = 1, exo = 1, weights=E(var1)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var1)$LABEL_COR, round(var1_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var1)$var1_alpha_centrality_stats_r<-round(V(var1)$var1_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var1)$var1_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var1)$var1_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var1)$color_s <- vertex_col_s[factor(V(var1)$var1_alpha_centrality_stats_r)]  
```
...
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.color=V(var1)$color_s, 
     vertex.label=V(var1)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var1, loops = FALSE, alpha = 1, exo = 1, weights=E(var1)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var1))^2)/50,
     edge.width=edge.betweenness(var1, weights =E(var1)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var1)$var1_alpha_centrality_stats_r
b<-V(var1)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var1_alpha_centrality_stats),sd(var1_alpha_centrality_stats)
     ))
```
...
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=10*hub.score(var1)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var1)+1)/10,
     edge.width=edge.betweenness(var1, weights =E(var1)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=10*authority.score(var1)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var1)+1)/20,
     edge.width=log(edge.betweenness(var1, weights =E(var1)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var1, 
     layout=layout.kamada.kawai(var1), 
     vertex.label=get.vertex.attribute(var1,"LABEL_COR"),
     vertex.size=200*page.rank(var1)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var1)+1)/15,
     edge.width=log(edge.betweenness(var1, weights =E(var1)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var1<-make_ego_graph(var1, order=1, V(var1)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var1, 
     layout=layout.kamada.kawai(make_ego_graph_all_var1), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var1,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var1)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var1)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var1))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var1)$LABEL_COR
b<-V(make_ego_graph_all_var1)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var1)$vector),
     sd(page.rank(make_ego_graph_all_var1)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var1<-make_ego_graph(var1, order=1, V(var1)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var1, 
     layout=layout.kamada.kawai(make_ego_graph_out_var1), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var1,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var1)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var1)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var1))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var1)$LABEL_COR
b<-V(make_ego_graph_out_var1)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var1)$vector),
     sd(page.rank(make_ego_graph_out_var1)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var1<-make_ego_graph(var1, order=1, V(var1)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var1, 
     layout=layout.kamada.kawai(make_ego_graph_in_var1), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var1,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var1)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var1))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var1))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var1)$LABEL_COR
b<-V(make_ego_graph_in_var1)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var1)$vector),
     sd(page.rank(make_ego_graph_in_var1)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var1_without_CAPSAD<-delete_vertices(make_ego_graph_all_var1,V(make_ego_graph_all_var1)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var1_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var1_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var1_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var1_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var1_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var1_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var1_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var1_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var1_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var1_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var1_without_complex<-
  delete_vertices(make_ego_graph_all_var1,
                  c(V(make_ego_graph_all_var1)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var1)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var1_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var1_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var1_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var1_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var1_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var1_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var1_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var1_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var1_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var1_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var1, 
     layout=layout.kamada.kawai(msp_var1), 
     vertex.label=get.vertex.attribute(msp_var1,"LABEL_COR"),
     vertex.size=degree(msp_var1)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var1)/50,
     edge.width=log(edge.betweenness(msp_var1, weights =E(msp_var1)$msp_var1))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var1, 
     layout=layout.auto(msp_var1), 
     vertex.label=get.vertex.attribute(msp_var1,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var1)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var1))/50,
     edge.width=log(edge.betweenness(msp_var1, weights=E(msp_var1)$msp_var1))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var1, mode="in")), 
     median(degree(msp_var1, mode="out"))
...
msp_var1_w<-minimum.spanning.tree(var1, weights=1/edge.betweenness(var1, weights =E(var1)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var1_w, 
     layout=layout.auto(msp_var1_w), 
     vertex.label=get.vertex.attribute(msp_var1_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var1_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var1_w))/20,
     edge.width=1/edge.betweenness(msp_var1_w, weights =E(msp_var1_w)$msp_var1_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var1)$mut/ecount(var1) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var1_sp_in <- shortest.paths(var1, mode='in', weights=E(var1)$weight) # sames as bellow
var1_sp_out <- shortest.paths(var1, mode='out', weights=E(var1)$weight) #same as above
var1_sp_all <- shortest.paths(var1, mode='all', weights=E(var1)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var1<-distances(var1, mode="all", weights=E(var1)$weight)
#distances_sp_all_var1

#In shortest paths 
distances_sp_in_var1<-distances(var1, mode="in",weights=E(var1)$weight)
#distances_sp_in_var1

#Out shortest paths 
distances_sp_out_var1<-distances(var1, mode="out", weights=E(var1)$weight)
#distances_sp_out_var1
```
...
var1_dist.from.CAPSAD <- distances(var1, v=V(var1)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var1), weights=E(var1)$weight)
...
plot(var1, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var1)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var1))/10,
     edge.width=edge.betweenness(var1, weights=E(var1)$var1)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var1, weights=E(var1)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var1, weights=E(var1)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var1, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var1)$transitivity_local_w<-transitivity(var1, type="barrat") 
transitivity_local_w<-transitivity(var1, weights=E(var1)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var1_u <- as.undirected(var1, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var1_u_size<-sapply(cliques(var1_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var1)$edge.btweenness<-edge.betweenness(var1, weights =E(var1)$weight)
var1_edge.betweenness <-edge.betweenness(var1, weights =E(var1)$weight)
```
...
plot(var1, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var1_edge.betweenness.community),
                      var1_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var1)+1)/10,
     edge.width=log(edge.betweenness(var1, weights =E(var1)$weight))/5,
     edge.curved = TRUE
     )
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var1 <- as.dendrogram(var1_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var1, main = "Dendrograma var1", nodePar=list(pch=c(NA, 20)))
```
...
plot(var1, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var1)),
     mark.groups = by(seq_along(var1_walktrap.community),
                      var1_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var1)+1)/10,
     edge.width=log(edge.betweenness(var1, weights =E(var1)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var1 <- decompose.graph(var1)
sapply(comps_var1, diameter)
table(sapply(comps_var1, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var11<-comps_var1[[1]]
#comps_var12<-comps_var1[[2]]
#comps_var13<-comps_var1[[3]]
#comps_var14<-comps_var1[[4]]
#comps_var15<-comps_var1[[5]]
#comps_var16<-comps_var1[[6]]
#comps_var17<-comps_var1[[7]]
#comps_var18<-comps_var1[[8]]
#...
```
...
plot(comps_var11, 
     layout=layout.kamada.kawai(comps_var11), 
     vertex.label=get.vertex.attribute(comps_var11,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var11)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var11)+1)/10,
     edge.width=log(edge.betweenness(comps_var11, weights=E(comps_var11)$comps_var11))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var11)$LABEL_COR
b<-V(comps_var11)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var11, mode="in")), 
     median(degree(comps_var11, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var1)$optimal_comm_var1 <- #membership(optimal.community(var1))
#optimal_comm_var1 <- membership(optimal.community(var1))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var1)
var1_dim<-get.diameter(var1)
var1_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var1, weights=E(var1)$weight)
var1_dim<-get.diameter(var1, weights=E(var1)$weight)
var1_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var1)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 3.CENTRALIDADE_REFERENCIA DE ENVIO (var1)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
