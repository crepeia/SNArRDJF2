---
title: "SNA Centralities 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)"
...
# 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)
...
```
#1. Descriptive Analysis for 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var6)/10, main="Histogram of Indegree Nodes - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var6)/10, main="Histogram of Outdegree Nodes - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var6)/10, main="Histogram of All Degree Nodes - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)")
```  
...
#Histogram var6 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var6, weights=E(var6)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var6)/10, main="Histogram of Strength Degree Nodes - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var6)/10, main="Histogram of Normalized Indegree Nodes - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var6)/10, main="Histogram of Normalized Outdegree Nodes - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var6, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var6)/10, main="Histogram of Normalized All Degree Nodes - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var6), breaks=vcount(var6)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var6)$var6_a.nn.deg <- graph.knn(var6,V(var6))$knn
```
...
plot(degree(var6), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var6)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var6), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var6)$size <- degree(var6)
V(var6)$label <- V(var6)$V5_LABEL_TIPO_NOME
V(var6)$label.cex <- degree(var6)/100
V(var6)$label.color <- "black"

## Just in case if we wanna change colors
#V(var6)$color <- V(var6)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var6)$weight <- E(var6)$weight
E(var6)$width <- E(var6)$weight
E(var6)$color <- "gray"

## Here we can change other edge parameter
#E(var6)[ weight < 0.5 ]$width <- 4
#E(var6)[ weight < 0.5 ]$color <- "green"
#E(var6)$label <- LETTERS[1:10]
#E(var6)$label.cex = seq(1, 2,length.out = 10)
#E(var6)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var6, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=degree(var6)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var6)/10000,
     vertex.label.cex=degree(var6)/500,
     edge.width=(edge.betweenness(var6, weights=V(var6)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ", cex = .5)
...
plot(var6, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var6))/800,
     edge.width=(edge.betweenness(var6, weights =E(var6)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var6, 
     layout=layout.kamada.kawai(small_var6), 
     vertex.label=get.vertex.attribute(small_var6,"LABEL_COR"),
     vertex.size=degree(small_var6)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var6)+1)/10,
     edge.width=(edge.betweenness(small_var6))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var6, mode="in")), 
     median(degree(small_var6, mode="out"))
   )
  )
```
...
plot(small_var6, 
     layout=layout.kamada.kawai(small_var6), 
     vertex.label=get.vertex.attribute(small_var6,"LABEL_COR"),
     vertex.size=degree(small_var6)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var6)+2)/5,
     edge.width=(edge.betweenness(small_var6)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var6, mode="in")), 
     median(degree(small_var6, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var6_a.nn.deg_w 
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=(graph.knn(var6,V(var6))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var6,V(var6))$knn+1)/30,
     edge.width=(edge.betweenness(var6, weights =E(var6)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var6,V(var6))$knn)
   ))
```
...
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var6,V(var6), weights= E(var6)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var6,V(var6), weights= E(var6)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var6, weights =E(var6)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var6,V(var6), weights= E(var6)$weight)$knn)
   ))
```
...
V(var6)$totalcloseness <- closeness(var6, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var6)$incloseness_n <- closeness(var6, mode = "in", normalized = T) %>% round(6)
V(var6)$outcloseness_n <- closeness(var6, mode = "out", normalized = T) %>% round(6)
V(var6)$totalcloseness_n <- closeness(var6, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var6_incloseness_n<- closeness(var6, mode = "in", normalized = T) %>% round(6)
var6_outcloseness_n<- closeness(var6, mode = "out", normalized = T) %>% round(6)
var6_totalcloseness_n<- closeness(var6, mode = "total", normalized = T) %>% round(6)
```
##Closeness Normalized  - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var6_incloseness_n)
sd(var6_incloseness_n)
```
##Closeness Normalized  - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var6_outcloseness_n)
sd(var6_outcloseness_n)
```
##Closeness Normalized - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var6_totalcloseness_n)
sd(var6_totalcloseness_n)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var6)$incloseness_w <- closeness(var6, mode = "in", normalized = T, weights=E(var6)$weight) %>% round(6)
V(var6)$outcloseness_w <- closeness(var6, mode = "out", normalized = T,weights=E(var6)$weight) %>% round(6)
V(var6)$totalcloseness_w <- closeness(var6, mode = "total", normalized = T, weights=E(var6)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var6_incloseness_w<- closeness(var6, mode = "in", normalized = T, weights=E(var6)$weight) %>% round(6)
var6_outcloseness_w<- closeness(var6, mode = "out", normalized = T, weights=E(var6)$weight) %>% round(6)
var6_totalcloseness_w<- closeness(var6, mode = "total", normalized = T, weights=E(var6)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var6_incloseness_w)
sd(var6_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var6_outcloseness_w)
sd(var6_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var6_totalcloseness_w)
sd(var6_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var6)$var6_closeness_stats_w <- closeness(var6, vids = V(var6), mode = "all", weights =E(var6)$weight, normalized = FALSE)
var6_closeness_stats_w <- closeness(var6, vids = V(var6), mode = "all", weights =E(var6)$weight, normalized = FALSE)
```
#2.7.5 Centralization Closseness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var6)$var6_centr_closeness<- centralization.closeness(var6)$res
var6_centr_closeness<- centralization.closeness(var6)$res
var6_centr_closeness_all<- centralization.closeness(var6)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var6_centr_closeness_all$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var6_centr_closeness_all$theoretical_max
```
...
var6_outcloseness_w<- closeness(var6, mode = "out", normalized = T, weights=E(var6)$weight) %>% round(6)
var6_totalcloseness_w<- closeness(var6, mode = "total", normalized = T, weights=E(var6)$weight) %>% round(6)
var6_closeness_stats_w <- closeness(var6, vids = V(var6), mode = "all", weights=E(var6)$weight, normalized = FALSE) %>% round(6)
var6_centr_closeness <- centralization.closeness(var6)$res %>% round(6)
```
#Creating a datagrame of measures
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var6_df_closseness <- data.frame(
var6_incloseness,
var6_outcloseness,
var6_totalcloseness,
var6_incloseness_n,
var6_outcloseness_n,
var6_totalcloseness_n,
var6_incloseness_w,
var6_outcloseness_w,
var6_totalcloseness_w,
var6_closeness_stats_w,
var6_centr_closeness) %>% round(6)

#Adding type
var6_df_closseness <-cbind(var6_df_closseness, V(var6)$LABEL_COR)

#Adding names
names(var6_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var6_df_closseness<-var6_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var6_df_closseness, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var6_df_closseness, by=list(var6_df_closseness$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var6_df_closseness, by=list(var6_df_closseness$Type), FUN=sd, na.rm=TRUE) 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var6)$var6_color_degree<-round(V(var6)$totalcloseness,4)
...
plot(var6, 
     ...
     vertex.color=V(var6)$vertex_var6_color_degree,
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=closeness(var6)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var6))/80,
     edge.width=(edge.betweenness(var6, weights =E(var6)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var6, mode="in")), 
     median(closeness(var6, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var6)$var6_color_degree<-round(V(var6)$var6_centr_closeness,2)
...
plot(var6, 
     ...
     vertex.color=V(var6)$vertex_var6_color_degree,
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=centralization.closeness(var6)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=centralization.closeness(var6)$res,
     edge.width=(edge.betweenness(var6, weights =E(var6)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Closeness - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var6, mode="in")), 
     median(closeness(var6, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var6)$var6_betweenness_w <- betweenness(var6, weights=E(var6)$weight) %>% round(1)
var6_betweenness_w <- betweenness(var6, weights=E(var6)$weight) %>% round(1)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var6)$var6_centr_betweenness <- centralization.betweenness(var6)$res
var6_centr_betweenness <- centralization.betweenness(var6)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var6_betweenness <- betweenness(var6) %>% round(1)
var6_betweenness_w <- betweenness(var6, weights=E(var6)$weight) %>% round(1)
var6_centr_betweenness <- centralization.betweenness(var6)$res %>% round(1)

#Creating a dataframe of measures
var6_df_betweenness <- data.frame(var6_betweenness,
var6_betweenness_w,
var6_centr_betweenness) %>% round(1)

#Adding type
var6_df_betweenness <-cbind(var6_df_betweenness, V(var6)$LABEL_COR)

#Adding names
names(var6_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var6_df_betweenness<-var6_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=betweenness(var6)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var6)+1)/10000,
     edge.width=edge.betweenness(var6, weights =E(var6)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var6)), 
     sd(betweenness(var6))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var6)$var6_centr_betweenness<-(centralization.betweenness(var6)$res)/10000
V(var6)$var6_color_degree<-round(V(var6)$var6_centr_betweenness,1)
...
plot(var6, 
     ...
     vertex.color=V(var6)$vertex_var6_color_degree,
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var6)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centralization.betweenness(var6)$res + 1)/10000,
     edge.width=(edge.betweenness(var6, weights =E(var6)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Betweenness - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var6)$eigenvector <- eigen_centrality(var6, directed = TRUE, weights =E(var6)$weight) %$% vector %>% round(3)
var6_eigenvector <- eigen_centrality(var6, directed = TRUE, weights = E(var6)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var6_eigenvector_value <- eigen_centrality(var6, directed = TRUE, weights = E(var6)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=(eigen_centrality(var6, directed =TRUE, weights = E(var6)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Eigenvector Centrality Measure - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var6)$var6_color_degree<-round(centr_eigen(var6, directed = T)$vector,2)
...
#Adding Title
  title("Network EigenVector - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var6)$LABEL_COR, var6_power_centrality_stats))
...
V(var6)$var6_power_centrality_stats_r<-round(V(var6)$var6_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var6)$var6_power_centrality_stats_r)), "Blues"))(length(unique(V(var6)$var6_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var6)$color_spower <- vertex_col_spower[factor(V(var6)$var6_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.color=V(var6)$color_spower, 
     vertex.label=V(var6)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var6)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var6)+1)^2)/10,
     edge.width=edge.betweenness(var6, weights =E(var6)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var6)$var6_power_centrality_stats_r
b<-V(var6)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var6_power_centrality_stats),sd(var6_power_centrality_stats)
     ))
```
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var6)$LABEL_COR, round(var6_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var6)$var6_alpha_centrality_stats_r<-round(V(var6)$var6_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var6)$var6_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var6)$var6_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var6)$color_s <- vertex_col_s[factor(V(var6)$var6_alpha_centrality_stats_r)]  
```
...
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.color=V(var6)$color_s, 
     vertex.label=V(var6)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var6, loops = FALSE, alpha = 1, exo = 1, weights=E(var6)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var6))^2)/50,
     edge.width=edge.betweenness(var6, weights =E(var6)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var6)$var6_alpha_centrality_stats_r
b<-V(var6)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var6_alpha_centrality_stats),sd(var6_alpha_centrality_stats)
     ))
```
...
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=10*hub.score(var6)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var6)+1)/10,
     edge.width=edge.betweenness(var6, weights =E(var6)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=10*authority.score(var6)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var6)+1)/20,
     edge.width=log(edge.betweenness(var6, weights =E(var6)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var6, 
     layout=layout.kamada.kawai(var6), 
     vertex.label=get.vertex.attribute(var6,"LABEL_COR"),
     vertex.size=200*page.rank(var6)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var6)+1)/15,
     edge.width=log(edge.betweenness(var6, weights =E(var6)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var6<-make_ego_graph(var6, order=1, V(var6)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var6, 
     layout=layout.kamada.kawai(make_ego_graph_all_var6), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var6,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var6)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var6)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var6))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var6)$LABEL_COR
b<-V(make_ego_graph_all_var6)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var6)$vector),
     sd(page.rank(make_ego_graph_all_var6)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var6<-make_ego_graph(var6, order=1, V(var6)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var6, 
     layout=layout.kamada.kawai(make_ego_graph_out_var6), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var6,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var6)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var6)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var6))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var6)$LABEL_COR
b<-V(make_ego_graph_out_var6)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var6)$vector),
     sd(page.rank(make_ego_graph_out_var6)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var6<-make_ego_graph(var6, order=1, V(var6)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var6, 
     layout=layout.kamada.kawai(make_ego_graph_in_var6), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var6,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var6)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var6))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var6))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var6)$LABEL_COR
b<-V(make_ego_graph_in_var6)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var6)$vector),
     sd(page.rank(make_ego_graph_in_var6)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var6_without_CAPSAD<-delete_vertices(make_ego_graph_all_var6,V(make_ego_graph_all_var6)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var6_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var6_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var6_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var6_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var6_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var6_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var6_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var6_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var6_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var6_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var6_without_complex<-
  delete_vertices(make_ego_graph_all_var6,
                  c(V(make_ego_graph_all_var6)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var6)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var6_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var6_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var6_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var6_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var6_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var6_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var6_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var6_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var6_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var6_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var6, 
     layout=layout.kamada.kawai(msp_var6), 
     vertex.label=get.vertex.attribute(msp_var6,"LABEL_COR"),
     vertex.size=degree(msp_var6)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var6)/50,
     edge.width=log(edge.betweenness(msp_var6, weights =E(msp_var6)$msp_var6))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var6, 
     layout=layout.auto(msp_var6), 
     vertex.label=get.vertex.attribute(msp_var6,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var6)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var6))/50,
     edge.width=log(edge.betweenness(msp_var6, weights=E(msp_var6)$msp_var6))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var6, mode="in")), 
     median(degree(msp_var6, mode="out"))
...
msp_var6_w<-minimum.spanning.tree(var6, weights=1/edge.betweenness(var6, weights =E(var6)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var6_w, 
     layout=layout.auto(msp_var6_w), 
     vertex.label=get.vertex.attribute(msp_var6_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var6_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var6_w))/20,
     edge.width=1/edge.betweenness(msp_var6_w, weights =E(msp_var6_w)$msp_var6_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var6)$mut/ecount(var6) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var6_sp_in <- shortest.paths(var6, mode='in', weights=E(var6)$weight) # sames as bellow
var6_sp_out <- shortest.paths(var6, mode='out', weights=E(var6)$weight) #same as above
var6_sp_all <- shortest.paths(var6, mode='all', weights=E(var6)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var6<-distances(var6, mode="all", weights=E(var6)$weight)
#distances_sp_all_var6

#In shortest paths 
distances_sp_in_var6<-distances(var6, mode="in",weights=E(var6)$weight)
#distances_sp_in_var6

#Out shortest paths 
distances_sp_out_var6<-distances(var6, mode="out", weights=E(var6)$weight)
#distances_sp_out_var6
```
...
var6_dist.from.CAPSAD <- distances(var6, v=V(var6)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var6), weights=E(var6)$weight)
...
plot(var6, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var6)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var6))/10,
     edge.width=edge.betweenness(var6, weights=E(var6)$var6)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var6, weights=E(var6)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var6, weights=E(var6)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var6, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var6)$transitivity_local_w<-transitivity(var6, type="barrat") 
transitivity_local_w<-transitivity(var6, weights=E(var6)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var6_u <- as.undirected(var6, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var6_u_size<-sapply(cliques(var6_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(var6)), 
     max(graph.coreness(var6))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var6)$edge.btweenness<-edge.betweenness(var6, weights =E(var6)$weight)
var6_edge.betweenness <-edge.betweenness(var6, weights =E(var6)$weight)
```
...
plot(var6, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var6_edge.betweenness.community),
                      var6_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var6)+1)/10,
     edge.width=log(edge.betweenness(var6, weights =E(var6)$weight))/5,
     edge.curved = TRUE
     )
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var6 <- as.dendrogram(var6_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var6, main = "Dendrograma var6", nodePar=list(pch=c(NA, 20)))
```
...
plot(var6, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var6)),
     mark.groups = by(seq_along(var6_walktrap.community),
                      var6_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var6)+1)/10,
     edge.width=log(edge.betweenness(var6, weights =E(var6)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var6 <- decompose.graph(var6)
sapply(comps_var6, diameter)
table(sapply(comps_var6, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var61<-comps_var6[[1]]
#comps_var62<-comps_var6[[2]]
#comps_var63<-comps_var6[[3]]
#comps_var64<-comps_var6[[4]]
#comps_var65<-comps_var6[[5]]
#comps_var66<-comps_var6[[6]]
#comps_var67<-comps_var6[[7]]
#comps_var68<-comps_var6[[8]]
#...
```
...
plot(comps_var61, 
     layout=layout.kamada.kawai(comps_var61), 
     vertex.label=get.vertex.attribute(comps_var61,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var61)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var61)+1)/10,
     edge.width=log(edge.betweenness(comps_var61, weights=E(comps_var61)$comps_var61))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var61)$LABEL_COR
b<-V(comps_var61)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var61, mode="in")), 
     median(degree(comps_var61, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var6)$optimal_comm_var6 <- #membership(optimal.community(var6))
#optimal_comm_var6 <- membership(optimal.community(var6))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var6)
var6_dim<-get.diameter(var6)
var6_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var6, weights=E(var6)$weight)
var6_dim<-get.diameter(var6, weights=E(var6)$weight)
var6_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var6)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 8.CENTRALIDADE_RECEBER TREINAMENTOS CAPACITAÇÕES (var6)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
