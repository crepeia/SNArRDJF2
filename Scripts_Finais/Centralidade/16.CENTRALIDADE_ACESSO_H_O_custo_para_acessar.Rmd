---
title: "SNA Centralities 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
...
# 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)
...
```
#1. Descriptive Analysis for 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var14, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var14)/10, main="Histogram of Indegree Nodes - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var14, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var14)/10, main="Histogram of Outdegree Nodes - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var14, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var14)/10, main="Histogram of All Degree Nodes - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```  
...
#Histogram var14 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var14, weights=E(var14)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var14)/10, main="Histogram of Strength Degree Nodes - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var14, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var14)/10, main="Histogram of Normalized Indegree Nodes - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var14, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var14)/10, main="Histogram of Normalized Outdegree Nodes - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var14, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var14)/10, main="Histogram of Normalized All Degree Nodes - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var14), breaks=vcount(var14)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var14)$var14_a.nn.deg <- graph.knn(var14,V(var14))$knn
```
...
plot(degree(var14), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14))
...
plot(degree(var14), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
     )
```
...
plot(var14, 
     ...
     edge.width=(edge.betweenness(var14, weights=V(var14)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ", cex = .5)
...
plot(var14, 
     ...
     edge.width=(edge.betweenness(var14, weights =E(var14)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
...
plot(small_var14, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var14)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var14, 
     ...
     vertex.label.cex=log(degree(small_var14)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var14, mode="in")), 
     median(degree(small_var14, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var14_a.nn.deg_w 
plot(var14, 
     layout=layout.kamada.kawai(var14), 
     vertex.label=get.vertex.attribute(var14,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var14,V(var14))$knn+1)/30,
     edge.width=(edge.betweenness(var14, weights =E(var14)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var14, 
     layout=layout.kamada.kawai(var14), 
     vertex.label=get.vertex.attribute(var14,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var14,V(var14), weights= E(var14)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var14,V(var14), weights= E(var14)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var14, weights =E(var14)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var14,V(var14), weights= E(var14)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var14)$incloseness_w <- closeness(var14, mode = "in", normalized = T, weights=E(var14)$weight) %>% round(6)
V(var14)$outcloseness_w <- closeness(var14, mode = "out", normalized = T,weights=E(var14)$weight) %>% round(6)
V(var14)$totalcloseness_w <- closeness(var14, mode = "total", normalized = T, weights=E(var14)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var14_incloseness_w<- closeness(var14, mode = "in", normalized = T, weights=E(var14)$weight) %>% round(6)
var14_outcloseness_w<- closeness(var14, mode = "out", normalized = T, weights=E(var14)$weight) %>% round(6)
var14_totalcloseness_w<- closeness(var14, mode = "total", normalized = T, weights=E(var14)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var14)$var14_closeness_stats_w <- closeness(var14, vids = V(var14), mode = "all", weights =E(var14)$weight, normalized = FALSE)
var14_closeness_stats_w <- closeness(var14, vids = V(var14), mode = "all", weights =E(var14)$weight, normalized = FALSE)
```
...
var14_outcloseness_w<- closeness(var14, mode = "out", normalized = T, weights=E(var14)$weight) %>% round(6)
var14_totalcloseness_w<- closeness(var14, mode = "total", normalized = T, weights=E(var14)$weight) %>% round(6)
var14_closeness_stats_w <- closeness(var14, vids = V(var14), mode = "all", weights=E(var14)$weight, normalized = FALSE) %>% round(6)
...
var14_incloseness_w,
var14_outcloseness_w,
var14_totalcloseness_w,
var14_closeness_stats_w,
...
#Adding names
names(var14_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var14_df_closseness<-var14_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var14)$var14_color_degree<-round(V(var14)$var14_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var14, mode="in")), 
     median(closeness(var14, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var14)$var14_betweenness_w <- betweenness(var14, weights=E(var14)$weight) %>% round(1)
var14_betweenness_w <- betweenness(var14, weights=E(var14)$weight) %>% round(1)
```
##Betweenness Centrality Weighted - (Vertex) - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var14_betweenness_w)
sd(var14_betweenness_w)
```
#2.8.3 Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var14)$var14_centr_betweenness <- centralization.betweenness(var14)$res
var14_centr_betweenness <- centralization.betweenness(var14)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var14_centr_betweenness$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var14_centr_betweenness$theoretical_max
```
...
var14_betweenness <- betweenness(var14) %>% round(1)
var14_betweenness_w <- betweenness(var14, weights=E(var14)$weight) %>% round(1)
var14_centr_betweenness <- centralization.betweenness(var14)$res %>% round(1)

#Creating a dataframe of measures
var14_df_betweenness <- data.frame(var14_betweenness,
var14_betweenness_w,
var14_centr_betweenness) %>% round(1)

#Adding type
var14_df_betweenness <-cbind(var14_df_betweenness, V(var14)$LABEL_COR)

#Adding names
names(var14_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var14_df_betweenness<-var14_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var14)$var14_centr_betweenness<-(centralization.betweenness(var14)$res)/10000
V(var14)$var14_color_degree<-round(V(var14)$var14_centr_betweenness,1)
...
#Adding Title
  title("Network Centralization Betweenness - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var14)$eigenvector <- eigen_centrality(var14, directed = TRUE, weights =E(var14)$weight) %$% vector %>% round(3)
var14_eigenvector <- eigen_centrality(var14, directed = TRUE, weights = E(var14)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var14_eigenvector_value <- eigen_centrality(var14, directed = TRUE, weights = E(var14)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var14)$var14_centr_eigen <- centr_eigen(var14, directed = T)$vector
var14_centr_eigen <-centr_eigen(var14, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var14_eigenvector_w <- eigen_centrality(var14, directed = TRUE, weights = E(var14)$weight) %$% vector %>% round(3) 
var14_centr_eigen <-centr_eigen(var14, directed = T)$vector

#Creating a datagrame of measures
var14_df_eigenvector <- data.frame(var14_eigenvector,
var14_eigenvector_w,
var14_centr_eigen) %>% round(3)

#Adding type
var14_df_eigenvector <-cbind(var14_df_eigenvector, V(var14)$LABEL_COR)

#Adding names
names(var14_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var14_df_eigenvector<-var14_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var14_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var14_df_eigenvector, by=list(var14_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var14_df_eigenvector, by=list(var14_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var14, 
     layout=layout.kamada.kawai(var14), 
     vertex.label=get.vertex.attribute(var14,"LABEL_COR"),
     vertex.size=(eigen_centrality(var14, directed =TRUE, weights = E(var14)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var14)$vector)+1)/10,
     edge.width=edge.betweenness(var14, weights =E(var14)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var14, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var14, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var14, weights =E(var14)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var14, directed = T)$vector), 
     sd(centr_eigen(var14, directed = T)$vector)
   ))
```
...
var14_power_centrality_stats <- power_centrality(var14, nodes = V(var14), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var14)$var14_power_centrality_stats <-power_centrality(var14, nodes = V(var14), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var14)$LABEL_COR, var14_power_centrality_stats))
...
V(var14)$var14_power_centrality_stats_r<-round(V(var14)$var14_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var14)$var14_power_centrality_stats_r)), "Blues"))(length(unique(V(var14)$var14_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var14)$color_spower <- vertex_col_spower[factor(V(var14)$var14_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var14)$var14_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var14_power_centrality_stats),sd(var14_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var14_alpha_centrality_stats <- alpha_centrality(var14, loops = FALSE, alpha = 1, exo = 1, weights=E(var14)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var14)$var14_alpha_centrality_stats<-alpha_centrality(var14, loops = FALSE, alpha = 1, exo = 1, weights=E(var14)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var14)$LABEL_COR, round(var14_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var14)$var14_alpha_centrality_stats_r<-round(V(var14)$var14_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var14)$var14_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var14)$var14_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var14)$color_s <- vertex_col_s[factor(V(var14)$var14_alpha_centrality_stats_r)]  
```
...
plot(var14, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var14, loops = FALSE, alpha = 1, exo = 1, weights=E(var14)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(var14)$var14_alpha_centrality_stats_r
b<-V(var14)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var14_alpha_centrality_stats),sd(var14_alpha_centrality_stats)
     ))
```
...
plot(var14, 
     layout=layout.kamada.kawai(var14), 
     vertex.label=get.vertex.attribute(var14,"LABEL_COR"),
     vertex.size=10*hub.score(var14)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var14, 
     layout=layout.kamada.kawai(var14), 
     vertex.label=get.vertex.attribute(var14,"LABEL_COR"),
     vertex.size=10*authority.score(var14)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var14)+1)/20,
     edge.width=log(edge.betweenness(var14, weights =E(var14)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var14, 
     layout=layout.kamada.kawai(var14), 
     vertex.label=get.vertex.attribute(var14,"LABEL_COR"),
     vertex.size=200*page.rank(var14)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var14)+1)/15,
     edge.width=log(edge.betweenness(var14, weights =E(var14)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_var14, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var14)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var14, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_var14)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var14)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var14, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_var14)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var14_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_var14_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var14_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var14_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var14_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var14_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var14_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_var14, 
     ...
     vertex.size=degree(msp_var14)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var14)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var14, mode="in")), 
     median(degree(msp_var14, mode="out"))
...
msp_var14_w<-minimum.spanning.tree(var14, weights=1/edge.betweenness(var14, weights =E(var14)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var14_w, 
     layout=layout.auto(msp_var14_w), 
     ...
     edge.width=1/edge.betweenness(msp_var14_w, weights =E(msp_var14_w)$msp_var14_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var14_sp_in <- shortest.paths(var14, mode='in', weights=E(var14)$weight) # sames as bellow
var14_sp_out <- shortest.paths(var14, mode='out', weights=E(var14)$weight) #same as above
var14_sp_all <- shortest.paths(var14, mode='all', weights=E(var14)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var14<-distances(var14, mode="all", weights=E(var14)$weight)
#distances_sp_all_var14

#In shortest paths 
distances_sp_in_var14<-distances(var14, mode="in",weights=E(var14)$weight)
#distances_sp_in_var14

#Out shortest paths 
distances_sp_out_var14<-distances(var14, mode="out", weights=E(var14)$weight)
...
var14_dist.from.CAPSAD <- distances(var14, v=V(var14)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var14), weights=E(var14)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var14, weights=E(var14)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var14, weights=E(var14)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(var14, weights=E(var14)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var14_u_size<-sapply(cliques(var14_u), length) # too intesive calculation
```
...
V(as.undirected_var14_u)$vcollabel[V(as.undirected_var14_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var14_u)$vcollabel [V(as.undirected_var14_u)$vcol=="grey80"]<-"Others"
```
...
plot(as.undirected(var14_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var14_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var14_u), weights =E(as.undirected(var14_u))$var14))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Coreness Colored Graph - 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var14)$edge.btweenness<-edge.betweenness(var14, weights =E(var14)$weight)
var14_edge.betweenness <-edge.betweenness(var14, weights =E(var14)$weight)
```
...
plot(var14, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var14)+1)/10,
     edge.width=log(edge.betweenness(var14, weights =E(var14)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_var141, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var141)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var14, weights=E(var14)$weight)
var14_dim<-get.diameter(var14, weights=E(var14)$weight)
var14_dim
```
...
#Adding Title
  title("Diameter of 16.CENTRALIDADE_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
