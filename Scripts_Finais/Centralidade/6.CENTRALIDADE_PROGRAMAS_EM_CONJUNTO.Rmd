---
title: "SNA Centralities 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)"
...
```
#1. Descriptive Analysis for 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var4, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var4)/10, main="Histogram of Indegree Nodes - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var4, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var4)/10, main="Histogram of Outdegree Nodes - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var4, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var4)/10, main="Histogram of All Degree Nodes - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)")
```  
...
#Histogram var4 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var4, weights=E(var4)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var4)/10, main="Histogram of Strength Degree Nodes - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var4, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var4)/10, main="Histogram of Normalized Indegree Nodes - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var4, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var4)/10, main="Histogram of Normalized Outdegree Nodes - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var4, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var4)/10, main="Histogram of Normalized All Degree Nodes - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var4), breaks=vcount(var4)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var4)$var4_a.nn.deg <- graph.knn(var4,V(var4))$knn
```
...
plot(degree(var4), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var4)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var4), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var4, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=degree(var4)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var4)/10000,
     vertex.label.cex=degree(var4)/500,
     edge.width=(edge.betweenness(var4, weights=V(var4)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ", cex = .5)
...
plot(var4, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var4))/800,
     edge.width=(edge.betweenness(var4, weights =E(var4)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var4, 
     layout=layout.kamada.kawai(small_var4), 
     vertex.label=get.vertex.attribute(small_var4,"LABEL_COR"),
     vertex.size=degree(small_var4)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var4)+1)/10,
     edge.width=(edge.betweenness(small_var4))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var4, mode="in")), 
     median(degree(small_var4, mode="out"))
   )
  )
```
...
plot(small_var4, 
     layout=layout.kamada.kawai(small_var4), 
     vertex.label=get.vertex.attribute(small_var4,"LABEL_COR"),
     vertex.size=degree(small_var4)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var4)+2)/5,
     edge.width=(edge.betweenness(small_var4)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var4, mode="in")), 
     median(degree(small_var4, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var4_a.nn.deg_w 
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=(graph.knn(var4,V(var4))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var4,V(var4))$knn+1)/30,
     edge.width=(edge.betweenness(var4, weights =E(var4)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var4,V(var4))$knn)
   ))
```
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var4,V(var4), weights= E(var4)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var4,V(var4), weights= E(var4)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var4, weights =E(var4)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var4,V(var4), weights= E(var4)$weight)$knn)
   ))
```
...
V(var4)$totalcloseness <- closeness(var4, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var4)$incloseness_n <- closeness(var4, mode = "in", normalized = T) %>% round(6)
V(var4)$outcloseness_n <- closeness(var4, mode = "out", normalized = T) %>% round(6)
V(var4)$totalcloseness_n <- closeness(var4, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var4_incloseness_n<- closeness(var4, mode = "in", normalized = T) %>% round(6)
var4_outcloseness_n<- closeness(var4, mode = "out", normalized = T) %>% round(6)
var4_totalcloseness_n<- closeness(var4, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var4)$incloseness_w <- closeness(var4, mode = "in", normalized = T, weights=E(var4)$weight) %>% round(6)
V(var4)$outcloseness_w <- closeness(var4, mode = "out", normalized = T,weights=E(var4)$weight) %>% round(6)
V(var4)$totalcloseness_w <- closeness(var4, mode = "total", normalized = T, weights=E(var4)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var4_incloseness_w<- closeness(var4, mode = "in", normalized = T, weights=E(var4)$weight) %>% round(6)
var4_outcloseness_w<- closeness(var4, mode = "out", normalized = T, weights=E(var4)$weight) %>% round(6)
var4_totalcloseness_w<- closeness(var4, mode = "total", normalized = T, weights=E(var4)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var4_incloseness_w)
sd(var4_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var4_outcloseness_w)
sd(var4_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var4_totalcloseness_w)
sd(var4_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var4)$var4_closeness_stats_w <- closeness(var4, vids = V(var4), mode = "all", weights =E(var4)$weight, normalized = FALSE)
var4_closeness_stats_w <- closeness(var4, vids = V(var4), mode = "all", weights =E(var4)$weight, normalized = FALSE)
```
...
var4_outcloseness_w<- closeness(var4, mode = "out", normalized = T, weights=E(var4)$weight) %>% round(6)
var4_totalcloseness_w<- closeness(var4, mode = "total", normalized = T, weights=E(var4)$weight) %>% round(6)
var4_closeness_stats_w <- closeness(var4, vids = V(var4), mode = "all", weights=E(var4)$weight, normalized = FALSE) %>% round(6)
...
var4_incloseness_w,
var4_outcloseness_w,
var4_totalcloseness_w,
var4_closeness_stats_w,
...
#Adding names
names(var4_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var4_df_closseness<-var4_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var4)$var4_color_degree<-round(V(var4)$totalcloseness,4)
...
plot(var4, 
     ...
     vertex.color=V(var4)$vertex_var4_color_degree,
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=closeness(var4)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var4))/80,
     edge.width=(edge.betweenness(var4, weights =E(var4)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var4, mode="in")), 
     median(closeness(var4, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var4)$var4_color_degree<-round(V(var4)$var4_centr_closeness,2)
...
plot(var4, 
     ...
     vertex.color=V(var4)$vertex_var4_color_degree,
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=centralization.closeness(var4)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var4, mode="in")), 
     median(closeness(var4, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var4)$var4_betweenness_w <- betweenness(var4, weights=E(var4)$weight) %>% round(1)
var4_betweenness_w <- betweenness(var4, weights=E(var4)$weight) %>% round(1)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var4)$var4_centr_betweenness <- centralization.betweenness(var4)$res
var4_centr_betweenness <- centralization.betweenness(var4)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var4_betweenness <- betweenness(var4) %>% round(1)
var4_betweenness_w <- betweenness(var4, weights=E(var4)$weight) %>% round(1)
var4_centr_betweenness <- centralization.betweenness(var4)$res %>% round(1)

#Creating a dataframe of measures
var4_df_betweenness <- data.frame(var4_betweenness,
var4_betweenness_w,
var4_centr_betweenness) %>% round(1)

#Adding type
var4_df_betweenness <-cbind(var4_df_betweenness, V(var4)$LABEL_COR)

#Adding names
names(var4_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var4_df_betweenness<-var4_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=betweenness(var4)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var4)+1)/10000,
     edge.width=edge.betweenness(var4, weights =E(var4)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var4)), 
     sd(betweenness(var4))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var4)$var4_centr_betweenness<-(centralization.betweenness(var4)$res)/10000
V(var4)$var4_color_degree<-round(V(var4)$var4_centr_betweenness,1)
...
plot(var4, 
     ...
     vertex.color=V(var4)$vertex_var4_color_degree,
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var4)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centralization.betweenness(var4)$res + 1)/10000,
     edge.width=(edge.betweenness(var4, weights =E(var4)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Betweenness - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var4)$eigenvector <- eigen_centrality(var4, directed = TRUE, weights =E(var4)$weight) %$% vector %>% round(3)
var4_eigenvector <- eigen_centrality(var4, directed = TRUE, weights = E(var4)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var4_eigenvector_value <- eigen_centrality(var4, directed = TRUE, weights = E(var4)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var4_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var4)$var4_centr_eigen <- centr_eigen(var4, directed = T)$vector
var4_centr_eigen <-centr_eigen(var4, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var4, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var4, directed = T)$theoretical_max
```
...
var4_eigenvector_w <- eigen_centrality(var4, directed = TRUE, weights = E(var4)$weight) %$% vector %>% round(3) 
var4_centr_eigen <-centr_eigen(var4, directed = T)$vector

#Creating a datagrame of measures
var4_df_eigenvector <- data.frame(var4_eigenvector,
var4_eigenvector_w,
var4_centr_eigen) %>% round(3)

#Adding type
var4_df_eigenvector <-cbind(var4_df_eigenvector, V(var4)$LABEL_COR)

#Adding names
names(var4_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var4_df_eigenvector<-var4_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var4_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var4_df_eigenvector, by=list(var4_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var4_df_eigenvector, by=list(var4_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=(eigen_centrality(var4, directed =TRUE, weights = E(var4)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var4)$vector)+1)/10,
     edge.width=edge.betweenness(var4, weights =E(var4)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var4)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var4)$var4_color_degree<-round(centr_eigen(var4, directed = T)$vector,2)
...
plot(var4, 
     ...
     vertex.color=V(var4)$vertex_var4_color_degree,
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=centr_eigen(var4, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var4, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var4, weights =E(var4)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var4, directed = T)$vector), 
     sd(centr_eigen(var4, directed = T)$vector)
   ))
```
...
var4_power_centrality_stats <- power_centrality(var4, nodes = V(var4), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var4)$var4_power_centrality_stats <-power_centrality(var4, nodes = V(var4), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var4)$LABEL_COR, var4_power_centrality_stats))
...
plot(var4, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var4)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var4)+1)^2)/10,
     edge.width=edge.betweenness(var4, weights =E(var4)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, results="asis"}
#Saving power as an object
var4_alpha_centrality_stats <- alpha_centrality(var4, loops = FALSE, alpha = 1, exo = 1, weights=E(var4)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var4)$var4_alpha_centrality_stats<-alpha_centrality(var4, loops = FALSE, alpha = 1, exo = 1, weights=E(var4)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var4)$LABEL_COR, round(var4_alpha_centrality_stats,1)))
...
plot(var4, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var4, loops = FALSE, alpha = 1, exo = 1, weights=E(var4)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var4))^2)/50,
     edge.width=edge.betweenness(var4, weights =E(var4)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
V(var4)$hub <- hub.score(var4)$vector
var4_hub<- hub.score(var4)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var4)$LABEL_COR, var4_hub))
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=10*hub.score(var4)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var4)+1)/10,
     edge.width=edge.betweenness(var4, weights =E(var4)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
V(var4)$authority.score<- authority.score(var4)$vector
var4_auth <- authority.score(var4)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var4)$LABEL_COR, var4_auth))
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=10*authority.score(var4)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var4)+1)/20,
     edge.width=log(edge.betweenness(var4, weights =E(var4)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var4_pr<-page.rank(var4)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var4)$LABEL_COR, var4_pr))
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=200*page.rank(var4)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var4)+1)/15,
     edge.width=log(edge.betweenness(var4, weights =E(var4)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
prPB<-page_rank(var4)$vector
hPB<-hub.score(var4)$vector
authPB<-authority.score(var4)$vector
indegPB<-degree(var4, mode="in")
outdegPB<-degree(var4, mode="out")
```
...
title("Hits by in and out degree - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var4<-make_ego_graph(var4, order=1, V(var4)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var4, 
     layout=layout.kamada.kawai(make_ego_graph_all_var4), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var4,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var4)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var4)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var4))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var4)$LABEL_COR
b<-V(make_ego_graph_all_var4)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var4)$vector),
     sd(page.rank(make_ego_graph_all_var4)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var4<-make_ego_graph(var4, order=1, V(var4)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var4, 
     layout=layout.kamada.kawai(make_ego_graph_out_var4), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var4,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var4)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var4)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var4))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var4)$LABEL_COR
b<-V(make_ego_graph_out_var4)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var4)$vector),
     sd(page.rank(make_ego_graph_out_var4)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var4<-make_ego_graph(var4, order=1, V(var4)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var4, 
     layout=layout.kamada.kawai(make_ego_graph_in_var4), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var4,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var4)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var4))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var4))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var4)$LABEL_COR
b<-V(make_ego_graph_in_var4)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var4)$vector),
     sd(page.rank(make_ego_graph_in_var4)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var4_without_CAPSAD<-delete_vertices(make_ego_graph_all_var4,V(make_ego_graph_all_var4)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var4_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var4_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var4_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var4_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var4_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var4_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var4_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var4_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var4_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var4_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var4_without_complex<-
  delete_vertices(make_ego_graph_all_var4,
                  c(V(make_ego_graph_all_var4)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var4)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var4_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var4_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var4_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var4_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var4_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var4_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var4_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var4_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var4_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var4_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var4, 
     layout=layout.kamada.kawai(msp_var4), 
     vertex.label=get.vertex.attribute(msp_var4,"LABEL_COR"),
     vertex.size=degree(msp_var4)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var4)/50,
     edge.width=log(edge.betweenness(msp_var4, weights =E(msp_var4)$msp_var4))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var4, 
     layout=layout.auto(msp_var4), 
     vertex.label=get.vertex.attribute(msp_var4,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var4)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var4))/50,
     edge.width=log(edge.betweenness(msp_var4, weights=E(msp_var4)$msp_var4))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var4, mode="in")), 
     median(degree(msp_var4, mode="out"))
...
msp_var4_w<-minimum.spanning.tree(var4, weights=1/edge.betweenness(var4, weights =E(var4)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var4_w, 
     layout=layout.auto(msp_var4_w), 
     vertex.label=get.vertex.attribute(msp_var4_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var4_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var4_w))/20,
     edge.width=1/edge.betweenness(msp_var4_w, weights =E(msp_var4_w)$msp_var4_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var4)$mut/ecount(var4) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var4_sp_in <- shortest.paths(var4, mode='in', weights=E(var4)$weight) # sames as bellow
var4_sp_out <- shortest.paths(var4, mode='out', weights=E(var4)$weight) #same as above
var4_sp_all <- shortest.paths(var4, mode='all', weights=E(var4)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var4<-distances(var4, mode="all", weights=E(var4)$weight)
#distances_sp_all_var4

#In shortest paths 
distances_sp_in_var4<-distances(var4, mode="in",weights=E(var4)$weight)
#distances_sp_in_var4

#Out shortest paths 
distances_sp_out_var4<-distances(var4, mode="out", weights=E(var4)$weight)
#distances_sp_out_var4
```
...
var4_dist.from.CAPSAD <- distances(var4, v=V(var4)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var4), weights=E(var4)$weight)
...
plot(var4, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var4)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var4))/10,
     edge.width=edge.betweenness(var4, weights=E(var4)$var4)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var4, weights=E(var4)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var4, weights=E(var4)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var4, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var4)$transitivity_local_w<-transitivity(var4, type="barrat") 
transitivity_local_w<-transitivity(var4, weights=E(var4)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var4_u <- as.undirected(var4, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var4_u_size<-sapply(cliques(var4_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var4)$edge.btweenness<-edge.betweenness(var4, weights =E(var4)$weight)
var4_edge.betweenness <-edge.betweenness(var4, weights =E(var4)$weight)
```
...
plot(var4, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var4_edge.betweenness.community),
                      var4_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var4)+1)/10,
     edge.width=log(edge.betweenness(var4, weights =E(var4)$weight))/5,
     edge.curved = TRUE
     )
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var4 <- as.dendrogram(var4_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var4, main = "Dendrograma var4", nodePar=list(pch=c(NA, 20)))
```
...
plot(var4, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var4)),
     mark.groups = by(seq_along(var4_walktrap.community),
                      var4_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var4)+1)/10,
     edge.width=log(edge.betweenness(var4, weights =E(var4)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var4 <- decompose.graph(var4)
sapply(comps_var4, diameter)
table(sapply(comps_var4, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var41<-comps_var4[[1]]
#comps_var42<-comps_var4[[2]]
#comps_var43<-comps_var4[[3]]
#comps_var44<-comps_var4[[4]]
#comps_var45<-comps_var4[[5]]
#comps_var46<-comps_var4[[6]]
#comps_var47<-comps_var4[[7]]
#comps_var48<-comps_var4[[8]]
#...
```
...
plot(comps_var41, 
     layout=layout.kamada.kawai(comps_var41), 
     vertex.label=get.vertex.attribute(comps_var41,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var41)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var41)+1)/10,
     edge.width=log(edge.betweenness(comps_var41, weights=E(comps_var41)$comps_var41))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var41)$LABEL_COR
b<-V(comps_var41)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var41, mode="in")), 
     median(degree(comps_var41, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var4)$optimal_comm_var4 <- #membership(optimal.community(var4))
#optimal_comm_var4 <- membership(optimal.community(var4))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var4)
var4_dim<-get.diameter(var4)
var4_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var4, weights=E(var4)$weight)
var4_dim<-get.diameter(var4, weights=E(var4)$weight)
var4_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var4)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 6.CENTRALIDADE_PROGRAMAS EM CONJUNTO (var4)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
