---
title: "SNA Centralities 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20)."
...
# 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).
...
```
#1. Descriptive Analysis for 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var20, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var20)/10, main="Histogram of Indegree Nodes - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var20, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var20)/10, main="Histogram of Outdegree Nodes - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var20, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var20)/10, main="Histogram of All Degree Nodes - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).")
```  
...
#Histogram var20 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var20, weights=E(var20)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var20)/10, main="Histogram of Strength Degree Nodes - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var20, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var20)/10, main="Histogram of Normalized Indegree Nodes - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var20, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var20)/10, main="Histogram of Normalized Outdegree Nodes - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var20, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var20)/10, main="Histogram of Normalized All Degree Nodes - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var20), breaks=vcount(var20)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20). ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20)."
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var20)$var20_a.nn.deg <- graph.knn(var20,V(var20))$knn
```
...
plot(degree(var20), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20)."
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).)
...
plot(degree(var20), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20)."
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var20, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var20, 
     ...
     edge.width=(edge.betweenness(var20, weights=V(var20)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ", cex = .5)
...
plot(var20, 
     ...
     edge.width=(edge.betweenness(var20, weights =E(var20)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
...
plot(small_var20, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var20)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var20, 
     ...
     vertex.label.cex=log(degree(small_var20)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var20, mode="in")), 
     median(degree(small_var20, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var20_a.nn.deg_w 
plot(var20, 
     layout=layout.kamada.kawai(var20), 
     vertex.label=get.vertex.attribute(var20,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var20,V(var20))$knn+1)/30,
     edge.width=(edge.betweenness(var20, weights =E(var20)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var20, 
     layout=layout.kamada.kawai(var20), 
     vertex.label=get.vertex.attribute(var20,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var20,V(var20), weights= E(var20)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var20,V(var20), weights= E(var20)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var20, weights =E(var20)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var20,V(var20), weights= E(var20)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var20)$incloseness_w <- closeness(var20, mode = "in", normalized = T, weights=E(var20)$weight) %>% round(6)
V(var20)$outcloseness_w <- closeness(var20, mode = "out", normalized = T,weights=E(var20)$weight) %>% round(6)
V(var20)$totalcloseness_w <- closeness(var20, mode = "total", normalized = T, weights=E(var20)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var20_incloseness_w<- closeness(var20, mode = "in", normalized = T, weights=E(var20)$weight) %>% round(6)
var20_outcloseness_w<- closeness(var20, mode = "out", normalized = T, weights=E(var20)$weight) %>% round(6)
var20_totalcloseness_w<- closeness(var20, mode = "total", normalized = T, weights=E(var20)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var20)$var20_closeness_stats_w <- closeness(var20, vids = V(var20), mode = "all", weights =E(var20)$weight, normalized = FALSE)
var20_closeness_stats_w <- closeness(var20, vids = V(var20), mode = "all", weights =E(var20)$weight, normalized = FALSE)
```
...
var20_outcloseness_w<- closeness(var20, mode = "out", normalized = T, weights=E(var20)$weight) %>% round(6)
var20_totalcloseness_w<- closeness(var20, mode = "total", normalized = T, weights=E(var20)$weight) %>% round(6)
var20_closeness_stats_w <- closeness(var20, vids = V(var20), mode = "all", weights=E(var20)$weight, normalized = FALSE) %>% round(6)
...
var20_incloseness_w,
var20_outcloseness_w,
var20_totalcloseness_w,
var20_closeness_stats_w,
...
#Adding names
names(var20_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var20_df_closseness<-var20_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var20)$var20_color_degree<-round(V(var20)$var20_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var20, mode="in")), 
     median(closeness(var20, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var20)$var20_betweenness_w <- betweenness(var20, weights=E(var20)$weight) %>% round(1)
var20_betweenness_w <- betweenness(var20, weights=E(var20)$weight) %>% round(1)
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var20)$var20_centr_betweenness<-(centralization.betweenness(var20)$res)/10000
...
#Adding Title
  title("Network Centralization Betweenness - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var20)$eigenvector <- eigen_centrality(var20, directed = TRUE, weights =E(var20)$weight) %$% vector %>% round(3)
var20_eigenvector <- eigen_centrality(var20, directed = TRUE, weights = E(var20)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var20_eigenvector_value <- eigen_centrality(var20, directed = TRUE, weights = E(var20)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var20)$var20_centr_eigen <- centr_eigen(var20, directed = T)$vector
var20_centr_eigen <-centr_eigen(var20, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var20_eigenvector_w <- eigen_centrality(var20, directed = TRUE, weights = E(var20)$weight) %$% vector %>% round(3) 
var20_centr_eigen <-centr_eigen(var20, directed = T)$vector

#Creating a datagrame of measures
var20_df_eigenvector <- data.frame(var20_eigenvector,
var20_eigenvector_w,
var20_centr_eigen) %>% round(3)

#Adding type
var20_df_eigenvector <-cbind(var20_df_eigenvector, V(var20)$LABEL_COR)

#Adding names
names(var20_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var20_df_eigenvector<-var20_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var20_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var20_df_eigenvector, by=list(var20_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var20_df_eigenvector, by=list(var20_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var20, 
     layout=layout.kamada.kawai(var20), 
     vertex.label=get.vertex.attribute(var20,"LABEL_COR"),
     vertex.size=(eigen_centrality(var20, directed =TRUE, weights = E(var20)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var20)$vector)+1)/10,
     edge.width=edge.betweenness(var20, weights =E(var20)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var20, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var20, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var20, weights =E(var20)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var20, directed = T)$vector), 
     sd(centr_eigen(var20, directed = T)$vector)
   ))
```
...
var20_power_centrality_stats <- power_centrality(var20, nodes = V(var20), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var20)$var20_power_centrality_stats <-power_centrality(var20, nodes = V(var20), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var20)$LABEL_COR, var20_power_centrality_stats))
...
V(var20)$var20_power_centrality_stats_r<-round(V(var20)$var20_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var20)$var20_power_centrality_stats_r)), "Blues"))(length(unique(V(var20)$var20_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var20)$color_spower <- vertex_col_spower[factor(V(var20)$var20_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var20)$var20_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var20_power_centrality_stats),sd(var20_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var20_alpha_centrality_stats <- alpha_centrality(var20, loops = FALSE, alpha = 1, exo = 1, weights=E(var20)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var20)$var20_alpha_centrality_stats<-alpha_centrality(var20, loops = FALSE, alpha = 1, exo = 1, weights=E(var20)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var20)$LABEL_COR, round(var20_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var20)$var20_alpha_centrality_stats_r<-round(V(var20)$var20_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var20)$var20_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var20)$var20_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var20)$color_s <- vertex_col_s[factor(V(var20)$var20_alpha_centrality_stats_r)]  
```
...
plot(var20, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var20, loops = FALSE, alpha = 1, exo = 1, weights=E(var20)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(var20)$var20_alpha_centrality_stats_r
b<-V(var20)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var20_alpha_centrality_stats),sd(var20_alpha_centrality_stats)
     ))
```
...
plot(var20, 
     layout=layout.kamada.kawai(var20), 
     vertex.label=get.vertex.attribute(var20,"LABEL_COR"),
     vertex.size=10*hub.score(var20)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var20, 
     layout=layout.kamada.kawai(var20), 
     vertex.label=get.vertex.attribute(var20,"LABEL_COR"),
     vertex.size=10*authority.score(var20)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var20)+1)/20,
     edge.width=log(edge.betweenness(var20, weights =E(var20)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var20, 
     layout=layout.kamada.kawai(var20), 
     vertex.label=get.vertex.attribute(var20,"LABEL_COR"),
     vertex.size=200*page.rank(var20)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var20)+1)/15,
     edge.width=log(edge.betweenness(var20, weights =E(var20)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_var20, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var20)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var20, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_var20)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var20)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var20, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_var20)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var20_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_var20_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var20_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var20_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var20_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var20_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var20_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_var20, 
     ...
     vertex.size=degree(msp_var20)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var20)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var20, mode="in")), 
     median(degree(msp_var20, mode="out"))
...
msp_var20_w<-minimum.spanning.tree(var20, weights=1/edge.betweenness(var20, weights =E(var20)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var20_w, 
     layout=layout.auto(msp_var20_w), 
     ...
     edge.width=1/edge.betweenness(msp_var20_w, weights =E(msp_var20_w)$msp_var20_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var20_sp_in <- shortest.paths(var20, mode='in', weights=E(var20)$weight) # sames as bellow
var20_sp_out <- shortest.paths(var20, mode='out', weights=E(var20)$weight) #same as above
var20_sp_all <- shortest.paths(var20, mode='all', weights=E(var20)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var20<-distances(var20, mode="all", weights=E(var20)$weight)
#distances_sp_all_var20

#In shortest paths 
distances_sp_in_var20<-distances(var20, mode="in",weights=E(var20)$weight)
#distances_sp_in_var20

#Out shortest paths 
distances_sp_out_var20<-distances(var20, mode="out", weights=E(var20)$weight)
...
var20_dist.from.CAPSAD <- distances(var20, v=V(var20)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var20), weights=E(var20)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var20, weights=E(var20)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var20, weights=E(var20)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(var20, weights=E(var20)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var20_u_size<-sapply(cliques(var20_u), length) # too intesive calculation
```
...
V(as.undirected_var20_u)$vcollabel[V(as.undirected_var20_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var20_u)$vcollabel [V(as.undirected_var20_u)$vcol=="grey80"]<-"Others"
```
...
plot(as.undirected(var20_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var20_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var20_u), weights =E(as.undirected(var20_u))$var20))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Coreness Colored Graph - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var20)$edge.btweenness<-edge.betweenness(var20, weights =E(var20)$weight)
var20_edge.betweenness <-edge.betweenness(var20, weights =E(var20)$weight)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
labels<-attr(E(var20), "vnames")
edgebt<-cbind(round(var20_edge.betweenness,2),labels)
datatable(edgebt)
```
...
plot(var20, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var20)+1)/10,
     edge.width=log(edge.betweenness(var20, weights =E(var20)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_var201, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var201)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var20, weights=E(var20)$weight)
var20_dim<-get.diameter(var20, weights=E(var20)$weight)
var20_dim
```
...
#Adding Title
  title("Diameter of 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
