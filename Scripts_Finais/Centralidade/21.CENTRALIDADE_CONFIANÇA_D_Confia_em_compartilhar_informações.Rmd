---
title: "SNA Centralities 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) "
...
# 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) 
...
```
#1. Descriptive Analysis for 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var19, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var19)/10, main="Histogram of Indegree Nodes - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var19, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var19)/10, main="Histogram of Outdegree Nodes - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var19, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var19)/10, main="Histogram of All Degree Nodes - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ")
```  
...
#Histogram var19 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var19, weights=E(var19)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var19)/10, main="Histogram of Strength Degree Nodes - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var19, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var19)/10, main="Histogram of Normalized Indegree Nodes - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var19, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var19)/10, main="Histogram of Normalized Outdegree Nodes - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var19, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var19)/10, main="Histogram of Normalized All Degree Nodes - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var19), breaks=vcount(var19)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19)  ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) "
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) )
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var19)$var19_a.nn.deg <- graph.knn(var19,V(var19))$knn
```
...
plot(degree(var19), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) "
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) )
...
plot(degree(var19), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) "
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var19)$size <- degree(var19)
V(var19)$label <- V(var19)$V5_LABEL_TIPO_NOME
V(var19)$label.cex <- degree(var19)/100
V(var19)$label.color <- "black"

## Just in case if we wanna change colors
#V(var19)$color <- V(var19)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var19)$weight <- E(var19)$weight
E(var19)$width <- E(var19)$weight
E(var19)$color <- "gray"

## Here we can change other edge parameter
#E(var19)[ weight < 0.5 ]$width <- 4
#E(var19)[ weight < 0.5 ]$color <- "green"
#E(var19)$label <- LETTERS[1:10]
#E(var19)$label.cex = seq(1, 2,length.out = 10)
#E(var19)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var19, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var19, 
     ...
     edge.width=(edge.betweenness(var19, weights=V(var19)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ", cex = .5)
...
plot(var19, 
     ...
     edge.width=(edge.betweenness(var19, weights =E(var19)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
...
plot(small_var19, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var19)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var19, 
     ...
     vertex.label.cex=log(degree(small_var19)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var19, mode="in")), 
     median(degree(small_var19, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var19_a.nn.deg_w 
plot(var19, 
     layout=layout.kamada.kawai(var19), 
     vertex.label=get.vertex.attribute(var19,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var19,V(var19))$knn+1)/30,
     edge.width=(edge.betweenness(var19, weights =E(var19)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var19, 
     layout=layout.kamada.kawai(var19), 
     vertex.label=get.vertex.attribute(var19,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var19,V(var19), weights= E(var19)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var19,V(var19), weights= E(var19)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var19, weights =E(var19)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var19,V(var19), weights= E(var19)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var19)$incloseness_w <- closeness(var19, mode = "in", normalized = T, weights=E(var19)$weight) %>% round(6)
V(var19)$outcloseness_w <- closeness(var19, mode = "out", normalized = T,weights=E(var19)$weight) %>% round(6)
V(var19)$totalcloseness_w <- closeness(var19, mode = "total", normalized = T, weights=E(var19)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var19_incloseness_w<- closeness(var19, mode = "in", normalized = T, weights=E(var19)$weight) %>% round(6)
var19_outcloseness_w<- closeness(var19, mode = "out", normalized = T, weights=E(var19)$weight) %>% round(6)
var19_totalcloseness_w<- closeness(var19, mode = "total", normalized = T, weights=E(var19)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var19)$var19_closeness_stats_w <- closeness(var19, vids = V(var19), mode = "all", weights =E(var19)$weight, normalized = FALSE)
var19_closeness_stats_w <- closeness(var19, vids = V(var19), mode = "all", weights =E(var19)$weight, normalized = FALSE)
```
...
var19_outcloseness_w<- closeness(var19, mode = "out", normalized = T, weights=E(var19)$weight) %>% round(6)
var19_totalcloseness_w<- closeness(var19, mode = "total", normalized = T, weights=E(var19)$weight) %>% round(6)
var19_closeness_stats_w <- closeness(var19, vids = V(var19), mode = "all", weights=E(var19)$weight, normalized = FALSE) %>% round(6)
...
var19_incloseness_w,
var19_outcloseness_w,
var19_totalcloseness_w,
var19_closeness_stats_w,
...
#Adding names
names(var19_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var19_df_closseness<-var19_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var19)$var19_color_degree<-round(V(var19)$var19_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var19, mode="in")), 
     median(closeness(var19, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var19)$var19_betweenness_w <- betweenness(var19, weights=E(var19)$weight) %>% round(1)
var19_betweenness_w <- betweenness(var19, weights=E(var19)$weight) %>% round(1)
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var19)$var19_centr_betweenness<-(centralization.betweenness(var19)$res)/10000
...
#Adding Title
  title("Network Centralization Betweenness - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var19)$eigenvector <- eigen_centrality(var19, directed = TRUE, weights =E(var19)$weight) %$% vector %>% round(3)
var19_eigenvector <- eigen_centrality(var19, directed = TRUE, weights = E(var19)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var19_eigenvector_value <- eigen_centrality(var19, directed = TRUE, weights = E(var19)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
plot(var19, 
     layout=layout.kamada.kawai(var19), 
     vertex.label=get.vertex.attribute(var19,"LABEL_COR"),
     vertex.size=(eigen_centrality(var19, directed =TRUE, weights = E(var19)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Eigenvector Centrality Measure - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network EigenVector - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var19_power_centrality_stats <- power_centrality(var19, nodes = V(var19), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var19)$var19_power_centrality_stats <-power_centrality(var19, nodes = V(var19), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var19)$LABEL_COR, var19_power_centrality_stats))
...
V(var19)$var19_power_centrality_stats_r<-round(V(var19)$var19_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var19)$var19_power_centrality_stats_r)), "Blues"))(length(unique(V(var19)$var19_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var19)$color_spower <- vertex_col_spower[factor(V(var19)$var19_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var19)$var19_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var19_power_centrality_stats),sd(var19_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var19_alpha_centrality_stats <- alpha_centrality(var19, loops = FALSE, alpha = 1, exo = 1, weights=E(var19)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var19)$var19_alpha_centrality_stats<-alpha_centrality(var19, loops = FALSE, alpha = 1, exo = 1, weights=E(var19)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var19)$LABEL_COR, round(var19_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var19)$var19_alpha_centrality_stats_r<-round(V(var19)$var19_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var19)$var19_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var19)$var19_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var19)$color_s <- vertex_col_s[factor(V(var19)$var19_alpha_centrality_stats_r)]  
```
...
plot(var19, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var19, loops = FALSE, alpha = 1, exo = 1, weights=E(var19)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(var19)$var19_alpha_centrality_stats_r
b<-V(var19)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var19_alpha_centrality_stats),sd(var19_alpha_centrality_stats)
     ))
```
...
plot(var19, 
     layout=layout.kamada.kawai(var19), 
     vertex.label=get.vertex.attribute(var19,"LABEL_COR"),
     vertex.size=10*hub.score(var19)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var19, 
     layout=layout.kamada.kawai(var19), 
     vertex.label=get.vertex.attribute(var19,"LABEL_COR"),
     vertex.size=10*authority.score(var19)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var19)+1)/20,
     edge.width=log(edge.betweenness(var19, weights =E(var19)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var19, 
     layout=layout.kamada.kawai(var19), 
     vertex.label=get.vertex.attribute(var19,"LABEL_COR"),
     vertex.size=200*page.rank(var19)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var19)+1)/15,
     edge.width=log(edge.betweenness(var19, weights =E(var19)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_var19, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var19)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var19, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_var19)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var19)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var19, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_var19)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var19_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_var19_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var19_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var19_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var19_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var19_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var19_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_var19, 
     ...
     vertex.size=degree(msp_var19)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var19)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var19, mode="in")), 
     median(degree(msp_var19, mode="out"))
...
msp_var19_w<-minimum.spanning.tree(var19, weights=1/edge.betweenness(var19, weights =E(var19)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var19_w, 
     layout=layout.auto(msp_var19_w), 
     ...
     edge.width=1/edge.betweenness(msp_var19_w, weights =E(msp_var19_w)$msp_var19_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var19_sp_in <- shortest.paths(var19, mode='in', weights=E(var19)$weight) # sames as bellow
var19_sp_out <- shortest.paths(var19, mode='out', weights=E(var19)$weight) #same as above
var19_sp_all <- shortest.paths(var19, mode='all', weights=E(var19)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var19<-distances(var19, mode="all", weights=E(var19)$weight)
#distances_sp_all_var19

#In shortest paths 
distances_sp_in_var19<-distances(var19, mode="in",weights=E(var19)$weight)
#distances_sp_in_var19

#Out shortest paths 
distances_sp_out_var19<-distances(var19, mode="out", weights=E(var19)$weight)
...
var19_dist.from.CAPSAD <- distances(var19, v=V(var19)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var19), weights=E(var19)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var19, weights=E(var19)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var19, weights=E(var19)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(var19, weights=E(var19)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var19_u_size<-sapply(cliques(var19_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var19)$edge.btweenness<-edge.betweenness(var19, weights =E(var19)$weight)
var19_edge.betweenness <-edge.betweenness(var19, weights =E(var19)$weight)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
labels<-attr(E(var19), "vnames")
edgebt<-cbind(round(var19_edge.betweenness,2),labels)
datatable(edgebt)
```
...
plot(var19, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var19)+1)/10,
     edge.width=log(edge.betweenness(var19, weights =E(var19)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_var191, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var191)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var19, weights=E(var19)$weight)
var19_dim<-get.diameter(var19, weights=E(var19)$weight)
var19_dim
```
...
#Adding Title
  title("Diameter of 21.CENTRALIDADE_CONFIANÇA D) Confia em compartilhar informações internas com este serviço. (var19) ", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
