---
title: "SNA Centralities 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)"
...
# 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)
...
```
#1. Descriptive Analysis for 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var15, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var15)/10, main="Histogram of Indegree Nodes - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var15, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var15)/10, main="Histogram of Outdegree Nodes - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var15, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var15)/10, main="Histogram of All Degree Nodes - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)")
```  
...
#Histogram var15 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var15, weights=E(var15)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var15)/10, main="Histogram of Strength Degree Nodes - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var15, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var15)/10, main="Histogram of Normalized Indegree Nodes - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var15, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var15)/10, main="Histogram of Normalized Outdegree Nodes - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var15, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var15)/10, main="Histogram of Normalized All Degree Nodes - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var15), breaks=vcount(var15)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$var15_a.nn.deg <- graph.knn(var15,V(var15))$knn
```
...
plot(degree(var15), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var15)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var15), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var15, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=degree(var15)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var15)/10000,
     vertex.label.cex=degree(var15)/500,
     edge.width=(edge.betweenness(var15, weights=V(var15)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ", cex = .5)
...
plot(var15, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var15))/800,
     edge.width=(edge.betweenness(var15, weights =E(var15)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var15, 
     layout=layout.kamada.kawai(small_var15), 
     vertex.label=get.vertex.attribute(small_var15,"LABEL_COR"),
     vertex.size=degree(small_var15)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var15)+1)/10,
     edge.width=(edge.betweenness(small_var15))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var15, mode="in")), 
     median(degree(small_var15, mode="out"))
   )
  )
```
...
plot(small_var15, 
     layout=layout.kamada.kawai(small_var15), 
     vertex.label=get.vertex.attribute(small_var15,"LABEL_COR"),
     vertex.size=degree(small_var15)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var15)+2)/5,
     edge.width=(edge.betweenness(small_var15)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var15, mode="in")), 
     median(degree(small_var15, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var15_a.nn.deg_w 
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=(graph.knn(var15,V(var15))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var15,V(var15))$knn+1)/30,
     edge.width=(edge.betweenness(var15, weights =E(var15)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var15,V(var15))$knn)
   ))
```
...
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var15,V(var15), weights= E(var15)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var15,V(var15), weights= E(var15)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var15, weights =E(var15)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var15,V(var15), weights= E(var15)$weight)$knn)
   ))
```
...
V(var15)$totalcloseness <- closeness(var15, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$incloseness_n <- closeness(var15, mode = "in", normalized = T) %>% round(6)
V(var15)$outcloseness_n <- closeness(var15, mode = "out", normalized = T) %>% round(6)
V(var15)$totalcloseness_n <- closeness(var15, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var15_incloseness_n<- closeness(var15, mode = "in", normalized = T) %>% round(6)
var15_outcloseness_n<- closeness(var15, mode = "out", normalized = T) %>% round(6)
var15_totalcloseness_n<- closeness(var15, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$incloseness_w <- closeness(var15, mode = "in", normalized = T, weights=E(var15)$weight) %>% round(6)
V(var15)$outcloseness_w <- closeness(var15, mode = "out", normalized = T,weights=E(var15)$weight) %>% round(6)
V(var15)$totalcloseness_w <- closeness(var15, mode = "total", normalized = T, weights=E(var15)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var15_incloseness_w<- closeness(var15, mode = "in", normalized = T, weights=E(var15)$weight) %>% round(6)
var15_outcloseness_w<- closeness(var15, mode = "out", normalized = T, weights=E(var15)$weight) %>% round(6)
var15_totalcloseness_w<- closeness(var15, mode = "total", normalized = T, weights=E(var15)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var15_incloseness_w)
sd(var15_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var15_outcloseness_w)
sd(var15_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var15_totalcloseness_w)
sd(var15_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$var15_closeness_stats_w <- closeness(var15, vids = V(var15), mode = "all", weights =E(var15)$weight, normalized = FALSE)
var15_closeness_stats_w <- closeness(var15, vids = V(var15), mode = "all", weights =E(var15)$weight, normalized = FALSE)
```
...
var15_outcloseness_w<- closeness(var15, mode = "out", normalized = T, weights=E(var15)$weight) %>% round(6)
var15_totalcloseness_w<- closeness(var15, mode = "total", normalized = T, weights=E(var15)$weight) %>% round(6)
var15_closeness_stats_w <- closeness(var15, vids = V(var15), mode = "all", weights=E(var15)$weight, normalized = FALSE) %>% round(6)
...
var15_incloseness_w,
var15_outcloseness_w,
var15_totalcloseness_w,
var15_closeness_stats_w,
...
#Adding names
names(var15_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var15_df_closseness<-var15_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var15)$var15_color_degree<-round(V(var15)$totalcloseness,4)
...
plot(var15, 
     ...
     vertex.color=V(var15)$vertex_var15_color_degree,
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=closeness(var15)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var15))/80,
     edge.width=(edge.betweenness(var15, weights =E(var15)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var15, mode="in")), 
     median(closeness(var15, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var15)$var15_color_degree<-round(V(var15)$var15_centr_closeness,2)
...
plot(var15, 
     ...
     vertex.color=V(var15)$vertex_var15_color_degree,
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=centralization.closeness(var15)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var15, mode="in")), 
     median(closeness(var15, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$var15_betweenness_w <- betweenness(var15, weights=E(var15)$weight) %>% round(1)
var15_betweenness_w <- betweenness(var15, weights=E(var15)$weight) %>% round(1)
```
##Betweenness Centrality Weighted - (Vertex) - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var15_betweenness_w)
sd(var15_betweenness_w)
```
#2.8.3 Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$var15_centr_betweenness <- centralization.betweenness(var15)$res
var15_centr_betweenness <- centralization.betweenness(var15)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var15_centr_betweenness$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var15_centr_betweenness$theoretical_max
```
...
var15_betweenness <- betweenness(var15) %>% round(1)
var15_betweenness_w <- betweenness(var15, weights=E(var15)$weight) %>% round(1)
var15_centr_betweenness <- centralization.betweenness(var15)$res %>% round(1)

#Creating a dataframe of measures
var15_df_betweenness <- data.frame(var15_betweenness,
var15_betweenness_w,
var15_centr_betweenness) %>% round(1)

#Adding type
var15_df_betweenness <-cbind(var15_df_betweenness, V(var15)$LABEL_COR)

#Adding names
names(var15_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var15_df_betweenness<-var15_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
# General tabel for Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var15_df_betweenness, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var15_df_betweenness, by=list(var15_df_betweenness$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var15_df_betweenness, by=list(var15_df_betweenness$Type), FUN=sd, na.rm=TRUE) 
...
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=betweenness(var15)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var15)+1)/10000,
     edge.width=edge.betweenness(var15, weights =E(var15)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var15)), 
     sd(betweenness(var15))
   ))
```
#2.8.2 Network Plotting Based On Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var15)$var15_centr_betweenness<-(centralization.betweenness(var15)$res)/10000
V(var15)$var15_color_degree<-round(V(var15)$var15_centr_betweenness,1)
...
plot(var15, 
     ...
     vertex.color=V(var15)$vertex_var15_color_degree,
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var15)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centralization.betweenness(var15)$res + 1)/10000,
     edge.width=(edge.betweenness(var15, weights =E(var15)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Betweenness - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var15)$eigenvector <- eigen_centrality(var15, directed = TRUE, weights =E(var15)$weight) %$% vector %>% round(3)
var15_eigenvector <- eigen_centrality(var15, directed = TRUE, weights = E(var15)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var15_eigenvector_value <- eigen_centrality(var15, directed = TRUE, weights = E(var15)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var15_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$var15_centr_eigen <- centr_eigen(var15, directed = T)$vector
var15_centr_eigen <-centr_eigen(var15, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var15, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var15, directed = T)$theoretical_max
```
...
var15_eigenvector_w <- eigen_centrality(var15, directed = TRUE, weights = E(var15)$weight) %$% vector %>% round(3) 
var15_centr_eigen <-centr_eigen(var15, directed = T)$vector

#Creating a datagrame of measures
var15_df_eigenvector <- data.frame(var15_eigenvector,
var15_eigenvector_w,
var15_centr_eigen) %>% round(3)

#Adding type
var15_df_eigenvector <-cbind(var15_df_eigenvector, V(var15)$LABEL_COR)

#Adding names
names(var15_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var15_df_eigenvector<-var15_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var15_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var15_df_eigenvector, by=list(var15_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var15_df_eigenvector, by=list(var15_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=(eigen_centrality(var15, directed =TRUE, weights = E(var15)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var15)$vector)+1)/10,
     edge.width=edge.betweenness(var15, weights =E(var15)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var15)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var15)$var15_color_degree<-round(centr_eigen(var15, directed = T)$vector,2)
...
plot(var15, 
     ...
     vertex.color=V(var15)$vertex_var15_color_degree,
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=centr_eigen(var15, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var15, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var15, weights =E(var15)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var15, directed = T)$vector), 
     sd(centr_eigen(var15, directed = T)$vector)
   ))
```
...
var15_power_centrality_stats <- power_centrality(var15, nodes = V(var15), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var15)$var15_power_centrality_stats <-power_centrality(var15, nodes = V(var15), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var15)$LABEL_COR, var15_power_centrality_stats))
...
V(var15)$var15_power_centrality_stats_r<-round(V(var15)$var15_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var15)$var15_power_centrality_stats_r)), "Blues"))(length(unique(V(var15)$var15_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var15)$color_spower <- vertex_col_spower[factor(V(var15)$var15_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.color=V(var15)$color_spower, 
     vertex.label=V(var15)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var15)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var15)+1)^2)/10,
     edge.width=edge.betweenness(var15, weights =E(var15)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var15)$var15_power_centrality_stats_r
b<-V(var15)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var15_power_centrality_stats),sd(var15_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var15_alpha_centrality_stats <- alpha_centrality(var15, loops = FALSE, alpha = 1, exo = 1, weights=E(var15)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var15)$var15_alpha_centrality_stats<-alpha_centrality(var15, loops = FALSE, alpha = 1, exo = 1, weights=E(var15)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$LABEL_COR, round(var15_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var15)$var15_alpha_centrality_stats_r<-round(V(var15)$var15_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var15)$var15_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var15)$var15_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var15)$color_s <- vertex_col_s[factor(V(var15)$var15_alpha_centrality_stats_r)]  
```
...
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.color=V(var15)$color_s, 
     vertex.label=V(var15)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var15, loops = FALSE, alpha = 1, exo = 1, weights=E(var15)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var15))^2)/50,
     edge.width=edge.betweenness(var15, weights =E(var15)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var15)$var15_alpha_centrality_stats_r
b<-V(var15)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var15_alpha_centrality_stats),sd(var15_alpha_centrality_stats)
     ))
```
...
V(var15)$hub <- hub.score(var15)$vector
var15_hub<- hub.score(var15)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$LABEL_COR, var15_hub))
...
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=10*hub.score(var15)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var15)+1)/10,
     edge.width=edge.betweenness(var15, weights =E(var15)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
V(var15)$authority.score<- authority.score(var15)$vector
var15_auth <- authority.score(var15)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$LABEL_COR, var15_auth))
...
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=10*authority.score(var15)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var15)+1)/20,
     edge.width=log(edge.betweenness(var15, weights =E(var15)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#PageRank
V(var15)$page.rank<-page.rank(var15)$vector
var15_pr<-page.rank(var15)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var15)$LABEL_COR, var15_pr))
...
plot(var15, 
     layout=layout.kamada.kawai(var15), 
     vertex.label=get.vertex.attribute(var15,"LABEL_COR"),
     vertex.size=200*page.rank(var15)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var15)+1)/15,
     edge.width=log(edge.betweenness(var15, weights =E(var15)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
prPB<-page_rank(var15)$vector
hPB<-hub.score(var15)$vector
authPB<-authority.score(var15)$vector
indegPB<-degree(var15, mode="in")
outdegPB<-degree(var15, mode="out")
```
...
title("Hits by in and out degree - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var15<-make_ego_graph(var15, order=1, V(var15)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var15, 
     layout=layout.kamada.kawai(make_ego_graph_all_var15), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var15,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var15)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var15)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var15))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var15)$LABEL_COR
b<-V(make_ego_graph_all_var15)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var15)$vector),
     sd(page.rank(make_ego_graph_all_var15)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var15<-make_ego_graph(var15, order=1, V(var15)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var15, 
     layout=layout.kamada.kawai(make_ego_graph_out_var15), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var15,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var15)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var15)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var15))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var15)$LABEL_COR
b<-V(make_ego_graph_out_var15)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var15)$vector),
     sd(page.rank(make_ego_graph_out_var15)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var15<-make_ego_graph(var15, order=1, V(var15)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var15, 
     layout=layout.kamada.kawai(make_ego_graph_in_var15), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var15,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var15)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var15))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var15))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var15)$LABEL_COR
b<-V(make_ego_graph_in_var15)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var15)$vector),
     sd(page.rank(make_ego_graph_in_var15)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var15_without_CAPSAD<-delete_vertices(make_ego_graph_all_var15,V(make_ego_graph_all_var15)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var15_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var15_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var15_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var15_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var15_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var15_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var15_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var15_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var15_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var15_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var15_without_complex<-
  delete_vertices(make_ego_graph_all_var15,
                  c(V(make_ego_graph_all_var15)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var15)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var15_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var15_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var15_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var15_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var15_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var15_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var15_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var15_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var15_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var15_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var15, 
     layout=layout.kamada.kawai(msp_var15), 
     vertex.label=get.vertex.attribute(msp_var15,"LABEL_COR"),
     vertex.size=degree(msp_var15)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var15)/50,
     edge.width=log(edge.betweenness(msp_var15, weights =E(msp_var15)$msp_var15))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var15, 
     layout=layout.auto(msp_var15), 
     vertex.label=get.vertex.attribute(msp_var15,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var15)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var15))/50,
     edge.width=log(edge.betweenness(msp_var15, weights=E(msp_var15)$msp_var15))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var15, mode="in")), 
     median(degree(msp_var15, mode="out"))
...
msp_var15_w<-minimum.spanning.tree(var15, weights=1/edge.betweenness(var15, weights =E(var15)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var15_w, 
     layout=layout.auto(msp_var15_w), 
     vertex.label=get.vertex.attribute(msp_var15_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var15_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var15_w))/20,
     edge.width=1/edge.betweenness(msp_var15_w, weights =E(msp_var15_w)$msp_var15_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var15)$mut/ecount(var15) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var15_sp_in <- shortest.paths(var15, mode='in', weights=E(var15)$weight) # sames as bellow
var15_sp_out <- shortest.paths(var15, mode='out', weights=E(var15)$weight) #same as above
var15_sp_all <- shortest.paths(var15, mode='all', weights=E(var15)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var15<-distances(var15, mode="all", weights=E(var15)$weight)
#distances_sp_all_var15

#In shortest paths 
distances_sp_in_var15<-distances(var15, mode="in",weights=E(var15)$weight)
#distances_sp_in_var15

#Out shortest paths 
distances_sp_out_var15<-distances(var15, mode="out", weights=E(var15)$weight)
#distances_sp_out_var15
```
...
var15_dist.from.CAPSAD <- distances(var15, v=V(var15)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var15), weights=E(var15)$weight)
...
plot(var15, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var15)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var15))/10,
     edge.width=edge.betweenness(var15, weights=E(var15)$var15)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var15, weights=E(var15)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var15, weights=E(var15)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var15, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$transitivity_local_w<-transitivity(var15, type="barrat") 
transitivity_local_w<-transitivity(var15, weights=E(var15)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var15_u <- as.undirected(var15, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var15_u_size<-sapply(cliques(var15_u), length) # too intesive calculation
```
...
as.undirected_var15_u<-as.undirected(var15_u)
...
V(as.undirected_var15_u)$vcol<-vcol

#Saving labels to display as legend
V(as.undirected_var15_u)$vcollabel[V(as.undirected_var15_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var15_u)$vcollabel [V(as.undirected_var15_u)$vcol=="grey80"]<-"Others"
```

#Plotting based only on degree measures 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(as.undirected(var15_u), 
     layout=layout.kamada.kawai(as.undirected(var15_u)), 
     vertex.label=get.vertex.attribute(as.undirected(var15_u),"LABEL_COR"),
     vertex.color=vcol,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(as.undirected(var15_u))),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var15_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var15_u), weights =E(as.undirected(var15_u))$var15))/50,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(as.undirected_var15_u)$vcollabel
b<-V(as.undirected_var15_u)$vcol
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Coreness Colored Graph - 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var15)$edge.btweenness<-edge.betweenness(var15, weights =E(var15)$weight)
var15_edge.betweenness <-edge.betweenness(var15, weights =E(var15)$weight)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var15_edge.betweenness)
sd(var15_edge.betweenness)
```
#Edge Betweenness Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
labels<-attr(E(var15), "vnames")
edgebt<-cbind(round(var15_edge.betweenness,2),labels)
datatable(edgebt)
```
...
plot(var15, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var15_edge.betweenness.community),
                      var15_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var15)+1)/10,
     edge.width=log(edge.betweenness(var15, weights =E(var15)$weight))/5,
     edge.curved = TRUE
     )
...
var15_walktrap.community <- walktrap.community(var15)
```

#3.11.1 Network Dendograma
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var15 <- as.dendrogram(var15_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var15, main = "Dendrograma var15", nodePar=list(pch=c(NA, 20)))
```

#3.11.2 Saving Random walk community
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var15)$walktrap.community <- membership(var15_walktrap.community)
var15_walktrap.community <- membership(var15_walktrap.community)
```
...
plot(var15, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var15)),
     mark.groups = by(seq_along(var15_walktrap.community),
                      var15_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var15)+1)/10,
     edge.width=log(edge.betweenness(var15, weights =E(var15)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var15 <- decompose.graph(var15)
sapply(comps_var15, diameter)
table(sapply(comps_var15, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var151<-comps_var15[[1]]
#comps_var152<-comps_var15[[2]]
#comps_var153<-comps_var15[[3]]
#comps_var154<-comps_var15[[4]]
#comps_var155<-comps_var15[[5]]
#comps_var156<-comps_var15[[6]]
#comps_var157<-comps_var15[[7]]
#comps_var158<-comps_var15[[8]]
#...
```
...
plot(comps_var151, 
     layout=layout.kamada.kawai(comps_var151), 
     vertex.label=get.vertex.attribute(comps_var151,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var151)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var151)+1)/10,
     edge.width=log(edge.betweenness(comps_var151, weights=E(comps_var151)$comps_var151))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var151)$LABEL_COR
b<-V(comps_var151)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var151, mode="in")), 
     median(degree(comps_var151, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var15)$optimal_comm_var15 <- #membership(optimal.community(var15))
#optimal_comm_var15 <- membership(optimal.community(var15))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var15)
var15_dim<-get.diameter(var15)
var15_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var15, weights=E(var15)$weight)
var15_dim<-get.diameter(var15, weights=E(var15)$weight)
var15_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var15)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 17.CENTRALIDADE_ACESSO I) O tempo gasto para acessar este serviço impede a realização ativades em conjunto. (var15)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
