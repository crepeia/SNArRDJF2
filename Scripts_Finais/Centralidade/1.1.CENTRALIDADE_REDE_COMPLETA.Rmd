---
title: "SNA Centralities 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)"
...
# 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)
...
```
#1. Descriptive Analysis for 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(full_no_zero, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(full_no_zero)/10, main="Histogram of Indegree Nodes - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(full_no_zero, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(full_no_zero)/10, main="Histogram of Outdegree Nodes - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(full_no_zero, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(full_no_zero)/10, main="Histogram of All Degree Nodes - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)")
```  
...
#Histogram full_no_zero degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(full_no_zero, weights=E(full_no_zero)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(full_no_zero)/10, main="Histogram of Strength Degree Nodes - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(full_no_zero, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(full_no_zero)/10, main="Histogram of Normalized Indegree Nodes - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(full_no_zero, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(full_no_zero)/10, main="Histogram of Normalized Outdegree Nodes - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(full_no_zero, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(full_no_zero)/10, main="Histogram of Normalized All Degree Nodes - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(full_no_zero), breaks=vcount(full_no_zero)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero))
...
plot(degree(full_no_zero), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero))
...
plot(degree(full_no_zero), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)"
     )
```
...
#Adding Title
  title("Network Vertex Degree Sized - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ", cex = .5)
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
...
#Adding Title
  title("Network Higher Than Median Degree - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Network Lower than Median Degree - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_full_no_zero, mode="in")), 
     median(degree(small_full_no_zero, mode="out"))
...
plot(full_no_zero, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(full_no_zero,V(full_no_zero))$knn+1)/30,
     edge.width=(edge.betweenness(full_no_zero, weights =E(full_no_zero)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(full_no_zero, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(full_no_zero,V(full_no_zero), weights= E(full_no_zero)$weight)$knn+1)/10,
     edge.width=edge.betweenness(full_no_zero, weights =E(full_no_zero)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Centralization Closeness - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(full_no_zero, mode="in")), 
     median(closeness(full_no_zero, mode="out"))
...
#Adding Title
  title("Network Vertex Betweenness Sized - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Centralization Betweenness - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Eigenvector Centrality Measure - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network EigenVector - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Hub Sized - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Authorities Scores  Sized - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Google Page Rank Sized - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_full_no_zero, 
     ...
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_full_no_zero)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_full_no_zero, mode="in")), 
     median(degree(msp_full_no_zero, mode="out"))
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
full_no_zero_sp_in <- shortest.paths(full_no_zero, mode='in', weights=E(full_no_zero)$weight) # sames as bellow
full_no_zero_sp_out <- shortest.paths(full_no_zero, mode='out', weights=E(full_no_zero)$weight) #same as above
...
#Adding Title
  title("Distance from CAPS AD - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(full_no_zero, weights=E(full_no_zero)$weight,type="weighted")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_full_no_zero_u_size<-sapply(cliques(full_no_zero_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
datatable(edgebt)
```
#Finding Communities using Betweenness - Grivan-Newman algorithm
```{r}
full_no_zero_edge.betweenness.community <- edge.betweenness.community(full_no_zero, E(full_no_zero)$weight, directed=T)
```
...
```{r}
function(i){
  g2 <- delete.edges(full_no_zero, full_no_zero_edge.betweenness.community$removed.edges[seq(length=i)])
  }
mods <- sapply(0:ecount(full_no_zero), i
               )
...
#Adding Title
  title("Diameter of 1.1.CENTRALIDADE - REDE COMPLETA (full_no_zero)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
