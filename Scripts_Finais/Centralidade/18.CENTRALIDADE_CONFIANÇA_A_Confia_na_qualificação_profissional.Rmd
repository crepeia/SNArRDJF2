---
title: "SNA Centralities 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)"
...
# 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)
...
```
#1. Descriptive Analysis for 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var16, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var16)/10, main="Histogram of Indegree Nodes - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var16, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var16)/10, main="Histogram of Outdegree Nodes - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var16, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var16)/10, main="Histogram of All Degree Nodes - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)")
```  
...
#Histogram var16 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var16, weights=E(var16)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var16)/10, main="Histogram of Strength Degree Nodes - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var16, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var16)/10, main="Histogram of Normalized Indegree Nodes - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var16, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var16)/10, main="Histogram of Normalized Outdegree Nodes - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var16, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var16)/10, main="Histogram of Normalized All Degree Nodes - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var16), breaks=vcount(var16)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$var16_a.nn.deg <- graph.knn(var16,V(var16))$knn
```
...
plot(degree(var16), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var16)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var16), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var16)$size <- degree(var16)
V(var16)$label <- V(var16)$V5_LABEL_TIPO_NOME
V(var16)$label.cex <- degree(var16)/100
V(var16)$label.color <- "black"

## Just in case if we wanna change colors
#V(var16)$color <- V(var16)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var16)$weight <- E(var16)$weight
E(var16)$width <- E(var16)$weight
E(var16)$color <- "gray"

## Here we can change other edge parameter
#E(var16)[ weight < 0.5 ]$width <- 4
#E(var16)[ weight < 0.5 ]$color <- "green"
#E(var16)$label <- LETTERS[1:10]
#E(var16)$label.cex = seq(1, 2,length.out = 10)
#E(var16)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var16, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=degree(var16)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var16)/10000,
     vertex.label.cex=degree(var16)/500,
     edge.width=(edge.betweenness(var16, weights=V(var16)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ", cex = .5)
...
plot(var16, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var16))/800,
     edge.width=(edge.betweenness(var16, weights =E(var16)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var16, 
     layout=layout.kamada.kawai(small_var16), 
     vertex.label=get.vertex.attribute(small_var16,"LABEL_COR"),
     vertex.size=degree(small_var16)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var16)+1)/10,
     edge.width=(edge.betweenness(small_var16))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var16, mode="in")), 
     median(degree(small_var16, mode="out"))
   )
  )
```
...
plot(small_var16, 
     layout=layout.kamada.kawai(small_var16), 
     vertex.label=get.vertex.attribute(small_var16,"LABEL_COR"),
     vertex.size=degree(small_var16)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var16)+2)/5,
     edge.width=(edge.betweenness(small_var16)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var16, mode="in")), 
     median(degree(small_var16, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var16_a.nn.deg_w 
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=(graph.knn(var16,V(var16))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var16,V(var16))$knn+1)/30,
     edge.width=(edge.betweenness(var16, weights =E(var16)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var16,V(var16))$knn)
   ))
```
...
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var16,V(var16), weights= E(var16)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var16,V(var16), weights= E(var16)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var16, weights =E(var16)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var16,V(var16), weights= E(var16)$weight)$knn)
   ))
```
...
V(var16)$totalcloseness <- closeness(var16, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$incloseness_n <- closeness(var16, mode = "in", normalized = T) %>% round(6)
V(var16)$outcloseness_n <- closeness(var16, mode = "out", normalized = T) %>% round(6)
V(var16)$totalcloseness_n <- closeness(var16, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var16_incloseness_n<- closeness(var16, mode = "in", normalized = T) %>% round(6)
var16_outcloseness_n<- closeness(var16, mode = "out", normalized = T) %>% round(6)
var16_totalcloseness_n<- closeness(var16, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$incloseness_w <- closeness(var16, mode = "in", normalized = T, weights=E(var16)$weight) %>% round(6)
V(var16)$outcloseness_w <- closeness(var16, mode = "out", normalized = T,weights=E(var16)$weight) %>% round(6)
V(var16)$totalcloseness_w <- closeness(var16, mode = "total", normalized = T, weights=E(var16)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var16_incloseness_w<- closeness(var16, mode = "in", normalized = T, weights=E(var16)$weight) %>% round(6)
var16_outcloseness_w<- closeness(var16, mode = "out", normalized = T, weights=E(var16)$weight) %>% round(6)
var16_totalcloseness_w<- closeness(var16, mode = "total", normalized = T, weights=E(var16)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var16_incloseness_w)
sd(var16_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var16_outcloseness_w)
sd(var16_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var16_totalcloseness_w)
sd(var16_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$var16_closeness_stats_w <- closeness(var16, vids = V(var16), mode = "all", weights =E(var16)$weight, normalized = FALSE)
var16_closeness_stats_w <- closeness(var16, vids = V(var16), mode = "all", weights =E(var16)$weight, normalized = FALSE)
```
...
var16_outcloseness_w<- closeness(var16, mode = "out", normalized = T, weights=E(var16)$weight) %>% round(6)
var16_totalcloseness_w<- closeness(var16, mode = "total", normalized = T, weights=E(var16)$weight) %>% round(6)
var16_closeness_stats_w <- closeness(var16, vids = V(var16), mode = "all", weights=E(var16)$weight, normalized = FALSE) %>% round(6)
...
var16_incloseness_w,
var16_outcloseness_w,
var16_totalcloseness_w,
var16_closeness_stats_w,
...
#Adding names
names(var16_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var16_df_closseness<-var16_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var16)$var16_color_degree<-round(V(var16)$totalcloseness,4)
...
plot(var16, 
     ...
     vertex.color=V(var16)$vertex_var16_color_degree,
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=closeness(var16)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var16))/80,
     edge.width=(edge.betweenness(var16, weights =E(var16)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var16, mode="in")), 
     median(closeness(var16, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var16)$var16_color_degree<-round(V(var16)$var16_centr_closeness,2)
...
plot(var16, 
     ...
     vertex.color=V(var16)$vertex_var16_color_degree,
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=centralization.closeness(var16)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var16, mode="in")), 
     median(closeness(var16, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$var16_betweenness_w <- betweenness(var16, weights=E(var16)$weight) %>% round(1)
var16_betweenness_w <- betweenness(var16, weights=E(var16)$weight) %>% round(1)
```
##Betweenness Centrality Weighted - (Vertex) - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var16_betweenness_w)
sd(var16_betweenness_w)
```
#2.8.3 Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$var16_centr_betweenness <- centralization.betweenness(var16)$res
var16_centr_betweenness <- centralization.betweenness(var16)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var16_centr_betweenness$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var16_centr_betweenness$theoretical_max
```
...
var16_betweenness <- betweenness(var16) %>% round(1)
var16_betweenness_w <- betweenness(var16, weights=E(var16)$weight) %>% round(1)
var16_centr_betweenness <- centralization.betweenness(var16)$res %>% round(1)

#Creating a dataframe of measures
var16_df_betweenness <- data.frame(var16_betweenness,
var16_betweenness_w,
var16_centr_betweenness) %>% round(1)

#Adding type
var16_df_betweenness <-cbind(var16_df_betweenness, V(var16)$LABEL_COR)

#Adding names
names(var16_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var16_df_betweenness<-var16_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=betweenness(var16)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var16)+1)/10000,
     edge.width=edge.betweenness(var16, weights =E(var16)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var16)), 
     sd(betweenness(var16))
   ))
```
#2.8.2 Network Plotting Based On Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var16)$var16_centr_betweenness<-(centralization.betweenness(var16)$res)/10000
V(var16)$var16_color_degree<-round(V(var16)$var16_centr_betweenness,1)
...
plot(var16, 
     ...
     vertex.color=V(var16)$vertex_var16_color_degree,
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var16)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centralization.betweenness(var16)$res + 1)/10000,
     edge.width=(edge.betweenness(var16, weights =E(var16)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Centralization Betweenness - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var16)$eigenvector <- eigen_centrality(var16, directed = TRUE, weights =E(var16)$weight) %$% vector %>% round(3)
var16_eigenvector <- eigen_centrality(var16, directed = TRUE, weights = E(var16)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var16_eigenvector_value <- eigen_centrality(var16, directed = TRUE, weights = E(var16)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var16_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$var16_centr_eigen <- centr_eigen(var16, directed = T)$vector
var16_centr_eigen <-centr_eigen(var16, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var16, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var16, directed = T)$theoretical_max
```
...
var16_eigenvector_w <- eigen_centrality(var16, directed = TRUE, weights = E(var16)$weight) %$% vector %>% round(3) 
var16_centr_eigen <-centr_eigen(var16, directed = T)$vector

#Creating a datagrame of measures
var16_df_eigenvector <- data.frame(var16_eigenvector,
var16_eigenvector_w,
var16_centr_eigen) %>% round(3)

#Adding type
var16_df_eigenvector <-cbind(var16_df_eigenvector, V(var16)$LABEL_COR)

#Adding names
names(var16_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var16_df_eigenvector<-var16_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var16_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var16_df_eigenvector, by=list(var16_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var16_df_eigenvector, by=list(var16_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=(eigen_centrality(var16, directed =TRUE, weights = E(var16)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var16)$vector)+1)/10,
     edge.width=edge.betweenness(var16, weights =E(var16)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var16)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var16)$var16_color_degree<-round(centr_eigen(var16, directed = T)$vector,2)
...
plot(var16, 
     ...
     vertex.color=V(var16)$vertex_var16_color_degree,
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=centr_eigen(var16, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var16, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var16, weights =E(var16)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var16, directed = T)$vector), 
     sd(centr_eigen(var16, directed = T)$vector)
   ))
```
...
var16_power_centrality_stats <- power_centrality(var16, nodes = V(var16), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var16)$var16_power_centrality_stats <-power_centrality(var16, nodes = V(var16), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var16)$LABEL_COR, var16_power_centrality_stats))
...
V(var16)$var16_power_centrality_stats_r<-round(V(var16)$var16_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var16)$var16_power_centrality_stats_r)), "Blues"))(length(unique(V(var16)$var16_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var16)$color_spower <- vertex_col_spower[factor(V(var16)$var16_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.color=V(var16)$color_spower, 
     vertex.label=V(var16)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var16)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var16)+1)^2)/10,
     edge.width=edge.betweenness(var16, weights =E(var16)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var16)$var16_power_centrality_stats_r
b<-V(var16)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var16_power_centrality_stats),sd(var16_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var16_alpha_centrality_stats <- alpha_centrality(var16, loops = FALSE, alpha = 1, exo = 1, weights=E(var16)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var16)$var16_alpha_centrality_stats<-alpha_centrality(var16, loops = FALSE, alpha = 1, exo = 1, weights=E(var16)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var16)$LABEL_COR, round(var16_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var16)$var16_alpha_centrality_stats_r<-round(V(var16)$var16_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var16)$var16_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var16)$var16_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var16)$color_s <- vertex_col_s[factor(V(var16)$var16_alpha_centrality_stats_r)]  
```
...
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.color=V(var16)$color_s, 
     vertex.label=V(var16)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var16, loops = FALSE, alpha = 1, exo = 1, weights=E(var16)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var16))^2)/50,
     edge.width=edge.betweenness(var16, weights =E(var16)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var16)$var16_alpha_centrality_stats_r
b<-V(var16)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var16_alpha_centrality_stats),sd(var16_alpha_centrality_stats)
     ))
```
...
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=10*hub.score(var16)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var16)+1)/10,
     edge.width=edge.betweenness(var16, weights =E(var16)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=10*authority.score(var16)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var16)+1)/20,
     edge.width=log(edge.betweenness(var16, weights =E(var16)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var16, 
     layout=layout.kamada.kawai(var16), 
     vertex.label=get.vertex.attribute(var16,"LABEL_COR"),
     vertex.size=200*page.rank(var16)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var16)+1)/15,
     edge.width=log(edge.betweenness(var16, weights =E(var16)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var16<-make_ego_graph(var16, order=1, V(var16)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var16, 
     layout=layout.kamada.kawai(make_ego_graph_all_var16), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var16,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var16)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var16)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var16))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var16)$LABEL_COR
b<-V(make_ego_graph_all_var16)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var16)$vector),
     sd(page.rank(make_ego_graph_all_var16)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var16<-make_ego_graph(var16, order=1, V(var16)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var16, 
     layout=layout.kamada.kawai(make_ego_graph_out_var16), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var16,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var16)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var16)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var16))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var16)$LABEL_COR
b<-V(make_ego_graph_out_var16)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var16)$vector),
     sd(page.rank(make_ego_graph_out_var16)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var16<-make_ego_graph(var16, order=1, V(var16)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var16, 
     layout=layout.kamada.kawai(make_ego_graph_in_var16), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var16,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var16)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var16))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var16))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var16)$LABEL_COR
b<-V(make_ego_graph_in_var16)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var16)$vector),
     sd(page.rank(make_ego_graph_in_var16)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var16_without_CAPSAD<-delete_vertices(make_ego_graph_all_var16,V(make_ego_graph_all_var16)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var16_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var16_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var16_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var16_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var16_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var16_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var16_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var16_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var16_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var16_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var16_without_complex<-
  delete_vertices(make_ego_graph_all_var16,
                  c(V(make_ego_graph_all_var16)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var16)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var16_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var16_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var16_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var16_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var16_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var16_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var16_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var16_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var16_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var16_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var16, 
     layout=layout.kamada.kawai(msp_var16), 
     vertex.label=get.vertex.attribute(msp_var16,"LABEL_COR"),
     vertex.size=degree(msp_var16)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var16)/50,
     edge.width=log(edge.betweenness(msp_var16, weights =E(msp_var16)$msp_var16))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var16, 
     layout=layout.auto(msp_var16), 
     vertex.label=get.vertex.attribute(msp_var16,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var16)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var16))/50,
     edge.width=log(edge.betweenness(msp_var16, weights=E(msp_var16)$msp_var16))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var16, mode="in")), 
     median(degree(msp_var16, mode="out"))
...
msp_var16_w<-minimum.spanning.tree(var16, weights=1/edge.betweenness(var16, weights =E(var16)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var16_w, 
     layout=layout.auto(msp_var16_w), 
     vertex.label=get.vertex.attribute(msp_var16_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var16_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var16_w))/20,
     edge.width=1/edge.betweenness(msp_var16_w, weights =E(msp_var16_w)$msp_var16_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var16)$mut/ecount(var16) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var16_sp_in <- shortest.paths(var16, mode='in', weights=E(var16)$weight) # sames as bellow
var16_sp_out <- shortest.paths(var16, mode='out', weights=E(var16)$weight) #same as above
var16_sp_all <- shortest.paths(var16, mode='all', weights=E(var16)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var16<-distances(var16, mode="all", weights=E(var16)$weight)
#distances_sp_all_var16

#In shortest paths 
distances_sp_in_var16<-distances(var16, mode="in",weights=E(var16)$weight)
#distances_sp_in_var16

#Out shortest paths 
distances_sp_out_var16<-distances(var16, mode="out", weights=E(var16)$weight)
#distances_sp_out_var16
```
...
var16_dist.from.CAPSAD <- distances(var16, v=V(var16)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var16), weights=E(var16)$weight)
...
plot(var16, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var16)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var16))/10,
     edge.width=edge.betweenness(var16, weights=E(var16)$var16)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var16, weights=E(var16)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var16, weights=E(var16)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var16, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$transitivity_local_w<-transitivity(var16, type="barrat") 
transitivity_local_w<-transitivity(var16, weights=E(var16)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var16_u <- as.undirected(var16, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var16_u_size<-sapply(cliques(var16_u), length) # too intesive calculation
```
...
as.undirected_var16_u<-as.undirected(var16_u)
...
V(as.undirected_var16_u)$vcol<-vcol

#Saving labels to display as legend
V(as.undirected_var16_u)$vcollabel[V(as.undirected_var16_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var16_u)$vcollabel [V(as.undirected_var16_u)$vcol=="grey80"]<-"Others"
```

#Plotting based only on degree measures 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(as.undirected(var16_u), 
     layout=layout.kamada.kawai(as.undirected(var16_u)), 
     vertex.label=get.vertex.attribute(as.undirected(var16_u),"LABEL_COR"),
     vertex.color=vcol,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(as.undirected(var16_u))),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var16_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var16_u), weights =E(as.undirected(var16_u))$var16))/50,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(as.undirected_var16_u)$vcollabel
b<-V(as.undirected_var16_u)$vcol
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Coreness Colored Graph - 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var16)$edge.btweenness<-edge.betweenness(var16, weights =E(var16)$weight)
var16_edge.betweenness <-edge.betweenness(var16, weights =E(var16)$weight)
```
...
plot(var16, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var16_edge.betweenness.community),
                      var16_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var16)+1)/10,
     edge.width=log(edge.betweenness(var16, weights =E(var16)$weight))/5,
     edge.curved = TRUE
     )
...
var16_walktrap.community <- walktrap.community(var16)
```

#3.11.1 Network Dendograma
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var16 <- as.dendrogram(var16_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var16, main = "Dendrograma var16", nodePar=list(pch=c(NA, 20)))
```

#3.11.2 Saving Random walk community
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var16)$walktrap.community <- membership(var16_walktrap.community)
var16_walktrap.community <- membership(var16_walktrap.community)
```
...
plot(var16, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var16)),
     mark.groups = by(seq_along(var16_walktrap.community),
                      var16_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var16)+1)/10,
     edge.width=log(edge.betweenness(var16, weights =E(var16)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var16 <- decompose.graph(var16)
sapply(comps_var16, diameter)
table(sapply(comps_var16, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var161<-comps_var16[[1]]
#comps_var162<-comps_var16[[2]]
#comps_var163<-comps_var16[[3]]
#comps_var164<-comps_var16[[4]]
#comps_var165<-comps_var16[[5]]
#comps_var166<-comps_var16[[6]]
#comps_var167<-comps_var16[[7]]
#comps_var168<-comps_var16[[8]]
#...
```
...
plot(comps_var161, 
     layout=layout.kamada.kawai(comps_var161), 
     vertex.label=get.vertex.attribute(comps_var161,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var161)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var161)+1)/10,
     edge.width=log(edge.betweenness(comps_var161, weights=E(comps_var161)$comps_var161))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var161)$LABEL_COR
b<-V(comps_var161)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var161, mode="in")), 
     median(degree(comps_var161, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var16)$optimal_comm_var16 <- #membership(optimal.community(var16))
#optimal_comm_var16 <- membership(optimal.community(var16))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var16)
var16_dim<-get.diameter(var16)
var16_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var16, weights=E(var16)$weight)
var16_dim<-get.diameter(var16, weights=E(var16)$weight)
var16_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var16)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 18.CENTRALIDADE_CONFIANÇA A) Confia na qualificação profissional da equipe deste serviço.(var16)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
