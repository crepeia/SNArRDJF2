---
title: "SNA Centralities 27.CENTRALIDADE_ATIVIDADE"
...
```
#1. Descriptive Analysis for 27.CENTRALIDADE_ATIVIDADE
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(atividade, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(atividade)/10, main="Histogram of Indegree Nodes - 27.CENTRALIDADE_ATIVIDADE")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(atividade, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(atividade)/10, main="Histogram of Outdegree Nodes - 27.CENTRALIDADE_ATIVIDADE")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(atividade, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(atividade)/10, main="Histogram of All Degree Nodes - 27.CENTRALIDADE_ATIVIDADE")
```  
...
#Histogram atividade degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(atividade, weights=E(atividade)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(atividade)/10, main="Histogram of Strength Degree Nodes - 27.CENTRALIDADE_ATIVIDADE")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(atividade, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(atividade)/10, main="Histogram of Normalized Indegree Nodes - 27.CENTRALIDADE_ATIVIDADE")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(atividade, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(atividade)/10, main="Histogram of Normalized Outdegree Nodes - 27.CENTRALIDADE_ATIVIDADE")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(atividade, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(atividade)/10, main="Histogram of Normalized All Degree Nodes - 27.CENTRALIDADE_ATIVIDADE")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(atividade), breaks=vcount(atividade)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 27.CENTRALIDADE_ATIVIDADE")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 27.CENTRALIDADE_ATIVIDADE ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 27.CENTRALIDADE_ATIVIDADE"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 27.CENTRALIDADE_ATIVIDADE)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(atividade)$atividade_a.nn.deg <- graph.knn(atividade,V(atividade))$knn
```
...
plot(degree(atividade), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 27.CENTRALIDADE_ATIVIDADE"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 27.CENTRALIDADE_ATIVIDADE)

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for atividade)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(atividade), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 27.CENTRALIDADE_ATIVIDADE"
     )
```
...
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=degree(atividade)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(atividade)/10000,
     vertex.label.cex=degree(atividade)/500,
     edge.width=(edge.betweenness(atividade, weights=V(atividade)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ", cex = .5)
...
plot(atividade, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(atividade))/800,
     edge.width=(edge.betweenness(atividade, weights =E(atividade)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
...
plot(small_atividade, 
     layout=layout.kamada.kawai(small_atividade), 
     vertex.label=get.vertex.attribute(small_atividade,"LABEL_COR"),
     vertex.size=degree(small_atividade)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_atividade)+1)/10,
     edge.width=(edge.betweenness(small_atividade))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_atividade, mode="in")), 
     median(degree(small_atividade, mode="out"))
   )
  )
```
...
plot(small_atividade, 
     layout=layout.kamada.kawai(small_atividade), 
     vertex.label=get.vertex.attribute(small_atividade,"LABEL_COR"),
     vertex.size=degree(small_atividade)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_atividade)+2)/5,
     edge.width=(edge.betweenness(small_atividade)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_atividade, mode="in")), 
     median(degree(small_atividade, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #atividade_a.nn.deg_w 
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=(graph.knn(atividade,V(atividade))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(atividade,V(atividade))$knn+1)/30,
     edge.width=(edge.betweenness(atividade, weights =E(atividade)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(atividade,V(atividade))$knn)
   ))
```
...
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(atividade,V(atividade), weights= E(atividade)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(atividade,V(atividade), weights= E(atividade)$weight)$knn+1)/10,
     edge.width=edge.betweenness(atividade, weights =E(atividade)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(atividade,V(atividade), weights= E(atividade)$weight)$knn)
   ))
```
...
V(atividade)$totalcloseness <- closeness(atividade, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(atividade)$incloseness_n <- closeness(atividade, mode = "in", normalized = T) %>% round(6)
V(atividade)$outcloseness_n <- closeness(atividade, mode = "out", normalized = T) %>% round(6)
V(atividade)$totalcloseness_n <- closeness(atividade, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
atividade_incloseness_n<- closeness(atividade, mode = "in", normalized = T) %>% round(6)
atividade_outcloseness_n<- closeness(atividade, mode = "out", normalized = T) %>% round(6)
atividade_totalcloseness_n<- closeness(atividade, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(atividade)$incloseness_w <- closeness(atividade, mode = "in", normalized = T, weights=E(atividade)$weight) %>% round(6)
V(atividade)$outcloseness_w <- closeness(atividade, mode = "out", normalized = T,weights=E(atividade)$weight) %>% round(6)
V(atividade)$totalcloseness_w <- closeness(atividade, mode = "total", normalized = T, weights=E(atividade)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
atividade_incloseness_w<- closeness(atividade, mode = "in", normalized = T, weights=E(atividade)$weight) %>% round(6)
atividade_outcloseness_w<- closeness(atividade, mode = "out", normalized = T, weights=E(atividade)$weight) %>% round(6)
atividade_totalcloseness_w<- closeness(atividade, mode = "total", normalized = T, weights=E(atividade)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(atividade_incloseness_w)
sd(atividade_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(atividade_outcloseness_w)
sd(atividade_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(atividade_totalcloseness_w)
sd(atividade_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(atividade)$atividade_closeness_stats_w <- closeness(atividade, vids = V(atividade), mode = "all", weights =E(atividade)$weight, normalized = FALSE)
atividade_closeness_stats_w <- closeness(atividade, vids = V(atividade), mode = "all", weights =E(atividade)$weight, normalized = FALSE)
```
...
atividade_outcloseness_w<- closeness(atividade, mode = "out", normalized = T, weights=E(atividade)$weight) %>% round(6)
atividade_totalcloseness_w<- closeness(atividade, mode = "total", normalized = T, weights=E(atividade)$weight) %>% round(6)
atividade_closeness_stats_w <- closeness(atividade, vids = V(atividade), mode = "all", weights=E(atividade)$weight, normalized = FALSE) %>% round(6)
...
atividade_incloseness_w,
atividade_outcloseness_w,
atividade_totalcloseness_w,
atividade_closeness_stats_w,
...
#Adding names
names(atividade_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
atividade_df_closseness<-atividade_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(atividade)$atividade_color_degree<-round(V(atividade)$totalcloseness,4)
...
plot(atividade, 
     ...
     vertex.color=V(atividade)$vertex_atividade_color_degree,
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=closeness(atividade)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(atividade))/80,
     edge.width=(edge.betweenness(atividade, weights =E(atividade)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(atividade, mode="in")), 
     median(closeness(atividade, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(atividade)$atividade_color_degree<-round(V(atividade)$atividade_centr_closeness,2)
...
plot(atividade, 
     ...
     vertex.color=V(atividade)$vertex_atividade_color_degree,
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=centralization.closeness(atividade)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(atividade, mode="in")), 
     median(closeness(atividade, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(atividade)$atividade_betweenness_w <- betweenness(atividade, weights=E(atividade)$weight) %>% round(1)
atividade_betweenness_w <- betweenness(atividade, weights=E(atividade)$weight) %>% round(1)
```
...
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=betweenness(atividade)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(atividade)+1)/10000,
     edge.width=edge.betweenness(atividade, weights =E(atividade)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(atividade)), 
     sd(betweenness(atividade))
   ))
```
#2.8.2 Network Plotting Based On Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(atividade)$atividade_centr_betweenness<-(centralization.betweenness(atividade)$res)/10000
...
plot(atividade, 
     ...
     vertex.color=V(atividade)$vertex_atividade_color_degree,
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=(centralization.betweenness(atividade)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Betweenness - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(atividade)$eigenvector <- eigen_centrality(atividade, directed = TRUE, weights =E(atividade)$weight) %$% vector %>% round(3)
atividade_eigenvector <- eigen_centrality(atividade, directed = TRUE, weights = E(atividade)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
atividade_eigenvector_value <- eigen_centrality(atividade, directed = TRUE, weights = E(atividade)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=(eigen_centrality(atividade, directed =TRUE, weights = E(atividade)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(atividade)$vector)+1)/10,
     edge.width=edge.betweenness(atividade, weights =E(atividade)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(atividade)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(atividade)$atividade_color_degree<-round(centr_eigen(atividade, directed = T)$vector,2)
...
plot(atividade, 
     ...
     vertex.color=V(atividade)$vertex_atividade_color_degree,
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=centr_eigen(atividade, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(atividade, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(atividade, weights =E(atividade)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(atividade, directed = T)$vector), 
     sd(centr_eigen(atividade, directed = T)$vector)
   ))
```
...
atividade_power_centrality_stats <- power_centrality(atividade, nodes = V(atividade), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(atividade)$atividade_power_centrality_stats <-power_centrality(atividade, nodes = V(atividade), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(atividade)$LABEL_COR, atividade_power_centrality_stats))
...
V(atividade)$atividade_power_centrality_stats_r<-round(V(atividade)$atividade_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(atividade)$atividade_power_centrality_stats_r)), "Blues"))(length(unique(V(atividade)$atividade_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(atividade)$color_spower <- vertex_col_spower[factor(V(atividade)$atividade_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.color=V(atividade)$color_spower, 
     vertex.label=V(atividade)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(atividade)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(atividade)+1)^2)/10,
     edge.width=edge.betweenness(atividade, weights =E(atividade)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(atividade)$atividade_power_centrality_stats_r
b<-V(atividade)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(atividade_power_centrality_stats),sd(atividade_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
atividade_alpha_centrality_stats <- alpha_centrality(atividade, loops = FALSE, alpha = 1, exo = 1, weights=E(atividade)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(atividade)$atividade_alpha_centrality_stats<-alpha_centrality(atividade, loops = FALSE, alpha = 1, exo = 1, weights=E(atividade)$weight, tol = 1e-07, sparse = TRUE)

#Descriptive 
summary(atividade_alpha_centrality_stats)
sd(atividade_alpha_centrality_stats)
```
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(atividade)$LABEL_COR, round(atividade_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(atividade)$atividade_alpha_centrality_stats_r<-round(V(atividade)$atividade_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(atividade)$atividade_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(atividade)$atividade_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(atividade)$color_s <- vertex_col_s[factor(V(atividade)$atividade_alpha_centrality_stats_r)]  
```
...
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.color=V(atividade)$color_s, 
     vertex.label=V(atividade)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(atividade, loops = FALSE, alpha = 1, exo = 1, weights=E(atividade)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(atividade))^2)/50,
     edge.width=edge.betweenness(atividade, weights =E(atividade)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(atividade)$atividade_alpha_centrality_stats_r
b<-V(atividade)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(atividade_alpha_centrality_stats),sd(atividade_alpha_centrality_stats)
     ))
```
...
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=10*hub.score(atividade)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(atividade)+1)/10,
     edge.width=edge.betweenness(atividade, weights =E(atividade)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=10*authority.score(atividade)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(atividade)+1)/20,
     edge.width=log(edge.betweenness(atividade, weights =E(atividade)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(atividade, 
     layout=layout.kamada.kawai(atividade), 
     vertex.label=get.vertex.attribute(atividade,"LABEL_COR"),
     vertex.size=200*page.rank(atividade)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(atividade)+1)/15,
     edge.width=log(edge.betweenness(atividade, weights =E(atividade)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 27.CENTRALIDADE_ATIVIDADE", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_atividade<-make_ego_graph(atividade, order=1, V(atividade)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_atividade, 
     layout=layout.kamada.kawai(make_ego_graph_all_atividade), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_atividade,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_atividade)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_atividade)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_atividade))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_atividade)$LABEL_COR
b<-V(make_ego_graph_all_atividade)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_atividade)$vector),
     sd(page.rank(make_ego_graph_all_atividade)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_atividade<-make_ego_graph(atividade, order=1, V(atividade)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_atividade, 
     layout=layout.kamada.kawai(make_ego_graph_out_atividade), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_atividade,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_atividade)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_atividade)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_atividade))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_atividade)$LABEL_COR
b<-V(make_ego_graph_out_atividade)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_atividade)$vector),
     sd(page.rank(make_ego_graph_out_atividade)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_atividade<-make_ego_graph(atividade, order=1, V(atividade)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_atividade, 
     layout=layout.kamada.kawai(make_ego_graph_in_atividade), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_atividade,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_atividade)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_atividade))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_atividade))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_atividade)$LABEL_COR
b<-V(make_ego_graph_in_atividade)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_atividade)$vector),
     sd(page.rank(make_ego_graph_in_atividade)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_atividade_without_CAPSAD<-delete_vertices(make_ego_graph_all_atividade,V(make_ego_graph_all_atividade)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_atividade_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_atividade_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_atividade_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_atividade_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_atividade_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_atividade_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_atividade_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_atividade_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_atividade_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_atividade_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_atividade_without_complex<-
  delete_vertices(make_ego_graph_all_atividade,
                  c(V(make_ego_graph_all_atividade)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_atividade)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_atividade_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_atividade_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_atividade_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_atividade_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_atividade_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_atividade_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_atividade_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_atividade_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_atividade_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_atividade_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_atividade, 
     layout=layout.kamada.kawai(msp_atividade), 
     vertex.label=get.vertex.attribute(msp_atividade,"LABEL_COR"),
     vertex.size=degree(msp_atividade)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_atividade)/50,
     edge.width=log(edge.betweenness(msp_atividade, weights =E(msp_atividade)$msp_atividade))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_atividade, 
     layout=layout.auto(msp_atividade), 
     vertex.label=get.vertex.attribute(msp_atividade,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_atividade)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_atividade))/50,
     edge.width=log(edge.betweenness(msp_atividade, weights=E(msp_atividade)$msp_atividade))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_atividade, mode="in")), 
     median(degree(msp_atividade, mode="out"))
...
msp_atividade_w<-minimum.spanning.tree(atividade, weights=1/edge.betweenness(atividade, weights =E(atividade)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_atividade_w, 
     layout=layout.auto(msp_atividade_w), 
     vertex.label=get.vertex.attribute(msp_atividade_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_atividade_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_atividade_w))/20,
     edge.width=1/edge.betweenness(msp_atividade_w, weights =E(msp_atividade_w)$msp_atividade_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(atividade)$mut/ecount(atividade) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
atividade_sp_in <- shortest.paths(atividade, mode='in', weights=E(atividade)$weight) # sames as bellow
atividade_sp_out <- shortest.paths(atividade, mode='out', weights=E(atividade)$weight) #same as above
atividade_sp_all <- shortest.paths(atividade, mode='all', weights=E(atividade)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_atividade<-distances(atividade, mode="all", weights=E(atividade)$weight)
#distances_sp_all_atividade

#In shortest paths 
distances_sp_in_atividade<-distances(atividade, mode="in",weights=E(atividade)$weight)
#distances_sp_in_atividade

#Out shortest paths 
distances_sp_out_atividade<-distances(atividade, mode="out", weights=E(atividade)$weight)
#distances_sp_out_atividade
```
...
atividade_dist.from.CAPSAD <- distances(atividade, v=V(atividade)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(atividade), weights=E(atividade)$weight)
...
plot(atividade, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(atividade)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(atividade))/10,
     edge.width=edge.betweenness(atividade, weights=E(atividade)$atividade)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(atividade, weights=E(atividade)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(atividade, weights=E(atividade)$weight,type="weighted")
```
...
transitivity_local<-transitivity(atividade, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(atividade)$transitivity_local_w<-transitivity(atividade, type="barrat") 
transitivity_local_w<-transitivity(atividade, weights=E(atividade)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
atividade_u <- as.undirected(atividade, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_atividade_u_size<-sapply(cliques(atividade_u), length) # too intesive calculation
```
...
as.undirected_atividade_u<-as.undirected(atividade_u)
...
V(as.undirected_atividade_u)$vcol<-vcol

#Saving labels to display as legend
V(as.undirected_atividade_u)$vcollabel[V(as.undirected_atividade_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_atividade_u)$vcollabel [V(as.undirected_atividade_u)$vcol=="grey80"]<-"Others"
```

#Plotting based only on degree measures 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(as.undirected(atividade_u), 
     layout=layout.kamada.kawai(as.undirected(atividade_u)), 
     vertex.label=get.vertex.attribute(as.undirected(atividade_u),"LABEL_COR"),
     vertex.color=vcol,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(as.undirected(atividade_u))),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(atividade_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(atividade_u), weights =E(as.undirected(atividade_u))$atividade))/50,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(as.undirected_atividade_u)$vcollabel
b<-V(as.undirected_atividade_u)$vcol
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
coreness <- graph.coreness(atividade) 
...
#Adding Title
  title("Coreness Colored Graph - 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(atividade)), 
     max(graph.coreness(atividade))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(atividade)$edge.btweenness<-edge.betweenness(atividade, weights =E(atividade)$weight)
atividade_edge.betweenness <-edge.betweenness(atividade, weights =E(atividade)$weight)
```
...
plot(atividade, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(atividade_edge.betweenness.community),
                      atividade_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(atividade)+1)/10,
     edge.width=log(edge.betweenness(atividade, weights =E(atividade)$weight))/5,
     edge.curved = TRUE
     )
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_atividade <- as.dendrogram(atividade_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_atividade, main = "Dendrograma atividade", nodePar=list(pch=c(NA, 20)))
```
...
plot(atividade, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(atividade)),
     mark.groups = by(seq_along(atividade_walktrap.community),
                      atividade_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(atividade)+1)/10,
     edge.width=log(edge.betweenness(atividade, weights =E(atividade)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_atividade <- decompose.graph(atividade)
sapply(comps_atividade, diameter)
table(sapply(comps_atividade, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_atividade1<-comps_atividade[[1]]
#comps_atividade2<-comps_atividade[[2]]
#comps_atividade3<-comps_atividade[[3]]
#comps_atividade4<-comps_atividade[[4]]
#comps_atividade5<-comps_atividade[[5]]
#comps_atividade6<-comps_atividade[[6]]
#comps_atividade7<-comps_atividade[[7]]
#comps_atividade8<-comps_atividade[[8]]
#...
```
...
plot(comps_atividade1, 
     layout=layout.kamada.kawai(comps_atividade1), 
     vertex.label=get.vertex.attribute(comps_atividade1,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_atividade1)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_atividade1)+1)/10,
     edge.width=log(edge.betweenness(comps_atividade1, weights=E(comps_atividade1)$comps_atividade1))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_atividade1)$LABEL_COR
b<-V(comps_atividade1)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_atividade1, mode="in")), 
     median(degree(comps_atividade1, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(atividade)$optimal_comm_atividade <- #membership(optimal.community(atividade))
#optimal_comm_atividade <- membership(optimal.community(atividade))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(atividade)
atividade_dim<-get.diameter(atividade)
atividade_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(atividade, weights=E(atividade)$weight)
atividade_dim<-get.diameter(atividade, weights=E(atividade)$weight)
atividade_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$atividade)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 27.CENTRALIDADE_ATIVIDADE", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
