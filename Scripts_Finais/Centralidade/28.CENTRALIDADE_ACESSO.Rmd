---
title: "SNA Centralities 28.CENTRALIDADE_ACESSO"
...
```
#1. Descriptive Analysis for 28.CENTRALIDADE_ACESSO
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso)/10, main="Histogram of Indegree Nodes - 28.CENTRALIDADE_ACESSO")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso)/10, main="Histogram of Outdegree Nodes - 28.CENTRALIDADE_ACESSO")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso)/10, main="Histogram of All Degree Nodes - 28.CENTRALIDADE_ACESSO")
```  
...
#Histogram acesso degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(acesso, weights=E(acesso)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso)/10, main="Histogram of Strength Degree Nodes - 28.CENTRALIDADE_ACESSO")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso)/10, main="Histogram of Normalized Indegree Nodes - 28.CENTRALIDADE_ACESSO")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso)/10, main="Histogram of Normalized Outdegree Nodes - 28.CENTRALIDADE_ACESSO")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso)/10, main="Histogram of Normalized All Degree Nodes - 28.CENTRALIDADE_ACESSO")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(acesso), breaks=vcount(acesso)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 28.CENTRALIDADE_ACESSO")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 28.CENTRALIDADE_ACESSO ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 28.CENTRALIDADE_ACESSO"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 28.CENTRALIDADE_ACESSO)
...
plot(degree(acesso), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 28.CENTRALIDADE_ACESSO"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 28.CENTRALIDADE_ACESSO)
...
plot(degree(acesso), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 28.CENTRALIDADE_ACESSO"
     )
```
...
#Adding Title
  title("Network Vertex Degree Sized - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ", cex = .5)
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
...
#Adding Title
  title("Network Higher Than Median Degree - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Network Lower than Median Degree - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_acesso, mode="in")), 
     median(degree(small_acesso, mode="out"))
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Centralization Closeness - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(acesso, mode="in")), 
     median(closeness(acesso, mode="out"))
...
#Adding Title
  title("Network Vertex Betweenness Sized - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Centralization Betweenness - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Eigenvector Centrality Measure - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network EigenVector - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Hub Sized - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Authorities Scores  Sized - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Network Google Page Rank Sized - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 28.CENTRALIDADE_ACESSO", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_acesso, mode="in")), 
     median(degree(msp_acesso, mode="out"))
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Distance from CAPS AD - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Adding Title
  title("Coreness Colored Graph - 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
#Adding Title
  title("Diameter of 28.CENTRALIDADE_ACESSO", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
