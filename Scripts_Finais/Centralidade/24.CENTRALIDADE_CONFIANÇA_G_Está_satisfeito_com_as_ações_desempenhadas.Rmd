---
title: "SNA Centralities 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22)."
...
```
#1. Descriptive Analysis for 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var22, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var22)/10, main="Histogram of Indegree Nodes - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var22, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var22)/10, main="Histogram of Outdegree Nodes - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var22, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var22)/10, main="Histogram of All Degree Nodes - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).")
```  
...
#Histogram var22 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var22, weights=E(var22)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var22)/10, main="Histogram of Strength Degree Nodes - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var22, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var22)/10, main="Histogram of Normalized Indegree Nodes - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var22, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var22)/10, main="Histogram of Normalized Outdegree Nodes - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var22, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var22)/10, main="Histogram of Normalized All Degree Nodes - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var22), breaks=vcount(var22)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22). ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22)."
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var22)$var22_a.nn.deg <- graph.knn(var22,V(var22))$knn
```
...
plot(degree(var22), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22)."
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).)
...
plot(degree(var22), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22)."
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var22, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var22, 
     ...
     edge.width=(edge.betweenness(var22, weights=V(var22)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ", cex = .5)
...
plot(var22, 
     ...
     edge.width=(edge.betweenness(var22, weights =E(var22)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
...
plot(small_var22, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var22)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var22, 
     ...
     vertex.label.cex=log(degree(small_var22)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var22, mode="in")), 
     median(degree(small_var22, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var22_a.nn.deg_w 
plot(var22, 
     layout=layout.kamada.kawai(var22), 
     vertex.label=get.vertex.attribute(var22,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var22,V(var22))$knn+1)/30,
     edge.width=(edge.betweenness(var22, weights =E(var22)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var22, 
     layout=layout.kamada.kawai(var22), 
     vertex.label=get.vertex.attribute(var22,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var22,V(var22), weights= E(var22)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var22,V(var22), weights= E(var22)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var22, weights =E(var22)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var22,V(var22), weights= E(var22)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var22)$incloseness_w <- closeness(var22, mode = "in", normalized = T, weights=E(var22)$weight) %>% round(6)
V(var22)$outcloseness_w <- closeness(var22, mode = "out", normalized = T,weights=E(var22)$weight) %>% round(6)
V(var22)$totalcloseness_w <- closeness(var22, mode = "total", normalized = T, weights=E(var22)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var22_incloseness_w<- closeness(var22, mode = "in", normalized = T, weights=E(var22)$weight) %>% round(6)
var22_outcloseness_w<- closeness(var22, mode = "out", normalized = T, weights=E(var22)$weight) %>% round(6)
var22_totalcloseness_w<- closeness(var22, mode = "total", normalized = T, weights=E(var22)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var22)$var22_closeness_stats_w <- closeness(var22, vids = V(var22), mode = "all", weights =E(var22)$weight, normalized = FALSE)
var22_closeness_stats_w <- closeness(var22, vids = V(var22), mode = "all", weights =E(var22)$weight, normalized = FALSE)
```
...
var22_outcloseness_w<- closeness(var22, mode = "out", normalized = T, weights=E(var22)$weight) %>% round(6)
var22_totalcloseness_w<- closeness(var22, mode = "total", normalized = T, weights=E(var22)$weight) %>% round(6)
var22_closeness_stats_w <- closeness(var22, vids = V(var22), mode = "all", weights=E(var22)$weight, normalized = FALSE) %>% round(6)
...
var22_incloseness_w,
var22_outcloseness_w,
var22_totalcloseness_w,
var22_closeness_stats_w,
...
#Adding names
names(var22_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var22_df_closseness<-var22_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var22)$var22_color_degree<-round(V(var22)$var22_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var22, mode="in")), 
     median(closeness(var22, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var22)$var22_betweenness_w <- betweenness(var22, weights=E(var22)$weight) %>% round(1)
var22_betweenness_w <- betweenness(var22, weights=E(var22)$weight) %>% round(1)
```
##Betweenness Centrality Weighted - (Vertex) - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var22_betweenness_w)
sd(var22_betweenness_w)
```
#2.8.3 Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var22)$var22_centr_betweenness <- centralization.betweenness(var22)$res
var22_centr_betweenness <- centralization.betweenness(var22)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var22_centr_betweenness$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var22_centr_betweenness$theoretical_max
```
...
var22_betweenness <- betweenness(var22) %>% round(1)
var22_betweenness_w <- betweenness(var22, weights=E(var22)$weight) %>% round(1)
var22_centr_betweenness <- centralization.betweenness(var22)$res %>% round(1)

#Creating a dataframe of measures
var22_df_betweenness <- data.frame(var22_betweenness,
var22_betweenness_w,
var22_centr_betweenness) %>% round(1)

#Adding type
var22_df_betweenness <-cbind(var22_df_betweenness, V(var22)$LABEL_COR)

#Adding names
names(var22_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var22_df_betweenness<-var22_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
# General tabel for Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var22_df_betweenness, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var22_df_betweenness, by=list(var22_df_betweenness$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var22_df_betweenness, by=list(var22_df_betweenness$Type), FUN=sd, na.rm=TRUE) 
...
#Adding Title
  title("Network Vertex Betweenness Sized - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var22)$var22_centr_betweenness<-(centralization.betweenness(var22)$res)/10000
V(var22)$var22_color_degree<-round(V(var22)$var22_centr_betweenness,1)
...
#Adding Title
  title("Network Centralization Betweenness - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var22)$eigenvector <- eigen_centrality(var22, directed = TRUE, weights =E(var22)$weight) %$% vector %>% round(3)
var22_eigenvector <- eigen_centrality(var22, directed = TRUE, weights = E(var22)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var22_eigenvector_value <- eigen_centrality(var22, directed = TRUE, weights = E(var22)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var22)$var22_centr_eigen <- centr_eigen(var22, directed = T)$vector
var22_centr_eigen <-centr_eigen(var22, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var22_eigenvector_w <- eigen_centrality(var22, directed = TRUE, weights = E(var22)$weight) %$% vector %>% round(3) 
var22_centr_eigen <-centr_eigen(var22, directed = T)$vector

#Creating a datagrame of measures
var22_df_eigenvector <- data.frame(var22_eigenvector,
var22_eigenvector_w,
var22_centr_eigen) %>% round(3)

#Adding type
var22_df_eigenvector <-cbind(var22_df_eigenvector, V(var22)$LABEL_COR)

#Adding names
names(var22_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var22_df_eigenvector<-var22_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var22_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var22_df_eigenvector, by=list(var22_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var22_df_eigenvector, by=list(var22_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var22, 
     layout=layout.kamada.kawai(var22), 
     vertex.label=get.vertex.attribute(var22,"LABEL_COR"),
     vertex.size=(eigen_centrality(var22, directed =TRUE, weights = E(var22)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var22)$vector)+1)/10,
     edge.width=edge.betweenness(var22, weights =E(var22)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var22, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var22, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var22, weights =E(var22)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var22, directed = T)$vector), 
     sd(centr_eigen(var22, directed = T)$vector)
   ))
```
...
var22_power_centrality_stats <- power_centrality(var22, nodes = V(var22), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var22)$var22_power_centrality_stats <-power_centrality(var22, nodes = V(var22), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var22)$LABEL_COR, var22_power_centrality_stats))
...
V(var22)$var22_power_centrality_stats_r<-round(V(var22)$var22_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var22)$var22_power_centrality_stats_r)), "Blues"))(length(unique(V(var22)$var22_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var22)$color_spower <- vertex_col_spower[factor(V(var22)$var22_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var22)$var22_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var22_power_centrality_stats),sd(var22_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var22_alpha_centrality_stats <- alpha_centrality(var22, loops = FALSE, alpha = 1, exo = 1, weights=E(var22)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var22)$var22_alpha_centrality_stats<-alpha_centrality(var22, loops = FALSE, alpha = 1, exo = 1, weights=E(var22)$weight, tol = 1e-07, sparse = TRUE)

#Descriptive 
summary(var22_alpha_centrality_stats)
sd(var22_alpha_centrality_stats)
```
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$LABEL_COR, round(var22_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var22)$var22_alpha_centrality_stats_r<-round(V(var22)$var22_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var22)$var22_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var22)$var22_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var22)$color_s <- vertex_col_s[factor(V(var22)$var22_alpha_centrality_stats_r)]  
```
...
plot(var22, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var22, loops = FALSE, alpha = 1, exo = 1, weights=E(var22)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(var22)$var22_alpha_centrality_stats_r
b<-V(var22)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var22_alpha_centrality_stats),sd(var22_alpha_centrality_stats)
     ))
```
...
var22_hub<- hub.score(var22)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$LABEL_COR, var22_hub))
...
plot(var22, 
     layout=layout.kamada.kawai(var22), 
     vertex.label=get.vertex.attribute(var22,"LABEL_COR"),
     vertex.size=10*hub.score(var22)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var22_auth <- authority.score(var22)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$LABEL_COR, var22_auth))
...
plot(var22, 
     layout=layout.kamada.kawai(var22), 
     vertex.label=get.vertex.attribute(var22,"LABEL_COR"),
     vertex.size=10*authority.score(var22)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var22)+1)/20,
     edge.width=log(edge.betweenness(var22, weights =E(var22)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var22_pr<-page.rank(var22)$vector %>% round(4)
```
#Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var22)$LABEL_COR, var22_pr))
...
plot(var22, 
     layout=layout.kamada.kawai(var22), 
     vertex.label=get.vertex.attribute(var22,"LABEL_COR"),
     vertex.size=200*page.rank(var22)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var22)+1)/15,
     edge.width=log(edge.betweenness(var22, weights =E(var22)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_var22, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var22)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var22, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_var22)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var22)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var22, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_var22)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var22_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_var22_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var22_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var22_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var22_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var22_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var22_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_var22, 
     ...
     vertex.size=degree(msp_var22)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var22)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var22, mode="in")), 
     median(degree(msp_var22, mode="out"))
...
msp_var22_w<-minimum.spanning.tree(var22, weights=1/edge.betweenness(var22, weights =E(var22)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var22_w, 
     layout=layout.auto(msp_var22_w), 
     ...
     edge.width=1/edge.betweenness(msp_var22_w, weights =E(msp_var22_w)$msp_var22_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var22_sp_in <- shortest.paths(var22, mode='in', weights=E(var22)$weight) # sames as bellow
var22_sp_out <- shortest.paths(var22, mode='out', weights=E(var22)$weight) #same as above
var22_sp_all <- shortest.paths(var22, mode='all', weights=E(var22)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var22<-distances(var22, mode="all", weights=E(var22)$weight)
#distances_sp_all_var22

#In shortest paths 
distances_sp_in_var22<-distances(var22, mode="in",weights=E(var22)$weight)
#distances_sp_in_var22

#Out shortest paths 
distances_sp_out_var22<-distances(var22, mode="out", weights=E(var22)$weight)
...
var22_dist.from.CAPSAD <- distances(var22, v=V(var22)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var22), weights=E(var22)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var22, weights=E(var22)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var22, weights=E(var22)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(var22, weights=E(var22)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var22_u_size<-sapply(cliques(var22_u), length) # too intesive calculation
```
...
V(as.undirected_var22_u)$vcollabel[V(as.undirected_var22_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var22_u)$vcollabel [V(as.undirected_var22_u)$vcol=="grey80"]<-"Others"
```
...
plot(as.undirected(var22_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var22_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var22_u), weights =E(as.undirected(var22_u))$var22))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Coreness Colored Graph - 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var22)$edge.btweenness<-edge.betweenness(var22, weights =E(var22)$weight)
var22_edge.betweenness <-edge.betweenness(var22, weights =E(var22)$weight)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
labels<-attr(E(var22), "vnames")
edgebt<-cbind(round(var22_edge.betweenness,2),labels)
datatable(edgebt)
```
...
plot(var22, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var22)+1)/10,
     edge.width=log(edge.betweenness(var22, weights =E(var22)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_var221, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var221)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var22, weights=E(var22)$weight)
var22_dim<-get.diameter(var22, weights=E(var22)$weight)
var22_dim
```
...
#Adding Title
  title("Diameter of 24.CENTRALIDADE_CONFIANÇA G) Está satisfeito com as ações desempenhadas por este serviço (var22).", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
