---
title: "SNA Centralities 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)"
...
# 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)
...
```
#1. Descriptive Analysis for 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var10, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var10)/10, main="Histogram of Indegree Nodes - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var10, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var10)/10, main="Histogram of Outdegree Nodes - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var10, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var10)/10, main="Histogram of All Degree Nodes - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)")
```  
...
#Histogram var10 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var10, weights=E(var10)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var10)/10, main="Histogram of Strength Degree Nodes - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var10, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var10)/10, main="Histogram of Normalized Indegree Nodes - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var10, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var10)/10, main="Histogram of Normalized Outdegree Nodes - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var10, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var10)/10, main="Histogram of Normalized All Degree Nodes - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var10), breaks=vcount(var10)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var10)$var10_a.nn.deg <- graph.knn(var10,V(var10))$knn
```
...
plot(degree(var10), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var10)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var10), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var10)$size <- degree(var10)
V(var10)$label <- V(var10)$V5_LABEL_TIPO_NOME
V(var10)$label.cex <- degree(var10)/100
V(var10)$label.color <- "black"

## Just in case if we wanna change colors
#V(var10)$color <- V(var10)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var10)$weight <- E(var10)$weight
E(var10)$width <- E(var10)$weight
E(var10)$color <- "gray"

## Here we can change other edge parameter
#E(var10)[ weight < 0.5 ]$width <- 4
#E(var10)[ weight < 0.5 ]$color <- "green"
#E(var10)$label <- LETTERS[1:10]
#E(var10)$label.cex = seq(1, 2,length.out = 10)
#E(var10)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var10, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=degree(var10)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var10)/10000,
     vertex.label.cex=degree(var10)/500,
     edge.width=(edge.betweenness(var10, weights=V(var10)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ", cex = .5)
...
plot(var10, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var10))/800,
     edge.width=(edge.betweenness(var10, weights =E(var10)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var10, 
     layout=layout.kamada.kawai(small_var10), 
     vertex.label=get.vertex.attribute(small_var10,"LABEL_COR"),
     vertex.size=degree(small_var10)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var10)+1)/10,
     edge.width=(edge.betweenness(small_var10))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var10, mode="in")), 
     median(degree(small_var10, mode="out"))
   )
  )
```
...
plot(small_var10, 
     layout=layout.kamada.kawai(small_var10), 
     vertex.label=get.vertex.attribute(small_var10,"LABEL_COR"),
     vertex.size=degree(small_var10)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var10)+2)/5,
     edge.width=(edge.betweenness(small_var10)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var10, mode="in")), 
     median(degree(small_var10, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var10_a.nn.deg_w 
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=(graph.knn(var10,V(var10))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var10,V(var10))$knn+1)/30,
     edge.width=(edge.betweenness(var10, weights =E(var10)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var10,V(var10))$knn)
   ))
```
...
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var10,V(var10), weights= E(var10)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var10,V(var10), weights= E(var10)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var10, weights =E(var10)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var10,V(var10), weights= E(var10)$weight)$knn)
   ))
```
...
V(var10)$totalcloseness <- closeness(var10, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var10)$incloseness_n <- closeness(var10, mode = "in", normalized = T) %>% round(6)
V(var10)$outcloseness_n <- closeness(var10, mode = "out", normalized = T) %>% round(6)
V(var10)$totalcloseness_n <- closeness(var10, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var10_incloseness_n<- closeness(var10, mode = "in", normalized = T) %>% round(6)
var10_outcloseness_n<- closeness(var10, mode = "out", normalized = T) %>% round(6)
var10_totalcloseness_n<- closeness(var10, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var10)$incloseness_w <- closeness(var10, mode = "in", normalized = T, weights=E(var10)$weight) %>% round(6)
V(var10)$outcloseness_w <- closeness(var10, mode = "out", normalized = T,weights=E(var10)$weight) %>% round(6)
V(var10)$totalcloseness_w <- closeness(var10, mode = "total", normalized = T, weights=E(var10)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var10_incloseness_w<- closeness(var10, mode = "in", normalized = T, weights=E(var10)$weight) %>% round(6)
var10_outcloseness_w<- closeness(var10, mode = "out", normalized = T, weights=E(var10)$weight) %>% round(6)
var10_totalcloseness_w<- closeness(var10, mode = "total", normalized = T, weights=E(var10)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var10_incloseness_w)
sd(var10_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var10_outcloseness_w)
sd(var10_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var10_totalcloseness_w)
sd(var10_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var10)$var10_closeness_stats_w <- closeness(var10, vids = V(var10), mode = "all", weights =E(var10)$weight, normalized = FALSE)
var10_closeness_stats_w <- closeness(var10, vids = V(var10), mode = "all", weights =E(var10)$weight, normalized = FALSE)
```
...
var10_outcloseness_w<- closeness(var10, mode = "out", normalized = T, weights=E(var10)$weight) %>% round(6)
var10_totalcloseness_w<- closeness(var10, mode = "total", normalized = T, weights=E(var10)$weight) %>% round(6)
var10_closeness_stats_w <- closeness(var10, vids = V(var10), mode = "all", weights=E(var10)$weight, normalized = FALSE) %>% round(6)
...
var10_incloseness_w,
var10_outcloseness_w,
var10_totalcloseness_w,
var10_closeness_stats_w,
...
#Adding names
names(var10_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var10_df_closseness<-var10_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var10)$var10_color_degree<-round(V(var10)$totalcloseness,4)
...
plot(var10, 
     ...
     vertex.color=V(var10)$vertex_var10_color_degree,
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=closeness(var10)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var10))/80,
     edge.width=(edge.betweenness(var10, weights =E(var10)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var10, mode="in")), 
     median(closeness(var10, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var10)$var10_color_degree<-round(V(var10)$var10_centr_closeness,2)
...
plot(var10, 
     ...
     vertex.color=V(var10)$vertex_var10_color_degree,
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=centralization.closeness(var10)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var10, mode="in")), 
     median(closeness(var10, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var10)$var10_betweenness_w <- betweenness(var10, weights=E(var10)$weight) %>% round(1)
var10_betweenness_w <- betweenness(var10, weights=E(var10)$weight) %>% round(1)
```
...
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=betweenness(var10)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var10)+1)/10000,
     edge.width=edge.betweenness(var10, weights =E(var10)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var10)), 
     sd(betweenness(var10))
   ))
```
#2.8.2 Network Plotting Based On Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var10)$var10_centr_betweenness<-(centralization.betweenness(var10)$res)/10000
...
plot(var10, 
     ...
     vertex.color=V(var10)$vertex_var10_color_degree,
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var10)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Betweenness - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var10)$eigenvector <- eigen_centrality(var10, directed = TRUE, weights =E(var10)$weight) %$% vector %>% round(3)
var10_eigenvector <- eigen_centrality(var10, directed = TRUE, weights = E(var10)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var10_eigenvector_value <- eigen_centrality(var10, directed = TRUE, weights = E(var10)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=(eigen_centrality(var10, directed =TRUE, weights = E(var10)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Eigenvector Centrality Measure - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var10)$var10_color_degree<-round(centr_eigen(var10, directed = T)$vector,2)
...
#Adding Title
  title("Network EigenVector - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var10_power_centrality_stats <- power_centrality(var10, nodes = V(var10), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var10)$var10_power_centrality_stats <-power_centrality(var10, nodes = V(var10), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var10)$LABEL_COR, var10_power_centrality_stats))
...
V(var10)$var10_power_centrality_stats_r<-round(V(var10)$var10_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var10)$var10_power_centrality_stats_r)), "Blues"))(length(unique(V(var10)$var10_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var10)$color_spower <- vertex_col_spower[factor(V(var10)$var10_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.color=V(var10)$color_spower, 
     vertex.label=V(var10)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var10)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var10)+1)^2)/10,
     edge.width=edge.betweenness(var10, weights =E(var10)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var10)$var10_power_centrality_stats_r
b<-V(var10)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var10_power_centrality_stats),sd(var10_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var10_alpha_centrality_stats <- alpha_centrality(var10, loops = FALSE, alpha = 1, exo = 1, weights=E(var10)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var10)$var10_alpha_centrality_stats<-alpha_centrality(var10, loops = FALSE, alpha = 1, exo = 1, weights=E(var10)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var10)$LABEL_COR, round(var10_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var10)$var10_alpha_centrality_stats_r<-round(V(var10)$var10_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var10)$var10_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var10)$var10_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var10)$color_s <- vertex_col_s[factor(V(var10)$var10_alpha_centrality_stats_r)]  
```
...
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.color=V(var10)$color_s, 
     vertex.label=V(var10)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var10, loops = FALSE, alpha = 1, exo = 1, weights=E(var10)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var10))^2)/50,
     edge.width=edge.betweenness(var10, weights =E(var10)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var10)$var10_alpha_centrality_stats_r
b<-V(var10)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var10_alpha_centrality_stats),sd(var10_alpha_centrality_stats)
     ))
```
...
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=10*hub.score(var10)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var10)+1)/10,
     edge.width=edge.betweenness(var10, weights =E(var10)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=10*authority.score(var10)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var10)+1)/20,
     edge.width=log(edge.betweenness(var10, weights =E(var10)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var10, 
     layout=layout.kamada.kawai(var10), 
     vertex.label=get.vertex.attribute(var10,"LABEL_COR"),
     vertex.size=200*page.rank(var10)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var10)+1)/15,
     edge.width=log(edge.betweenness(var10, weights =E(var10)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var10<-make_ego_graph(var10, order=1, V(var10)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var10, 
     layout=layout.kamada.kawai(make_ego_graph_all_var10), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var10,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var10)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var10)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var10))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var10)$LABEL_COR
b<-V(make_ego_graph_all_var10)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var10)$vector),
     sd(page.rank(make_ego_graph_all_var10)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var10<-make_ego_graph(var10, order=1, V(var10)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var10, 
     layout=layout.kamada.kawai(make_ego_graph_out_var10), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var10,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var10)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var10)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var10))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var10)$LABEL_COR
b<-V(make_ego_graph_out_var10)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var10)$vector),
     sd(page.rank(make_ego_graph_out_var10)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var10<-make_ego_graph(var10, order=1, V(var10)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var10, 
     layout=layout.kamada.kawai(make_ego_graph_in_var10), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var10,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var10)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var10))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var10))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var10)$LABEL_COR
b<-V(make_ego_graph_in_var10)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var10)$vector),
     sd(page.rank(make_ego_graph_in_var10)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var10_without_CAPSAD<-delete_vertices(make_ego_graph_all_var10,V(make_ego_graph_all_var10)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var10_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var10_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var10_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var10_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var10_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var10_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var10_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var10_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var10_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var10_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var10_without_complex<-
  delete_vertices(make_ego_graph_all_var10,
                  c(V(make_ego_graph_all_var10)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var10)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var10_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var10_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var10_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var10_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var10_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var10_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var10_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var10_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var10_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var10_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var10, 
     layout=layout.kamada.kawai(msp_var10), 
     vertex.label=get.vertex.attribute(msp_var10,"LABEL_COR"),
     vertex.size=degree(msp_var10)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var10)/50,
     edge.width=log(edge.betweenness(msp_var10, weights =E(msp_var10)$msp_var10))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var10, 
     layout=layout.auto(msp_var10), 
     vertex.label=get.vertex.attribute(msp_var10,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var10)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var10))/50,
     edge.width=log(edge.betweenness(msp_var10, weights=E(msp_var10)$msp_var10))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var10, mode="in")), 
     median(degree(msp_var10, mode="out"))
...
msp_var10_w<-minimum.spanning.tree(var10, weights=1/edge.betweenness(var10, weights =E(var10)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var10_w, 
     layout=layout.auto(msp_var10_w), 
     vertex.label=get.vertex.attribute(msp_var10_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var10_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var10_w))/20,
     edge.width=1/edge.betweenness(msp_var10_w, weights =E(msp_var10_w)$msp_var10_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var10)$mut/ecount(var10) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var10_sp_in <- shortest.paths(var10, mode='in', weights=E(var10)$weight) # sames as bellow
var10_sp_out <- shortest.paths(var10, mode='out', weights=E(var10)$weight) #same as above
var10_sp_all <- shortest.paths(var10, mode='all', weights=E(var10)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var10<-distances(var10, mode="all", weights=E(var10)$weight)
#distances_sp_all_var10

#In shortest paths 
distances_sp_in_var10<-distances(var10, mode="in",weights=E(var10)$weight)
#distances_sp_in_var10

#Out shortest paths 
distances_sp_out_var10<-distances(var10, mode="out", weights=E(var10)$weight)
#distances_sp_out_var10
```
...
var10_dist.from.CAPSAD <- distances(var10, v=V(var10)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var10), weights=E(var10)$weight)
...
plot(var10, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var10)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var10))/10,
     edge.width=edge.betweenness(var10, weights=E(var10)$var10)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var10, weights=E(var10)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var10, weights=E(var10)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var10, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var10)$transitivity_local_w<-transitivity(var10, type="barrat") 
transitivity_local_w<-transitivity(var10, weights=E(var10)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var10_u <- as.undirected(var10, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var10_u_size<-sapply(cliques(var10_u), length) # too intesive calculation
```
...
as.undirected_var10_u<-as.undirected(var10_u)
...
V(as.undirected_var10_u)$vcol<-vcol

#Saving labels to display as legend
V(as.undirected_var10_u)$vcollabel[V(as.undirected_var10_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var10_u)$vcollabel [V(as.undirected_var10_u)$vcol=="grey80"]<-"Others"
```

#Plotting based only on degree measures 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(as.undirected(var10_u), 
     layout=layout.kamada.kawai(as.undirected(var10_u)), 
     vertex.label=get.vertex.attribute(as.undirected(var10_u),"LABEL_COR"),
     vertex.color=vcol,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(as.undirected(var10_u))),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var10_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var10_u), weights =E(as.undirected(var10_u))$var10))/50,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(as.undirected_var10_u)$vcollabel
b<-V(as.undirected_var10_u)$vcol
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Coreness Colored Graph - 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(var10)), 
     max(graph.coreness(var10))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var10)$edge.btweenness<-edge.betweenness(var10, weights =E(var10)$weight)
var10_edge.betweenness <-edge.betweenness(var10, weights =E(var10)$weight)
```
...
plot(var10, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var10_edge.betweenness.community),
                      var10_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var10)+1)/10,
     edge.width=log(edge.betweenness(var10, weights =E(var10)$weight))/5,
     edge.curved = TRUE
     )
...
var10_walktrap.community <- walktrap.community(var10)
```

#3.11.1 Network Dendograma
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var10 <- as.dendrogram(var10_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var10, main = "Dendrograma var10", nodePar=list(pch=c(NA, 20)))
```

#3.11.2 Saving Random walk community
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var10)$walktrap.community <- membership(var10_walktrap.community)
var10_walktrap.community <- membership(var10_walktrap.community)
```
...
plot(var10, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var10)),
     mark.groups = by(seq_along(var10_walktrap.community),
                      var10_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var10)+1)/10,
     edge.width=log(edge.betweenness(var10, weights =E(var10)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var10 <- decompose.graph(var10)
sapply(comps_var10, diameter)
table(sapply(comps_var10, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var101<-comps_var10[[1]]
#comps_var102<-comps_var10[[2]]
#comps_var103<-comps_var10[[3]]
#comps_var104<-comps_var10[[4]]
#comps_var105<-comps_var10[[5]]
#comps_var106<-comps_var10[[6]]
#comps_var107<-comps_var10[[7]]
#comps_var108<-comps_var10[[8]]
#...
```
...
plot(comps_var101, 
     layout=layout.kamada.kawai(comps_var101), 
     vertex.label=get.vertex.attribute(comps_var101,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var101)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var101)+1)/10,
     edge.width=log(edge.betweenness(comps_var101, weights=E(comps_var101)$comps_var101))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var101)$LABEL_COR
b<-V(comps_var101)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var101, mode="in")), 
     median(degree(comps_var101, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var10)$optimal_comm_var10 <- #membership(optimal.community(var10))
#optimal_comm_var10 <- membership(optimal.community(var10))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var10)
var10_dim<-get.diameter(var10)
var10_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var10, weights=E(var10)$weight)
var10_dim<-get.diameter(var10, weights=E(var10)$weight)
var10_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var10)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 12.CENTRALIDADE_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
