---
title: "SNA Centralities 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)"
...
```
#1. Descriptive Analysis for 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var11, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var11)/10, main="Histogram of Indegree Nodes - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var11, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var11)/10, main="Histogram of Outdegree Nodes - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var11, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var11)/10, main="Histogram of All Degree Nodes - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)")
```  
...
#Histogram var11 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var11, weights=E(var11)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var11)/10, main="Histogram of Strength Degree Nodes - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var11, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var11)/10, main="Histogram of Normalized Indegree Nodes - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var11, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var11)/10, main="Histogram of Normalized Outdegree Nodes - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var11, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var11)/10, main="Histogram of Normalized All Degree Nodes - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var11), breaks=vcount(var11)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var11)$var11_a.nn.deg <- graph.knn(var11,V(var11))$knn
```
...
plot(degree(var11), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11))
...
plot(degree(var11), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)"
     )
```
...
plot(var11, 
     ...
     edge.width=(edge.betweenness(var11, weights=V(var11)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ", cex = .5)
...
plot(var11, 
     ...
     edge.width=(edge.betweenness(var11, weights =E(var11)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
...
plot(small_var11, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var11)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var11, 
     ...
     vertex.label.cex=log(degree(small_var11)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var11, mode="in")), 
     median(degree(small_var11, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var11_a.nn.deg_w 
plot(var11, 
     layout=layout.kamada.kawai(var11), 
     vertex.label=get.vertex.attribute(var11,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var11,V(var11))$knn+1)/30,
     edge.width=(edge.betweenness(var11, weights =E(var11)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var11, 
     layout=layout.kamada.kawai(var11), 
     vertex.label=get.vertex.attribute(var11,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var11,V(var11), weights= E(var11)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var11,V(var11), weights= E(var11)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var11, weights =E(var11)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var11,V(var11), weights= E(var11)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var11)$incloseness_w <- closeness(var11, mode = "in", normalized = T, weights=E(var11)$weight) %>% round(6)
V(var11)$outcloseness_w <- closeness(var11, mode = "out", normalized = T,weights=E(var11)$weight) %>% round(6)
V(var11)$totalcloseness_w <- closeness(var11, mode = "total", normalized = T, weights=E(var11)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var11_incloseness_w<- closeness(var11, mode = "in", normalized = T, weights=E(var11)$weight) %>% round(6)
var11_outcloseness_w<- closeness(var11, mode = "out", normalized = T, weights=E(var11)$weight) %>% round(6)
var11_totalcloseness_w<- closeness(var11, mode = "total", normalized = T, weights=E(var11)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var11)$var11_closeness_stats_w <- closeness(var11, vids = V(var11), mode = "all", weights =E(var11)$weight, normalized = FALSE)
var11_closeness_stats_w <- closeness(var11, vids = V(var11), mode = "all", weights =E(var11)$weight, normalized = FALSE)
```
...
var11_outcloseness_w<- closeness(var11, mode = "out", normalized = T, weights=E(var11)$weight) %>% round(6)
var11_totalcloseness_w<- closeness(var11, mode = "total", normalized = T, weights=E(var11)$weight) %>% round(6)
var11_closeness_stats_w <- closeness(var11, vids = V(var11), mode = "all", weights=E(var11)$weight, normalized = FALSE) %>% round(6)
...
var11_incloseness_w,
var11_outcloseness_w,
var11_totalcloseness_w,
var11_closeness_stats_w,
...
#Adding names
names(var11_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var11_df_closseness<-var11_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var11)$var11_color_degree<-round(V(var11)$var11_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var11, mode="in")), 
     median(closeness(var11, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var11)$var11_betweenness_w <- betweenness(var11, weights=E(var11)$weight) %>% round(1)
var11_betweenness_w <- betweenness(var11, weights=E(var11)$weight) %>% round(1)
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var11)$var11_centr_betweenness<-(centralization.betweenness(var11)$res)/10000
...
#Adding Title
  title("Network Centralization Betweenness - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var11)$eigenvector <- eigen_centrality(var11, directed = TRUE, weights =E(var11)$weight) %$% vector %>% round(3)
var11_eigenvector <- eigen_centrality(var11, directed = TRUE, weights = E(var11)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var11_eigenvector_value <- eigen_centrality(var11, directed = TRUE, weights = E(var11)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var11)$var11_centr_eigen <- centr_eigen(var11, directed = T)$vector
var11_centr_eigen <-centr_eigen(var11, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var11_eigenvector_w <- eigen_centrality(var11, directed = TRUE, weights = E(var11)$weight) %$% vector %>% round(3) 
var11_centr_eigen <-centr_eigen(var11, directed = T)$vector

#Creating a datagrame of measures
var11_df_eigenvector <- data.frame(var11_eigenvector,
var11_eigenvector_w,
var11_centr_eigen) %>% round(3)

#Adding type
var11_df_eigenvector <-cbind(var11_df_eigenvector, V(var11)$LABEL_COR)

#Adding names
names(var11_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var11_df_eigenvector<-var11_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var11_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var11_df_eigenvector, by=list(var11_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var11_df_eigenvector, by=list(var11_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var11, 
     layout=layout.kamada.kawai(var11), 
     vertex.label=get.vertex.attribute(var11,"LABEL_COR"),
     vertex.size=(eigen_centrality(var11, directed =TRUE, weights = E(var11)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var11)$vector)+1)/10,
     edge.width=edge.betweenness(var11, weights =E(var11)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var11, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var11, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var11, weights =E(var11)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var11, directed = T)$vector), 
     sd(centr_eigen(var11, directed = T)$vector)
   ))
```
...
var11_power_centrality_stats <- power_centrality(var11, nodes = V(var11), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var11)$var11_power_centrality_stats <-power_centrality(var11, nodes = V(var11), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var11)$LABEL_COR, var11_power_centrality_stats))
...
V(var11)$var11_power_centrality_stats_r<-round(V(var11)$var11_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var11)$var11_power_centrality_stats_r)), "Blues"))(length(unique(V(var11)$var11_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var11)$color_spower <- vertex_col_spower[factor(V(var11)$var11_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var11)$var11_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var11_power_centrality_stats),sd(var11_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var11_alpha_centrality_stats <- alpha_centrality(var11, loops = FALSE, alpha = 1, exo = 1, weights=E(var11)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var11)$var11_alpha_centrality_stats<-alpha_centrality(var11, loops = FALSE, alpha = 1, exo = 1, weights=E(var11)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var11)$LABEL_COR, round(var11_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var11)$var11_alpha_centrality_stats_r<-round(V(var11)$var11_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var11)$var11_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var11)$var11_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var11)$color_s <- vertex_col_s[factor(V(var11)$var11_alpha_centrality_stats_r)]  
```
...
plot(var11, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var11, loops = FALSE, alpha = 1, exo = 1, weights=E(var11)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(var11)$var11_alpha_centrality_stats_r
b<-V(var11)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var11_alpha_centrality_stats),sd(var11_alpha_centrality_stats)
     ))
```
...
plot(var11, 
     layout=layout.kamada.kawai(var11), 
     vertex.label=get.vertex.attribute(var11,"LABEL_COR"),
     vertex.size=10*hub.score(var11)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var11, 
     layout=layout.kamada.kawai(var11), 
     vertex.label=get.vertex.attribute(var11,"LABEL_COR"),
     vertex.size=10*authority.score(var11)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var11)+1)/20,
     edge.width=log(edge.betweenness(var11, weights =E(var11)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var11, 
     layout=layout.kamada.kawai(var11), 
     vertex.label=get.vertex.attribute(var11,"LABEL_COR"),
     vertex.size=200*page.rank(var11)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var11)+1)/15,
     edge.width=log(edge.betweenness(var11, weights =E(var11)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_var11, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var11)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var11, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_var11)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var11)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var11, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_var11)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var11_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_var11_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var11_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var11_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var11_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var11_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var11_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_var11, 
     ...
     vertex.size=degree(msp_var11)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var11)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var11, mode="in")), 
     median(degree(msp_var11, mode="out"))
...
msp_var11_w<-minimum.spanning.tree(var11, weights=1/edge.betweenness(var11, weights =E(var11)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var11_w, 
     layout=layout.auto(msp_var11_w), 
     ...
     edge.width=1/edge.betweenness(msp_var11_w, weights =E(msp_var11_w)$msp_var11_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var11_sp_in <- shortest.paths(var11, mode='in', weights=E(var11)$weight) # sames as bellow
var11_sp_out <- shortest.paths(var11, mode='out', weights=E(var11)$weight) #same as above
var11_sp_all <- shortest.paths(var11, mode='all', weights=E(var11)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var11<-distances(var11, mode="all", weights=E(var11)$weight)
#distances_sp_all_var11

#In shortest paths 
distances_sp_in_var11<-distances(var11, mode="in",weights=E(var11)$weight)
#distances_sp_in_var11

#Out shortest paths 
distances_sp_out_var11<-distances(var11, mode="out", weights=E(var11)$weight)
...
var11_dist.from.CAPSAD <- distances(var11, v=V(var11)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var11), weights=E(var11)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var11, weights=E(var11)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var11, weights=E(var11)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(var11, weights=E(var11)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var11_u_size<-sapply(cliques(var11_u), length) # too intesive calculation
```
...
V(as.undirected_var11_u)$vcollabel[V(as.undirected_var11_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var11_u)$vcollabel [V(as.undirected_var11_u)$vcol=="grey80"]<-"Others"
```
...
plot(as.undirected(var11_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var11_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var11_u), weights =E(as.undirected(var11_u))$var11))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Coreness Colored Graph - 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(var11)), 
     max(graph.coreness(var11))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var11)$edge.btweenness<-edge.betweenness(var11, weights =E(var11)$weight)
var11_edge.betweenness <-edge.betweenness(var11, weights =E(var11)$weight)
```
...
plot(var11, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var11)+1)/10,
     edge.width=log(edge.betweenness(var11, weights =E(var11)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_var111, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var111)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var11, weights=E(var11)$weight)
var11_dim<-get.diameter(var11, weights=E(var11)$weight)
var11_dim
```
...
#Adding Title
  title("Diameter of 13.CENTRALIDADE_ACESSO E) Os canais de comunicação com este serviço são suficientes para realização de ações em conjunto. (var11)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
