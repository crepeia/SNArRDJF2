---
title: "SNA Centralities 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)"
...
# 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)
...
```
#1. Descriptive Analysis for 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var3, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var3)/10, main="Histogram of Indegree Nodes - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var3, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var3)/10, main="Histogram of Outdegree Nodes - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var3, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var3)/10, main="Histogram of All Degree Nodes - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)")
```  
...
#Histogram var3 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var3, weights=E(var3)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var3)/10, main="Histogram of Strength Degree Nodes - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var3, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var3)/10, main="Histogram of Normalized Indegree Nodes - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var3, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var3)/10, main="Histogram of Normalized Outdegree Nodes - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var3, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var3)/10, main="Histogram of Normalized All Degree Nodes - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var3), breaks=vcount(var3)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var3)$var3_a.nn.deg <- graph.knn(var3,V(var3))$knn
```
...
plot(degree(var3), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3))
...
plot(degree(var3), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var3)$size <- degree(var3)
V(var3)$label <- V(var3)$V5_LABEL_TIPO_NOME
V(var3)$label.cex <- degree(var3)/100
V(var3)$label.color <- "black"

## Just in case if we wanna change colors
#V(var3)$color <- V(var3)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var3)$weight <- E(var3)$weight
E(var3)$width <- E(var3)$weight
E(var3)$color <- "gray"

## Here we can change other edge parameter
#E(var3)[ weight < 0.5 ]$width <- 4
#E(var3)[ weight < 0.5 ]$color <- "green"
#E(var3)$label <- LETTERS[1:10]
#E(var3)$label.cex = seq(1, 2,length.out = 10)
#E(var3)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var3, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var3, 
     ...
     edge.width=(edge.betweenness(var3, weights=V(var3)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ", cex = .5)
...
plot(var3, 
     ...
     edge.width=(edge.betweenness(var3, weights =E(var3)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
...
plot(small_var3, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var3)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var3, 
     ...
     vertex.label.cex=log(degree(small_var3)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var3, mode="in")), 
     median(degree(small_var3, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var3_a.nn.deg_w 
plot(var3, 
     layout=layout.kamada.kawai(var3), 
     vertex.label=get.vertex.attribute(var3,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var3,V(var3))$knn+1)/30,
     edge.width=(edge.betweenness(var3, weights =E(var3)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var3, 
     layout=layout.kamada.kawai(var3), 
     vertex.label=get.vertex.attribute(var3,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var3,V(var3), weights= E(var3)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var3,V(var3), weights= E(var3)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var3, weights =E(var3)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var3,V(var3), weights= E(var3)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var3)$incloseness_w <- closeness(var3, mode = "in", normalized = T, weights=E(var3)$weight) %>% round(6)
V(var3)$outcloseness_w <- closeness(var3, mode = "out", normalized = T,weights=E(var3)$weight) %>% round(6)
V(var3)$totalcloseness_w <- closeness(var3, mode = "total", normalized = T, weights=E(var3)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var3_incloseness_w<- closeness(var3, mode = "in", normalized = T, weights=E(var3)$weight) %>% round(6)
var3_outcloseness_w<- closeness(var3, mode = "out", normalized = T, weights=E(var3)$weight) %>% round(6)
var3_totalcloseness_w<- closeness(var3, mode = "total", normalized = T, weights=E(var3)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var3)$var3_closeness_stats_w <- closeness(var3, vids = V(var3), mode = "all", weights =E(var3)$weight, normalized = FALSE)
var3_closeness_stats_w <- closeness(var3, vids = V(var3), mode = "all", weights =E(var3)$weight, normalized = FALSE)
```
...
var3_outcloseness_w<- closeness(var3, mode = "out", normalized = T, weights=E(var3)$weight) %>% round(6)
var3_totalcloseness_w<- closeness(var3, mode = "total", normalized = T, weights=E(var3)$weight) %>% round(6)
var3_closeness_stats_w <- closeness(var3, vids = V(var3), mode = "all", weights=E(var3)$weight, normalized = FALSE) %>% round(6)
...
var3_incloseness_w,
var3_outcloseness_w,
var3_totalcloseness_w,
var3_closeness_stats_w,
...
#Adding names
names(var3_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var3_df_closseness<-var3_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var3)$var3_color_degree<-round(V(var3)$var3_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var3, mode="in")), 
     median(closeness(var3, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var3)$var3_betweenness_w <- betweenness(var3, weights=E(var3)$weight) %>% round(1)
var3_betweenness_w <- betweenness(var3, weights=E(var3)$weight) %>% round(1)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var3)$var3_centr_betweenness <- centralization.betweenness(var3)$res
var3_centr_betweenness <- centralization.betweenness(var3)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var3_betweenness <- betweenness(var3) %>% round(1)
var3_betweenness_w <- betweenness(var3, weights=E(var3)$weight) %>% round(1)
var3_centr_betweenness <- centralization.betweenness(var3)$res %>% round(1)

#Creating a dataframe of measures
var3_df_betweenness <- data.frame(var3_betweenness,
var3_betweenness_w,
var3_centr_betweenness) %>% round(1)

#Adding type
var3_df_betweenness <-cbind(var3_df_betweenness, V(var3)$LABEL_COR)

#Adding names
names(var3_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var3_df_betweenness<-var3_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var3)$var3_centr_betweenness<-(centralization.betweenness(var3)$res)/10000
V(var3)$var3_color_degree<-round(V(var3)$var3_centr_betweenness,1)
...
#Adding Title
  title("Network Centralization Betweenness - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var3)$eigenvector <- eigen_centrality(var3, directed = TRUE, weights =E(var3)$weight) %$% vector %>% round(3)
var3_eigenvector <- eigen_centrality(var3, directed = TRUE, weights = E(var3)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var3_eigenvector_value <- eigen_centrality(var3, directed = TRUE, weights = E(var3)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var3)$var3_centr_eigen <- centr_eigen(var3, directed = T)$vector
var3_centr_eigen <-centr_eigen(var3, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var3_eigenvector_w <- eigen_centrality(var3, directed = TRUE, weights = E(var3)$weight) %$% vector %>% round(3) 
var3_centr_eigen <-centr_eigen(var3, directed = T)$vector

#Creating a datagrame of measures
var3_df_eigenvector <- data.frame(var3_eigenvector,
var3_eigenvector_w,
var3_centr_eigen) %>% round(3)

#Adding type
var3_df_eigenvector <-cbind(var3_df_eigenvector, V(var3)$LABEL_COR)

#Adding names
names(var3_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var3_df_eigenvector<-var3_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var3_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var3_df_eigenvector, by=list(var3_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var3_df_eigenvector, by=list(var3_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var3, 
     layout=layout.kamada.kawai(var3), 
     vertex.label=get.vertex.attribute(var3,"LABEL_COR"),
     vertex.size=(eigen_centrality(var3, directed =TRUE, weights = E(var3)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var3)$vector)+1)/10,
     edge.width=edge.betweenness(var3, weights =E(var3)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var3, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var3, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var3, weights =E(var3)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var3, directed = T)$vector), 
     sd(centr_eigen(var3, directed = T)$vector)
   ))
```
...
var3_power_centrality_stats <- power_centrality(var3, nodes = V(var3), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var3)$var3_power_centrality_stats <-power_centrality(var3, nodes = V(var3), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var3)$LABEL_COR, var3_power_centrality_stats))
...
V(var3)$var3_power_centrality_stats_r<-round(V(var3)$var3_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var3)$var3_power_centrality_stats_r)), "Blues"))(length(unique(V(var3)$var3_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var3)$color_spower <- vertex_col_spower[factor(V(var3)$var3_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var3)$var3_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var3_power_centrality_stats),sd(var3_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var3_alpha_centrality_stats <- alpha_centrality(var3, loops = FALSE, alpha = 1, exo = 1, weights=E(var3)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var3)$var3_alpha_centrality_stats<-alpha_centrality(var3, loops = FALSE, alpha = 1, exo = 1, weights=E(var3)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var3)$LABEL_COR, round(var3_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var3)$var3_alpha_centrality_stats_r<-round(V(var3)$var3_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var3)$var3_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var3)$var3_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var3)$color_s <- vertex_col_s[factor(V(var3)$var3_alpha_centrality_stats_r)]  
```
...
plot(var3, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var3, loops = FALSE, alpha = 1, exo = 1, weights=E(var3)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(var3)$var3_alpha_centrality_stats_r
b<-V(var3)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var3_alpha_centrality_stats),sd(var3_alpha_centrality_stats)
     ))
```
...
plot(var3, 
     layout=layout.kamada.kawai(var3), 
     vertex.label=get.vertex.attribute(var3,"LABEL_COR"),
     vertex.size=10*hub.score(var3)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var3, 
     layout=layout.kamada.kawai(var3), 
     vertex.label=get.vertex.attribute(var3,"LABEL_COR"),
     vertex.size=10*authority.score(var3)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var3)+1)/20,
     edge.width=log(edge.betweenness(var3, weights =E(var3)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var3, 
     layout=layout.kamada.kawai(var3), 
     vertex.label=get.vertex.attribute(var3,"LABEL_COR"),
     vertex.size=200*page.rank(var3)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var3)+1)/15,
     edge.width=log(edge.betweenness(var3, weights =E(var3)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_var3, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var3)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var3, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_var3)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var3)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var3, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_var3)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var3_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_var3_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var3_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var3_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var3_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var3_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var3_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_var3, 
     ...
     vertex.size=degree(msp_var3)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var3)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var3, mode="in")), 
     median(degree(msp_var3, mode="out"))
...
msp_var3_w<-minimum.spanning.tree(var3, weights=1/edge.betweenness(var3, weights =E(var3)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var3_w, 
     layout=layout.auto(msp_var3_w), 
     ...
     edge.width=1/edge.betweenness(msp_var3_w, weights =E(msp_var3_w)$msp_var3_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var3_sp_in <- shortest.paths(var3, mode='in', weights=E(var3)$weight) # sames as bellow
var3_sp_out <- shortest.paths(var3, mode='out', weights=E(var3)$weight) #same as above
var3_sp_all <- shortest.paths(var3, mode='all', weights=E(var3)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var3<-distances(var3, mode="all", weights=E(var3)$weight)
#distances_sp_all_var3

#In shortest paths 
distances_sp_in_var3<-distances(var3, mode="in",weights=E(var3)$weight)
#distances_sp_in_var3

#Out shortest paths 
distances_sp_out_var3<-distances(var3, mode="out", weights=E(var3)$weight)
...
var3_dist.from.CAPSAD <- distances(var3, v=V(var3)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var3), weights=E(var3)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var3, weights=E(var3)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var3, weights=E(var3)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(var3, weights=E(var3)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var3_u_size<-sapply(cliques(var3_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var3)$edge.btweenness<-edge.betweenness(var3, weights =E(var3)$weight)
var3_edge.betweenness <-edge.betweenness(var3, weights =E(var3)$weight)
```
...
plot(var3, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var3)+1)/10,
     edge.width=log(edge.betweenness(var3, weights =E(var3)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_var31, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var31)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var3, weights=E(var3)$weight)
var3_dim<-get.diameter(var3, weights=E(var3)$weight)
var3_dim
```
...
#Adding Title
  title("Diameter of 5.CENTRALIDADE_COORDENAÇÃO CONJUNTA DE CASOS (var3)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
