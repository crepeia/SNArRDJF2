---
title: "SNA Centralities 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)"
...
# 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)
...
```
#1. Descriptive Analysis for 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var8, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var8)/10, main="Histogram of Indegree Nodes - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var8, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var8)/10, main="Histogram of Outdegree Nodes - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var8, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var8)/10, main="Histogram of All Degree Nodes - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)")
```  
...
#Histogram var8 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var8, weights=E(var8)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var8)/10, main="Histogram of Strength Degree Nodes - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var8, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var8)/10, main="Histogram of Normalized Indegree Nodes - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var8, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var8)/10, main="Histogram of Normalized Outdegree Nodes - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var8, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var8)/10, main="Histogram of Normalized All Degree Nodes - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var8), breaks=vcount(var8)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var8)$var8_a.nn.deg <- graph.knn(var8,V(var8))$knn
```
...
plot(degree(var8), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8))
...
plot(degree(var8), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var8)$size <- degree(var8)
V(var8)$label <- V(var8)$V5_LABEL_TIPO_NOME
V(var8)$label.cex <- degree(var8)/100
V(var8)$label.color <- "black"

## Just in case if we wanna change colors
#V(var8)$color <- V(var8)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var8)$weight <- E(var8)$weight
E(var8)$width <- E(var8)$weight
E(var8)$color <- "gray"

## Here we can change other edge parameter
#E(var8)[ weight < 0.5 ]$width <- 4
#E(var8)[ weight < 0.5 ]$color <- "green"
#E(var8)$label <- LETTERS[1:10]
#E(var8)$label.cex = seq(1, 2,length.out = 10)
#E(var8)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var8, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var8, 
     ...
     edge.width=(edge.betweenness(var8, weights=V(var8)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ", cex = .5)
...
plot(var8, 
     ...
     edge.width=(edge.betweenness(var8, weights =E(var8)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
...
plot(small_var8, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var8)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var8, 
     ...
     vertex.label.cex=log(degree(small_var8)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var8, mode="in")), 
     median(degree(small_var8, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var8_a.nn.deg_w 
plot(var8, 
     layout=layout.kamada.kawai(var8), 
     vertex.label=get.vertex.attribute(var8,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var8,V(var8))$knn+1)/30,
     edge.width=(edge.betweenness(var8, weights =E(var8)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var8, 
     layout=layout.kamada.kawai(var8), 
     vertex.label=get.vertex.attribute(var8,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var8,V(var8), weights= E(var8)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var8,V(var8), weights= E(var8)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var8, weights =E(var8)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var8,V(var8), weights= E(var8)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var8)$incloseness_w <- closeness(var8, mode = "in", normalized = T, weights=E(var8)$weight) %>% round(6)
V(var8)$outcloseness_w <- closeness(var8, mode = "out", normalized = T,weights=E(var8)$weight) %>% round(6)
V(var8)$totalcloseness_w <- closeness(var8, mode = "total", normalized = T, weights=E(var8)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var8_incloseness_w<- closeness(var8, mode = "in", normalized = T, weights=E(var8)$weight) %>% round(6)
var8_outcloseness_w<- closeness(var8, mode = "out", normalized = T, weights=E(var8)$weight) %>% round(6)
var8_totalcloseness_w<- closeness(var8, mode = "total", normalized = T, weights=E(var8)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var8)$var8_closeness_stats_w <- closeness(var8, vids = V(var8), mode = "all", weights =E(var8)$weight, normalized = FALSE)
var8_closeness_stats_w <- closeness(var8, vids = V(var8), mode = "all", weights =E(var8)$weight, normalized = FALSE)
```
...
var8_outcloseness_w<- closeness(var8, mode = "out", normalized = T, weights=E(var8)$weight) %>% round(6)
var8_totalcloseness_w<- closeness(var8, mode = "total", normalized = T, weights=E(var8)$weight) %>% round(6)
var8_closeness_stats_w <- closeness(var8, vids = V(var8), mode = "all", weights=E(var8)$weight, normalized = FALSE) %>% round(6)
...
var8_incloseness_w,
var8_outcloseness_w,
var8_totalcloseness_w,
var8_closeness_stats_w,
...
#Adding names
names(var8_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var8_df_closseness<-var8_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var8)$var8_color_degree<-round(V(var8)$var8_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var8, mode="in")), 
     median(closeness(var8, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var8)$var8_betweenness_w <- betweenness(var8, weights=E(var8)$weight) %>% round(1)
var8_betweenness_w <- betweenness(var8, weights=E(var8)$weight) %>% round(1)
```
##Betweenness Centrality Weighted - (Vertex) - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var8_betweenness_w)
sd(var8_betweenness_w)
```
#2.8.3 Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var8)$var8_centr_betweenness <- centralization.betweenness(var8)$res
var8_centr_betweenness <- centralization.betweenness(var8)
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var8_centr_betweenness$centralization
```
#Theoretical Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var8_centr_betweenness$theoretical_max
```
...
var8_betweenness <- betweenness(var8) %>% round(1)
var8_betweenness_w <- betweenness(var8, weights=E(var8)$weight) %>% round(1)
var8_centr_betweenness <- centralization.betweenness(var8)$res %>% round(1)

#Creating a dataframe of measures
var8_df_betweenness <- data.frame(var8_betweenness,
var8_betweenness_w,
var8_centr_betweenness) %>% round(1)

#Adding type
var8_df_betweenness <-cbind(var8_df_betweenness, V(var8)$LABEL_COR)

#Adding names
names(var8_df_betweenness) <- c("Betweenness", "Betweenness Weighted", "Centralization Betweenness","Type")

#Ordering Variables
var8_df_betweenness<-var8_df_betweenness[c("Type","Betweenness", "Betweenness Weighted", "Centralization Betweenness")]
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var8)$var8_centr_betweenness<-(centralization.betweenness(var8)$res)/10000
V(var8)$var8_color_degree<-round(V(var8)$var8_centr_betweenness,1)
...
#Adding Title
  title("Network Centralization Betweenness - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var8)$eigenvector <- eigen_centrality(var8, directed = TRUE, weights =E(var8)$weight) %$% vector %>% round(3)
var8_eigenvector <- eigen_centrality(var8, directed = TRUE, weights = E(var8)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var8_eigenvector_value <- eigen_centrality(var8, directed = TRUE, weights = E(var8)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var8)$var8_centr_eigen <- centr_eigen(var8, directed = T)$vector
var8_centr_eigen <-centr_eigen(var8, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
var8_eigenvector_w <- eigen_centrality(var8, directed = TRUE, weights = E(var8)$weight) %$% vector %>% round(3) 
var8_centr_eigen <-centr_eigen(var8, directed = T)$vector

#Creating a datagrame of measures
var8_df_eigenvector <- data.frame(var8_eigenvector,
var8_eigenvector_w,
var8_centr_eigen) %>% round(3)

#Adding type
var8_df_eigenvector <-cbind(var8_df_eigenvector, V(var8)$LABEL_COR)

#Adding names
names(var8_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var8_df_eigenvector<-var8_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var8_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var8_df_eigenvector, by=list(var8_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var8_df_eigenvector, by=list(var8_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var8, 
     layout=layout.kamada.kawai(var8), 
     vertex.label=get.vertex.attribute(var8,"LABEL_COR"),
     vertex.size=(eigen_centrality(var8, directed =TRUE, weights = E(var8)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var8)$vector)+1)/10,
     edge.width=edge.betweenness(var8, weights =E(var8)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var8, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var8, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var8, weights =E(var8)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var8, directed = T)$vector), 
     sd(centr_eigen(var8, directed = T)$vector)
   ))
```
...
var8_power_centrality_stats <- power_centrality(var8, nodes = V(var8), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var8)$var8_power_centrality_stats <-power_centrality(var8, nodes = V(var8), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var8)$LABEL_COR, var8_power_centrality_stats))
...
V(var8)$var8_power_centrality_stats_r<-round(V(var8)$var8_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var8)$var8_power_centrality_stats_r)), "Blues"))(length(unique(V(var8)$var8_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var8)$color_spower <- vertex_col_spower[factor(V(var8)$var8_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var8)$var8_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var8_power_centrality_stats),sd(var8_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var8_alpha_centrality_stats <- alpha_centrality(var8, loops = FALSE, alpha = 1, exo = 1, weights=E(var8)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var8)$var8_alpha_centrality_stats<-alpha_centrality(var8, loops = FALSE, alpha = 1, exo = 1, weights=E(var8)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var8)$LABEL_COR, round(var8_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var8)$var8_alpha_centrality_stats_r<-round(V(var8)$var8_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var8)$var8_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var8)$var8_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var8)$color_s <- vertex_col_s[factor(V(var8)$var8_alpha_centrality_stats_r)]  
```
...
plot(var8, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var8, loops = FALSE, alpha = 1, exo = 1, weights=E(var8)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(var8)$var8_alpha_centrality_stats_r
b<-V(var8)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var8_alpha_centrality_stats),sd(var8_alpha_centrality_stats)
     ))
```
...
plot(var8, 
     layout=layout.kamada.kawai(var8), 
     vertex.label=get.vertex.attribute(var8,"LABEL_COR"),
     vertex.size=10*hub.score(var8)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var8, 
     layout=layout.kamada.kawai(var8), 
     vertex.label=get.vertex.attribute(var8,"LABEL_COR"),
     vertex.size=10*authority.score(var8)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var8)+1)/20,
     edge.width=log(edge.betweenness(var8, weights =E(var8)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var8, 
     layout=layout.kamada.kawai(var8), 
     vertex.label=get.vertex.attribute(var8,"LABEL_COR"),
     vertex.size=200*page.rank(var8)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var8)+1)/15,
     edge.width=log(edge.betweenness(var8, weights =E(var8)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_var8, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var8)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var8, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_var8)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var8)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var8, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_var8)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var8_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_var8_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var8_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var8_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var8_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var8_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var8_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_var8, 
     ...
     vertex.size=degree(msp_var8)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var8)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var8, mode="in")), 
     median(degree(msp_var8, mode="out"))
...
msp_var8_w<-minimum.spanning.tree(var8, weights=1/edge.betweenness(var8, weights =E(var8)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var8_w, 
     layout=layout.auto(msp_var8_w), 
     ...
     edge.width=1/edge.betweenness(msp_var8_w, weights =E(msp_var8_w)$msp_var8_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var8_sp_in <- shortest.paths(var8, mode='in', weights=E(var8)$weight) # sames as bellow
var8_sp_out <- shortest.paths(var8, mode='out', weights=E(var8)$weight) #same as above
var8_sp_all <- shortest.paths(var8, mode='all', weights=E(var8)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var8<-distances(var8, mode="all", weights=E(var8)$weight)
#distances_sp_all_var8

#In shortest paths 
distances_sp_in_var8<-distances(var8, mode="in",weights=E(var8)$weight)
#distances_sp_in_var8

#Out shortest paths 
distances_sp_out_var8<-distances(var8, mode="out", weights=E(var8)$weight)
...
var8_dist.from.CAPSAD <- distances(var8, v=V(var8)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var8), weights=E(var8)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var8, weights=E(var8)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var8, weights=E(var8)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(var8, weights=E(var8)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var8_u_size<-sapply(cliques(var8_u), length) # too intesive calculation
```
...
V(as.undirected_var8_u)$vcollabel[V(as.undirected_var8_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var8_u)$vcollabel [V(as.undirected_var8_u)$vcol=="grey80"]<-"Others"
```
...
plot(as.undirected(var8_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var8_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var8_u), weights =E(as.undirected(var8_u))$var8))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Coreness Colored Graph - 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var8)$edge.btweenness<-edge.betweenness(var8, weights =E(var8)$weight)
var8_edge.betweenness <-edge.betweenness(var8, weights =E(var8)$weight)
```
...
plot(var8, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var8)+1)/10,
     edge.width=log(edge.betweenness(var8, weights =E(var8)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_var81, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var81)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var8, weights=E(var8)$weight)
var8_dim<-get.diameter(var8, weights=E(var8)$weight)
var8_dim
```
...
#Adding Title
  title("Diameter of 10.CENTRALIDADE_ACESSO B) O horário de funcionamento deste serviço possibilita a realização de ações em conjunto. (var8)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
