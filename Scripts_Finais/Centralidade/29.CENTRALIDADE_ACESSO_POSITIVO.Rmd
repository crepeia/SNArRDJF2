---
title: "SNA Centralities 29.CENTRALIDADE_ACESSO_POSITIVO"
...
# 29.CENTRALIDADE_ACESSO_POSITIVO
...
```
#1. Descriptive Analysis for 29.CENTRALIDADE_ACESSO_POSITIVO
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Indegree Nodes - 29.CENTRALIDADE_ACESSO_POSITIVO")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Outdegree Nodes - 29.CENTRALIDADE_ACESSO_POSITIVO")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of All Degree Nodes - 29.CENTRALIDADE_ACESSO_POSITIVO")
```  
...
#Histogram acesso_positivo degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(acesso_positivo, weights=E(acesso_positivo)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Strength Degree Nodes - 29.CENTRALIDADE_ACESSO_POSITIVO")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Normalized Indegree Nodes - 29.CENTRALIDADE_ACESSO_POSITIVO")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Normalized Outdegree Nodes - 29.CENTRALIDADE_ACESSO_POSITIVO")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Normalized All Degree Nodes - 29.CENTRALIDADE_ACESSO_POSITIVO")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(acesso_positivo), breaks=vcount(acesso_positivo)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 29.CENTRALIDADE_ACESSO_POSITIVO")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 29.CENTRALIDADE_ACESSO_POSITIVO ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 29.CENTRALIDADE_ACESSO_POSITIVO"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 29.CENTRALIDADE_ACESSO_POSITIVO)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acesso_positivo)$acesso_positivo_a.nn.deg <- graph.knn(acesso_positivo,V(acesso_positivo))$knn
```
...
plot(degree(acesso_positivo), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 29.CENTRALIDADE_ACESSO_POSITIVO"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 29.CENTRALIDADE_ACESSO_POSITIVO)
...
plot(degree(acesso_positivo), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 29.CENTRALIDADE_ACESSO_POSITIVO"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(acesso_positivo)$size <- degree(acesso_positivo)
V(acesso_positivo)$label <- V(acesso_positivo)$V5_LABEL_TIPO_NOME
V(acesso_positivo)$label.cex <- degree(acesso_positivo)/100
V(acesso_positivo)$label.color <- "black"

## Just in case if we wanna change colors
#V(acesso_positivo)$color <- V(acesso_positivo)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(acesso_positivo)$weight <- E(acesso_positivo)$weight
E(acesso_positivo)$width <- E(acesso_positivo)$weight
E(acesso_positivo)$color <- "gray"

## Here we can change other edge parameter
#E(acesso_positivo)[ weight < 0.5 ]$width <- 4
#E(acesso_positivo)[ weight < 0.5 ]$color <- "green"
#E(acesso_positivo)$label <- LETTERS[1:10]
#E(acesso_positivo)$label.cex = seq(1, 2,length.out = 10)
#E(acesso_positivo)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(acesso_positivo, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(acesso_positivo, 
     ...
     edge.width=(edge.betweenness(acesso_positivo, weights=V(acesso_positivo)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ", cex = .5)
...
plot(acesso_positivo, 
     ...
     edge.width=(edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
...
plot(small_acesso_positivo, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_acesso_positivo)+1)/10,
...
#Adding Title
  title("Network Higher Than Median Degree - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_acesso_positivo, 
     ...
     vertex.label.cex=log(degree(small_acesso_positivo)+2)/5,
...
#Adding Title
  title("Network Lower than Median Degree - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_acesso_positivo, mode="in")), 
     median(degree(small_acesso_positivo, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #acesso_positivo_a.nn.deg_w 
plot(acesso_positivo, 
     layout=layout.kamada.kawai(acesso_positivo), 
     vertex.label=get.vertex.attribute(acesso_positivo,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(acesso_positivo,V(acesso_positivo))$knn+1)/30,
     edge.width=(edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(acesso_positivo, 
     layout=layout.kamada.kawai(acesso_positivo), 
     vertex.label=get.vertex.attribute(acesso_positivo,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(acesso_positivo,V(acesso_positivo), weights= E(acesso_positivo)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(acesso_positivo,V(acesso_positivo), weights= E(acesso_positivo)$weight)$knn+1)/10,
     edge.width=edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(acesso_positivo,V(acesso_positivo), weights= E(acesso_positivo)$weight)$knn)
   ))
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acesso_positivo)$incloseness_w <- closeness(acesso_positivo, mode = "in", normalized = T, weights=E(acesso_positivo)$weight) %>% round(6)
V(acesso_positivo)$outcloseness_w <- closeness(acesso_positivo, mode = "out", normalized = T,weights=E(acesso_positivo)$weight) %>% round(6)
V(acesso_positivo)$totalcloseness_w <- closeness(acesso_positivo, mode = "total", normalized = T, weights=E(acesso_positivo)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
acesso_positivo_incloseness_w<- closeness(acesso_positivo, mode = "in", normalized = T, weights=E(acesso_positivo)$weight) %>% round(6)
acesso_positivo_outcloseness_w<- closeness(acesso_positivo, mode = "out", normalized = T, weights=E(acesso_positivo)$weight) %>% round(6)
acesso_positivo_totalcloseness_w<- closeness(acesso_positivo, mode = "total", normalized = T, weights=E(acesso_positivo)$weight) %>% round(6)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acesso_positivo)$acesso_positivo_closeness_stats_w <- closeness(acesso_positivo, vids = V(acesso_positivo), mode = "all", weights =E(acesso_positivo)$weight, normalized = FALSE)
acesso_positivo_closeness_stats_w <- closeness(acesso_positivo, vids = V(acesso_positivo), mode = "all", weights =E(acesso_positivo)$weight, normalized = FALSE)
```
...
acesso_positivo_outcloseness_w<- closeness(acesso_positivo, mode = "out", normalized = T, weights=E(acesso_positivo)$weight) %>% round(6)
acesso_positivo_totalcloseness_w<- closeness(acesso_positivo, mode = "total", normalized = T, weights=E(acesso_positivo)$weight) %>% round(6)
acesso_positivo_closeness_stats_w <- closeness(acesso_positivo, vids = V(acesso_positivo), mode = "all", weights=E(acesso_positivo)$weight, normalized = FALSE) %>% round(6)
...
acesso_positivo_incloseness_w,
acesso_positivo_outcloseness_w,
acesso_positivo_totalcloseness_w,
acesso_positivo_closeness_stats_w,
...
#Adding names
names(acesso_positivo_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
acesso_positivo_df_closseness<-acesso_positivo_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(acesso_positivo)$acesso_positivo_color_degree<-round(V(acesso_positivo)$acesso_positivo_centr_closeness,2)
...
#Adding Title
  title("Network Centralization Closeness - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(acesso_positivo, mode="in")), 
     median(closeness(acesso_positivo, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acesso_positivo)$acesso_positivo_betweenness_w <- betweenness(acesso_positivo, weights=E(acesso_positivo)$weight) %>% round(1)
acesso_positivo_betweenness_w <- betweenness(acesso_positivo, weights=E(acesso_positivo)$weight) %>% round(1)
```
...
#Adding Title
  title("Network Vertex Betweenness Sized - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(acesso_positivo)$acesso_positivo_centr_betweenness<-(centralization.betweenness(acesso_positivo)$res)/10000
...
#Adding Title
  title("Network Centralization Betweenness - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(acesso_positivo)$eigenvector <- eigen_centrality(acesso_positivo, directed = TRUE, weights =E(acesso_positivo)$weight) %$% vector %>% round(3)
acesso_positivo_eigenvector <- eigen_centrality(acesso_positivo, directed = TRUE, weights = E(acesso_positivo)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
acesso_positivo_eigenvector_value <- eigen_centrality(acesso_positivo, directed = TRUE, weights = E(acesso_positivo)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(acesso_positivo)$acesso_positivo_centr_eigen <- centr_eigen(acesso_positivo, directed = T)$vector
acesso_positivo_centr_eigen <-centr_eigen(acesso_positivo, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
#Getting  Measures
#Eigen_Centrality 
acesso_positivo_eigenvector <- eigen_centrality(acesso_positivo, directed = TRUE) %$% vector %>% round(3)
acesso_positivo_eigenvector_w <- eigen_centrality(acesso_positivo, directed = TRUE, weights = E(acesso_positivo)$weight) %$% vector %>% round(3) 
acesso_positivo_centr_eigen <-centr_eigen(acesso_positivo, directed = T)$vector

#Creating a datagrame of measures
acesso_positivo_df_eigenvector <- data.frame(acesso_positivo_eigenvector,
acesso_positivo_eigenvector_w,
acesso_positivo_centr_eigen) %>% round(3)

#Adding type
acesso_positivo_df_eigenvector <-cbind(acesso_positivo_df_eigenvector, V(acesso_positivo)$LABEL_COR)

#Adding names
names(acesso_positivo_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
acesso_positivo_df_eigenvector<-acesso_positivo_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(acesso_positivo_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(acesso_positivo_df_eigenvector, by=list(acesso_positivo_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(acesso_positivo_df_eigenvector, by=list(acesso_positivo_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(acesso_positivo, 
     layout=layout.kamada.kawai(acesso_positivo), 
     vertex.label=get.vertex.attribute(acesso_positivo,"LABEL_COR"),
     vertex.size=(eigen_centrality(acesso_positivo, directed =TRUE, weights = E(acesso_positivo)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(acesso_positivo)$vector)+1)/10,
     edge.width=edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(acesso_positivo, 
     ...
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(acesso_positivo, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(acesso_positivo, directed = T)$vector), 
     sd(centr_eigen(acesso_positivo, directed = T)$vector)
   ))
```
...
acesso_positivo_power_centrality_stats <- power_centrality(acesso_positivo, nodes = V(acesso_positivo), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(acesso_positivo)$acesso_positivo_power_centrality_stats <-power_centrality(acesso_positivo, nodes = V(acesso_positivo), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(acesso_positivo)$LABEL_COR, acesso_positivo_power_centrality_stats))
...
V(acesso_positivo)$acesso_positivo_power_centrality_stats_r<-round(V(acesso_positivo)$acesso_positivo_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(acesso_positivo)$acesso_positivo_power_centrality_stats_r)), "Blues"))(length(unique(V(acesso_positivo)$acesso_positivo_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(acesso_positivo)$color_spower <- vertex_col_spower[factor(V(acesso_positivo)$acesso_positivo_power_centrality_stats_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(acesso_positivo)$acesso_positivo_power_centrality_stats_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(acesso_positivo_power_centrality_stats),sd(acesso_positivo_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
acesso_positivo_alpha_centrality_stats <- alpha_centrality(acesso_positivo, loops = FALSE, alpha = 1, exo = 1, weights=E(acesso_positivo)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(acesso_positivo)$acesso_positivo_alpha_centrality_stats<-alpha_centrality(acesso_positivo, loops = FALSE, alpha = 1, exo = 1, weights=E(acesso_positivo)$weight, tol = 1e-07, sparse = TRUE)
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(acesso_positivo)$LABEL_COR, round(acesso_positivo_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(acesso_positivo)$acesso_positivo_alpha_centrality_stats_r<-round(V(acesso_positivo)$acesso_positivo_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(acesso_positivo)$acesso_positivo_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(acesso_positivo)$acesso_positivo_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(acesso_positivo)$color_s <- vertex_col_s[factor(V(acesso_positivo)$acesso_positivo_alpha_centrality_stats_r)]  
```
...
plot(acesso_positivo, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(acesso_positivo, loops = FALSE, alpha = 1, exo = 1, weights=E(acesso_positivo)$weight, tol = 1e-07, sparse = TRUE)^2)), 
...
#Solving Problems with legend rendering 
a<-V(acesso_positivo)$acesso_positivo_alpha_centrality_stats_r
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(acesso_positivo_alpha_centrality_stats),sd(acesso_positivo_alpha_centrality_stats)
     ))
```
...
plot(acesso_positivo, 
     layout=layout.kamada.kawai(acesso_positivo), 
     vertex.label=get.vertex.attribute(acesso_positivo,"LABEL_COR"),
     vertex.size=10*hub.score(acesso_positivo)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
...
#Adding Title
  title("Network Hub Sized - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(acesso_positivo, 
     layout=layout.kamada.kawai(acesso_positivo), 
     vertex.label=get.vertex.attribute(acesso_positivo,"LABEL_COR"),
     vertex.size=10*authority.score(acesso_positivo)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(acesso_positivo)+1)/20,
     edge.width=log(edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(acesso_positivo, 
     layout=layout.kamada.kawai(acesso_positivo), 
     vertex.label=get.vertex.attribute(acesso_positivo,"LABEL_COR"),
     vertex.size=200*page.rank(acesso_positivo)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(acesso_positivo)+1)/15,
     edge.width=log(edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 29.CENTRALIDADE_ACESSO_POSITIVO", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(make_ego_graph_all_acesso_positivo, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_acesso_positivo)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_acesso_positivo, 
     ...
     vertex.size=100*page.rank(make_ego_graph_out_acesso_positivo)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_acesso_positivo)+1)/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_acesso_positivo, 
     ...
     vertex.size=100*page.rank(make_ego_graph_in_acesso_positivo)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_acesso_positivo_without_CAPSAD, 
     ...
     vertex.size=100*page.rank(make_ego_graph_all_acesso_positivo_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_acesso_positivo_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_acesso_positivo_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_acesso_positivo_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_acesso_positivo_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_acesso_positivo_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(msp_acesso_positivo, 
     ...
     vertex.size=degree(msp_acesso_positivo)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_acesso_positivo)/50,
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_acesso_positivo, 
     layout=layout.auto(msp_acesso_positivo), 
     vertex.label=get.vertex.attribute(msp_acesso_positivo,"LABEL_COR"),
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_acesso_positivo, mode="in")), 
     median(degree(msp_acesso_positivo, mode="out"))
...
msp_acesso_positivo_w<-minimum.spanning.tree(acesso_positivo, weights=1/edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_acesso_positivo_w, 
     layout=layout.auto(msp_acesso_positivo_w), 
     ...
     edge.width=1/edge.betweenness(msp_acesso_positivo_w, weights =E(msp_acesso_positivo_w)$msp_acesso_positivo_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
acesso_positivo_sp_in <- shortest.paths(acesso_positivo, mode='in', weights=E(acesso_positivo)$weight) # sames as bellow
acesso_positivo_sp_out <- shortest.paths(acesso_positivo, mode='out', weights=E(acesso_positivo)$weight) #same as above
acesso_positivo_sp_all <- shortest.paths(acesso_positivo, mode='all', weights=E(acesso_positivo)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_acesso_positivo<-distances(acesso_positivo, mode="all", weights=E(acesso_positivo)$weight)
#distances_sp_all_acesso_positivo

#In shortest paths 
distances_sp_in_acesso_positivo<-distances(acesso_positivo, mode="in",weights=E(acesso_positivo)$weight)
#distances_sp_in_acesso_positivo

#Out shortest paths 
distances_sp_out_acesso_positivo<-distances(acesso_positivo, mode="out", weights=E(acesso_positivo)$weight)
...
acesso_positivo_dist.from.CAPSAD <- distances(acesso_positivo, v=V(acesso_positivo)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(acesso_positivo), weights=E(acesso_positivo)$weight)
...
#Adding Title
  title("Distance from CAPS AD - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(acesso_positivo, weights=E(acesso_positivo)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(acesso_positivo, weights=E(acesso_positivo)$weight,type="weighted")
```
...
transitivity_local_w<-transitivity(acesso_positivo, weights=E(acesso_positivo)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_acesso_positivo_u_size<-sapply(cliques(acesso_positivo_u), length) # too intesive calculation
```
...
#Adding Title
  title("Coreness Colored Graph - 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(acesso_positivo)$edge.btweenness<-edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight)
acesso_positivo_edge.betweenness <-edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight)
```
...
plot(acesso_positivo, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(acesso_positivo)+1)/10,
     edge.width=log(edge.betweenness(acesso_positivo, weights =E(acesso_positivo)$weight))/5,
     edge.curved = TRUE
     )
...
plot(comps_acesso_positivo1, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_acesso_positivo1)+1)/10,
...
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(acesso_positivo, weights=E(acesso_positivo)$weight)
acesso_positivo_dim<-get.diameter(acesso_positivo, weights=E(acesso_positivo)$weight)
acesso_positivo_dim
```
...
#Adding Title
  title("Diameter of 29.CENTRALIDADE_ACESSO_POSITIVO", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
