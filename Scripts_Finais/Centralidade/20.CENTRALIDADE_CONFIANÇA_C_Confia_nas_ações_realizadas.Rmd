---
title: "SNA Centralities 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)"
...
# 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)
...
```
#1. Descriptive Analysis for 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var18, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var18)/10, main="Histogram of Indegree Nodes - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var18, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var18)/10, main="Histogram of Outdegree Nodes - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var18, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var18)/10, main="Histogram of All Degree Nodes - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)")
```  
...
#Histogram var18 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var18, weights=E(var18)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var18)/10, main="Histogram of Strength Degree Nodes - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var18, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var18)/10, main="Histogram of Normalized Indegree Nodes - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var18, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var18)/10, main="Histogram of Normalized Outdegree Nodes - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var18, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var18)/10, main="Histogram of Normalized All Degree Nodes - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var18), breaks=vcount(var18)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var18)$var18_a.nn.deg <- graph.knn(var18,V(var18))$knn
```
...
plot(degree(var18), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var18)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var18), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)"
     )
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
## Vertex 
V(var18)$size <- degree(var18)
V(var18)$label <- V(var18)$V5_LABEL_TIPO_NOME
V(var18)$label.cex <- degree(var18)/100
V(var18)$label.color <- "black"

## Just in case if we wanna change colors
#V(var18)$color <- V(var18)$color # We defined colors in script 1.Principal.Rmd

## Edge
E(var18)$weight <- E(var18)$weight
E(var18)$width <- E(var18)$weight
E(var18)$color <- "gray"

## Here we can change other edge parameter
#E(var18)[ weight < 0.5 ]$width <- 4
#E(var18)[ weight < 0.5 ]$color <- "green"
#E(var18)$label <- LETTERS[1:10]
#E(var18)$label.cex = seq(1, 2,length.out = 10)
#E(var18)$label.color = "black"
```
#Interactive Plotting
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
visIgraph(var18, physics =TRUE, smooth = TRUE, type = "full", randomSeed = 123) %>%
...
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=degree(var18)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var18)/10000,
     vertex.label.cex=degree(var18)/500,
     edge.width=(edge.betweenness(var18, weights=V(var18)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ", cex = .5)
...
plot(var18, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var18))/800,
     edge.width=(edge.betweenness(var18, weights =E(var18)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var18, 
     layout=layout.kamada.kawai(small_var18), 
     vertex.label=get.vertex.attribute(small_var18,"LABEL_COR"),
     vertex.size=degree(small_var18)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var18)+1)/10,
     edge.width=(edge.betweenness(small_var18))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var18, mode="in")), 
     median(degree(small_var18, mode="out"))
   )
  )
```
...
plot(small_var18, 
     layout=layout.kamada.kawai(small_var18), 
     vertex.label=get.vertex.attribute(small_var18,"LABEL_COR"),
     vertex.size=degree(small_var18)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var18)+2)/5,
     edge.width=(edge.betweenness(small_var18)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var18, mode="in")), 
     median(degree(small_var18, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var18_a.nn.deg_w 
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=(graph.knn(var18,V(var18))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var18,V(var18))$knn+1)/30,
     edge.width=(edge.betweenness(var18, weights =E(var18)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var18,V(var18))$knn)
   ))
```
...
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var18,V(var18), weights= E(var18)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var18,V(var18), weights= E(var18)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var18, weights =E(var18)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var18,V(var18), weights= E(var18)$weight)$knn)
   ))
```
...
V(var18)$totalcloseness <- closeness(var18, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var18)$incloseness_n <- closeness(var18, mode = "in", normalized = T) %>% round(6)
V(var18)$outcloseness_n <- closeness(var18, mode = "out", normalized = T) %>% round(6)
V(var18)$totalcloseness_n <- closeness(var18, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var18_incloseness_n<- closeness(var18, mode = "in", normalized = T) %>% round(6)
var18_outcloseness_n<- closeness(var18, mode = "out", normalized = T) %>% round(6)
var18_totalcloseness_n<- closeness(var18, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var18)$incloseness_w <- closeness(var18, mode = "in", normalized = T, weights=E(var18)$weight) %>% round(6)
V(var18)$outcloseness_w <- closeness(var18, mode = "out", normalized = T,weights=E(var18)$weight) %>% round(6)
V(var18)$totalcloseness_w <- closeness(var18, mode = "total", normalized = T, weights=E(var18)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var18_incloseness_w<- closeness(var18, mode = "in", normalized = T, weights=E(var18)$weight) %>% round(6)
var18_outcloseness_w<- closeness(var18, mode = "out", normalized = T, weights=E(var18)$weight) %>% round(6)
var18_totalcloseness_w<- closeness(var18, mode = "total", normalized = T, weights=E(var18)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var18_incloseness_w)
sd(var18_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var18_outcloseness_w)
sd(var18_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var18_totalcloseness_w)
sd(var18_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var18)$var18_closeness_stats_w <- closeness(var18, vids = V(var18), mode = "all", weights =E(var18)$weight, normalized = FALSE)
var18_closeness_stats_w <- closeness(var18, vids = V(var18), mode = "all", weights =E(var18)$weight, normalized = FALSE)
```
...
var18_outcloseness_w<- closeness(var18, mode = "out", normalized = T, weights=E(var18)$weight) %>% round(6)
var18_totalcloseness_w<- closeness(var18, mode = "total", normalized = T, weights=E(var18)$weight) %>% round(6)
var18_closeness_stats_w <- closeness(var18, vids = V(var18), mode = "all", weights=E(var18)$weight, normalized = FALSE) %>% round(6)
...
var18_incloseness_w,
var18_outcloseness_w,
var18_totalcloseness_w,
var18_closeness_stats_w,
...
#Adding names
names(var18_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var18_df_closseness<-var18_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var18)$var18_color_degree<-round(V(var18)$totalcloseness,4)
...
plot(var18, 
     ...
     vertex.color=V(var18)$vertex_var18_color_degree,
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=closeness(var18)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var18))/80,
     edge.width=(edge.betweenness(var18, weights =E(var18)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var18, mode="in")), 
     median(closeness(var18, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var18)$var18_color_degree<-round(V(var18)$var18_centr_closeness,2)
...
plot(var18, 
     ...
     vertex.color=V(var18)$vertex_var18_color_degree,
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=centralization.closeness(var18)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var18, mode="in")), 
     median(closeness(var18, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var18)$var18_betweenness_w <- betweenness(var18, weights=E(var18)$weight) %>% round(1)
var18_betweenness_w <- betweenness(var18, weights=E(var18)$weight) %>% round(1)
```
...
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=betweenness(var18)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var18)+1)/10000,
     edge.width=edge.betweenness(var18, weights =E(var18)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var18)), 
     sd(betweenness(var18))
   ))
```
#2.8.2 Network Plotting Based On Centralization Betweenness
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var18)$var18_centr_betweenness<-(centralization.betweenness(var18)$res)/10000
...
plot(var18, 
     ...
     vertex.color=V(var18)$vertex_var18_color_degree,
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var18)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Betweenness - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var18)$eigenvector <- eigen_centrality(var18, directed = TRUE, weights =E(var18)$weight) %$% vector %>% round(3)
var18_eigenvector <- eigen_centrality(var18, directed = TRUE, weights = E(var18)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var18_eigenvector_value <- eigen_centrality(var18, directed = TRUE, weights = E(var18)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=(eigen_centrality(var18, directed =TRUE, weights = E(var18)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Eigenvector Centrality Measure - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var18)$var18_color_degree<-round(centr_eigen(var18, directed = T)$vector,2)
...
#Adding Title
  title("Network EigenVector - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var18)$LABEL_COR, var18_power_centrality_stats))
...
V(var18)$var18_power_centrality_stats_r<-round(V(var18)$var18_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var18)$var18_power_centrality_stats_r)), "Blues"))(length(unique(V(var18)$var18_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var18)$color_spower <- vertex_col_spower[factor(V(var18)$var18_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.color=V(var18)$color_spower, 
     vertex.label=V(var18)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var18)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var18)+1)^2)/10,
     edge.width=edge.betweenness(var18, weights =E(var18)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var18)$var18_power_centrality_stats_r
b<-V(var18)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var18_power_centrality_stats),sd(var18_power_centrality_stats)
     ))
```
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var18)$LABEL_COR, round(var18_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var18)$var18_alpha_centrality_stats_r<-round(V(var18)$var18_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var18)$var18_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var18)$var18_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var18)$color_s <- vertex_col_s[factor(V(var18)$var18_alpha_centrality_stats_r)]  
```
...
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.color=V(var18)$color_s, 
     vertex.label=V(var18)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var18, loops = FALSE, alpha = 1, exo = 1, weights=E(var18)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var18))^2)/50,
     edge.width=edge.betweenness(var18, weights =E(var18)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var18)$var18_alpha_centrality_stats_r
b<-V(var18)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var18_alpha_centrality_stats),sd(var18_alpha_centrality_stats)
     ))
```
...
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=10*hub.score(var18)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var18)+1)/10,
     edge.width=edge.betweenness(var18, weights =E(var18)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=10*authority.score(var18)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var18)+1)/20,
     edge.width=log(edge.betweenness(var18, weights =E(var18)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var18, 
     layout=layout.kamada.kawai(var18), 
     vertex.label=get.vertex.attribute(var18,"LABEL_COR"),
     vertex.size=200*page.rank(var18)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var18)+1)/15,
     edge.width=log(edge.betweenness(var18, weights =E(var18)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var18<-make_ego_graph(var18, order=1, V(var18)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var18, 
     layout=layout.kamada.kawai(make_ego_graph_all_var18), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var18,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var18)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var18)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var18))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var18)$LABEL_COR
b<-V(make_ego_graph_all_var18)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var18)$vector),
     sd(page.rank(make_ego_graph_all_var18)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var18<-make_ego_graph(var18, order=1, V(var18)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var18, 
     layout=layout.kamada.kawai(make_ego_graph_out_var18), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var18,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var18)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var18)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var18))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var18)$LABEL_COR
b<-V(make_ego_graph_out_var18)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var18)$vector),
     sd(page.rank(make_ego_graph_out_var18)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var18<-make_ego_graph(var18, order=1, V(var18)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var18, 
     layout=layout.kamada.kawai(make_ego_graph_in_var18), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var18,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var18)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var18))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var18))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var18)$LABEL_COR
b<-V(make_ego_graph_in_var18)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var18)$vector),
     sd(page.rank(make_ego_graph_in_var18)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var18_without_CAPSAD<-delete_vertices(make_ego_graph_all_var18,V(make_ego_graph_all_var18)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var18_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var18_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var18_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var18_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var18_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var18_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var18_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var18_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var18_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var18_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var18_without_complex<-
  delete_vertices(make_ego_graph_all_var18,
                  c(V(make_ego_graph_all_var18)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var18)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var18_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var18_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var18_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var18_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var18_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var18_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var18_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var18_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var18_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var18_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var18, 
     layout=layout.kamada.kawai(msp_var18), 
     vertex.label=get.vertex.attribute(msp_var18,"LABEL_COR"),
     vertex.size=degree(msp_var18)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var18)/50,
     edge.width=log(edge.betweenness(msp_var18, weights =E(msp_var18)$msp_var18))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
#Plotting based only on degree measures 
plot(msp_var18, 
     layout=layout.auto(msp_var18), 
     vertex.label=get.vertex.attribute(msp_var18,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var18)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var18))/50,
     edge.width=log(edge.betweenness(msp_var18, weights=E(msp_var18)$msp_var18))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var18, mode="in")), 
     median(degree(msp_var18, mode="out"))
...
msp_var18_w<-minimum.spanning.tree(var18, weights=1/edge.betweenness(var18, weights =E(var18)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var18_w, 
     layout=layout.auto(msp_var18_w), 
     vertex.label=get.vertex.attribute(msp_var18_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var18_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var18_w))/20,
     edge.width=1/edge.betweenness(msp_var18_w, weights =E(msp_var18_w)$msp_var18_w)*2,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
reciprocity(var18, mode="default")
```
#3.2.2 Reciprocity Ratio
Reciprocity Ratio - Probability  of mutual connections between a vertex pair - if we know - probability that hte opposite counterpart of a directed graph is also included in the 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
reciprocity(var18, mode="ratio")
```
#3.4 Dyad Census
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dyad.census_var18<-dyad.census(var18)
```
# Calculating reciprocity - just as an example based on dyads
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var18)$mut/ecount(var18) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dyad.census_var18_mut<-dyad.census_var18$mut
dyad.census_var18_mut
```
#The number of pairs with non-mutual connections.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dyad.census_var18_asym<-dyad.census_var18$asym
dyad.census_var18_asym
```
#The number of pairs with no connection between them.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dyad.census_var18_null<-dyad.census_var18$null
dyad.census_var18_null
```
...
write.csv(triad_df_var18, "~/SNArRDJF/Banco Redes R/var18_complet_triads.csv")
```
#3.5.1 - Triad Census Types 
#Describing triads
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
triad_df_var18
datatable(triad_df_var18)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var18_sp_in <- shortest.paths(var18, mode='in', weights=E(var18)$weight) # sames as bellow
var18_sp_out <- shortest.paths(var18, mode='out', weights=E(var18)$weight) #same as above
var18_sp_all <- shortest.paths(var18, mode='all', weights=E(var18)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var18<-distances(var18, mode="all", weights=E(var18)$weight)
#distances_sp_all_var18

#In shortest paths 
distances_sp_in_var18<-distances(var18, mode="in",weights=E(var18)$weight)
#distances_sp_in_var18

#Out shortest paths 
distances_sp_out_var18<-distances(var18, mode="out", weights=E(var18)$weight)
#distances_sp_out_var18
```
...
var18_dist.from.CAPSAD <- distances(var18, v=V(var18)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var18), weights=E(var18)$weight)
...
plot(var18, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var18)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var18))/10,
     edge.width=edge.betweenness(var18, weights=E(var18)$var18)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var18, weights=E(var18)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var18, weights=E(var18)$weight,type="weighted")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var18)$transitivity_local<-transitivity(var18, type="local") 
transitivity_local<-transitivity(var18, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var18)$transitivity_local_w<-transitivity(var18, type="barrat") 
transitivity_local_w<-transitivity(var18, weights=E(var18)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var18_u <- as.undirected(var18, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var18_u_size<-sapply(cliques(var18_u), length) # too intesive calculation
```
...
as.undirected_var18_u<-as.undirected(var18_u)
...
V(as.undirected_var18_u)$vcol<-vcol

#Saving labels to display as legend
V(as.undirected_var18_u)$vcollabel[V(as.undirected_var18_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var18_u)$vcollabel [V(as.undirected_var18_u)$vcol=="grey80"]<-"Others"
```

#Plotting based only on degree measures 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(as.undirected(var18_u), 
     layout=layout.kamada.kawai(as.undirected(var18_u)), 
     vertex.label=get.vertex.attribute(as.undirected(var18_u),"LABEL_COR"),
     vertex.color=vcol,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(as.undirected(var18_u))),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var18_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var18_u), weights =E(as.undirected(var18_u))$var18))/50,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(as.undirected_var18_u)$vcollabel
b<-V(as.undirected_var18_u)$vcol
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Coreness Colored Graph - 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
   sprintf("Mean Coreness: %.2f\nMax Coreness: %.2f",
     mean(graph.coreness(var18)), 
     max(graph.coreness(var18))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var18)$edge.btweenness<-edge.betweenness(var18, weights =E(var18)$weight)
var18_edge.betweenness <-edge.betweenness(var18, weights =E(var18)$weight)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var18_edge.betweenness)
sd(var18_edge.betweenness)
```
#Edge Betweenness Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
labels<-attr(E(var18), "vnames")
edgebt<-cbind(round(var18_edge.betweenness,2),labels)
datatable(edgebt)
```
...
plot(var18, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var18_edge.betweenness.community),
                      var18_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var18)+1)/10,
     edge.width=log(edge.betweenness(var18, weights =E(var18)$weight))/5,
     edge.curved = TRUE
     )
...
var18_walktrap.community <- walktrap.community(var18)
```

#3.11.1 Network Dendograma
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var18 <- as.dendrogram(var18_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var18, main = "Dendrograma var18", nodePar=list(pch=c(NA, 20)))
```

#3.11.2 Saving Random walk community
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var18)$walktrap.community <- membership(var18_walktrap.community)
var18_walktrap.community <- membership(var18_walktrap.community)
```
...
plot(var18, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var18)),
     mark.groups = by(seq_along(var18_walktrap.community),
                      var18_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var18)+1)/10,
     edge.width=log(edge.betweenness(var18, weights =E(var18)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var18 <- decompose.graph(var18)
sapply(comps_var18, diameter)
table(sapply(comps_var18, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var181<-comps_var18[[1]]
#comps_var182<-comps_var18[[2]]
#comps_var183<-comps_var18[[3]]
#comps_var184<-comps_var18[[4]]
#comps_var185<-comps_var18[[5]]
#comps_var186<-comps_var18[[6]]
#comps_var187<-comps_var18[[7]]
#comps_var188<-comps_var18[[8]]
#...
```
...
plot(comps_var181, 
     layout=layout.kamada.kawai(comps_var181), 
     vertex.label=get.vertex.attribute(comps_var181,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var181)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var181)+1)/10,
     edge.width=log(edge.betweenness(comps_var181, weights=E(comps_var181)$comps_var181))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var181)$LABEL_COR
b<-V(comps_var181)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var181, mode="in")), 
     median(degree(comps_var181, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var18)$optimal_comm_var18 <- #membership(optimal.community(var18))
#optimal_comm_var18 <- membership(optimal.community(var18))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var18)
var18_dim<-get.diameter(var18)
var18_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var18, weights=E(var18)$weight)
var18_dim<-get.diameter(var18, weights=E(var18)$weight)
var18_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var18)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 20.CENTRALIDADE_CONFIANÇA C) Confia nas ações realizadas por este serviço. (var18)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
