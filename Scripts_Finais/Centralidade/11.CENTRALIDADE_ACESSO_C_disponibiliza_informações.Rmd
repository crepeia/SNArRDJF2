---
title: "SNA Centralities 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)"
...
```
#1. Descriptive Analysis for 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var9, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var9)/10, main="Histogram of Indegree Nodes - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var9, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var9)/10, main="Histogram of Outdegree Nodes - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var9, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var9)/10, main="Histogram of All Degree Nodes - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)")
```  
...
#Histogram var9 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(var9, weights=E(var9)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var9)/10, main="Histogram of Strength Degree Nodes - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var9, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var9)/10, main="Histogram of Normalized Indegree Nodes - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var9, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var9)/10, main="Histogram of Normalized Outdegree Nodes - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(var9, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var9)/10, main="Histogram of Normalized All Degree Nodes - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(var9), breaks=vcount(var9)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9) ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)"
     )
```
#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var9)$var9_a.nn.deg <- graph.knn(var9,V(var9))$knn
```
...
plot(degree(var9), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)"
     )
```
#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9))

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var9)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
plot(degree(var9), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)"
     )
```
...
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=degree(var9)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=degree(var9)/10000,
     vertex.label.cex=degree(var9)/500,
     edge.width=(edge.betweenness(var9, weights=V(var9)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ", cex = .5)
...
plot(var9, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(degree(var9))/800,
     edge.width=(edge.betweenness(var9, weights =E(var9)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
...
#Plotting 
plot(small_var9, 
     layout=layout.kamada.kawai(small_var9), 
     vertex.label=get.vertex.attribute(small_var9,"LABEL_COR"),
     vertex.size=degree(small_var9)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var9)+1)/10,
     edge.width=(edge.betweenness(small_var9))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Higher Than Median Degree - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var9, mode="in")), 
     median(degree(small_var9, mode="out"))
   )
  )
```
...
plot(small_var9, 
     layout=layout.kamada.kawai(small_var9), 
     vertex.label=get.vertex.attribute(small_var9,"LABEL_COR"),
     vertex.size=degree(small_var9)/2,
     edge.arrow.size=0.1,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.degree=(-pi)/2,	
     vertex.label.cex=log(degree(small_var9)+2)/5,
     edge.width=(edge.betweenness(small_var9)),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Lower than Median Degree - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var9, mode="in")), 
     median(degree(small_var9, mode="out"))
...
```{r, echo=FALSE}
#Plotting based only on degree measures  #var9_a.nn.deg_w 
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=(graph.knn(var9,V(var9))$knn)/10,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var9,V(var9))$knn+1)/30,
     edge.width=(edge.betweenness(var9, weights =E(var9)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median(graph.knn(var9,V(var9))$knn)
   ))
```
...
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var9,V(var9), weights= E(var9)$weight)$knn),
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var9,V(var9), weights= E(var9)$weight)$knn+1)/10,
     edge.width=edge.betweenness(var9, weights =E(var9)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var9,V(var9), weights= E(var9)$weight)$knn)
   ))
```
...
V(var9)$totalcloseness <- closeness(var9, mode = "total") %>% round(4)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var9)$incloseness_n <- closeness(var9, mode = "in", normalized = T) %>% round(6)
V(var9)$outcloseness_n <- closeness(var9, mode = "out", normalized = T) %>% round(6)
V(var9)$totalcloseness_n <- closeness(var9, mode = "total", normalized = T) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var9_incloseness_n<- closeness(var9, mode = "in", normalized = T) %>% round(6)
var9_outcloseness_n<- closeness(var9, mode = "out", normalized = T) %>% round(6)
var9_totalcloseness_n<- closeness(var9, mode = "total", normalized = T) %>% round(6)
```
...
#Saving to Igraph object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var9)$incloseness_w <- closeness(var9, mode = "in", normalized = T, weights=E(var9)$weight) %>% round(6)
V(var9)$outcloseness_w <- closeness(var9, mode = "out", normalized = T,weights=E(var9)$weight) %>% round(6)
V(var9)$totalcloseness_w <- closeness(var9, mode = "total", normalized = T, weights=E(var9)$weight) %>% round(6)
```
#Saving to Environment
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var9_incloseness_w<- closeness(var9, mode = "in", normalized = T, weights=E(var9)$weight) %>% round(6)
var9_outcloseness_w<- closeness(var9, mode = "out", normalized = T, weights=E(var9)$weight) %>% round(6)
var9_totalcloseness_w<- closeness(var9, mode = "total", normalized = T, weights=E(var9)$weight) %>% round(6)
```
###Closeness Normalized weighted - in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var9_incloseness_w)
sd(var9_incloseness_w)
```
###Closeness Normalized weighted - out
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var9_outcloseness_w)
sd(var9_outcloseness_w)
```
###Closeness Normalized weighted - all
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var9_totalcloseness_w)
sd(var9_totalcloseness_w)
```
#2.7.4 Closeness Weighted for all vertex 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var9)$var9_closeness_stats_w <- closeness(var9, vids = V(var9), mode = "all", weights =E(var9)$weight, normalized = FALSE)
var9_closeness_stats_w <- closeness(var9, vids = V(var9), mode = "all", weights =E(var9)$weight, normalized = FALSE)
```
...
var9_outcloseness_w<- closeness(var9, mode = "out", normalized = T, weights=E(var9)$weight) %>% round(6)
var9_totalcloseness_w<- closeness(var9, mode = "total", normalized = T, weights=E(var9)$weight) %>% round(6)
var9_closeness_stats_w <- closeness(var9, vids = V(var9), mode = "all", weights=E(var9)$weight, normalized = FALSE) %>% round(6)
...
var9_incloseness_w,
var9_outcloseness_w,
var9_totalcloseness_w,
var9_closeness_stats_w,
...
#Adding names
names(var9_df_closseness) <- c("In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness","Type")

#Ordering Variables
var9_df_closseness<-var9_df_closseness[c("Type","In Closeness", "Out Closeness", "Total Closeness","In Closeness Normalized", "Out Closeness Normalized", "Total Closeness Normalized", "In Closeness Weighted", "Out Closeness Weighted", "Total Closeness Weighted", "All Closeness Weighted","Centralization Closeness")]
```
# General tabel - DT
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var9)$var9_color_degree<-round(V(var9)$totalcloseness,4)
...
plot(var9, 
     ...
     vertex.color=V(var9)$vertex_var9_color_degree,
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=closeness(var9)*4000,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(closeness(var9))/80,
     edge.width=(edge.betweenness(var9, weights =E(var9)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var9, mode="in")), 
     median(closeness(var9, mode="out"))
   ))
```
#2.7.6 Network Plotting Based On Centralization Closeness 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var9)$var9_color_degree<-round(V(var9)$var9_centr_closeness,2)
...
plot(var9, 
     ...
     vertex.color=V(var9)$vertex_var9_color_degree,
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=centralization.closeness(var9)$res*20,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Closeness - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var9, mode="in")), 
     median(closeness(var9, mode="out"))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var9)$var9_betweenness_w <- betweenness(var9, weights=E(var9)$weight) %>% round(1)
var9_betweenness_w <- betweenness(var9, weights=E(var9)$weight) %>% round(1)
```
...
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=betweenness(var9)/500,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=(betweenness(var9)+1)/10000,
     edge.width=edge.betweenness(var9, weights =E(var9)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Betweenness: %.2f\nSD Betweenness: %.2f",
     median(betweenness(var9)), 
     sd(betweenness(var9))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var9)$var9_centr_betweenness<-(centralization.betweenness(var9)$res)/10000
...
plot(var9, 
     ...
     vertex.color=V(var9)$vertex_var9_color_degree,
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=(centralization.betweenness(var9)$res)/500,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
...
#Adding Title
  title("Network Centralization Betweenness - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Eigen_Centrality 
V(var9)$eigenvector <- eigen_centrality(var9, directed = TRUE, weights =E(var9)$weight) %$% vector %>% round(3)
var9_eigenvector <- eigen_centrality(var9, directed = TRUE, weights = E(var9)$weight) %$% vector %>% round(3)
#Eigenvalue Calculated Eigenvector
var9_eigenvector_value <- eigen_centrality(var9, directed = TRUE, weights = E(var9)$weight) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
#Eigenvalue Calculated Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var9_eigenvector_value
```

#2.9.3 Centralization EigenVector - how central the most central node in the network in relation to all other nodes.
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var9)$var9_centr_eigen <- centr_eigen(var9, directed = T)$vector
var9_centr_eigen <-centr_eigen(var9, directed = T)$vector
```
#Centralization
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var9, directed = T)$centralization
```
#Max
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
centr_eigen(var9, directed = T)$theoretical_max
```
...
var9_eigenvector_w <- eigen_centrality(var9, directed = TRUE, weights = E(var9)$weight) %$% vector %>% round(3) 
var9_centr_eigen <-centr_eigen(var9, directed = T)$vector

#Creating a datagrame of measures
var9_df_eigenvector <- data.frame(var9_eigenvector,
var9_eigenvector_w,
var9_centr_eigen) %>% round(3)

#Adding type
var9_df_eigenvector <-cbind(var9_df_eigenvector, V(var9)$LABEL_COR)

#Adding names
names(var9_df_eigenvector) <- c("Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector","Type")

#Ordering Variables
var9_df_eigenvector<-var9_df_eigenvector[c("Type","Eigenvector", "Eigenvector Weighted", "Centralization Eigenvector")]
```
# General tabel - DT Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
datatable(var9_df_eigenvector, filter = 'top')
```
#Aggregating data from previous table - mean
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_mean <-aggregate(var9_df_eigenvector, by=list(var9_df_eigenvector$Type), FUN=mean, na.rm=TRUE)
...
#Aggregating data from previous table - sd
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
aggdata_sd <-aggregate(var9_df_eigenvector, by=list(var9_df_eigenvector$Type), FUN=sd, na.rm=TRUE) 
...
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=(eigen_centrality(var9, directed =TRUE, weights = E(var9)$weight)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((eigen_centrality(var9)$vector)+1)/10,
     edge.width=edge.betweenness(var9, weights =E(var9)$weight)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.2f",
     median(eigen_centrality(var9)$vector)
   ))
```
#2.9.4 Network Plotting Based On Centralization Eigenvector
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Get Variable
V(var9)$var9_color_degree<-round(centr_eigen(var9, directed = T)$vector,2)
...
plot(var9, 
     ...
     vertex.color=V(var9)$vertex_var9_color_degree,
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=centr_eigen(var9, directed = T)$vector*25,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var9, directed = T)$vector + 1)/5,
     edge.width=(edge.betweenness(var9, weights =E(var9)$weight))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network EigenVector - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Eigenvector: %.0f\nSD Eigenvector: %.0f",
     mean(centr_eigen(var9, directed = T)$vector), 
     sd(centr_eigen(var9, directed = T)$vector)
   ))
```
...
var9_power_centrality_stats <- power_centrality(var9, nodes = V(var9), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var9)$var9_power_centrality_stats <-power_centrality(var9, nodes = V(var9), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 
```
#Power (beta) Centrality Stats
...
```{r, results="asis"}
d=as.data.frame(cbind(V(var9)$LABEL_COR, var9_power_centrality_stats))
...
V(var9)$var9_power_centrality_stats_r<-round(V(var9)$var9_power_centrality_stats,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var9)$var9_power_centrality_stats_r)), "Blues"))(length(unique(V(var9)$var9_power_centrality_stats_r))) 

#Saving as Vertex properties                             
V(var9)$color_spower <- vertex_col_spower[factor(V(var9)$var9_power_centrality_stats_r)]  
```
#2.8.3 Plotting Power Centrality Degree
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.color=V(var9)$color_spower, 
     vertex.label=V(var9)$V5_LABEL_LABEL,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt((power_centrality(var9)^2))*5,
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt((power_centrality(var9)+1)^2)/10,
     edge.width=edge.betweenness(var9, weights =E(var9)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var9)$var9_power_centrality_stats_r
b<-V(var9)$color_spower
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(var9_power_centrality_stats),sd(var9_power_centrality_stats)
     ))
```
#2.8.2 Alpha Bonacich's centrality scores of network positions
```{r, results="asis"}
#Saving power as an object
var9_alpha_centrality_stats <- alpha_centrality(var9, loops = FALSE, alpha = 1, exo = 1, weights=E(var9)$weight, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var9)$var9_alpha_centrality_stats<-alpha_centrality(var9, loops = FALSE, alpha = 1, exo = 1, weights=E(var9)$weight, tol = 1e-07, sparse = TRUE)

#Descriptive 
summary(var9_alpha_centrality_stats)
sd(var9_alpha_centrality_stats)
```
...
- Are you more powerful if you're connected to powerful people? (positive attenuation factor)
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
d=as.data.frame(cbind(V(var9)$LABEL_COR, round(var9_alpha_centrality_stats,1)))
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
# Set colors to plot distances:
V(var9)$var9_alpha_centrality_stats_r<-round(V(var9)$var9_alpha_centrality_stats,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var9)$var9_alpha_centrality_stats_r)), "YlOrRd"))(length(unique(V(var9)$var9_alpha_centrality_stats_r))) 

#Saving as Vertex properties                                                                  
V(var9)$color_s <- vertex_col_s[factor(V(var9)$var9_alpha_centrality_stats_r)]  
```
...
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.color=V(var9)$color_s, 
     vertex.label=V(var9)$V5_LABEL_LABEL,
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var9, loops = FALSE, alpha = 1, exo = 1, weights=E(var9)$weight, tol = 1e-07, sparse = TRUE)^2)), 
     edge.arrow.size=0.01,
     vertex.label.cex=sqrt((alpha_centrality(var9))^2)/50,
     edge.width=edge.betweenness(var9, weights =E(var9)$weight)/500,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(var9)$var9_alpha_centrality_stats_r
b<-V(var9)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(var9_alpha_centrality_stats),sd(var9_alpha_centrality_stats)
     ))
```
...
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=10*hub.score(var9)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.01,
     vertex.label.cex=log(degree(var9)+1)/10,
     edge.width=edge.betweenness(var9, weights =E(var9)$weight)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=10*authority.score(var9)$vector,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var9)+1)/20,
     edge.width=log(edge.betweenness(var9, weights =E(var9)$weight))/50,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var9, 
     layout=layout.kamada.kawai(var9), 
     vertex.label=get.vertex.attribute(var9,"LABEL_COR"),
     vertex.size=200*page.rank(var9)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(var9)+1)/15,
     edge.width=log(edge.betweenness(var9, weights =E(var9)$weight))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
title("Hits by in and out degree - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", outer=TRUE)
par(op)
```
#Top HITs
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
make_ego_graph_all_var9<-make_ego_graph(var9, order=1, V(var9)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="all", mindist = 0)[[1]]

#Plotting ego based on Page Rank 
plot(make_ego_graph_all_var9, 
     layout=layout.kamada.kawai(make_ego_graph_all_var9), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var9,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var9)$vector),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_all_var9)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var9))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var9)$LABEL_COR
b<-V(make_ego_graph_all_var9)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var9)$vector),
     sd(page.rank(make_ego_graph_all_var9)$vector)
     ))
```
#2.10.3.1.2 Out connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_out_var9<-make_ego_graph(var9, order=1, V(var9)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="out", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_out_var9, 
     layout=layout.kamada.kawai(make_ego_graph_out_var9), 
     vertex.label=get.vertex.attribute(make_ego_graph_out_var9,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_out_var9)$vector,
     edge.arrow.size=0.1,
    vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_out_var9)+1)/10,
     edge.width=log(edge.betweenness(make_ego_graph_out_var9))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_out_var9)$LABEL_COR
b<-V(make_ego_graph_out_var9)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_out_var9)$vector),
     sd(page.rank(make_ego_graph_out_var9)$vector)
     ))
```
#2.10.3.1.3 - In connections 
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_in_var9<-make_ego_graph(var9, order=1, V(var9)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], mode ="in", mindist = 0)[[1]]
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_in_var9, 
     layout=layout.kamada.kawai(make_ego_graph_in_var9), 
     vertex.label=get.vertex.attribute(make_ego_graph_in_var9,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_in_var9)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=log(degree(make_ego_graph_in_var9))/10,
     edge.width=log(edge.betweenness(make_ego_graph_in_var9))/100,
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_in_var9)$LABEL_COR
b<-V(make_ego_graph_in_var9)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_in_var9)$vector),
     sd(page.rank(make_ego_graph_in_var9)$vector)
     ))
```
##2.10.4 Removing CAPSAD from its own ego network-  Example considering its high page rank and resilience test
#Making igrpah ego object
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
make_ego_graph_all_var9_without_CAPSAD<-delete_vertices(make_ego_graph_all_var9,V(make_ego_graph_all_var9)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"])
```
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var9_without_CAPSAD, 
     layout=layout.kamada.kawai(make_ego_graph_all_var9_without_CAPSAD), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var9_without_CAPSAD,"LABEL_COR"),
     vertex.size=100*page.rank(make_ego_graph_all_var9_without_CAPSAD)$vector,
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     vertex.label.cex=log(page.rank(make_ego_graph_all_var9_without_CAPSAD)$vector+1)*10,
     edge.width=edge.betweenness(make_ego_graph_all_var9_without_CAPSAD)/500,
     edge.curved = TRUE)
#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var9_without_CAPSAD)$LABEL_COR
b<-V(make_ego_graph_all_var9_without_CAPSAD)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var9_without_CAPSAD)$vector),
     sd(page.rank(make_ego_graph_all_var9_without_CAPSAD)$vector)
     ))
```
...
make_ego_graph_all_var9_without_complex<-
  delete_vertices(make_ego_graph_all_var9,
                  c(V(make_ego_graph_all_var9)
                  [V2_LABEL_ID=="q170_CAPS...CAPS.AD"],#Removing CAPSAD - Psychosocial Treatment Center
                  V(make_ego_graph_all_var9)
...
#Plotting ego based on Page Rank 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(make_ego_graph_all_var9_without_complex, 
     layout=layout.kamada.kawai(make_ego_graph_all_var9_without_complex), 
     vertex.label=get.vertex.attribute(make_ego_graph_all_var9_without_complex,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var9_without_complex)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(page.rank(make_ego_graph_all_var9_without_complex)$vector+1)/10,
     edge.width=edge.betweenness(make_ego_graph_all_var9_without_complex)/500,
     vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE)

#Solving Problems with legend rendering 
a<-V(make_ego_graph_all_var9_without_complex)$LABEL_COR
b<-V(make_ego_graph_all_var9_without_complex)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
     mean(page.rank(make_ego_graph_all_var9_without_complex)$vector),
     sd(page.rank(make_ego_graph_all_var9_without_complex)$vector)
     ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(msp_var9, 
     layout=layout.kamada.kawai(msp_var9), 
     vertex.label=get.vertex.attribute(msp_var9,"LABEL_COR"),
     vertex.size=degree(msp_var9)/2,
     edge.arrow.size=0.01,
     vertex.label.cex=degree(msp_var9)/50,
     edge.width=log(edge.betweenness(msp_var9, weights =E(msp_var9)$msp_var9))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var9, mode="in")), 
     median(degree(msp_var9, mode="out"))
   ))
```
...
#Plotting based only on degree measures 
plot(msp_var9, 
     layout=layout.auto(msp_var9), 
     vertex.label=get.vertex.attribute(msp_var9,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var9)),
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(degree(msp_var9))/50,
     edge.width=log(edge.betweenness(msp_var9, weights=E(msp_var9)$msp_var9))/5,
      vertex.frame.color="#ffffff",
      vertex.label.color="black",
     edge.curved = TRUE
...
#Adding Title
  title("Alternative Visualization -Minimum Spanning Tree Non-normalized - from 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var9, mode="in")), 
     median(degree(msp_var9, mode="out"))
...
msp_var9_w<-minimum.spanning.tree(var9, weights=1/edge.betweenness(var9, weights =E(var9)$weight), algorithm='prim')

#Plotting based only on degree measures 
plot(msp_var9_w, 
     layout=layout.auto(msp_var9_w), 
     vertex.label=get.vertex.attribute(msp_var9_w,"LABEL_COR"),
     vertex.size=sqrt(degree(msp_var9_w)),
     edge.arrow.size=0.1,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label.cex=sqrt(degree(msp_var9_w))/20,
     edge.width=1/edge.betweenness(msp_var9_w, weights =E(msp_var9_w)$msp_var9_w)*2,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(msp_var9_w)$LABEL_COR
b<-V(msp_var9_w)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(msp_var9_w, mode="in")), 
     median(degree(msp_var9_w, mode="out"))
   ))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
2*dyad_census(var9)$mut/ecount(var9) # Calculating reciprocity
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Shortest Paths
var9_sp_in <- shortest.paths(var9, mode='in', weights=E(var9)$weight) # sames as bellow
var9_sp_out <- shortest.paths(var9, mode='out', weights=E(var9)$weight) #same as above
var9_sp_all <- shortest.paths(var9, mode='all', weights=E(var9)$weight) # all
```
#Shortest Paths #in
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#All shortest paths 
distances_sp_all_var9<-distances(var9, mode="all", weights=E(var9)$weight)
#distances_sp_all_var9

#In shortest paths 
distances_sp_in_var9<-distances(var9, mode="in",weights=E(var9)$weight)
#distances_sp_in_var9

#Out shortest paths 
distances_sp_out_var9<-distances(var9, mode="out", weights=E(var9)$weight)
#distances_sp_out_var9
```
...
var9_dist.from.CAPSAD <- distances(var9, v=V(var9)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var9), weights=E(var9)$weight)
...
plot(var9, 
     ...
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(var9)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var9))/10,
     edge.width=edge.betweenness(var9, weights=E(var9)$var9)/500,
     edge.curved = TRUE)
...
#Adding Title
  title("Distance from CAPS AD - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
#Non-weighted
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity(var9, weights=E(var9)$weight, type="global")
```
#Weighted by Vertex
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
transitivity_weighted<-transitivity(var9, weights=E(var9)$weight,type="weighted")
```
...
transitivity_local<-transitivity(var9, type="local") #local - ratio of triangles to connected triples each vertex is part of.
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var9)$transitivity_local_w<-transitivity(var9, type="barrat") 
transitivity_local_w<-transitivity(var9, weights=E(var9)$weight, type="barrat")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
var9_u <- as.undirected(var9, mode= "collapse",
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#cliques_var9_u_size<-sapply(cliques(var9_u), length) # too intesive calculation
```
...
as.undirected_var9_u<-as.undirected(var9_u)
...
V(as.undirected_var9_u)$vcol<-vcol

#Saving labels to display as legend
V(as.undirected_var9_u)$vcollabel[V(as.undirected_var9_u)$vcol=="gold"]<-"Largets Clique"
V(as.undirected_var9_u)$vcollabel [V(as.undirected_var9_u)$vcol=="grey80"]<-"Others"
```

#Plotting based only on degree measures 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
plot(as.undirected(var9_u), 
     layout=layout.kamada.kawai(as.undirected(var9_u)), 
     vertex.label=get.vertex.attribute(as.undirected(var9_u),"LABEL_COR"),
     vertex.color=vcol,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.size=sqrt(degree(as.undirected(var9_u))),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var9_u))+1)/10,
     edge.width=log(edge.betweenness(as.undirected(var9_u), weights =E(as.undirected(var9_u))$var9))/50,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(as.undirected_var9_u)$vcollabel
b<-V(as.undirected_var9_u)$vcol
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Coreness Colored Graph - 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ", cex = .5)
  text(x = -1, y = -1.2, cex = .5, labels = 
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#Edge Betweenness
E(var9)$edge.btweenness<-edge.betweenness(var9, weights =E(var9)$weight)
var9_edge.betweenness <-edge.betweenness(var9, weights =E(var9)$weight)
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
summary(var9_edge.betweenness)
sd(var9_edge.betweenness)
```
#Edge Betweenness Table
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
labels<-attr(E(var9), "vnames")
edgebt<-cbind(round(var9_edge.betweenness,2),labels)
datatable(edgebt)
```
...
plot(var9, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     mark.groups = by(seq_along(var9_edge.betweenness.community),
                      var9_edge.betweenness.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var9)+1)/10,
     edge.width=log(edge.betweenness(var9, weights =E(var9)$weight))/5,
     edge.curved = TRUE
     )
...
var9_walktrap.community <- walktrap.community(var9)
```

#3.11.1 Network Dendograma
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
dend.g.network_var9 <- as.dendrogram(var9_walktrap.community, se.modularity=TRUE)
plot(dend.g.network_var9, main = "Dendrograma var9", nodePar=list(pch=c(NA, 20)))
```

#3.11.2 Saving Random walk community
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
V(var9)$walktrap.community <- membership(var9_walktrap.community)
var9_walktrap.community <- membership(var9_walktrap.community)
```
...
plot(var9, 
     ...
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(var9)),
     mark.groups = by(seq_along(var9_walktrap.community),
                      var9_walktrap.community, 
                      invisible),   ## Add community indicating background colors
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var9)+1)/10,
     edge.width=log(edge.betweenness(var9, weights =E(var9)$weight))/5,
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var9 <- decompose.graph(var9)
sapply(comps_var9, diameter)
table(sapply(comps_var9, vcount))
```

#3.12.1 Getting Plotting Decomposed Graphs

```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
comps_var91<-comps_var9[[1]]
#comps_var92<-comps_var9[[2]]
#comps_var93<-comps_var9[[3]]
#comps_var94<-comps_var9[[4]]
#comps_var95<-comps_var9[[5]]
#comps_var96<-comps_var9[[6]]
#comps_var97<-comps_var9[[7]]
#comps_var98<-comps_var9[[8]]
#...
```
...
plot(comps_var91, 
     layout=layout.kamada.kawai(comps_var91), 
     vertex.label=get.vertex.attribute(comps_var91,"LABEL_COR"),
          vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt(degree(comps_var91)),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var91)+1)/10,
     edge.width=log(edge.betweenness(comps_var91, weights=E(comps_var91)$comps_var91))/5,
     edge.curved = TRUE
     )

#Solving Problems with legend rendering 
a<-V(comps_var91)$LABEL_COR
b<-V(comps_var91)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  ...
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(comps_var91, mode="in")), 
     median(degree(comps_var91, mode="out"))
   ))
```
#3.14 Optimal Community - This is a NP complex problem - too intense
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
#V(var9)$optimal_comm_var9 <- #membership(optimal.community(var9))
#optimal_comm_var9 <- membership(optimal.community(var9))
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var9)
var9_dim<-get.diameter(var9)
var9_dim
```
#Diameter Weigthed 
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
diameter(var9, weights=E(var9)$weight)
var9_dim<-get.diameter(var9, weights=E(var9)$weight)
var9_dim
```
...
plot(g, 
     ...
     edge.width=edge.betweenness(g, weights=E(g)$var9)/500,
     edge.curved = TRUE
...
#Adding Title
  title("Diameter of 11.CENTRALIDADE_ACESSO C) Este serviço disponibiliza informações sobre suas ativades para o seu serviço. (var9)", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
