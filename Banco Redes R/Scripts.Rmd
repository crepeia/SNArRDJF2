...
{
x<-as.matrix(assign(x, read.table(x,sep=";", stringsAsFactors=FALSE, header = T)))[-c(70, 105, 109, 126, 131, 133, 154, 166),-c(1)]
}
...
```{r}
colnames(gMatriz_x2.txt)<-c('source','target','x2')
colnames(gMatriz_0.txt)<-c('source','target','var0')
colnames(gMatriz_1.txt)<-c('source','target','var1')
colnames(gMatriz_2.txt)<-c('source','target','var2')
colnames(gMatriz_3.txt)<-c('source','target','var3')
colnames(gMatriz_4.txt)<-c('source','target','var4')
colnames(gMatriz_5.txt)<-c('source','target','var5')
colnames(gMatriz_6.txt)<-c('source','target','var6')
colnames(gMatriz_7.txt)<-c('source','target','var7')
colnames(gMatriz_8.txt)<-c('source','target','var8')
colnames(gMatriz_9.txt)<-c('source','target','var9')
colnames(gMatriz_10.txt)<-c('source','target','var10')
colnames(gMatriz_11.txt)<-c('source','target','var11')
colnames(gMatriz_12.txt)<-c('source','target','var12')
colnames(gMatriz_13.txt)<-c('source','target','var13')
colnames(gMatriz_14.txt)<-c('source','target','var14')
colnames(gMatriz_15.txt)<-c('source','target','var15')
colnames(gMatriz_16.txt)<-c('source','target','var16')
colnames(gMatriz_17.txt)<-c('source','target','var17')
colnames(gMatriz_18.txt)<-c('source','target','var18')
colnames(gMatriz_19.txt)<-c('source','target','var19')
colnames(gMatriz_20.txt)<-c('source','target','var20')
colnames(gMatriz_21.txt)<-c('source','target','var21')
colnames(gMatriz_22.txt)<-c('source','target','var22')
colnames(gMatriz_23.txt)<-c('source','target','var23')
colnames(gMatriz_24.txt)<-c('source','target','var24')
colnames(gMatriz_atividade.txt)<-c('source','target','atividade')
colnames(gMatriz_acesso.txt)<-c('source','target','acesso')
colnames(gMatriz_confianca.txt)<-c('source','target','confianca')
colnames(gMatriz_total.txt)<-c('source','target','total')
```
