...
# Also see Basic 1 for prior functions.

#Using this function you can load all data without wating until your tomorrow after
load("~/SNArRDJF/Banco Redes R/Base Completa.RData")
