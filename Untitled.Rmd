...
#SOMATÓRIO ATIVIDADE
full_data_frame_id$atividade_n=(full_data_frame_id$neg_var1 + full_data_frame_id$neg_var2 + full_data_frame_id$neg_var3 + full_data_frame_id$neg_var4 + full_data_frame_id$neg_var5 + full_data_frame_id$neg_var6)

full_data_frame_id$atividade=(full_data_frame_id$neg_var1 + full_data_frame_id$neg_var2 + full_data_frame_id$neg_var3 + full_data_frame_id$neg_var4 + full_data_frame_id$neg_var5 + full_data_frame_id$neg_var6)

#SOMATÓRIO ACESSO TOTAL
full_data_frame_id$acesso=(full_data_frame_id$neg_var7 + full_data_frame_id$neg_var8 + full_data_frame_id$neg_var9 + full_data_frame_id$neg_var10 + full_data_frame_id$neg_var11 + full_data_frame_id$neg_var12 + full_data_frame_id$neg_var13 + full_data_frame_id$neg_var14 + full_data_frame_id$neg_var15)

#SOMATÓRIO ACESSO POSITIVO - HORÁRIOS, INFORMAÇÕES E COMUNICAÇÃO 
full_data_frame_id$acesso_positivo=(full_data_frame_id$neg_var7 + full_data_frame_id$neg_var8 + full_data_frame_id$neg_var9 + full_data_frame_id$neg_var10 + full_data_frame_id$var11 + full_data_frame_id$neg_var12 + full_data_frame_id$neg_var13)

#SOMATÓRIO ACESSO NEGATIVO - BARREIRAS GEOGRÁFICAS, TEMPO E CUSTO
full_data_frame_id$acesso_negativo=(full_data_frame_id$var14 + full_data_frame_id$var15 + full_data_frame_id$var16)

#SOMATÓRIO CONFIANÇA
full_data_frame_id$confianca=(full_data_frame_id$neg_var17 + full_data_frame_id$neg_var18 + full_data_frame_id$neg_var19 + full_data_frame_id$neg_var20 + full_data_frame_id$neg_var21 + full_data_frame_id$neg_var22 + full_data_frame_id$neg_var23 + full_data_frame_id$neg_var24)

#SOMATÓRIO ACESSO E CONFIANÇA
full_data_frame_id$acessoeconfianca=full_data_frame_id$acesso + full_data_frame_id$confianca

#SOMATÓRIO TOTAL
full_data_frame_id$total= full_data_frame_id$acessoeconfianca + full_data_frame_id$acessoeconfianca

#SOMATÓRIO ACESSO PONDERADO
full_data_frame_id$neg_acesso= rowSums(full_data_frame_id[,c(32:42)]) 

#SOMATÓRIO CONFIANÇA PONDERADO
full_data_frame_id$neg_confianca= rowSums(full_data_frame_id[,c(43:49)]) 

#SOMATÓRIO CONFIANÇA E ACESSO PONDERADO
full_data_frame_id$neg_acessoeconfianca= full_data_frame_id$neg_confianca + full_data_frame_id$neg_acesso

#SOMATÓRIO TOTAL PONDERADO
full_data_frame_id$neg_total= full_data_frame_id$atividade + full_data_frame_id$neg_acessoeconfianca 
