---
title: "SNA Interactive Plotting 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20)."
...
```
#Interactive Plotting - 22.CENTRALIDADE_CONFIANÇA E) Confia nas informações recebas deste serviço (var20).
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
save.image("~/SNArRDJF/Robject/0_interactive_var20.RData") 
```
