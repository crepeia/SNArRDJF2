---
title: "SNA Interactive Plotting 27.CENTRALIDADE_ATIVIDADE"
...
```
#Interactive Plotting - 27.CENTRALIDADE_ATIVIDADE
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
...
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
save.image("~/SNArRDJF/Robject/0_interactive_atividade.RData") 
```
