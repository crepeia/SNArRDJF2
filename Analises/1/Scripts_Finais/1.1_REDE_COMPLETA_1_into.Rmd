---
title: "SNA Introduction 1.1 - REDE COMPLETA (full_no_zero)"
...
load("~/SNArRDJF/Robject/0_interactive_full_no_zero.RData")
```
...
```
#Descriptive Analysis for 1.1 - REDE COMPLETA (full_no_zero)
...
```{r, echo=T, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
save.image("~/SNArRDJF/Robject/1_intro_full_no_zero.RData") 
```
