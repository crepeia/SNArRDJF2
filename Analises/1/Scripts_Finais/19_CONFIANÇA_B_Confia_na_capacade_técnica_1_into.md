# SNA Introduction 19_CONFIANÇA B) Confia na capacade técnica da equipe deste serviço. (var17)
Leonardo Martins  
17 de julho de 2016  
...
load("~/SNArRDJF/Robject/0_interactive_var17.RData")
```
...
```
#Descriptive Analysis for 19_CONFIANÇA B) Confia na capacade técnica da equipe deste serviço. (var17)
...
V(var17)$name[1]  # just as an example
```
...
```r
V(var17)$name[2]  # just as an example
```
...
```r
V(var17)$name[3]  # just as an example
```
...
```r
# list by others id's
V(var17)$name[6]  # just as an example
```
...
```r
V(var17)$name[150]  # just as an example
```
...
```r
V(var17)$name[185]  # just as an example
```
...
```r
save.image("~/SNArRDJF/Robject/1_intro_var17.RData") 
```
