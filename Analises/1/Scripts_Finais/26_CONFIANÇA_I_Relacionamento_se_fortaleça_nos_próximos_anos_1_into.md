# SNA Introduction 26_CONFIANÇA I) Espera que o relacionamento com este serviço se fortaleça nos próximos anos. (var24)
Leonardo Martins  
17 de julho de 2016  
...
load("~/SNArRDJF/Robject/0_interactive_var24.RData")
```
...
```
#Descriptive Analysis for 26_CONFIANÇA I) Espera que o relacionamento com este serviço se fortaleça nos próximos anos. (var24)
...
V(var24)$name[1]  # just as an example
```
...
```r
V(var24)$name[2]  # just as an example
```
...
```r
V(var24)$name[3]  # just as an example
```
...
```r
# list by others id's
V(var24)$name[6]  # just as an example
```
...
```r
V(var24)$name[150]  # just as an example
```
...
```r
V(var24)$name[185]  # just as an example
```
...
```r
save.image("~/SNArRDJF/Robject/1_intro_var24.RData") 
```
