# SNA Introduction 32_ACESSO E CONFIANÇA
Leonardo Martins  
17 de julho de 2016  
...
load("~/SNArRDJF/Robject/0_interactive_acessoeconfianca.RData")
```
...
```r
save.image("~/SNArRDJF/Robject/1_intro_acessoeconfianca.RData") 
```
