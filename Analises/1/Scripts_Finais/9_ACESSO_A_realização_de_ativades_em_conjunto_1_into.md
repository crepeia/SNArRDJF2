# SNA Introduction 9_ACESSO A) Este serviço mostra-se disponível para realização de ativades em conjunto. (var7)
Leonardo Martins  
17 de julho de 2016  
...
load("~/SNArRDJF/Robject/0_interactive_var7.RData")
```
...
```r
save.image("~/SNArRDJF/Robject/1_intro_var7.RData") 
```
