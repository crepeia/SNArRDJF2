# SNA Introduction 12_ACESSO D) O seu serviço consegue acessar facilmente informações deste serviço. (var10)
Leonardo Martins  
17 de julho de 2016  
...
load("~/SNArRDJF/Robject/0_interactive_var10.RData")
```
...
```r
save.image("~/SNArRDJF/Robject/1_intro_var10.RData") 
```
