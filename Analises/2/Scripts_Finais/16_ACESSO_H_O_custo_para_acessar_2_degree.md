# SNA Degrees 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)
Leonardo Martins  
17 de julho de 2016  
...
```r
hist(degree(var14, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var14)/10, main="Histogram of Indegree Nodes - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
```r
hist(degree(var14, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var14)/10, main="Histogram of Outdegree Nodes - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
```r
hist(degree(var14, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var14)/10, main="Histogram of All Degree Nodes - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
```r
hist(strength(var14, weights=E(var14)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var14)/10, main="Histogram of Strength Degree Nodes - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
```r
hist(degree(var14, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var14)/10, main="Histogram of Normalized Indegree Nodes - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-20-1.png)<!-- -->
...
```r
hist(degree(var14, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var14)/10, main="Histogram of Normalized Outdegree Nodes - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-22-1.png)<!-- -->
...
```r
hist(degree(var14, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var14)/10, main="Histogram of Normalized All Degree Nodes - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-24-1.png)<!-- -->
...
```r
hist(degree.distribution(var14), breaks=vcount(var14)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-30-1.png)<!-- -->
...
```r
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14) ")
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-32-1.png)<!-- -->
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
     )
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-34-1.png)<!-- -->

#Average Neighbor Degree versus Vertex Degree (log-log scale for 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14))
...
plot(degree(var14), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
     )
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-38-1.png)<!-- -->

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14))
...
plot(degree(var14), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)"
     )
```

![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-43-1.png)<!-- -->
...
#Adding Title
  title("Network Vertex Degree Sized - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ", cex = .5)
...
![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-51-1.png)<!-- -->
...
#Adding Title
  title("Network Vertex Degree Sized and Red to Blue - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(var14, mode="in")), 
     median(degree(var14, mode="out"))
...
![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-52-1.png)<!-- -->
...
#Adding Title
  title("Network Vertex Centralization Degree Sized Spectral Colored - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(var14, mode="in")), 
     median(degree(var14, mode="out"))
...
![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-53-1.png)<!-- -->
...
#Adding Title
  title("Network Higher Than Median Degree - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
...
![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-54-1.png)<!-- -->
...
#Adding Title
  title("Network Smaller Than Median Degree - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Mean In Degree: %.2f\nMean Out Degree: %.2f",
...
![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-55-1.png)<!-- -->
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
...
![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-56-1.png)<!-- -->
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 16_ACESSO H) O custo para acessar este serviço impede a realização de ativades em conjunto. (var14)", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
...
![](16_ACESSO_H_O_custo_para_acessar_2_degree_files/figure-html/unnamed-chunk-57-1.png)<!-- -->
