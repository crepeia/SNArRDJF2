# SNA Degrees 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).
Leonardo Martins  
17 de julho de 2016  
...
load("~/SNArRDJF/Robject/1_intro_var12.RData")
```
##Reload packages
...
```r
hist(degree(var12, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var12)/10, main="Histogram of Indegree Nodes - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
```r
hist(degree(var12, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var12)/10, main="Histogram of Outdegree Nodes - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
```r
hist(degree(var12, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var12)/10, main="Histogram of All Degree Nodes - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  -15.00    2.00    5.00    8.61   10.00  142.00
```
...
```r
hist(strength(var12, weights=E(var12)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(var12)/10, main="Histogram of Strength Degree Nodes - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
```r
hist(degree(var12, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var12)/10, main="Histogram of Normalized Indegree Nodes - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-20-1.png)<!-- -->
...
```r
hist(degree(var12, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var12)/10, main="Histogram of Normalized Outdegree Nodes - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-22-1.png)<!-- -->
...
```r
hist(degree(var12, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var12)/10, main="Histogram of Normalized All Degree Nodes - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-24-1.png)<!-- -->
...
```r
hist(degree.distribution(var12), breaks=vcount(var12)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-30-1.png)<!-- -->
...
```r
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12). ")
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-32-1.png)<!-- -->
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12)."
     )
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-34-1.png)<!-- -->

#Average Neighbor Degree versus Vertex Degree (log-log scale for 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).)
...
```r
var12_a.nn.deg <- graph.knn(var12, weights =E(var12)$weight)$knn %>% round(1)
```

##Saving to igraph object

```r
V(var12)$var12_a.nn.deg <- graph.knn(var12, weights=E(var12)$weight)$knn
```
...
plot(degree(var12), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12)."
     )
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-38-1.png)<!-- -->

#Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).)
...
##  -679.0    25.2    43.2    57.7    89.9   666.0       6
```

```r
sd(var12_a.nn.deg_w, na.rm = T)
```
...
plot(degree(var12), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12)."
     )
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-43-1.png)<!-- -->
...
minC[1] <- maxC[1] <- 0
co <- layout_with_fr(var12, niter=10000, minx=minC, maxx=maxC,miny=minC, maxy=maxC, weights = E(var12)$weight)

#PLotting
plot(var12, 
     layout=co,
     edge.color=V(var12)$color[edge.start],
     edge.arrow.size=(degree(var12)+1)/1000,
     edge.width=E(var12)$weight/10,
     edge.curved = TRUE,
     vertex.size=log((degree(var12)+2))*10,
     vertex.size=20,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label=get.vertex.attribute(var12,"LABEL_COR"),
     vertex.label.cex=log((degree(var12)+2))/10,
     vertex.label.dist=0,
     rescale=F,
     xlim=range(co[,1]), 
     ylim=range(co[,2]))
...
#Adding Title
  title("Network Vertex Degree Sized - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ", cex = .5)
...
![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-51-1.png)<!-- -->
...
#Adding Title
  title("Network Vertex Degree Sized and Red to Blue - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(var12, mode="in")), 
     median(degree(var12, mode="out"))
...
![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-52-1.png)<!-- -->
...
plot(var12, 
     ...
     edge.arrow.size=(degree(var12)+1)/10000,
     edge.width=E(var12)$weight/10,
     edge.curved = TRUE,
     vertex.color=V(var12)$vertex_var12_color_degree,
    vertex.size=log((V(var12)$var12_centr_degree+2))*10,
     vertex.size=20,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label=get.vertex.attribute(var12,"LABEL_COR"),
...
#Adding Title
  title("Network Vertex Centralization Degree Sized Spectral Colored - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(var12, mode="in")), 
     median(degree(var12, mode="out"))
...
![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-53-1.png)<!-- -->
...
higherthanmedian.network_var12<-V(var12)[degree(var12)<median(degree(var12))] 

#Deleting vertices based in intersection betewenn var12 
high_var12<-delete.vertices(var12, higherthanmedian.network_var12)

#Plotting based only on degree measures 
edge.start <- ends(high_var12, es=E(high_var12), names=F)[,1]

# Fixing ego
minC <- rep(-Inf, vcount(high_var12))
maxC <- rep(Inf, vcount(high_var12))
minC[1] <- maxC[1] <- 0
co <- layout_with_fr(high_var12, niter=10000, minx=minC, maxx=maxC,miny=minC, maxy=maxC, weights = E(high_var12)$weight)

#PLotting
plot(high_var12, 
     layout=co,
     edge.color=V(high_var12)$color[edge.start],
     edge.arrow.size=(degree(high_var12)+1)/1000,
     edge.width=E(high_var12)$weight/10,
     edge.curved = TRUE,
     vertex.size=log((V(high_var12)$var12_centr_degree+2))*10,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label=get.vertex.attribute(high_var12,"LABEL_COR"),
     vertex.label.cex=log((degree(high_var12)+2))/10,
     vertex.label.dist=0,
     rescale=F,
     xlim=range(co[,1]), 
     ylim=range(co[,2]))
...
#Solving Problems with legend rendering 
a<-V(high_var12)$LABEL_COR
b<-V(high_var12)$color
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
f<-t(e$a)
...
#Adding Title
  title("Network Higher Than Median Degree - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Mean In Degree: %.2f\n Mean Out Degree: %.2f",
     mean(degree(high_var12, mode="in")), 
     mean(degree(high_var12, mode="out"))
   )
  )
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-54-1.png)<!-- -->
...
#Plotting based only on degree measures 
edge.start <- ends(small_var12, es=E(small_var12), names=F)[,1]

# Fixing ego
minC <- rep(-Inf, vcount(small_var12))
maxC <- rep(Inf, vcount(small_var12))
minC[1] <- maxC[1] <- 0
co <- layout_with_fr(small_var12, niter=10000, minx=minC, maxx=maxC,miny=minC, maxy=maxC, weights = E(small_var12)$weight)

#PLotting
plot(small_var12, 
     layout=co,
     edge.color=V(small_var12)$color[edge.start],
     edge.arrow.size=(degree(small_var12)+1)/1000,
     edge.width=E(small_var12)$weight/10,
     edge.curved = TRUE,
     vertex.size=log((V(small_var12)$var12_centr_degree+2))*20,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label=get.vertex.attribute(small_var12,"LABEL_COR"),
     vertex.label.cex=log((degree(small_var12)+2))/3,
     vertex.label.dist=0,
     rescale=F,
     xlim=range(co[,1]), 
     ylim=range(co[,2]))
...
#Adding Title
  title("Network Smaller Than Median Degree - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Mean In Degree: %.2f\nMean Out Degree: %.2f",
     mean(degree(small_var12, mode="in")), 
     mean(degree(small_var12, mode="out"))
   )
  )
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-55-1.png)<!-- -->
...
#Plotting based only on degree measures  #var12_a.nn.deg
V(var12)$var12_a.nn.deg<-as.numeric(graph.knn(var12)$knn)
V(var12)$var12_a.nn.deg[V(var12)$var12_a.nn.deg=="NaN"]<-0

#PLotting
plot(high_var12, 
     layout=co,
     edge.color=V(var12)$color[edge.start],
     edge.arrow.size=sqrt((V(var12)$var12_a.nn.deg)^2+1)/1000,
     edge.width=E(var12)$weight/100,
     edge.curved = TRUE,
     vertex.color=V(var12)$color,
     vertex.size=(sqrt((V(var12)$var12_a.nn.deg)^2))/5,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label=get.vertex.attribute(var12,"LABEL_COR"),
     vertex.label.cex=(sqrt((V(var12)$var12_a.nn.deg)^2)+1)/500,
     vertex.label.dist=0,
     rescale=F,
     xlim=range(co[,1]), 
     ylim=range(co[,2]))
...
#Adding Title
  title("Network Average Neighbor Degree Sized - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Median Average Neighbor Degree: %.2f",
     median((var12_a.nn.deg+1))
   ))
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-56-1.png)<!-- -->
...
#Plotting based only on degree measures  #var12_a.nn.deg
V(var12)$var12_a.nn.deg_w<-as.numeric(graph.knn(var12, weights = E(var12)$weight)$knn)
V(var12)$var12_a.nn.deg_w[V(var12)$var12_a.nn.deg_w=="NaN"]<-0

#PLotting
plot(high_var12, 
     layout=co,
     edge.color=V(var12)$color[edge.start],
     edge.arrow.size=sqrt((V(var12)$var12_a.nn.deg_w)^2+1)/1000,
     edge.width=E(var12)$weight/100,
     edge.curved = TRUE,
     vertex.color=V(var12)$color,
     vertex.size=(sqrt((V(var12)$var12_a.nn.deg_w)^2))/5,
     vertex.frame.color="#ffffff",
     vertex.label.color="black",
     vertex.label=get.vertex.attribute(var12,"LABEL_COR"),
     vertex.label.cex=(sqrt((V(var12)$var12_a.nn.deg_w)^2)+1)/500,
     vertex.label.dist=0,
     rescale=F,
     xlim=range(co[,1]), 
     ylim=range(co[,2]))
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - 14_ACESSO F) Seu serviço tem facilade de entrar em contato com este serviço para realizar ativades em conjunto (var12).", sub = "Source: from authors ")
  text(x=range(co[,1])[1], y=range(co[,2])[1], labels = 
   sprintf("Median Average Weighted Neighbor Degree: %.2f",
     median((var12_a.nn.deg_w+1))
   ))
```

![](14_ACESSO_F_entrar_em_contato_ara_realizar_ativades_2_degree_files/figure-html/unnamed-chunk-57-1.png)<!-- -->
...
```r
save.image("~/SNArRDJF/Robject/2_degree_var12.RData")
```
