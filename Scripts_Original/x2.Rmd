...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(x2)/10, main="Histogram of Indegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(x2)/10, main="Histogram of Outdegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(x2)/10, main="Histogram of All Degree Nodes - fuull_no_zero_fancy")
```  
...
#Histogram x2 degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(x2, weights=E(x2)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(x2)/10, main="Histogram of Strength Degree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(x2)/10, main="Histogram of Normalized Indegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(x2)/10, main="Histogram of Normalized Outdegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(x2, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(x2)/10, main="Histogram of Normalized All Degree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(x2), breaks=vcount(x2)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - fuull_no_zero_fancy")
```
