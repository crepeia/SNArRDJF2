...
#1. Descriptive Analysis for var4* - Complete Graph - All networks were generated using from this one
...
hist(degree(var4, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var4)/10, main="Histogram of Indegree Nodes - var4*")
hist(degree(var4, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var4)/10, main="Histogram of Outdegree Nodes - var4*")
hist(degree(var4, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(var4)/10, main="Histogram of All Degree Nodes - var4*")
```  
...
```{r}
V(var4)$strength_var4<- strength(var4, weights=E(var4)$var4)
strength_var4<- strength(var4, weights=E(var4)$var4)

##Stats
summary(strength_var4)
sd(strength_var4)
```
...
#Histogram var4 degree
hist(degree(var4, mode = "in", normalized = F), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var4)/10, main="Histogram of Normalized Indegree Nodes - var4*")
hist(degree(var4, mode = "out", normalized = F), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var4)/10, main="Histogram of Normalized Indegree Nodes - var4*")
hist(degree(var4, mode = "all", normalized = F), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(var4)/10, main="Histogram of Normalized All Degree Nodes - var4*")
```

#2.2.1 Centralization Degree
```{r}
V(var4)$centr_degree_var4 <- centralization.degree(var4)$res
centr_degree_var4 <- centralization.degree(var4)

#Centralization
centr_degree_var4$centralization
#Theoretical Max
centr_degree_var4$theoretical_max
```
...
hist(degree.distribution(var4), breaks=vcount(var4)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - var4*")

#Degree Probability Distribution
dd <- degree.distribution(var4, cumulative=T, mode="all")
plot(dd, pch=19, cex=1, col="orange", xlab="Degree", ylab="Cumulative Frequency", main= "Cumulative Frequency of var4* ")
```
...
plot(d[ind], 
     ...
     main="Log-Log Degree Distribution For var4*"
     )
```

#2.5.1 Average Neighbor Degree versus Vertex Degree (log-log scale for var4*)
```{r}
#Average Neighbor Degree versus vertex degree (log-log scale for var4)
a.nn.deg.var4 <- graph.knn(var4,V(var4))$knn

#Saving to igraph object
V(var4)$a.nn.deg.var4 <- a.nn.deg.var4 <- graph.knn(var4,V(var4))$knn
...
plot(degree(var4), 
     ...
     main="Average Neighbor Degree vs Vertex Degree - Log-Log Scale for var4*"
     )
```

#2.5.2 Average Weighted Neighbor Degree versus vertex degree (log-log scale for weighted var4*)
```{r}
#Average Weighted Neighbor Degree versus vertex degree (log-log scale for var4)
a.nn.deg.var4_w <- graph.knn(var4,V(var4), weights=E(var4)$var4)$knn

#Saving to igraph object
V(var4)$a.nn.deg.var4_w <-a.nn.deg.var4 <- graph.knn(var4,V(var4), weights=E(var4)$var4)$knn

#Average Weighted Neighbor Descriptive
summary(a.nn.deg.var4_w)
sd(a.nn.deg.var4_w)
...
plot(degree(var4), 
     ...
     xlab=c("Log Vertex Degree"),
     ylab=c("Log Average Neighbor Degree"),
     main="Average Weighted Neighbor Degree vs Vertex Degree - Log-Log Scale For Weighted var4*"
     )
```
...
#Adding Title
  title("Network Vertex Degree Sized - var4*", sub = "Source: from authors ")
...
```{r}
#Get Variable
V(var4)$var4_color_degree<-V(var4)$totaldegree
...
#Adding Title
  title("Network Vertex Degree Sized and Colored - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(var4, mode="in")), 
     median(degree(var4, mode="out"))
...
```{r}
#Get Variable
V(var4)$var4_color_degree<-V(var4)$centr_degree_var4
...
plot(small_var4, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(small_var4))/10,
...
#Adding Title
  title("Network Higher Than Median Degree - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
plot(small_var4, 
     ...
     vertex.label.cex=log(degree(small_var4)+2)/2,
...
#Adding Title
  title("Network Lower than Median Degree - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(small_var4, mode="in")), 
     median(degree(small_var4, mode="out"))
...
```{r}
#Plotting based only on degree measures  #a.nn.deg.var4_w 
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(graph.knn(var4,V(var4))$knn)/20,
     edge.width=(edge.betweenness(var4, weights =E(var4)$var4))/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Neighbor Degree Sized - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=sqrt(graph.knn(var4,V(var4), weights= E(var4)$var4)$knn),
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=log(graph.knn(var4,V(var4), weights= E(var4)$var4)$knn)/10,
     edge.width=edge.betweenness(var4, weights =E(var4)$var4)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Average Weighted Neighbor Degree Sized - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Average Weighte Neighbor Degree: %.2f",
     median(graph.knn(var4,V(var4), weights= E(var4)$var4)$knn)
   ))
```
...
#Saving to Igraph object
V(var4)$incloseness_w <- closeness(var4, mode = "in", normalized = T, weights=E(var4)$var4) #%>% round(6)
V(var4)$outcloseness_w <- closeness(var4, mode = "out", normalized = T,weights=E(var4)$var4) #%>% round(6)
V(var4)$totalcloseness_w <- closeness(var4, mode = "total", normalized = T, weights=E(var4)$var4) #%>% round(6)

#Saving to Environment
var4_incloseness_w<- closeness(var4, mode = "in", normalized = T, weights=E(var4)$var4) #%>% round(6)
var4_outcloseness_w<- closeness(var4, mode = "out", normalized = T, weights=E(var4)$var4) #%>% round(6)
var4_totalcloseness_w<- closeness(var4, mode = "total", normalized = T, weights=E(var4)$var4) #%>% round(6)
...
```{r}
V(var4)$closeness_stats_var4_w <- closeness(var4, vids = V(var4), mode = "all", weights =V(var4)$var4, normalized = FALSE)

closeness_stats_var4_w <- closeness(var4, vids = V(var4), mode = "all", weights =V(var4)$var4, normalized = FALSE)
```

#2.7.5 Centralization Closseness
```{r}
V(var4)$centr_closeness_var4 <- centralization.closeness(var4)$res
centr_closeness_var4 <- centralization.closeness(var4)

#Centralization
centr_closeness_var4$centralization
#Theoretical Max
centr_closeness_var4$theoretical_max
```
...
#Adding Title
  title("Network Closeness Degree Sized and Colored - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r}
#Get Variable
V(var4)$var4_color_degree<-round(V(var4)$centr_closeness_var4,3)
...
#Adding Title
  title("Network Centralization Closeness - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Closennes: %.4f\nMedian Out Closennes: %.4f",
     median(closeness(var4, mode="in")), 
     median(closeness(var4, mode="out"))
...
```{r}
V(var4)$betweenness_var4_w <- betweenness(var4, weights=E(var4)$var4) %>% round(1)

betweenness_var4_w <- betweenness(var4, weights=E(var4)$var4) %>% round(1)

##all
summary(betweenness_var4_w)
sd(betweenness_var4_w)
```

#2.8.3 Centralization Betweenness
```{r}
V(var4)$centr_betweenness_var4 <- centralization.betweenness(var4)$res
centr_betweenness_var4 <- centralization.betweenness(var4)

#Centralization
centr_betweenness_var4$centralization
#Theoretical Max
centr_betweenness_var4$theoretical_max
```
...
plot(var4, 
     ...
     edge.width=log(edge.betweenness(var4, weights =E(var4)$var4))/50,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Network Vertex Betweenness Sized - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r}
#Get Variable
V(var4)$var4_color_degree<-round(V(var4)$centr_betweenness_var4,3)
...
#Adding Title
  title("Network Centralization Betweenness - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r}
#Eigen_Centrality 
V(var4)$eigenvector <- eigen_centrality(var4, directed = TRUE, weights = V(var4)$var4) %$% vector %>% round(3)

var4_eigenvector <- eigen_centrality(var4, directed = TRUE, weights = V(var4)$var4) %$% vector %>% round(3)

#Eigenvalue Calculated Eigenvector
var4_eigenvector_value <- eigen_centrality(var4, directed = TRUE, weights = V(var4)$var4) %$% value %>% round(3) # The eigenvalue corresponding to the calculated eigenvector, i.e. the centrality scores.
```
...
```{r}
V(var4)$centr_eigen_var4 <- centr_eigen(var4, directed = T)$vector
centr_eigen_var4 <-centr_eigen(var4, directed = T)$vector
#Centralization
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=(eigen_centrality(var4)$vector)*20,
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=sqrt(eigen_centrality(var4)$vector)/2,
     edge.width=edge.betweenness(var4, weights =E(var4)$var4)/500,
     edge.curved = TRUE
     )
...
#Adding Title
  title("Eigenvector Centrality Measure - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var4, 
     ...
     vertex.frame.color="#ffffff",
     edge.arrow.size=0.1,
     vertex.label.cex=(centr_eigen(var4, directed = T)$vector + 1)/10,
     edge.width=(edge.betweenness(var4, weights =E(var4)$var4))/500,
     edge.curved = TRUE
     )
...
power_centrality_stats_var4 <- power_centrality(var4, nodes = V(var4), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var4)$power_centrality_stats_var4 <-power_centrality(var4, nodes = V(var4), loops = FALSE, exponent = 1, rescale = FALSE, tol = 1e-07, sparse = TRUE) 

#Or are you more powerful if you're connected to weak, dependent people? (negative attenuation factor)
i=sort(power_centrality_stats_var4) %>% round(3)
table_i<-cbind(V(var4)$V5_LABEL_LABEL,i)
...
d=sort(power_centrality_stats_var4, decreasing = T) %>% round(3)
table_d<-cbind(V(var4)$V5_LABEL_LABEL,d)
...
V(var4)$power_centrality_stats_var4_r<-round(V(var4)$power_centrality_stats_var4,0)

# Creating brewer pallette
vertex_col_spower <- colorRampPalette(brewer.pal(length(unique(V(var4)$power_centrality_stats_var4_r)), "Blues"))(length(unique(V(var4)$power_centrality_stats_var4_r))) 

#Saving as Vertex properties                                   
V(var4)$color_spower <- vertex_col_spower[factor(V(var4)$power_centrality_stats_var4_r)]  
```
...
#Solving Problems with legend rendering 
a<-V(var4)$power_centrality_stats_var4_r
...
#Adding Title
  title("Bonacich Power Centrality Scores of Network Positions - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Power Degree: %.2f\n SD Power Degree:%.2f",
     median(power_centrality_stats_var4),sd(power_centrality_stats_var4)
     ))
```
...
```{r, results="asis"}
#Saving power as an object
alpha_centrality_stats_var4 <- alpha_centrality(var4, loops = FALSE, alpha = 1, exo = 1, weights = V(var4)$var4, tol = 1e-07, sparse = TRUE)

#Saving power as an igraph attributte
V(var4)$alpha_centrality_stats_var4<-alpha_centrality(var4, loops = FALSE, alpha = 1, exo = 1, weights = V(var4)$var4, tol = 1e-07, sparse = TRUE)

#Descriptive 
summary(alpha_centrality_stats_var4)
sd(alpha_centrality_stats_var4)

#Or are you more powerful if you're connected to weak, dependent people? (negative attenuation factor)
i=sort(alpha_centrality_stats_var4) %>% round(3)
table_i<-cbind(V(var4)$V5_LABEL_LABEL,i)
...
#Are you more powerful if you're connected to powerful people? (positive attenuation factor)
d=sort(alpha_centrality_stats_var4, decreasing = T) %>% round(3)
table_d<-cbind(V(var4)$V5_LABEL_LABEL,d)
colnames(table_d) <- c("ID", "Power")
table_d10<-table_d[1:10,]
...
```{r}
# Set colors to plot distances:
V(var4)$alpha_centrality_stats_var4_r<-round(V(var4)$alpha_centrality_stats_var4,0)

# Creating brewer pallette
vertex_col_s <- colorRampPalette(brewer.pal(length(unique(V(var4)$alpha_centrality_stats_var4_r)), "YlOrRd"))(length(unique(V(var4)$alpha_centrality_stats_var4_r))) 

#Saving as Vertex properties                                                                  
V(var4)$color_s <- vertex_col_s[factor(V(var4)$alpha_centrality_stats_var4_r)]  
```
...
plot(var4, 
     ...
     vertex.label.color="black",
     vertex.frame.color="#ffffff",
     vertex.size=sqrt((alpha_centrality(var4, weights = V(var4)$var4)^2)),
     edge.arrow.size=0.1,
...
#Solving Problems with legend rendering 
a<-V(var4)$alpha_centrality_stats_var4_r
b<-V(var4)$color_s
c<-table(a,b)
d<-as.data.frame(c)
e<-subset(d, d$Freq>0)
...
#Adding Title
  title("Bonacich's Alpha Centrality Scores of Network Positions - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median Alpha Degree: %.2f\n SD Alpha Degree:%.2f",
     median(alpha_centrality_stats_var4),sd(alpha_centrality_stats_var4)
     ))
```
...
var4_hub<- hub.score(var4)$vector
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=10*sqrt(hub.score(var4)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var4))/10,
     edge.width=log(edge.betweenness(var4, weights =E(var4)$var4))/5,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Hub Sized - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
var4_auth <- authority.score(var4)$vector
#stats
summary(var4_auth)
sd(var4_auth)
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=10*sqrt(authority.score(var4)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var4))/10,
     edge.width=log(edge.betweenness(var4, weights =E(var4)$var4))/5,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Authorities Scores  Sized - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
plot(var4, 
     layout=layout.kamada.kawai(var4), 
     vertex.label=get.vertex.attribute(var4,"LABEL_COR"),
     vertex.size=30*sqrt(page.rank(var4)$vecto),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(var4))/10,
     edge.width=log(edge.betweenness(var4, weights =E(var4)$var4))/100,
     edge.curved = TRUE)
...
#Adding Title
  title("Network Google Page Rank Sized - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
```{r}
#For in-degrees:
indegnamesPB=which(indegPB>sort(indegPB)[vcount(var4)-5]) #For out- degrees:
outdegnamesPB=which(outdegPB>sort(outdegPB)[vcount(var4)-5]) #For PageRank:
prnamesPB=which(prPB>sort(prPB)[vcount(var4)-5]) #For Hubs:
hnamesPB=which(hPB>sort(hPB)[vcount(var4)-5]) #For Authorities:
authnamesPB=which(authPB>sort(authPB)[vcount(var4)-5])
...
plot(make_ego_graph_all_var4, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(make_ego_graph_all_var4))/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - All connections from CAPSAD - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_out_var4, 
     ...
     vertex.size=30*sqrt(page.rank(make_ego_graph_out_var4)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(make_ego_graph_out_var4))/10,
...
#Adding Title
  title("Ego Network Page Rank Sized - Out Connections from CAPSAD - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_in_var4, 
     ...
     vertex.size=30*sqrt(page.rank(make_ego_graph_in_var4)$vector),
     edge.arrow.size=0.1,
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - In connections from CAPS AD - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var4_without_CAPSAD, 
     ...
     vertex.size=30*sqrt(page.rank(make_ego_graph_all_var4_without_CAPSAD)$vector),
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(make_ego_graph_all_var4_without_CAPSAD))/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var4_without_CAPSAD))/10,
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing CAPS AD - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
plot(make_ego_graph_all_var4_without_complex, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(make_ego_graph_all_var4_without_complex))/10,
     edge.width=log(edge.betweenness(make_ego_graph_all_var4_without_complex))/10,
     edge.curved = TRUE)
...
#Adding Title
  title("Ego Network CAPS AD Page Rank Sized - All Connections Removing High Complex Service - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Mean Page Rank Scores: %.2f\n SD Page Rank Scores: %.2f",
...
#Adding Title
  title("Minimum Spanning Tree Non-normalized - from var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
msp_var4_w<-minimum.spanning.tree(var4, weights=1/edge.betweenness(var4, weights =E(var4)$var4), algorithm='prim')
...
#Plotting based only on degree measures 
plot(msp_var4_w, 
     layout=layout.kamada.kawai(msp_var4_w), 
     ...
     edge.width=1/edge.betweenness(msp_var4_w, weights =E(msp_var4_w)$msp_var4_w),
     edge.curved = TRUE
     )
...
#Adding Title
  title("Minimum Weighted Spanning Tree (Edge Betweenness) - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
...
is.connected(var4) #trick information - let's check this out further
```

#3.3.1 Strong Connected Components
```{r}
#Strong Connected
components_strong_var4<-components(var4, mode="strong")
V(var4)$components_strong_var4_membership<-components_strong_var4$membership # adding to igraph object

#Number of clusters
count_components(var4)

#Display components structure
components_strong_var4
```
...
plot(var4, 
     ...
     mark.groups = by(seq_along(components_strong_var4$membership),
                      components_strong_var4$membership, 
...
#Adding Title
  title("Network Vertex Degree Sized - Classfied by Components Structure - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
   sprintf("Median In Degree: %.2f\nMedian Out Degree: %.2f",
     median(degree(var4, mode="in")), 
     median(degree(var4, mode="out"))
...
```{r}
#Shortest Paths
var4_sp_in <- shortest.paths(var4, mode='in', weights=V(var4)$var4) # sames as bellow
var4_sp_out <- shortest.paths(var4, mode='out', weights=V(var4)$var4) #same as above
var4_sp_all <- shortest.paths(var4, mode='all', weights=V(var4)$var4) # all
...
```{r}
#All shortest paths 
distances_sp_all_var4<-distances(var4, mode="all", weights=E(var4)$var4)
#distances_sp_all_var4

#In shortest paths 
distances_sp_in_var4<-distances(var4, mode="in",weights=E(var4)$var4)
#distances_sp_in_var4

#Out shortest paths 
distances_sp_out_var4<-distances(var4, mode="out", weights=E(var4)$var4)
#distances_sp_out_var4
```

#3.7.4 Histogram from shortest path length between each pair of vertices. 
```{r}
distance_table(var4, directed = TRUE)
```
...
var4_dist.from.CAPSAD <- distances(var4, v=V(var4)[V2_LABEL_ID=="q170_CAPS...CAPS.AD"], to=V(var4), weights=V(var4)$var4)
...
#Adding Title
  title("Distance from CAPS AD - var4*", sub = "Source: from authors ")
  text(x = -1, y = -1.2, labels = 
...
cliques_var4_u_size<-sapply(cliques(var4_u), length) # clique sizes
largest_cliques(var4_u) # cliques with max number of nodes
```
...
V(as.undirected_var4_u)$vcollabel <- recode(V(as.undirected_var4_u)$vcol, "'gold' = 'Largest Clique'; else= 'Others'")
...
plot(as.undirected(var4_u), 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(as.undirected(var4_u)))/10,
     edge.width=log(edge.betweenness(as.undirected(var4_u), weights =E(as.undirected(var4_u))$var4))/5,
     edge.curved = TRUE
     )
...
```{r}
#Edge Betweenness
E(var4)$edge.btweenness<-edge.betweenness(var4, weights =E(var4)$var4)
...
E(var4)[order(var4_edge.betweenness, decreasing=T)[1:10]]
```

#3.10.1 Community detection (using edge betweenness)
```{r}
## Community structure detection based on edge betweenness
communityEdgeBetwn_var4 <- edge.betweenness.community(var4)
...
plot(comps_var41, 
     ...
     edge.arrow.size=0.1,
     vertex.label.cex=log(degree(comps_var41))/10,
...
#Non-weighted 
transitivity(var4, weights=E(var4)$var4, type="global")

#Weighted
transitivity(var4, weights=E(var4)$var4,type="weighted")
transitivity(var4, weights=E(var4)$var4,type="global")
...
transitivity_local_w<-transitivity(var4, weights=E(var4)$var4, type="barrat")
...
#Diameter Weigthed 
diameter(var4, weights=E(var4)$var4)
var4_dim<-get.diameter(var4, weights=E(var4)$var4)
var4_dim
```
...
#Adding Title
  title("Diameter of var4*", sub = "Source: from authors ", xlab="created by igraph 0")
#Adding Stats
...
node_list <- get.data.frame(var4, what = "vertices")

#Writing Node CSV 
write.csv2(node_list, "~/SNArRDJF/Banco Redes R/Networks/node_var4.csv", fileEncoding = "macintosh")

# Edge List
edge_list <- get.data.frame(var4, what = "edges") %>%
...
write.csv2(edge_list, "~/SNArRDJF/Banco Redes R/Networks/edge_var4.csv", fileEncoding = "macintosh")
