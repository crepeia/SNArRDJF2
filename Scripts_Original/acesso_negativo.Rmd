...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_negativo, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_negativo)/10, main="Histogram of Indegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_negativo, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_negativo)/10, main="Histogram of Outdegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_negativo, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_negativo)/10, main="Histogram of All Degree Nodes - fuull_no_zero_fancy")
```  
...
#Histogram acesso_negativo degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(acesso_negativo, weights=E(acesso_negativo)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_negativo)/10, main="Histogram of Strength Degree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_negativo, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_negativo)/10, main="Histogram of Normalized Indegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_negativo, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_negativo)/10, main="Histogram of Normalized Outdegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_negativo, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_negativo)/10, main="Histogram of Normalized All Degree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(acesso_negativo), breaks=vcount(acesso_negativo)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - fuull_no_zero_fancy")
```
