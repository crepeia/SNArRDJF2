...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(confianca, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(confianca)/10, main="Histogram of Indegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(confianca, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(confianca)/10, main="Histogram of Outdegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(confianca, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(confianca)/10, main="Histogram of All Degree Nodes - fuull_no_zero_fancy")
```  
...
#Histogram confianca degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(confianca, weights=E(confianca)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(confianca)/10, main="Histogram of Strength Degree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(confianca, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(confianca)/10, main="Histogram of Normalized Indegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(confianca, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(confianca)/10, main="Histogram of Normalized Outdegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(confianca, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(confianca)/10, main="Histogram of Normalized All Degree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(confianca), breaks=vcount(confianca)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - fuull_no_zero_fancy")
```
