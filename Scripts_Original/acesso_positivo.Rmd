...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "in", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Indegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "out", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Outdegree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "all", normalized = F), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of All Degree Nodes - fuull_no_zero_fancy")
```  
...
#Histogram acesso_positivo degree - All
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(strength(acesso_positivo, weights=E(acesso_positivo)$weight), ylab="Frequency", xlab="Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Strength Degree Nodes - fuull_no_zero_fancy")
```  
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "in", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Normalized Indegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "out", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Normalized Outdegree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree(acesso_positivo, mode = "all", normalized = T), ylab="Frequency", xlab="Normalized Degree",  breaks=vcount(acesso_positivo)/10, main="Histogram of Normalized All Degree Nodes - fuull_no_zero_fancy")
```
...
```{r, echo=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE}
hist(degree.distribution(acesso_positivo), breaks=vcount(acesso_positivo)/10, ylab="Frequency", xlab="Degree Distribuition", main="Histogram of Degree Distribuition - fuull_no_zero_fancy")
```
